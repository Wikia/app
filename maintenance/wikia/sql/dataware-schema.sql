...
CREATE TABLE `blobs` (
  ...
  KEY `rev_ip` (`rev_ip`)
) ENGINE=InnoDB AUTO_INCREMENT=65561448 DEFAULT CHARSET=utf8;
...
CREATE TABLE `notify_log` (
  ...
  KEY `nl_city` (`nl_city`)
) ENGINE=InnoDB AUTO_INCREMENT=3140079 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=8605 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=1154297 DEFAULT CHARSET=latin1;
...
-- Dump completed on 2009-10-23 11:07:41
