...
docker build -f base/Dockerfile -t artifactory.wikia-inc.com/sus/php-wikia-base:0ab78b3 ./base
docker push artifactory.wikia-inc.com/sus/php-wikia-base:0ab78b3
