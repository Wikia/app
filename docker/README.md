...
docker build -f base/Dockerfile -t artifactory.wikia-inc.com/sus/php-wikia-base:d1a86ff ./base
docker push artifactory.wikia-inc.com/sus/php-wikia-base:d1a86ff
