...
docker build -f base/Dockerfile -t artifactory.wikia-inc.com/sus/php-wikia-base:959312e ./base
docker push artifactory.wikia-inc.com/sus/php-wikia-base:959312e
