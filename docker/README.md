...
docker build -f base/Dockerfile -t artifactory.wikia-inc.com/sus/php-wikia-base:9af347f ./base
docker push artifactory.wikia-inc.com/sus/php-wikia-base:9af347f
