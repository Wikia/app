...
$.fn.extend({
  makeModal: function(options) {
	...
	function getModalTop() {
   	...
   	wrapper
   		.prepend('<h1 class="modalTitle color1"><div style="background-image: url(http://images.wikia.com/common/skins/monaco/images/sprite.png?20091112.1);"></div>' + this.attr('title') + '</h1>')
