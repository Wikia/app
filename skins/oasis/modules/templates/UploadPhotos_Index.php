<div id="UploadPhotos" class="UploadPhotos">
	<form action="<?= $wg->ScriptPath ?>/wikia.php?controller=UploadPhotos&method=Upload&format=html" method="POST" enctype="multipart/form-data">
		...
		<input id="upload-photos-token" type="hidden" name="token" value="">
		...
		<div class="advanced">
			...
			<a href="#" data-more="<?= wfMessage( 'oasis-upload-photos-more-options' )->escaped(); ?>" data-fewer="<?= wfMessage( 'oasis-upload-photos-fewer-options' )->escaped(); ?>"><?= wfMessage( 'oasis-upload-photos-more-options' )->escaped(); ?></a>
		</div>
