...
class OasisController extends WikiaController {
	...
	private function loadJs() {
		global $wgJsMimeType, $wgUser, $wgSpeedBox, $wgDevelEnvironment, $wgEnableAdEngineExt, $wgAdEngineDisableLateQueue, $wgAllInOne, $wgEnableRHonDesktop;
		wfProfileIn(__METHOD__);
		...
		if ($wgEnableAdEngineExt && !$wgEnableRHonDesktop && !$wgAdEngineDisableLateQueue) {
