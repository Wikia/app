	...
	<!-- ##### Begin main content #### -->
		...
		<div id="answers_ask">
			<form method="get" action="" onsubmit="return false" name="ask_form" id="ask_form">
				<input type="text" id="answers_ask_field" value="<?=htmlentities(wfMsg("ask_a_question"))?>" class="header_field alt" /><span>?</span>
				<input type="text" id="answers_category_field" value="<?=htmlentities(wfMsg("in_category"))?>" class="header_field alt" />
