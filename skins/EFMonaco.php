...
class SkinEFMonaco extends SkinTemplate {
	...
	public function initPage(&$out) {
		...
		$this->skinname  = 'efmonaco';
		$this->stylename = 'efmonaco';
		$this->template  = 'EFMonacoTemplate';
...
class EFMonacoTemplate extends QuickTemplate {
