...
$messages['he'] = array(
	...
	'asksqltext' => "ניתן להשתמש בטופס שלהלן כדי לשלוח שאילתות ישירות לבסיס הנתונים.
השתמשו בגרשיים בודדים ('כמו אלו') כדי לתחום מחרוזות מילוליות.
פעולה זו עלולה לגרום לעומס משמעותי לשרת, לכן אנא השתמשו בדף זה בחסכנות.",
	'sqlislogged' => 'שימו לב כי כל השאילתות נרשמות ביומן.',
	'sqlquery' => 'הזנת שאילתה',
	'querybtn' => 'שליחת שאילתה',
	'selectonly' => 'רק שאילתות לקריאה בלבד מורשות.',
	'querysuccessful' => 'השאילתה בוצעה בהצלחה',
...
$messages['lt'] = array(
	'asksql' => 'SQL prieiga',
	'asksql-desc' => 'Vykdo SQL užklausas [[Special:Asksql|specialiajame puslapyje]]',
	'asksqltext' => "Naudokitės šia forma norėdami įvykdyti tiesiogines užklausas duomenų bazėje.
Naudokite viengubąsias kabutes ('tokias'), norėdami apgaubti teksto eilutes.
Tai gali papildomai apkrauti serverį, taigi naudokite šią funkciją atsakingai.",
...
$messages['oc'] = array(
	...
	'asksqltext' => "Utilizatz aqueste formulari per far una requèsta dirècta dins la banca de donadas. Utilizatz los apostròfes ('atal') per las cadenas de caractèrs. Aquò pòt sovent subrecargar lo servidor. Alara, utilizatz aquesta foncion amb parsimoniá.",
	'sqlislogged' => 'Notatz plan que totas las requèstas son jornalizadas.',
	'sqlquery' => 'Picatz la requèsta',
