...
この問題については[[Special:Contact|Fandomにお問い合わせ]]ください。<br />なお、ブロックしたユーザーから次の理由も報告されています：$1',
	...
	'phalanx-view-blocker' => 'フィルタのテキストで検索：',
	'phalanx-view-blocks' => '検索フィルタ',
	'phalanx-view-id' => 'IDでフィルタを取得：',
	'phalanx-view-id-submit' => 'フィルタを取得',
...
「{{int:phalanx-edit-block}}」をクリックすると変更が保存されます。',
	...
	'phalanx-legend-input' => 'フィルタの作成と変更',
	'phalanx-legend-listing' => '有効なフィルタ',
	'phalanx-filters-intro' => '以下は、現在適用されているすべてのフィルタのリストです。下のフォームを使用すると、リストの絞り込みや検索ができます。

フィルタを削除すると、そのフィルタと関連操作のすべてにここからアクセスできなくなります。フィルタの作成と削除は[[$1|ログの特別ページ]]に記録され、削除できません。',
	'phalanx-unblock-message' => 'ブロックID#$1を削除しました',
	'phalanx-help-type-content' => 'このフィルタは、ブラックリストに登録されている語句のいずれかにコンテンツが一致する編集の保存を禁止します。',
	'phalanx-help-type-summary' => 'このフィルタは、ブラックリストに登録されている語句のいずれかに指定の概要が一致する編集の保存を禁止します。',
...
注：回答型のwikiでのみ使用できます。',
	...
	'phalanx-stats-row-per-wiki' => "ユーザー'''$2'''さんは、'''$4'''にフィルタID'''$3'''（$5）によってブロックされました（種類：'''$1'''、参照元：'''$6'''）",
	'phalanx-stats-not-implemented' => 'この機能はまだ実装されていません',
	'phalanx-stats-results' => 'ブロックログ',
	'phalanx-rule-log-header' => '以下は、ファランクス・ルールへの変更のログです。',
	'phalanx-email-rule-log-header' => '以下は、メールのファランクス・ルールへの変更のログです。',
...
Примечание: работает только на вики для ответов.',
	...
	'phalanx-user-block-reason-ip' => 'Участнику с этим IP-адресом запрещено редактировать на всём пространстве FANDOM из-за вандализма или другого нарушения, совершённого вами или другим пользователем с этим IP-адресом. 
Если вы считаете, что это ошибка, свяжитесь с [[Служебная:Contact|поддержкой FANDOM]].',
	'phalanx-user-block-reason-exact' => 'Участнику с этим именем или IP-адресом запрещено редактировать на всём пространстве FANDOM из-за вандализма или другого нарушения. 
Если вы считаете, что это ошибка, свяжитесь с [[Служебная:Contact|поддержкой FANDOM]].',
	'phalanx-user-block-reason-similar' => 'Участнику с этим именем запрещено редактировать на всём пространстве FANDOM из-за вандализма или другого нарушения. 
Если вы считаете, что это ошибка, свяжитесь с [[Служебная:Contact|поддержкой FANDOM]].',
	'phalanx-user-block-new-account' => 'Это имя пользователя не доступно для регистрации. Пожалуйста, выберите другое.',
	'phalanx-user-block-withreason-ip' => 'Участнику с этим IP-адресом запрещено редактировать на всём пространстве FANDOM из-за вандализма или другого нарушения, совершённого вами или другим пользователем с этим IP-адресом. 
Если вы считаете, что это ошибка, свяжитесь с [[Служебная:Contact|поддержкой FANDOM]].<br />Причина блокировки: $1.',
	'phalanx-user-block-withreason-exact' => 'Участнику с этим именем или IP-адресом запрещено редактировать на всём пространстве FANDOM из-за вандализма или другого нарушения. 
Если вы считаете, что это ошибка, свяжитесь с [[Служебная:Contact|поддержкой FANDOM]].<br />Причина блокировки: $1.',
	'phalanx-user-block-withreason-similar' => 'Участнику с этим именем запрещено редактировать на всём пространстве FANDOM из-за вандализма или другого нарушения. 
Если вы считаете, что это ошибка, свяжитесь с [[Служебная:Contact|поддержкой FANDOM]].<br />Причина блокировки: $1.',
	...
	'phalanx-sp-contributions-blocked-globally' => 'В настоящее время этот участник заблокирован на всём пространстве FANDOM.',
