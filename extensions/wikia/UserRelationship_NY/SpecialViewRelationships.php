...
*/
	...
	class ViewRelationships extends SpecialPage {
		...
		function ViewRelationships(){
			SpecialPage::SpecialPage("ViewRelationships");
		}
		...
		function execute(){
			...
			if(!$rel_type || !is_numeric($rel_type) || $wgDisableFoeing == true )$rel_type = 1;
			$per_page = 50;
			$per_row = 2;
			...
			*/
			...
			$invite_contacts_link = Title::makeTitle(NS_SPECIAL,"InviteEmail");
