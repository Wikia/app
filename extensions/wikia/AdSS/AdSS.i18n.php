...
$messages['en'] = array(
	...
	'adss-form-site-plan-description' => 'Get your links running across the whole wiki for one low price. 1 share is currently equal to 25% of {{SITENAME}} sponsored links and only costs $1 per day. You can cancel at any time. <br />[[FAQ | More details]]',
	'adss-form-site-plan-price' => '$1 per day for one share',
	'adss-form-page-plan-header' => 'Buy a link on just this page',
	'adss-form-page-plan-description' => 'This let you target a custom message to the best page for your product at only $1 per month, and you can cancel at any time.',
	'adss-form-page-plan-price' => '$1 per month for one link',
