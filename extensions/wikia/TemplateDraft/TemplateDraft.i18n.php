...
$messages['de'] = array(
	...
	'templatedraft-editintro' => 'Hier ist ein Entwurf deiner Vorlage, der mit unserem neuen Markup erstellt wurde. Bitte überprüfe ihn und nimm vor dem Speichern nötige Änderungen vor. Weitere Informationen findest du auf der Hilfeseite zum Thema $1 oder $2.',
	'templatedraft-approval-no-page-error' => 'Bei der Übernahme des Entwurfs ist ein Fehler aufgetreten. Dieser Entwurf wurde bereits genehmigt oder gelöscht. Bitte überprüfe [{{fullurl:{{ns:Template}}:{{PAGENAME}}}}?action=den Verlauf und die Unterschiede] für diese Vorlage.',
...
$messages['fr'] = array(
	...
	'templatedraft-editintro' => "Voici une version brouillon de votre modèle générée avec notre nouveau balisage. Veuillez la passer en revue et effectuer toute éventuelle modification avant d'enregistrer. Pour en savoir plus, veuillez $1 ou $2.",
...
$messages['it'] = array(
	...
	'templatedraft-editintro' => "Ecco una bozza del tuo template che è stata generata con il nostro nuovo markup. Per favore, controllala ed effettua le modifiche appropriate prima di salvare. Per ulteriori informazioni consulta la pagina d'aiuto $1 o $2.",
...
$messages['ja'] = array(
	...
	'templatedraft-editintro' => 'こちらは新しいマークアップで生成されたテンプレートになります。ご確認の上、必要に応じて変更してから保存してください。詳しくは$1もしくは$2のヘルプページをご参照ください。',
...
$messages['pl'] = array(
	...
	'templatedraft-editintro' => 'Tu znajduje się szkic szablonu, który został wygenerowany z użyciem naszych nowych znaczników. Zapoznaj się z nim i wprowadź zmiany przed zapisaniem. Aby uzyskać więcej informacji przejdź do strony pomocy na temat $1 lub $2.',
	'templatedraft-approval-no-page-error' => 'Wystąpił problem z zatwierdzeniem szkicu. Ten szkic został już zatwierdzony lub usunięty. Zapoznaj się z [{{fullurl:{{ns:Template}}:{{PAGENAME}}}}?action=history historią i różnicami] dla tego szablonu.',
...
$messages['ru'] = array(
	...
	'templatedraft-editintro' => 'Создан черновик вашего шаблона c новой разметкой. Просмотрите его и внесите изменения перед сохранением. Для получения подробной информации, посетите следующие страницы: $1 или $2.',
	'templatedraft-approval-no-page-error' => 'При подтверждении черновика возникла проблема. Этот черновик уже был одобрен для использования или удален. Вы можете посмотреть [{{fullurl:{{ns:Template}}:{{PAGENAME}}}}?action=history историю изменений] этого шаблона.',
	'templatedraft-approval-no-templatedraft-error' => 'При подтверждении черновика возникла проблема. Эта страница не является действительным черновиком шаблона.',
	'templatedraft-approval-success-confirmation' => 'Содержимое шаблона заменено обновленной обновленной версией из черновика шаблона. Черновик шаблона удален.',
...
$messages['zh-hans'] = array(
	...
	'templatedraft-subpage' => '模版草稿',
	'templatedraft-editintro' => '这里是从我们新标记文件中生成的模版草稿。请审核和更改之后再进行保存。有关详细信息，请在$1或$2上查看帮助页。',
...
$messages['zh-hant'] = array(
	'templatedraft-description' => '模板草稿的擴展功能',
	'templatedraft-subpage' => '模版草稿',
	'templatedraft-editintro' => '這是從我們的新標記檔案中生成的模板草稿。請審核和更改之後再進行保存。有關詳細資訊，請在$1或$2上查看幫助頁。',
	'templatedraft-approval-no-page-error' => '批准這個草稿出現錯誤。草稿可能已經被批准或刪除。請查看這個模板的[{{fullurl:{{ns:Template}}:{{PAGENAME}}}}?action=history 歷史記錄和差異]。',
	'templatedraft-approval-no-templatedraft-error' => '批准這個草稿出現錯誤。 這個頁面不被視為有效的模板草稿。',
	'templatedraft-approval-success-confirmation' => '此模板中的內容已被更新後的模板草稿版本替代。模板草稿已刪除。',
	'templatedraft-approval-summary' => '使用[[w:c:zh.community:Help:移動化訊息框|行動化訊息框]]遷移工具進行更新',
