...
$messages['es'] = array(
	...
	'templatedraft-approval-summary' => 'El Infobox se actualizó usando la herramienta de migración de [[Help:PortableInfoboxes|infobox portátil]]',
...
$messages['fr'] = array(
	...
	'templatedraft-subpage' => 'Brouillon',
	'templatedraft-editintro' => "Eh voilà ! Nous avons généré une version brouillon de votre infobox avec notre nouveau balisage. Nous allons l'enregistrer comme sous-page afin que vous puissiez la vérifier et y apporter d'éventuelles modifications. Vous voudrez peut-être $1 ou $2.",
	'templatedraft-approval-no-page-error' => "Échec d'approbation : page brouillon inexistante",
	'templatedraft-approval-no-templatedraft-error' => "Impossible d'approuver un brouillon qui ne concerne pas un modèle",
	'templatedraft-approval-success-confirmation' => 'Le contenu de ce modèle a été remplacé par la version mise à jour du modèle brouillon et le brouillon a été supprimé.',
	'templatedraft-approval-summary' => "Infobox mise à jour à l'aide de l'outil de migration des [[Help:PortableInfoboxes|infoboxes portables]]",
	...
	'templatedraft-module-subtitle-create' => "Le nouveau [[Help:PortableInfoboxes|balisage des infoboxes]] n'est pas utilisé pour ce modèle.",
	'templatedraft-module-content-create' => "Nous pouvons générer une version brouillon du balisage de votre infobox et l'enregistrer comme sous-page afin que vous puissiez la vérifier et y apporter d'éventuelles modifications.",
	'templatedraft-module-button-create' => 'Générer le balisage brouillon',
	...
	'templatedraft-module-title-approve' => 'Déplacer ce modèle brouillon',
	'templatedraft-module-content-approve' => "Vous êtes satisfait de ce brouillon et souhaitez l'appliquer au modèle en production ?",
	'templatedraft-module-button-approve' => 'Approuver ce brouillon',
...
[{{fullurl:{{ns:Template}}:{{PAGENAME}}}}?action=purge Cliquez ici pour actualiser l'aperçu ci-dessus.]",
	'templatedraft-module-editintro-please-convert' => 'Nous pouvons générer une version brouillon de votre infobox avec notre nouveau balisage. Il vous suffit de cliquer sur $1.',
	'templatedraft-module-view-parent' => 'afficher le wikitexte du modèle parent',
	'templatedraft-module-help' => "afficher la page d'aide sur le balisage des infoboxes",
...
$messages['ja'] = array(
	...
	'templatedraft-module-subtitle-create' => 'このテンプレートでは、新しい[[Help:PortableInfoboxes|インフォボックスのマークアップ]]を使用していません。',
	'templatedraft-module-content-create' => '既存のインフォボックスからマークアップのドラフト版を生成するとサブページとして保存されるので、内容を確認しながら必要に応じて変更を加えることができます。',
	'templatedraft-module-button-create' => 'ドラフトのマークアップを生成する',
...
[{{fullurl:{{ns:Template}}:{{PAGENAME}}}}?action=purge ここをクリックすると上のプレビューを更新できます]',
	...
	'templatedraft-module-view-parent' => '親テンプレートのウィキテキストを表示する',
...
$messages['pl'] = array(
	...
	'templatedraft-approval-summary' => 'Infoboks został uaktualniony przy użyciu narzędzia do migracji do [[Pomoc:PortableInfobox|przenośnych infoboksów]]',
	...
	'templatedraft-module-subtitle-create' => 'Ten szablon nie korzysta z nowych [[Pomoc:PortableInfobox|znaczników infoboksów]].',
...
$messages['ru'] = array(
	...
	'templatedraft-editintro' => 'Вы создали модульную версию вашего инфобокса, построенного на основе новой разметки. Она будет сохранена на подстранице, где вы сможете проверить изменения и внести поправки, если требуется. Вы можете $1 или $2.',
	...
	'templatedraft-approval-success-confirmation' => 'Содержимое этого шаблона было заменено новой версией из черновика, и черновая версия была удалена',
	'templatedraft-approval-summary' => 'Инфобокс был обновлён с помощью конвертера [[Справка:Модульные инфобоксы|модульных инфобоксов]]',
	...
	'templatedraft-module-subtitle-create' => 'Этот шаблон не использует новую [[Справка:Модульные инфобоксы|модульную разметку]] инфобоксов.',
	...
	'templatedraft-module-button-create' => 'Генерация модульной разметки',
...
$messages['zh-hans'] = array(
	...
	'templatedraft-approval-summary' => '使用[[Help:PortableInfoboxes|可移动信息框]]迁移工具更新的信息框',
	'templatedraft-draft-removal-summary' => '清理。被批准为父页面的草稿。',
	'templatedraft-module-title-create' => '迁移此信息框',
	'templatedraft-module-subtitle-create' => '此模版不使用新的[[Help:PortableInfoboxes|信息框标记文件]]。',
...
$messages['zh-hant'] = array(
	...
	'templatedraft-approval-summary' => '使用[[Help:PortableInfoboxes|可移動的信息框]]遷移工具更新的資訊框',
	'templatedraft-draft-removal-summary' => '清理。被批准為父頁面的草稿',
	'templatedraft-module-title-create' => '遷移這個資訊框',
	'templatedraft-module-subtitle-create' => '這個模版不使用新的[[Help:PortableInfoboxes|資訊標記文件]]。',
