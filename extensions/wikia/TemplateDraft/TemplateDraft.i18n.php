...
$messages['fr'] = array(
	...
	'templatedraft-editintro' => "Voici une version de travail de votre modèle générée avec notre nouveau code. Veuillez la passer en revue et effectuer toute éventuelle modification avant d'enregistrer. Pour en savoir plus, veuillez $1 ou $2.",
...
$messages['it'] = array(
	...
	'templatedraft-editintro' => "Ecco una bozza del tuo template che è stata generata con il nostro nuovo markup. Per favore, controllala ed effettua le modifiche desiderate prima di salvare. Per ulteriori informazioni consulta la pagina d'aiuto $1 o visualizza $2.",
...
$messages['ru'] = array(
	...
	'templatedraft-editintro' => 'Создан черновик вашего шаблона c новой разметкой. Просмотрите его и внесите изменения перед сохранением. Для получения подробной информации посетите страницу справки $1 или посмотрите $2.',
...
[{{fullurl:{{ns:Template}}:{{PAGENAME}}}}?action=purge Нажмите здесь, чтобы обновить шаблон выше]',
	...
	'templatedraft-module-help' => 'Разметка инфобоксов',
