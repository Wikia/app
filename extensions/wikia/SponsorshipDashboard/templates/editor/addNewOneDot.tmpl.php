...
<form class="sd-form sd-sub-form sd-monthly">
	<input type="hidden" name="sourceType" value="OneDot" />
	...
	<div class="sd-source-title"> <?=wfMsg('sponsorship-dashboard-source-datasource');?> <b>#1</b>: <?=wfMsg('sponsorship-dashboard-source-OneDot'); ?></div>
	<div> <?=wfMsg('sponsorship-dashboard-source-main-wiki');?> <input name="<?=SponsorshipDashboardSourceOneDot::SD_PARAMS_ONEDOT_CITY_ID; ?>" class="validate-number sd-short" type="text" value="<?=$data[SponsorshipDashboardSourceOneDot::SD_PARAMS_ONEDOT_CITY_ID]; ?>" ></div>
