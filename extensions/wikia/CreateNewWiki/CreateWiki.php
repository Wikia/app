...
class CreateWiki {
	...
	public function __construct( $name, $domain, $language, $vertical, $categories, $fcCommunityId = null ) {
		$this->taskContext = TaskContext::newFromUserInput( $name, $domain, $language, $vertical, $categories, $fcCommunityId );
	}
