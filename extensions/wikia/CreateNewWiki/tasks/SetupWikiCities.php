...
class SetupWikiCities implements Task {
	...
	public function run() {
		...
		wfDebugLog( "createwiki", __METHOD__ . ": Row added added into city_list table, city_id = {$this->taskContext->getCityId()}\n", true );
		...
		wfDebugLog( "createwiki", __METHOD__ . ": Row added into city_domains table, city_id = {$this->taskContext->getCityId()}\n", true );
	}
	...
	private function addToCityList() {
		...
		$insertFields = array(
			...
			'city_umbrella'       => $this->taskContext->getName()
		);
