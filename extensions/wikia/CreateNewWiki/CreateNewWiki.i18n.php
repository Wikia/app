...
$messages['ru'] = array(
	...
	'autocreatewiki-welcometalk-wall' => 'Здравствуйте. Я представляю команду поддержки FANDOM. Мы рады, что сообщество {{subst:SITENAME}} стала частью FANDOM. 
...
*Наконец, не забывайте о [[w:c:ru.community:Справка:Содержание|Справке]], на страницах которой вы узнаете обо всех особенностях использования FANDOM, или посмотрите видеоуроки [[w:c:ru.community:Университет FANDOM|Университета FANDOM]].

Удачи!',
	'autocreatewiki-welcometalk' => '== Добро пожаловать! ==
Привет,

Мы рады, что «$4» стала частью сообществ FANDOM. Вам ещё многое предстоит сделать, поэтому позвольте дать несколько советов и полезных ссылок, которые помогут вам начать работу.
...
*Загляните на [[w:c:ru.community|Вики Сообщества]], чтобы найти последние новости из [[w:c:ru.community.wikia.com/wiki/Блог:Блоги_сотрудников|блогов сотрудников]]. Вы можете задать вопросы на нашем [[w:c:ru.community:Special:Forum|форуме]], посмотреть видеоуроки [[w:c:ru.community:Университет FANDOM|Университета FANDOM]] или общаться в [[w:c:ru.community:Special:Chat|чате]] с другими участниками.
*Наконец, не забывайте о [[w:c:ru.community:Справка:Содержание|Справке]], на страницах которой вы узнаете обо всех особенностях использования FANDOM.
