...
$messages['it'] = array(
	...
	'cnw-theme-creative' => 'Selezione uno dei nostri temi che meglio si adatta alla tua wiki.',
	'cnw-theme-instruction' => 'Puoi personalizzare il look della tua wiki in Theme Designer ogni volta che vuoi!',
...
$messages['ja'] = array(
	...
	'cnw-name-wiki-headline' => '新しいwikiの名称を入力してください（日本語使用可）',
	'cnw-name-wiki-creative' => '世界中で大人気のエンターテイメントに関するコミュニティでも、個人的なプロジェクトについてのコミュニティでも、そのコミュニティを適切に表す名前が必要です。',
	...
	'cnw-desc-placeholder' => 'この説明はwikiのメインページに表示されますが、後からいつでも変更できます。',
	'cnw-desc-tip1' => 'Point ①',
	...
	'cnw-theme-creative' => 'このwikiに最もふさわしいテーマを1つ選択してください。',
	'cnw-theme-instruction' => 'Wikiのデザインは、テーマデザイナーでいつでもカスタマイズできます。',
	'cnw-welcome-headline' => '$1 が作成されました！',
	'cnw-welcome-instruction1' => '下のボタンをクリックすると、wikiに新しいページを追加できます。',
...
',
	...
	'cnw-name-wiki-domain' => '.wikia.com',
	'cnw-theme-loading-state' => 'Wikiを作成しています。この間に必要であればテーマを変更していただけます。',
...
$messages['pl'] = array(
	...
	'cnw-desc-creative' => 'Jak opisałbyś twoją wiki?',
	...
	'right-finishcreate' => 'Proces tworzenia wiki może zostać zakończony',
);
...
$messages['ru'] = array(
	...
	'cnw-name-wiki-creative' => 'Какой бы ни была тема вашего википроекта, – сенсация в мире развлечений или личный проект – ему нужно уникальное, интересное название:',
	...
	'cnw-desc-placeholder' => 'Это описание будет отображаться на заглавной странице вашей вики. Не беспокойтесь, вы можете изменить в любой момент.',
	...
	'cnw-desc-tip-all-ages' => 'Тема википроекта будет интересна детям? В соответствии с законодательством США, мы отслеживаем проекты по темам, которые предназначены для детей в возрасте до 12 лет.',
	...
	'cnw-theme-creative' => 'Выберите тему, которая лучше всего подходит для вашей вики.',
	'cnw-theme-instruction' => 'С помощью конструктора темы вы можете в любой момент изменить дизайн вашей вики!',
	'cnw-welcome-headline' => 'Поздравляем! Вики «$1» создана',
	'cnw-welcome-instruction1' => 'Нажмите на кнопку ниже, чтобы начать создавать страницы на вики.',
	...
	'cnw-name-wiki-language' => '',
	'cnw-name-wiki-domain' => '.wikia.com',
	'cnw-theme-loading-state' => 'Создание вики. Сейчас вы можете изменить тему.',
...
$messages['zh-hans'] = array(
	...
	'cnw-name-wiki-creative' => '无论社区关注的是世界级的娱乐焦点或者是个人项目，它都需要一个独特的名称：',
...
$messages['zh-hant'] = array(
	...
	'cnw-name-wiki-creative' => '無論社群關注的是世界級的娛樂焦點或者是個人專案，它都需要一個獨特的名稱：',
	...
	'cnw-name-wiki-domain' => '.wikia.com',
	'cnw-desc-tip2' => '提示2：',
	'cnw-desc-select-vertical' => '選擇一個主題中心︰',
	...
	'cnw-theme-loading-state' => '創建您的Wiki。在此期間，您可以更改您的主題。',
