...
$messages['en'] = array(
	...
	'cnw-name-wiki-submit-error' => 'Make sure all the fields are filled with valid entries above.',
	// step2 - signup/login
	'cnw-login' => 'Log In',
	...
	'cnw-auth-headline' => 'Start a wiki',
	'cnw-auth-creative' => 'Log in to your account to continue building your wiki.',
	'cnw-auth-signup-creative' => 'You will need an account to continue building your wiki.<br />It only takes a minute to sign up!',
	// step3 - wiki description
	'cnw-desc-headline' => 'What is your wiki about?',
	'cnw-desc-creative' => 'Describe your topic',
	'cnw-desc-placeholder' => 'This will appear on the main page of your wiki.',
	'cnw-desc-tip1' => 'Tip 1',
	'cnw-desc-tip1-creative' => 'Tell people what your wiki is about',
	'cnw-desc-tip2' => 'Tip 2',
	'cnw-desc-tip2-creative' => 'Be sure to add details',
	'cnw-desc-tip3' => 'Tip 3',
	'cnw-desc-tip3-creative' => 'Invite people to help by editing',
	...
	// step4 - select theme
	'cnw-theme-headline' => 'Design your wiki',
	'cnw-theme-creative' => 'Choose a theme that fits your wiki.',
	'cnw-theme-instruction' => 'You can change your theme or design your own any time by using "My Tools" located on the toolbar at the bottom of the page.',
	// step5 - upgrade
...
Upgrade through PayPal to get an ad-free wiki for only $4.95 per month!',
	...
	'cnw-welcome-headline' => 'Congratulations, you have created $1',
	'cnw-welcome-instruction1' => 'Now click the button below to start filling your wiki with info:',
	'cnw-welcome-instruction2' => 'You will see this button throughout your wiki.<br />Use it any time you want to add a new page.',
