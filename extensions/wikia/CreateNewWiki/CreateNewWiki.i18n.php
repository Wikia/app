...
$messages['af'] = array(
	...
	'cnw-name-wiki-headline' => "Begin 'n Wiki", # Fuzzy
	'cnw-signup' => 'Skep gebruiker',
	'cnw-auth-facebook-login' => 'Teken aan met Facebook',
	'cnw-desc-headline' => 'Waaroor gaan u wiki?', # Fuzzy
	'cnw-desc-creative' => 'Beskryf u onderwerp', # Fuzzy
	'cnw-desc-tip1' => 'Wenk', # Fuzzy
	'cnw-desc-tip2' => 'Pst!', # Fuzzy
	'cnw-desc-select-one' => 'Kies een',
	'cnw-desc-default-lang' => 'Die hooftaal van u wiki is: $1', # Fuzzy
...
$messages['ar'] = array(
	...
	'cnw-name-wiki-headline' => 'بدء ويكي', # Fuzzy
	'cnw-name-wiki-creative' => 'ويكيا هو أفضل مكان لبناء موقع على شبكة الإنترنت وتنمية مجتمع حول ما تحب.', # Fuzzy
	'cnw-name-wiki-label' => 'اختر اسما للويكي', # Fuzzy
	'cnw-name-wiki-domain-label' => 'اختر عنوان للويكي', # Fuzzy
	...
	'cnw-desc-creative' => 'يساعد الوصف الناس لكي يجدوا الويكي الخاصة بك', # Fuzzy
	'cnw-desc-placeholder' => 'سوف يظهر هذا عل الصفحة الرئيسية في الويكي', # Fuzzy
	'cnw-desc-tip1' => 'نصيحة', # Fuzzy
	'cnw-desc-tip1-creative' => 'استخدم هذه المساحة لتقول للناس حول الويكيا الخاصة بك في جملة أو اثنين', # Fuzzy
	'cnw-desc-tip2' => 'ملاحظة', # Fuzzy
	'cnw-desc-tip2-creative' => 'قم بإعطاء الزوار بعض التفاصيل حول موضوع هذه الويكي', # Fuzzy
	'cnw-desc-select-vertical' => 'اختر المحور', # Fuzzy
	'cnw-desc-select-categories' => 'أختر تصنيفات اضافية', # Fuzzy
	...
	'cnw-desc-default-lang' => 'سوف تكون هذه الويكي باللغة $1', # Fuzzy
	'cnw-desc-change-lang' => 'تغيير',
	'cnw-desc-lang' => 'اللغة',
	'cnw-desc-wiki-submit-error' => 'الرجاء اختيار فئة',
	'cnw-theme-headline' => 'إختيار المظهر',
	'cnw-theme-creative' => 'اختر أحد المظاهر أدناه، سوف تتمكن من رؤية معاينة حول كل مظهر لكي تختاره', # Fuzzy
	'cnw-theme-instruction' => 'يمكنك أيضا تصميم مظهر خاص بك في وقت لاحق عن طريق "أدواتي".', # Fuzzy
	'cnw-welcome-headline' => 'تهانينا! لقد تم إنشاء $1', # Fuzzy
	'cnw-welcome-instruction1' => 'انقر الزر أدناه لبدء إضافة صفحات في الويكي الخاص بك.', # Fuzzy
	'cnw-welcome-help' => 'إبحث عن إجابات و نصائح و معلومات أكثر في  <a href="http://ar.wikia.com"> مركز ويكيا</a>.', # Fuzzy
...
$messages['avk'] = array(
	...
	'cnw-name-wiki-headline' => 'Bokara va wiki', # Fuzzy
	'cnw-name-wiki-creative' => 'Wikia tir telo xonyo ta kolnara va internetxo is laumara ke doda aname rinaf albaks.', # Fuzzy
	'cnw-name-wiki-label' => 'Yoltara va bati wiki', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Bazera va mane tori bati wiki', # Fuzzy
	'cnw-login' => 'Dogluyara',
	...
	'cnw-desc-headline' => 'Toka watsa ke bati wiki tir ?', # Fuzzy
	'cnw-desc-creative' => 'Va bate detce pimtal', # Fuzzy
	'cnw-desc-placeholder' => 'Batcoba moe emudexo ke wiki awitir.', # Fuzzy
	'cnw-desc-tip1' => 'Palsera', # Fuzzy
	'cnw-desc-tip2' => 'Psst', # Fuzzy
	'cnw-desc-tip2-creative' => 'Va yona aptolafa pinta pu worasik icde rinafa watsa bilder', # Fuzzy
	'cnw-desc-select-one' => 'Va tanoy rebal',
	'cnw-desc-default-lang' => 'Bati wiki dene $1 tigitir', # Fuzzy
	'cnw-desc-change-lang' => 'betara',
	'cnw-desc-lang' => 'Ava',
	'cnw-desc-wiki-submit-error' => 'Va loma vay kiblal',
	'cnw-theme-headline' => 'Kiblara va watsa',
	'cnw-welcome-headline' => 'Sendara ! $1 su zo redur', # Fuzzy
	'cnw-welcome-instruction1' => 'Ta loplekura va bu den bati wiki va vlevefo uzadjo vulegal.', # Fuzzy
...
$messages['azb'] = array(
	...
	'cnw-name-wiki-headline' => 'یئنی بیر ویکی باشلات', # Fuzzy
	'cnw-name-wiki-label' => 'ویکینیزین آدی', # Fuzzy
	'cnw-name-wiki-domain-label' => 'ویکینیزی بیر آدرس سئچینیز', # Fuzzy
	'cnw-login' => 'گیر',
...
$messages['bar'] = array(
	...
	'cnw-name-wiki-headline' => 'A Wiki starten', # Fuzzy
	'cnw-name-wiki-creative' => 'Wikia is da béste Ort, um rund um deih Liablingsthéma a Webseiten afzbaun und a Gmoahschoft woxen zan lossen.', # Fuzzy
	'cnw-name-wiki-label' => 'Gib an Wiki an Naum', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Gib deim Wiki a Adress', # Fuzzy
);
...
$messages['bg'] = array(
	...
	'cnw-name-wiki-headline' => 'Създаване на уики', # Fuzzy
	'cnw-name-wiki-creative' => 'Уикия е най-доброто място за изграждане на уебсайт и изграждане на общност около темите, които ви вълнуват.', # Fuzzy
	'cnw-name-wiki-label' => 'Изберете име на уикито', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Изберете адрес на уикито', # Fuzzy
	...
	'cnw-desc-headline' => 'За какво е вашето уики?', # Fuzzy
	'cnw-desc-creative' => 'Опишете темата', # Fuzzy
	'cnw-desc-placeholder' => 'Съдържанието от тази кутия ще бъде публикувано на началната страница на вашето уики.', # Fuzzy
	'cnw-desc-tip1' => 'Съвет', # Fuzzy
	'cnw-desc-tip1-creative' => 'Използвайте това пространство, за да разкажете и опишете с едно-две изречение вашето уики пред потребителите', # Fuzzy
	'cnw-desc-tip2' => 'Псст', # Fuzzy
	'cnw-desc-select-one' => 'Избиране',
	'cnw-desc-all-ages' => 'Всички възрасти', # Fuzzy
	'cnw-desc-default-lang' => 'Вашето уики ще бъде на $1', # Fuzzy
	...
	'cnw-theme-creative' => 'Изберете тема от списъка по-долу; можете да видите предварителен преглед на всяка тема, като я изберете.', # Fuzzy
	'cnw-theme-instruction' => 'Също така можете да направите своя тема по-късно като отидете в „Моите инструменти“.', # Fuzzy
	'cnw-welcome-headline' => 'Поздравления! Уикито $1 беше създадено', # Fuzzy
	'cnw-welcome-instruction1' => 'Щракнете върху бутона по-долу, за да започнете да добавяте страници към вашето уики.', # Fuzzy
	'cnw-welcome-help' => 'Можете да откриете отговори, съвети и други полезни неща в <a href="http://community.wikia.com">Централната общност</a>.', # Fuzzy
...
$messages['bgn'] = array(
	...
	'cnw-back' => 'بیئرگشت',
	'cnw-or' => 'یا',
	'cnw-name-wiki-headline' => 'یک ویکی ئی شرو کورتین', # Fuzzy
...
$messages['br'] = array(
	...
	'cnw-name-wiki-headline' => 'Kregiñ gant ur wiki', # Fuzzy
	'cnw-name-wiki-creative' => "Wikia eo al lec'h gwellañ evit sevel ul lec'hienn wiki ha lakaat ur gumuniezh da greskiñ en-dro d'ar pezh a garit.", # Fuzzy
	'cnw-name-wiki-label' => "Roit un anv d'ho wiki", # Fuzzy
	'cnw-name-wiki-domain-label' => "Roit ur chomlec'h d'ho wiki", # Fuzzy
	...
	'cnw-desc-creative' => 'Gant ho teskrivadur e vo skoazellet an dud da gavout ho wikia', # Fuzzy
	'cnw-desc-placeholder' => 'Dont a ray war wel war bajenn bennañ ho wiki.', # Fuzzy
	'cnw-desc-tip1' => 'Tun', # Fuzzy
	'cnw-desc-tip1-creative' => "Implijit ar c'horn-mañ da zisplegañ d'an dud krak-ha-berr eus petra zo kaoz en ho wikia", # Fuzzy
	'cnw-desc-tip2' => 'Kuzul 2', # Fuzzy
	'cnw-desc-tip2-creative' => 'Merkit un nebeud displegadurioù war an danvez evit ar weladennerien', # Fuzzy
	'cnw-desc-select-vertical' => 'Dibab un tem', # Fuzzy
	'cnw-desc-select-categories' => 'Dibab ar rummadoù ouzhpenn', # Fuzzy
	...
	'cnw-desc-default-lang' => 'E $1 e vo ho wiki', # Fuzzy
	'cnw-desc-change-lang' => 'kemmañ',
	'cnw-desc-lang' => 'Yezh',
	'cnw-desc-wiki-submit-error' => 'Dibabit ur rummad, mar plij',
	'cnw-theme-headline' => 'Krouit ho wiki',
	'cnw-theme-creative' => "Dibabit un dodenn amañ dindan, gellout a reoc'h rakwelet pep dodenn en ur ziuzañ anezhi.", # Fuzzy
	'cnw-theme-instruction' => 'Gellout a rit ivez krouiñ ho todenn hiniennel un tamm diwezhatoc\'h en ur vont e "Ma ostilhoù".', # Fuzzy
	'cnw-welcome-headline' => "Gourc'hemennoù, krouet hoc'h eus $1", # Fuzzy
	'cnw-welcome-instruction1' => "Klikit war ar bouton amañ dindan evit kregiñ da ouzhpennañ pajennoù d'ho wiki.", # Fuzzy
	'cnw-welcome-help' => 'Kavout a reot respontoù, kuzulioù ha kement zo war <a href="http://community.wikia.com">Kalonenn ar gumuniezh</a>.', # Fuzzy
...
$messages['ca'] = array(
	...
	'cnw-name-wiki-headline' => 'Començar un Wiki', # Fuzzy
	'cnw-name-wiki-creative' => "Wikia és el millor lloc per construir un lloc web i fer créixer una comunitat al voltant del que t'agrada.", # Fuzzy
	'cnw-name-wiki-label' => 'Nom del teu wiki', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Dóna el teu wiki una adreça', # Fuzzy
	...
	'cnw-desc-creative' => 'La teva descripció ajudarà a la gent a troba el teu wiki', # Fuzzy
	'cnw-desc-placeholder' => 'Això apareixerà a la pàgina principal del teu wiki.', # Fuzzy
	'cnw-desc-tip1' => 'Suggerència', # Fuzzy
	'cnw-desc-tip1-creative' => 'Utilitza aquest espai per dir a la gent coses sobre el teu wiki en un parell de frases', # Fuzzy
	'cnw-desc-tip2' => 'Suggerència 2', # Fuzzy
	'cnw-desc-tip2-creative' => 'Dóna als teus visitants alguns detalls específics sobre el tema', # Fuzzy
	'cnw-desc-select-vertical' => 'Seleccioneu un Hub', # Fuzzy
	'cnw-desc-select-categories' => 'Seleccioneu categories addicionals', # Fuzzy
	...
	'cnw-desc-default-lang' => 'El teu wiki serà en $1', # Fuzzy
	...
	'cnw-theme-creative' => "Tria un tema que s'ajusti al teu wiki.", # Fuzzy
	'cnw-theme-instruction' => 'Pots canviar el tema o dissenyar el teu propi en qualsevol moment utilitzant "Les meves Eines" situat en la barra d\'eines en la part inferior de la pàgina.', # Fuzzy
	'cnw-welcome-headline' => 'Felicitats! Has creat $1', # Fuzzy
	'cnw-welcome-instruction1' => 'Fes clic al botó de sota per començar a afegir pàgines al teu wiki.', # Fuzzy
	'cnw-welcome-help' => 'Troba respostes, assessorament i més informació a <a href="http://ca.wikia.com">Comunitat Central</a>.', # Fuzzy
...
$messages['cs'] = array(
	...
	'cnw-name-wiki-headline' => 'Vytvořit Wiki', # Fuzzy
	'cnw-name-wiki-creative' => 'Wikia je nejvhodnějším místem pro vytvoření takové webové stránky, kterou bude spravovat milující komunita.', # Fuzzy
	'cnw-name-wiki-label' => 'Název vaší wiki', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Dejte vaší wiki adresu', # Fuzzy
...
$messages['cy'] = array(
	...
	'cnw-name-wiki-headline' => 'Dechrau wici', # Fuzzy
...
$messages['de'] = array(
	...
	'cnw-name-wiki-headline' => 'Ein Wikia starten',
...
$messages['diq'] = array(
	...
	'cnw-name-wiki-headline' => 'Wikiyo newe pêkerdış', # Fuzzy
	'cnw-name-wiki-label' => 'Nameyê wikiyê şıma', # Fuzzy
	'cnw-login' => 'Qeyd be',
...
$messages['fi'] = array(
	...
	'cnw-name-wiki-creative' => 'Wikia on paras paikka rakentaa nettisivu ja kasvattaa yhteisö sen ympärille.', # Fuzzy
	'cnw-name-wiki-label' => 'Nimeä wikisi', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Anna wikillesi osoite', # Fuzzy
	...
	'cnw-desc-creative' => 'Hyvä kuvaus auttaa ihmisiä löytämään wikiasi', # Fuzzy
	'cnw-desc-placeholder' => 'Tämä ilmestyy wikisi etusivulle.', # Fuzzy
	'cnw-desc-tip1' => 'Vihje', # Fuzzy
	'cnw-desc-tip1-creative' => 'Käytä tätä tilaa kertomaan ihmisille wikiastasi parilla lauseella', # Fuzzy
	'cnw-desc-tip2' => 'Psst', # Fuzzy
	'cnw-desc-tip2-creative' => 'Kerro vierailijoille jotain erityisiä tietoja aiheestasi', # Fuzzy
	...
	'cnw-desc-default-lang' => 'Wikisi kieli tulee olemaan $1', # Fuzzy
	'cnw-desc-change-lang' => 'vaihda',
	'cnw-desc-lang' => 'Kieli',
	'cnw-desc-wiki-submit-error' => 'Valitse luokka',
	'cnw-theme-headline' => 'Valitse teema',
	'cnw-theme-creative' => 'Valitse alta teema, näet esikatselun jokaisesta teemasta kun valitset sen.', # Fuzzy
	'cnw-theme-instruction' => 'Pystyt myös suunnittelemaan oman teema myöhemmin menemällä "Omiin työkaluihin".', # Fuzzy
	'cnw-welcome-headline' => 'Onnittelut! $1 on luotu', # Fuzzy
	'cnw-welcome-instruction1' => 'Klikkaa painiketta alta aloittaaksesi sivujen lisäämisen wikiisi.', # Fuzzy
	'cnw-welcome-help' => 'Löydä vastauksia, neuvoa, ja muuta <a href="http://community.wikia.com">Community Central:sta</a>', # Fuzzy
...
$messages['fo'] = array(
	...
	'cnw-name-wiki-headline' => 'Byrja eina Wiki', # Fuzzy
	'cnw-name-wiki-label' => 'Navngev tína wiki', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Gev tínari wiki ein bústað', # Fuzzy
	...
	'cnw-desc-headline' => 'Hvat snýr tín wiki seg um?', # Fuzzy
	'cnw-desc-creative' => 'Skriva frágreiðign um títt evni', # Fuzzy
	'cnw-desc-placeholder' => 'Hetta verður víst á forsíðuni á tínari wiki.', # Fuzzy
	'cnw-desc-select-one' => 'Vel ein',
	'cnw-desc-all-ages' => 'Allir aldursbólkar', # Fuzzy
...
$messages['fr'] = array(
	...
	'cnw-name-wiki-headline' => 'Commencer un wikia',
...
$messages['gl'] = array(
	...
	'cnw-name-wiki-headline' => 'Comezar un wiki', # Fuzzy
	'cnw-name-wiki-creative' => 'Wikia é o mellor sitio para construír unha páxina web e facer medrar unha comunidade ao redor do tema que lle gusta.', # Fuzzy
	'cnw-name-wiki-label' => 'Déalle un nome ao seu wiki', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Déalle un enderezo ao seu wiki', # Fuzzy
	...
	'cnw-desc-placeholder' => 'Isto aparecerá na páxina principal do seu wiki.', # Fuzzy
	'cnw-desc-tip1' => 'Suxestión', # Fuzzy
	'cnw-desc-tip1-creative' => 'Use este espazo para contar á xente de que vai o wiki nunha ou dúas oracións', # Fuzzy
	'cnw-desc-tip2' => 'Consello', # Fuzzy
	'cnw-desc-tip2-creative' => 'Dea aos visitantes algúns detalles específicos sobre o tema', # Fuzzy
	'cnw-desc-select-vertical' => 'Seleccione unha categoría Hub', # Fuzzy
	...
	'cnw-desc-default-lang' => 'O seu wiki será en $1', # Fuzzy
	'cnw-desc-change-lang' => 'cambiar',
	'cnw-desc-lang' => 'Lingua',
	'cnw-desc-wiki-submit-error' => 'Seleccione unha categoría',
	'cnw-theme-headline' => 'Escolla un tema visual',
	'cnw-theme-creative' => 'Escolla un dos temas visuais que hai a continuación; verá unha vista previa do tema cando o seleccione.', # Fuzzy
	'cnw-theme-instruction' => 'Tamén pode deseñar o seu propio tema visual máis tarde indo ata "As miñas ferramentas".', # Fuzzy
	'cnw-welcome-headline' => 'Parabéns! Creouse $1', # Fuzzy
	'cnw-welcome-instruction1' => 'Prema no botón que hai a continuación para comezar a engadir páxinas ao seu wiki.', # Fuzzy
	'cnw-welcome-help' => 'Atope respostas, consellos e máis cousas na <a href="http://community.wikia.com">central da comunidade</a>.', # Fuzzy
...
$messages['ia'] = array(
	...
	'cnw-name-wiki-headline' => 'Comenciar un wiki', # Fuzzy
	'cnw-name-wiki-creative' => 'Wikia es le optime loco pro construer un sito web e cultivar un communitate circa lo que tu ama.', # Fuzzy
	'cnw-name-wiki-label' => 'Nomina tu wiki', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Da un adresse a tu wiki', # Fuzzy
	...
	'cnw-desc-headline' => 'Que es le thema de tu wiki?', # Fuzzy
	'cnw-desc-creative' => 'Describe tu topico', # Fuzzy
	'cnw-desc-placeholder' => 'Isto apparera in le pagina principal de tu wiki.', # Fuzzy
	'cnw-desc-tip1' => 'Consilio', # Fuzzy
	'cnw-desc-tip1-creative' => 'Usa iste spatio pro explicar le thema de tu wiki al visitatores in un phrase o duo', # Fuzzy
	'cnw-desc-tip2' => 'Psst', # Fuzzy
	'cnw-desc-tip2-creative' => 'Specifica al visitatores alcun detalios a proposito de tu thema', # Fuzzy
	'cnw-desc-select-one' => 'Selige un',
	'cnw-desc-default-lang' => 'Tu wiki essera in $1', # Fuzzy
	'cnw-desc-change-lang' => 'cambiar',
	'cnw-desc-lang' => 'Lingua',
	'cnw-desc-wiki-submit-error' => 'Per favor selige un categoria',
	'cnw-theme-headline' => 'Designar tu wiki',
	'cnw-theme-creative' => 'Selige un apparentia hic infra. Tu videra un previsualisation de cata apparentia quando tu lo selige.', # Fuzzy
	'cnw-theme-instruction' => 'Es equalmente possibile designar tu proprie apparentia usante "Mi instrumentos".', # Fuzzy
	'cnw-welcome-headline' => 'Felicitationes, tu ha create $1', # Fuzzy
	'cnw-welcome-instruction1' => 'Clicca sur le button hic infra pro comenciar a adder paginas a tu wiki.', # Fuzzy
	'cnw-welcome-help' => 'Trova responsas, consilios e plus in <a href="http://community.wikia.com">le centro del communitate</a>.', # Fuzzy
...
$messages['it'] = array(
	...
	'cnw-name-wiki-headline' => 'Crea una wiki', # Fuzzy
	'cnw-name-wiki-creative' => 'Wikia è il posto migliore per costruire un sito web e far crescere una community intorno a ciò che ti piace.', # Fuzzy
	'cnw-name-wiki-label' => 'Dai un nome alla tua wiki', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Dai un indirizzo alla tua wiki', # Fuzzy
	...
	'cnw-desc-placeholder' => 'Questo testo apparirà nella pagina principale della tua wiki.', # Fuzzy
	'cnw-desc-tip1' => 'Suggerimento', # Fuzzy
	'cnw-desc-tip1-creative' => 'Utilizza questo spazio per descrivere alle persone la tua wiki con poche parole', # Fuzzy
	'cnw-desc-tip2' => 'Psst', # Fuzzy
	'cnw-desc-tip2-creative' => 'Fornisci ai visitatori alcuni dettagli specifici sul tuo argomento', # Fuzzy
	'cnw-desc-select-one' => 'Seleziona',
	'cnw-desc-default-lang' => 'La tua wiki sarà in $1', # Fuzzy
	'cnw-desc-change-lang' => 'cambia',
	'cnw-desc-lang' => 'Lingua',
	'cnw-desc-wiki-submit-error' => 'Per favore scegli una categoria',
	'cnw-theme-headline' => 'Scegli un tema',
	'cnw-theme-creative' => "Scegli uno dei temi qui sotto. Puoi vedere l'anteprima di ogni tema quando lo selezioni.", # Fuzzy
	'cnw-theme-instruction' => 'Puoi anche creare il tuo tema personalizzato più avanti tramite "I miei strumenti".', # Fuzzy
	'cnw-welcome-headline' => 'Complimenti! $1 è stata creata', # Fuzzy
	'cnw-welcome-instruction1' => 'Clicca il pulsante sottostante per iniziare a creare pagine nella tua wiki.', # Fuzzy
	'cnw-welcome-help' => 'Puoi trovare risposte, consigli e altro nella <a href="http://it.community.wikia.com/wiki/Wiki_della_Community">Wiki della Community</a>.', # Fuzzy
...
$messages['ja'] = array(
	...
	'cnw-or' => 'または',
	'cnw-title' => '新しいウィキを作成',
	'cnw-name-wiki-headline' => 'ウィキを作成する', # Fuzzy
	'cnw-name-wiki-creative' => 'ウィキアは、あなたが好きなものに関するウェブサイトやコミュニティを構築するのに最適の場所です。', # Fuzzy
	'cnw-name-wiki-label' => 'ウィキの名称を入力してください', # Fuzzy
	'cnw-name-wiki-domain-label' => 'ウィキのアドレスを入力してください', # Fuzzy
	...
	'cnw-desc-placeholder' => 'ここに入力した内容がメインページに表示されます。', # Fuzzy
	'cnw-desc-tip1' => 'ヒント', # Fuzzy
	'cnw-desc-tip1-creative' => 'この領域を利用し、訪問者に対してこのウィキがどのようなウィキであるかを1・2文で伝えましょう。', # Fuzzy
	'cnw-desc-tip2' => 'ちょっとした補足', # Fuzzy
	'cnw-desc-tip2-creative' => 'このウィキが扱う話題について、具体的な内容をいくつか挙げましょう。', # Fuzzy
	'cnw-desc-select-one' => '1つを選択',
	'cnw-desc-all-ages' => 'すべての年齢', # Fuzzy
	'cnw-desc-default-lang' => 'ウィキの言語設定は $1 になっています', # Fuzzy
	'cnw-desc-change-lang' => '変更する',
	'cnw-desc-lang' => '言語',
	'cnw-desc-wiki-submit-error' => 'カテゴリを選択してください',
	'cnw-theme-headline' => 'テーマを選択',
	'cnw-theme-creative' => '下の一覧からテーマを選んでください。それぞれのテーマをクリックすると、選択したテーマのプレビューを確認できます。', # Fuzzy
	'cnw-theme-instruction' => '後で「マイツール」から独自のテーマをデザインすることもできます。', # Fuzzy
	'cnw-welcome-headline' => 'おめでとうございます！ $1 が作成されました', # Fuzzy
	'cnw-welcome-instruction1' => '下のボタンをクリックすると、新しいページを作成できます。', # Fuzzy
	'cnw-welcome-help' => '助言を求めたいとき、質問したい時などは <a href="http://ja.wikia.com/">Community Central 日本語版</a> までお越しください。', # Fuzzy
...
$messages['km'] = array(
	...
	'cnw-name-wiki-headline' => 'ចាប់ផ្ដើមវិគីមួយ', # Fuzzy
	'cnw-name-wiki-creative' => 'Wikia ជាកន្លែងដ៏ប្រសើរបំផុតក្នុងការស្ថាបនាវិបសៃថ៍និង​ពង្រីកសហគមន៍ជុំវិញអ្នកអ្វីដែលអ្នកស្រឡាញ់ចូលចិត្ត។', # Fuzzy
	'cnw-name-wiki-label' => 'ឈ្មោះវិគីរបស់អ្នក', # Fuzzy
	'cnw-name-wiki-domain-label' => 'ផ្ដល់អាសយដ្ឋានមួយដល់វិគីរបស់អ្នក', # Fuzzy
	...
	'cnw-desc-headline' => 'តើវិគីរបស់អ្នកនិយាយពីអ្វី?', # Fuzzy
	'cnw-desc-creative' => 'ពណ៌នាពីប្រធានបទរបស់អ្នក', # Fuzzy
	'cnw-desc-placeholder' => 'របស់នេះនឹងត្រូវបង្ហាញនៅលើទំព័រដើមរបស់វិគីរបស់អ្នក។', # Fuzzy
	'cnw-desc-tip1' => 'គន្លឹះ', # Fuzzy
	'cnw-desc-tip1-creative' => 'ប្រើកន្លែងទំនេរនេះ ដើម្បីសរសេរពីរបីល្បះរៀបរាប់ពីវិគីរបស់អ្នកអោយអ្នកដទៃ។', # Fuzzy
	'cnw-desc-tip2' => 'គន្លឺះ', # Fuzzy
	'cnw-desc-tip2-creative' => 'ផ្ដល់ព័ត៌មានលំអិតដល់អ្នកទស្សនា ស្ដីពីប្រធានបទរបស់អ្នក', # Fuzzy
	'cnw-desc-select-one' => 'ជ្រើសរើសមួយ',
	'cnw-desc-default-lang' => 'វិគីរបស់នឹងត្រូវសរសេរជា $1', # Fuzzy
	...
	'cnw-theme-creative' => 'ជ្រើសរើសរចនាបថខាងក្រោម។ អ្នកនឹងអាចមើលរចនាបថនោះជាមុនពេលដែលជ្រើសរើសវា។', # Fuzzy
	'cnw-theme-instruction' => 'អ្នកក៏អាចធ្វើការឌីស្សាញរចនាបថដោយខ្លួនអ្នកនាពេលក្រោយដោយចូលទៅ"ឧបករណ៍"។', # Fuzzy
	'cnw-welcome-headline' => 'សូមអបអរសាទរ! $1 ត្រូវបានបង្កើតហើយ', # Fuzzy
	'cnw-welcome-instruction1' => 'ចុចលើប៊ូតុងខាងក្រោមដើម្បីចាប់ផ្ដើមបន្ថែមទំព័រទៅលើវិគីរបស់អ្នក។', # Fuzzy
	'cnw-welcome-help' => 'រកចំលើយ ដំបូន្មាន និង អ្វីៗបន្ថែមទៀតនៅលើ<a href="http://community.wikia.com">មជ្ឍមណ្ឌលសហគមន៍</a>។', # Fuzzy
...
$messages['kn'] = array(
	...
	'cnw-name-wiki-headline' => 'ಒಂದು ಹೊಸ ವಿಕಿ ಪ್ರಾರಂಭಿಸಿ', # Fuzzy
	'cnw-name-wiki-label' => 'ನಿಮ್ಮ ವಿಕಿಗೆ ಹೆಸರು ಕೊಡಿ', # Fuzzy
	'cnw-name-wiki-domain-label' => 'ನಿಮ್ಮ ವಿಕಿಗೆ ಒಂದು ವಿಳಾಸಕೊಡಿ', # Fuzzy
	'cnw-login' => 'ಲಾಗ್ ಇನ್',
	...
	'cnw-desc-headline' => 'ನಿಮ್ಮ ವಿಕಿ ಬಗ್ಗೆ ಏನು?', # Fuzzy
	'cnw-desc-creative' => 'ನಿಮ್ಮ ವಿಷಯವನ್ನು ವಿವರಿಸಿ', # Fuzzy
	'cnw-desc-placeholder' => 'ಇದು ನಿಮ್ಮ ವಿಕಿಯ ಮುಖಪುಟದಲ್ಲಿ ಪ್ರದರ್ಶಿಸಲ್ಪಡುತ್ತದೆ.', # Fuzzy
	'cnw-desc-tip1' => 'ಸೂಚನೆ', # Fuzzy
	'cnw-desc-tip1-creative' => 'ನಿಮ್ಮ ವಿಕಿಯ ಬಗ್ಗೆ ಒಂದೆರಡು ವಾಕ್ಯಗಳಲ್ಲಿ ಜನರಿಗೆ ತಿಳಿಸಲು ಈ ಸ್ಥಳವನ್ನು ಉಪಯೋಗಿಸಿ', # Fuzzy
	'cnw-desc-tip2-creative' => 'ನಿಮ್ಮ ವಿಷಯದ ಬಗ್ಗೆ ಬೇಟಿಕೊಡುವವರಿಗೆ ಕೆಲವು ವಿವರ ತಿಳಿಸಿ', # Fuzzy
	'cnw-desc-select-one' => 'ಒಂದನ್ನು ಆಯ್ಕೆ ಮಾಡಿ',
	'cnw-desc-all-ages' => 'ಎಲ್ಲ ಪುಟಗಳು', # Fuzzy
	'cnw-desc-default-lang' => 'ನಿಮ್ಮ ವಿಕಿಯು $1 ರಲ್ಲಿರುತ್ತದೆ', # Fuzzy
	...
	'cnw-welcome-headline' => 'ಅಭಿನಂದನೆಗಳು!$1 ಸೃಜಿಸಲ್ಪಟ್ಟಿದೆ', # Fuzzy
	'cnw-welcome-instruction1' => 'ನಿಮ್ಮ ವಿಕಿಗೆ ಪುಟಗಳನ್ನು ಸೇರಿಸಿಸಲು ಕೆಳಗಿನ ಗುಂಡಿಯನ್ನು ಅದುಮಿ.', # Fuzzy
...
$messages['lki'] = array(
	...
	'cnw-name-wiki-headline' => 'ویکی باجؤگِلّ-شؤروع کۀ', # Fuzzy
	'cnw-name-wiki-creative' => 'ویکی بئترین جا ئۀرا وبسایت سازینؤ کڵنْگا کردن خۀلکئ کۀ گه هؤمۀ دوست درینؤ', # Fuzzy
	'cnw-name-wiki-label' => 'نؤم ویکی هؤمۀ', # Fuzzy
	...
	'cnw-desc-placeholder' => 'رئ نیشؤن دائن-راهنمایی', # Fuzzy
	'cnw-desc-tip1' => 'رئ نیشؤن دائن-راهنمایی', # Fuzzy
...
$messages['lrc'] = array(
	...
	'cnw-name-wiki-headline' => 'یه گل ویکی نه شرو بکید', # Fuzzy
...
$messages['lt'] = array(
	...
	'cnw-name-wiki-headline' => 'Sukurti naują Wiki', # Fuzzy
	...
	'cnw-desc-headline' => 'Apie ką jūsų wiki?', # Fuzzy
	'cnw-desc-creative' => 'Aprašykite savo temą', # Fuzzy
	'cnw-desc-tip1' => 'Patarimas', # Fuzzy
	'cnw-desc-tip2' => 'Psst', # Fuzzy
	...
	'cnw-welcome-headline' => 'Sveikiname! $1 buvo sukurtas', # Fuzzy
...
$messages['mk'] = array(
	...
	'cnw-name-wiki-headline' => 'Започнете вики', # Fuzzy
	'cnw-name-wiki-creative' => 'Викија е најдоброто место за да изработите мрежно место и да создадете растечка заедница што се темели на она што го сакате.', # Fuzzy
	'cnw-name-wiki-label' => 'Именувајте го викито', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Дајте му адреса на викито', # Fuzzy
	...
	'cnw-desc-creative' => 'Опис што ќе им помогне на другите да ја најдат вашата викија', # Fuzzy
	'cnw-desc-placeholder' => 'Ова ќе се прикажува на главната страница на викито', # Fuzzy
	'cnw-desc-tip1' => 'Совет', # Fuzzy
	'cnw-desc-tip1-creative' => 'Овој простор користете го за да ги известите луѓето за вашата викија во една до две реченици', # Fuzzy
	'cnw-desc-tip2' => 'Псст', # Fuzzy
	'cnw-desc-tip2-creative' => 'Наведете што повеќе подробности за тематиката', # Fuzzy
	'cnw-desc-select-vertical' => 'Изберете главна јазолна категорија', # Fuzzy
	'cnw-desc-select-categories' => 'Изберете дополнителни категории', # Fuzzy
	...
	'cnw-desc-default-lang' => 'Викито ќе биде на $1', # Fuzzy
	...
	'cnw-theme-creative' => 'Подолу изберете изглед. За секој избран изглед ќе се прикаже преглед .', # Fuzzy
	'cnw-theme-instruction' => 'Подоцна можете да изработите свој изглед преку „Мои алатки“.', # Fuzzy
	'cnw-welcome-headline' => 'Честитаме! Го создадовте $1', # Fuzzy
	'cnw-welcome-instruction1' => 'Стиснете на копчето подолу за да почнете да додавате страници на викито.', # Fuzzy
	'cnw-welcome-help' => 'Одговори на прашања, совети и друго ќе добиете на <a href="http://community.wikia.com">Центарот на заедницата</a>.', # Fuzzy
...
$messages['ml'] = array(
	...
	'cnw-name-wiki-headline' => 'വിക്കി തുടങ്ങുക', # Fuzzy
	'cnw-name-wiki-label' => 'താങ്കളുടെ വിക്കിയുടെ പേര്', # Fuzzy
	...
	'cnw-desc-headline' => 'താങ്കളുടെ വിക്കി എന്തിനെക്കുറിച്ചുള്ളതാണ്?', # Fuzzy
	'cnw-desc-creative' => 'താങ്കളുടെ വിഷയം വിശദമാക്കുക', # Fuzzy
	...
	'cnw-welcome-headline' => 'അഭിനന്ദനങ്ങൾ! $1 സൃഷ്ടിക്കപ്പെട്ടിരിക്കുന്നു', # Fuzzy
);
...
$messages['nb'] = array(
	...
	'cnw-name-wiki-headline' => 'Start en wiki', # Fuzzy
	'cnw-name-wiki-creative' => 'Wikia er det beste stedet å bygge et nettsted og lage en fellesskap rundt det du elsker.', # Fuzzy
	'cnw-name-wiki-label' => 'Navngi wikien din', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Gi wikien din en adresse', # Fuzzy
	...
	'cnw-desc-headline' => 'Hva handler wikien din om?', # Fuzzy
	'cnw-desc-creative' => 'Beskriv emnet ditt', # Fuzzy
	'cnw-desc-placeholder' => 'Dette vil vises på hovedsiden til wikien din.', # Fuzzy
	'cnw-desc-tip1' => 'Hint', # Fuzzy
	'cnw-desc-tip1-creative' => 'Bruk denne plassen til å fortelle folk om wikien din med en setning eller to', # Fuzzy
	'cnw-desc-tip2' => 'Psst', # Fuzzy
	'cnw-desc-tip2-creative' => 'Gi dine besøkende noen spesifikke detaljer om feltet ditt', # Fuzzy
	'cnw-desc-select-one' => 'Velg en',
	'cnw-desc-all-ages' => 'Alle aldere', # Fuzzy
	'cnw-desc-default-lang' => 'Wikien din vil være på $1', # Fuzzy
	'cnw-desc-change-lang' => 'endre',
	'cnw-desc-lang' => 'Språk',
	'cnw-desc-wiki-submit-error' => 'Vennligst velg en kategori',
	'cnw-theme-headline' => 'Velg et tema',
	'cnw-theme-creative' => 'Velg et tema under. Du vil kunne se en forhåndsvisning av hvert tema når du markerer det.', # Fuzzy
	'cnw-theme-instruction' => 'Du kan også utforme ditt eget tema senere ved å gå til «Mine verktøy».', # Fuzzy
	'cnw-welcome-headline' => 'Gratulerer! $1 har blitt opprettet', # Fuzzy
	'cnw-welcome-instruction1' => 'Trykk på knappen under for å begynne å legge til siden på wikien din.', # Fuzzy
	'cnw-welcome-help' => 'Finn svar, råd, og mer på <a href="http://community.wikia.com">Community Central</a>.', # Fuzzy
...
$messages['nl-informal'] = array(
	'cnw-name-wiki-creative' => 'Wikia is de beste plaats om een website te bouwen en een gemeenschap te laten groeien om het onderwerp dat je aan het hart gaat.', # Fuzzy
	'cnw-name-wiki-label' => 'Geef je wiki een naam', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Geef je wiki een adres', # Fuzzy
	...
	'cnw-desc-headline' => 'Waar gaat je wiki over?', # Fuzzy
	'cnw-desc-creative' => 'Beschrijf je onderwerp', # Fuzzy
	'cnw-desc-placeholder' => 'Dit wordt weergegeven op de hoofdpagina van je wiki.', # Fuzzy
	'cnw-desc-tip1-creative' => 'Gebruik deze ruimte om mensen over je wiki te vertellen in een paar zinnen', # Fuzzy
	'cnw-desc-tip2-creative' => 'Geef je bezoeker wat details over je onderwerp', # Fuzzy
	'cnw-desc-default-lang' => 'De hoofdtaal van je wiki is: $1', # Fuzzy
	'cnw-theme-creative' => 'Kies hieronder een vormgeving. Als je een vormgeving selecteert, wordt een voorvertoning weergegeven.', # Fuzzy
	'cnw-theme-instruction' => 'Je kunt je thema of ontwerp altijd later aanpassen via "Mijn hulpmiddelen".', # Fuzzy
	'cnw-welcome-instruction1' => "Klik op de onderstaande knop om pagina's aan je wiki toe te voegen.", # Fuzzy
...
$messages['oc'] = array(
	...
	'cnw-name-wiki-headline' => 'Començar un Wiki', # Fuzzy
	'cnw-name-wiki-creative' => "Wikia es lo melhor endrech per bastir un site Web e crear una comunautat a l'entorn de çò que vos agrada.", # Fuzzy
	'cnw-name-wiki-label' => 'Nomenatz vòstre wiki', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Donatz una adreça a vòstre wiki', # Fuzzy
	...
	'cnw-desc-creative' => 'Vòstra descripcion ajudarà lo monde a trobar vòstre wikia', # Fuzzy
	'cnw-desc-tip1' => 'Astúcia', # Fuzzy
	'cnw-desc-tip2' => 'Psst', # Fuzzy
	'cnw-desc-select-vertical' => 'Seleccionatz un tèma', # Fuzzy
	'cnw-desc-select-categories' => 'Seleccionatz de categorias addicionalas', # Fuzzy
	'cnw-desc-select-one' => 'Ne seleccionar una',
	'cnw-desc-all-ages' => 'Aqueste wikia es destinat als enfants ?',
	'cnw-desc-default-lang' => 'Vòstre wiki serà en $1', # Fuzzy
...
$messages['pl'] = array(
	...
	'cnw-name-wiki-headline' => 'Utwórz wiki', # Fuzzy
	'cnw-name-wiki-creative' => 'Wikia to najlepsze miejsce do budowania własnej wiki i tworzenia społeczności wokół tego co kochasz.', # Fuzzy
	'cnw-name-wiki-label' => 'Nazwij swoją wiki', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Nadaj adres swojej wiki', # Fuzzy
	...
	'cnw-desc-creative' => 'Opis pomoże znaleźć ludziom twoją wiki.', # Fuzzy
	'cnw-desc-placeholder' => 'To pojawi się na stronie głównej Twojej wiki', # Fuzzy
	'cnw-desc-tip1' => 'Wskazówka 1', # Fuzzy
	'cnw-desc-tip1-creative' => 'Użyć tego miejsca, aby opowiedzieć innym o swojej wiki.', # Fuzzy
	'cnw-desc-tip2' => 'Wskazówka 2', # Fuzzy
	'cnw-desc-tip2-creative' => 'Podziel się z innymi szczegółami o Twojej wiki', # Fuzzy
	'cnw-desc-select-vertical' => 'Wybierz kategorię Huba', # Fuzzy
	'cnw-desc-select-categories' => 'Wybierz dodatkowe kategorie', # Fuzzy
	...
	'cnw-desc-default-lang' => 'Twoja wiki będzie w języku: $1', # Fuzzy
	'cnw-desc-change-lang' => 'zmień',
	'cnw-desc-lang' => 'Język',
	'cnw-desc-wiki-submit-error' => 'Proszę wybrać kategorię',
	'cnw-theme-headline' => 'Wybierz motyw',
	'cnw-theme-creative' => 'Wybierz jeden z poniższych motywów aby zobaczyć podgląd i zdecydować o wyborze.', # Fuzzy
	'cnw-theme-instruction' => 'Możesz także zaprojektować motyw później, korzystając z menu "Moje narzędzia".', # Fuzzy
	'cnw-welcome-headline' => 'Gratulacje! $1 została utworzona', # Fuzzy
	'cnw-welcome-instruction1' => 'Kliknij na poniższy przycisk aby zacząć dodawanie stron do Twojej wiki', # Fuzzy
	'cnw-welcome-help' => 'Znajdź odpowiedzi, porady i więcej w <a href="http://spolecznosc.wikia.com">Centrum Społeczności</a>.', # Fuzzy
...
$messages['pms'] = array(
	...
	'cnw-name-wiki-headline' => 'Anandié na Wiki', # Fuzzy
	'cnw-name-wiki-creative' => "Wikia a l'é ël mej pòst për fé un sit dla Ragnà e fé chërse na comunità dantorn a lòn ch'a-j pias.", # Fuzzy
	'cnw-name-wiki-label' => 'Daje un nòm a toa wiki', # Fuzzy
	'cnw-name-wiki-domain-label' => "Daje n'adrëssa a toa wiki", # Fuzzy
	...
	'cnw-desc-headline' => "Ëd lòn ch'a parla soa wiki?", # Fuzzy
	'cnw-desc-creative' => "Ch'a descriva l'argoment", # Fuzzy
	'cnw-desc-placeholder' => "Sòn a comparirà an sla pàgina d'intrada ëd soa wiki.", # Fuzzy
	'cnw-desc-tip1' => 'Sugeriment', # Fuzzy
	'cnw-desc-tip1-creative' => "Ch'a deuvra së spassi për dije a la gent ëd lòn ch'a trata soa wiki ant na fras o doe", # Fuzzy
	'cnw-desc-tip2' => "Ch'a scota", # Fuzzy
	'cnw-desc-tip2-creative' => "Ch'a-j daga ai sò visitador chèich detaj specìfich a propòsit dël soget", # Fuzzy
	'cnw-desc-select-one' => 'Sern-ne un-a',
	'cnw-desc-default-lang' => 'Toa wiki a sarà an $1', # Fuzzy
	'cnw-desc-change-lang' => 'cambia',
	'cnw-desc-lang' => 'Lenga',
	'cnw-desc-wiki-submit-error' => "Për piasì, ch'a serna na categorìa",
	'cnw-theme-headline' => 'Sern un tema',
	'cnw-theme-creative' => "Ch'a serna un tema sì-sota, a podrà vëdde na preuva ëd minca tema an selessionandlo.", # Fuzzy
	'cnw-theme-instruction' => 'A peul ëdcò progeté sò tema përsonal pi tard andasend su «Ij mè utiss».', # Fuzzy
	'cnw-welcome-headline' => "Congratulassion! $1 a l'é stàita creà", # Fuzzy
	'cnw-welcome-instruction1' => "Ch'a sgnaca an sël boton sì-sota për ancaminé a gionté dle pàgine a soa wiki.", # Fuzzy
	'cnw-welcome-help' => 'Ch\'a treuva dle rispòste, dij consej, e ancor ëd pi dzora la <a href="http://community.wikia.com">Sentral dla comunità</a>.', # Fuzzy
...
$messages['pt'] = array(
	...
	'cnw-name-wiki-headline' => 'Iniciar uma Wiki', # Fuzzy
	'cnw-name-wiki-creative' => 'A Wikia é o melhor sítio para criar um site e desenvolver uma comunidade em torno de um tema do teu agrado.', # Fuzzy
	'cnw-name-wiki-label' => 'Nome da tua wiki', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Dá um endereço à tua wiki', # Fuzzy
	...
	'cnw-desc-creative' => 'A tua descrição irá ajudar as pessoas a encontrar a tua wikia', # Fuzzy
	'cnw-desc-placeholder' => 'Isto irá aparecer na página principal da tua wiki.', # Fuzzy
	'cnw-desc-tip1' => 'Sugestão', # Fuzzy
	'cnw-desc-tip1-creative' => 'Usa este espaço para descrever a tua wikia aos visitantes numa frase ou duas', # Fuzzy
	'cnw-desc-tip2' => 'Conselho', # Fuzzy
	'cnw-desc-tip2-creative' => 'Dá aos visitantes detalhes específicos sobre o assunto da tua wiki', # Fuzzy
	...
	'cnw-desc-default-lang' => 'A tua wiki será em $1', # Fuzzy
	...
	'cnw-theme-creative' => 'Escolhe uma variante do tema; podes ver uma antevisão de cada variante, clicando-a.', # Fuzzy
	'cnw-theme-instruction' => 'Também podes criar uma variante personalizada mais tarde, usando “As minhas ferramentas”.', # Fuzzy
	'cnw-welcome-headline' => 'Parabéns! A $1 foi criada', # Fuzzy
	'cnw-welcome-instruction1' => 'Clica o botão abaixo para começar a criar páginas na tua wiki.', # Fuzzy
	'cnw-welcome-help' => 'Vais encontrar respostas, conselhos e mais na <a href="http://pt.wikia.com">Comunidade Central</a>.', # Fuzzy
...
$messages['pt-br'] = array(
	...
	'cnw-name-wiki-headline' => 'Iniciar uma Wikia', # Fuzzy
...
$messages['ro'] = array(
	...
	'cnw-name-wiki-headline' => 'Porneşte un wiki', # Fuzzy
	'cnw-name-wiki-creative' => 'Wikia este cel mai bun loc ca să construieşti un sait web şi să creşti o comunitate în jurul a ceea ce-ţi place.', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Dă-i wiki-ului tău o adresă', # Fuzzy
	...
	'cnw-desc-creative' => 'Descrieţi-vă subiectul', # Fuzzy
	'cnw-desc-placeholder' => 'Asta va apărea pe pagina principală a wiki-ului tău.', # Fuzzy
	'cnw-desc-tip2-creative' => 'Dă-le vizitatorilor tăi unele detalii specifice despre subiectul tău', # Fuzzy
	'cnw-desc-select-one' => 'Selectează una',
	'cnw-desc-default-lang' => 'Wiki-ul tău va fi în $1', # Fuzzy
	'cnw-desc-change-lang' => 'schimbă',
	'cnw-desc-lang' => 'Limbă',
	'cnw-desc-wiki-submit-error' => 'Te rugăm alege o categorie',
	'cnw-theme-headline' => 'Alege o temă',
	'cnw-welcome-instruction1' => 'Apasă pe butonul de mai jos pentru a începe să adaugi pagini wiki-ului tău.', # Fuzzy
);
...
$messages['sr-ec'] = array(
	...
	'cnw-name-wiki-headline' => 'Направите вики', # Fuzzy
	'cnw-name-wiki-creative' => 'Викија је најбоље место да направите веб-сајт и створите растућу заједницу која се темељи на ономе што волите.', # Fuzzy
	'cnw-name-wiki-label' => 'Именујте вики:', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Унесите адресу викија:', # Fuzzy
	...
	'cnw-desc-headline' => 'Која је тематика викија?', # Fuzzy
	'cnw-desc-creative' => 'Опишите тему:', # Fuzzy
	'cnw-desc-placeholder' => 'Текст који унесете овде ће бити приказан на главној страници викија.', # Fuzzy
	'cnw-desc-tip1' => 'Савет', # Fuzzy
	'cnw-desc-tip1-creative' => 'Овај простор користите да упознате људе с викијем у једној или две реченице.', # Fuzzy
	'cnw-desc-tip2' => 'Псст', # Fuzzy
	'cnw-desc-tip2-creative' => 'Наведите што више појединости о тематици.', # Fuzzy
	'cnw-desc-select-one' => 'изаберите',
	'cnw-desc-default-lang' => 'Вики ће бити на $1', # Fuzzy
	'cnw-desc-change-lang' => 'промени',
	'cnw-desc-lang' => 'Језик:',
	'cnw-desc-wiki-submit-error' => 'Изаберите категорију',
	'cnw-theme-headline' => 'Изаберите тему',
	'cnw-theme-creative' => 'Изаберите неку од тема испод. Преглед ће се појавити истог тренутка.', # Fuzzy
	'cnw-theme-instruction' => 'Касније можете да израдите сопствену тему преко „Мојих алатки“.', # Fuzzy
	'cnw-welcome-headline' => 'Честитамо! Вики $1 је направљен', # Fuzzy
	'cnw-welcome-instruction1' => 'Кликните на дугме испод да почнете с додавањем страница на вики.', # Fuzzy
	'cnw-welcome-help' => 'Одговори на питања, савети и друго се налазе на <a href="http://community.wikia.com">Центру заједнице</a>.', # Fuzzy
...
$messages['te'] = array(
	...
	'cnw-name-wiki-headline' => 'ఓ వికీని మొదలుపెట్టండి', # Fuzzy
	'cnw-name-wiki-creative' => 'ఓ వెబ్‍సైటును తయారుచేసుకుని, తద్వారా మీకు నచ్చిన అంశం చుట్టూ ఓ సముదాయాన్ని నిర్మించుకోడానికి వికియా చక్కటి స్థలం.', # Fuzzy
	'cnw-name-wiki-label' => 'మీ వికీ పేరు', # Fuzzy
	'cnw-name-wiki-domain-label' => 'వికీ చిరునామా', # Fuzzy
	...
	'cnw-desc-headline' => 'మీ వికీ దేని గురించి?', # Fuzzy
	'cnw-desc-creative' => 'మీ అంశాన్ని వివరించండి', # Fuzzy
	'cnw-desc-placeholder' => 'ఇది మీ వికీ మొదటిపేజీలో కనిపిస్తుంది.', # Fuzzy
	'cnw-desc-tip1' => 'చిట్కా', # Fuzzy
	'cnw-desc-tip1-creative' => 'మీ వికీ గురించి ఒకటి రెండు వాక్యాల్లో చెప్పడానికి ఈ జాగాను వాడండి', # Fuzzy
	'cnw-desc-tip2' => 'ఇస్.స్.స్.', # Fuzzy
	'cnw-desc-tip2-creative' => 'మీ అంశం గురించిన కొన్ని విశిష్ట వివరాలను మీ సందర్శకులకు ఇవ్వండి', # Fuzzy
	'cnw-desc-select-one' => 'ఒకటి ఎంచుకోండి',
	'cnw-desc-all-ages' => 'అన్ని వయసుల వారికీ', # Fuzzy
	'cnw-desc-tip-all-ages' => 'ఈ వికీ పిల్లలకు ఆసక్తి కలిగించే అంశం గురించా? అమెరికా చట్టాలకు అనుగుణంగా 12 సంవత్సరాల లోపు పిల్లలను ఆకట్టుకునే అంశాలున్న వికీలను మేం గమనిస్తూంటాం.', # Fuzzy
	'cnw-desc-default-lang' => 'మీ వికీ $1 లో ఉంటుంది', # Fuzzy
	'cnw-desc-change-lang' => 'మార్చండి',
	'cnw-desc-lang' => 'భాష',
	'cnw-desc-wiki-submit-error' => 'ఓ వర్గాన్ని ఎంచుకోండి',
	'cnw-theme-headline' => 'ఓ థీమును ఎంచుకోండి',
	'cnw-theme-creative' => 'ఓ థీమును ఎంచుకోండి. ఏదైనా థీమును ఎంచుకోగానే మీరు దాని మునుజూపును చూడవచ్చు.', # Fuzzy
	'cnw-theme-instruction' => 'తరువాత "నా పరికరాలు" కు వెళ్ళి మీ స్వంత థీమును తయారుచేసుకోవచ్చు కూడాను.', # Fuzzy
	'cnw-welcome-headline' => 'అభినందనలు! $1 సృష్టించబడింది', # Fuzzy
	'cnw-welcome-instruction1' => 'మీ వికీకి పేజీలను చేర్చేందుకు కింది బొత్తాన్ని నొక్కండి.', # Fuzzy
	'cnw-welcome-help' => '<a href="http://community.wikia.com">సముదాయ కేంద్రం</a> లో జవాబులు, సలహాలు, ఇంకా ఇతర వివరాల్ను పొందండి.', # Fuzzy
...
$messages['tl'] = array(
	...
	'cnw-name-wiki-headline' => 'Magsimula ng isang Wiki', # Fuzzy
	'cnw-name-wiki-creative' => 'Ang Wikia ang pinakamahusay na pook upang makapagtatag ng isang websayt at makapagpalaki ng isang pamayanan sa paligid ng minamahal mong bagay.', # Fuzzy
	'cnw-name-wiki-label' => 'Pangalanan ang wiki mo', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Bigyan ang wiki ng isang tirahan', # Fuzzy
	...
	'cnw-desc-headline' => 'Tungkol ba saan ang wiki mo?', # Fuzzy
	'cnw-desc-creative' => 'Ilarawan ang paksa mo', # Fuzzy
	'cnw-desc-placeholder' => 'Lilitaw ito sa pangunahing pahina ng wiki mo.', # Fuzzy
	'cnw-desc-tip1' => 'Pahiwatig', # Fuzzy
	'cnw-desc-tip1-creative' => 'Gamitin ang puwang na ito upang sabihin sa mga tao ang tungkol sa wiki mo sa pamamagitan ng isa o dalawang mga pangungusap', # Fuzzy
	'cnw-desc-tip2' => 'Hoy', # Fuzzy
	'cnw-desc-tip2-creative' => 'Bigyan ang mga panauhin mo ng ilang partikular na mga detalye ukol sa paksa mo', # Fuzzy
	'cnw-desc-select-one' => 'Pumili ng isa',
	'cnw-desc-default-lang' => 'Ang wiki mo ay magiging nasa $1', # Fuzzy
	...
	'cnw-theme-creative' => 'Pumili ng isang temang nasa ibaba, magagawa mong makakita ng isang paunang pagtanaw ng bawat tema habang pinipili mo ito.', # Fuzzy
	'cnw-theme-instruction' => 'Makakapagdisenyo ka rin ng sarili mong tema paglaon sa pamamagitan ng pagpunta sa "Mga Kasangkapan Ko".', # Fuzzy
	'cnw-welcome-headline' => 'Maligayang bati! Nalikha na ang $1', # Fuzzy
	'cnw-welcome-instruction1' => 'Pindutin ang pindutang nasa ibaba upang makapagsimulang magdagdag ng mga pahina sa wiki mo.', # Fuzzy
	'cnw-welcome-help' => 'Maghanap ng mga sagot, mga payo, at marami pa sa <a href="http://community.wikia.com">Lunduyan ng Pamayanan</a>.', # Fuzzy
...
$messages['tr'] = array(
	...
	'cnw-name-wiki-headline' => 'Bir Wiki Başlat', # Fuzzy
	'cnw-name-wiki-creative' => 'Wikia bir web sitesi oluşturmak için en iyi yerdir ve sevgi çerçevesinde topluluk büyür.', # Fuzzy
	'cnw-name-wiki-label' => 'Wikinizin adı', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Lütfen Wiki adresini ekleyin', # Fuzzy
	...
	'cnw-desc-headline' => 'Wikiniz ne hakkında?', # Fuzzy
	'cnw-desc-creative' => 'Konuyu açıklayın', # Fuzzy
	'cnw-desc-placeholder' => 'Bu wikinizin ana sayfanızda görünecektir.', # Fuzzy
	'cnw-desc-tip1' => 'İpucu', # Fuzzy
	'cnw-desc-tip1-creative' => 'Wikinizin konusunu insanlara bir iki cümle ile anlatmak için bu alanı kullanın', # Fuzzy
	'cnw-desc-tip2' => 'Hişt', # Fuzzy
	'cnw-desc-tip2-creative' => 'Ziyaretçilerinize konu hakkında bazı özel bilgiler verin', # Fuzzy
	'cnw-desc-select-one' => 'Birini seç',
	'cnw-desc-all-ages' => 'Tüm süreler', # Fuzzy
	'cnw-desc-tip-all-ages' => 'Bu wiki çocukları ilgilendiren bir konu hakkında mı? ABD yasaları uyarınca ve yardımcı olmak için 12 yaş ve altı çocuklara hitap eden konuları takip ediyoruz.', # Fuzzy
	'cnw-desc-default-lang' => 'Sizin wikiniz $1 olacak', # Fuzzy
	'cnw-desc-change-lang' => 'değiştir',
	'cnw-desc-lang' => 'Dil',
	'cnw-desc-wiki-submit-error' => 'Lütfen bir kategori seçin',
	'cnw-theme-headline' => 'Bir tema seçin',
	'cnw-theme-creative' => 'Aşağıdan bir tema seçin. Seçtiğiniz her temanın ön izlemesini görebilirsiniz.', # Fuzzy
	'cnw-theme-instruction' => 'Kendi temanızı "Araçlarım" bölümüne giderek, daha sonra da tasarlayabilirsiniz.', # Fuzzy
	'cnw-welcome-headline' => 'Tebrikler!  $1  oluşturuldu', # Fuzzy
	'cnw-welcome-instruction1' => 'Wikinize sayfalar eklemeye başlamak için aşağıdaki düğmeye tıklayın.', # Fuzzy
	'cnw-welcome-help' => 'Daha fazla cevap ve öneri bulabilmek için <a href="http://community.wikia.com">Topluluk Merkezini</a> ziyaret edin.', # Fuzzy
...
$messages['tt-cyrl'] = array(
	...
	'cnw-name-wiki-headline' => 'Вики башлау', # Fuzzy
	'cnw-name-wiki-creative' => 'Викия - сез яраткан нәрсәләр турында веб-сайт төзү өчен иң кулай урын.', # Fuzzy
	'cnw-name-wiki-label' => 'Викиның исеме', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Вики адресыгызны языгыз', # Fuzzy
	...
	'cnw-desc-headline' => 'Сезнең вики нәрсә турында булачак?', # Fuzzy
	'cnw-desc-creative' => 'Темагызны тасвирлагыз', # Fuzzy
	'cnw-desc-placeholder' => 'Бу сезнең викиның баш битендә булачак.', # Fuzzy
	'cnw-desc-tip1' => 'Ярдәм', # Fuzzy
	'cnw-desc-tip1-creative' => 'Бу урынны кешеләргә сезнең вики турында бер-ике җөмлә белән сөйләр өчен кулланыгыз.', # Fuzzy
	'cnw-desc-tip2' => 'Псс', # Fuzzy
	'cnw-desc-tip2-creative' => 'Вики кунакларына сезнең теманың кайбер үзенчәлекләрен сөйләп китегез.', # Fuzzy
	'cnw-desc-select-one' => 'Берсен сайлагыз',
	'cnw-desc-default-lang' => 'Сезнең вики $1 бүлегендә булачак', # Fuzzy
	'cnw-desc-change-lang' => 'үзгәртү',
	'cnw-desc-lang' => 'Тел',
	'cnw-desc-wiki-submit-error' => 'Зинһар өчен, төркем сайлагыз',
	'cnw-theme-headline' => 'Тема сайлау',
	'cnw-theme-creative' => 'Теманы астарак сайлагыз; сез төгәл карар кабул иткәнче, бөтен теманы да карап чыга аласыз.', # Fuzzy
	'cnw-theme-instruction' => 'Соңрак, "Минем коралларым"а кереп, сез үзегезнең темаларыгызны ясый аласыз.', # Fuzzy
	'cnw-welcome-headline' => 'Котлыйбыз! $1 ачылды!', # Fuzzy
	'cnw-welcome-instruction1' => 'Викигә мәкаләләр өстәр өчен, астагы төймәгә басыгыз', # Fuzzy
	'cnw-welcome-help' => 'Җаваплар, киңәшләр һәм башка бик күп кирәк нәрсәләрне <a href="http://community.wikia.com">Үзәк викидә</a> табарсыз.', # Fuzzy
...
$messages['uk'] = array(
	...
	'cnw-name-wiki-headline' => 'Створити вікі', # Fuzzy
	'cnw-name-wiki-creative' => 'Вікія - це найкраще місце для створення веб-сайту про те, що ви любите, і зростання спільноти навколо цього.', # Fuzzy
	'cnw-name-wiki-label' => 'Назва вашого вікі-сайту', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Дайте адресу вашому вікі-сайту', # Fuzzy
	...
	'cnw-desc-creative' => 'Ваш опис допомагатиме людям віднайти вашу вікію', # Fuzzy
	'cnw-desc-placeholder' => 'Це відображатиметься на головній сторінці вікі.', # Fuzzy
	'cnw-desc-tip1' => 'Підказка', # Fuzzy
	'cnw-desc-tip1-creative' => 'Використовуйте це місце, щоб коротко розповісти людям про вашу вікію за одне або два речення.', # Fuzzy
	'cnw-desc-tip2' => 'Писати', # Fuzzy
	'cnw-desc-tip2-creative' => 'Про що ви зібралися писати?', # Fuzzy
	'cnw-desc-select-vertical' => 'Виберіть категорію концентратора', # Fuzzy
	'cnw-desc-select-categories' => 'Виберіть додаткові категорії', # Fuzzy
	...
	'cnw-desc-default-lang' => 'Ваша вікі буде в розділі $1', # Fuzzy
	'cnw-desc-change-lang' => 'змінити',
	'cnw-desc-lang' => 'Мова',
	'cnw-desc-wiki-submit-error' => 'Просимо вибрати категорію',
	'cnw-theme-headline' => 'Обрати тему',
	'cnw-theme-creative' => 'Виберіть тему нижче, ви можете переглянути кожну тему до того, як зробити остаточний вибір', # Fuzzy
	'cnw-theme-instruction' => 'Ви також можете створювати свої власні теми пізніше, перейшовши в "Мої інструменти".', # Fuzzy
	'cnw-welcome-headline' => 'Вітаємо! $1 створена', # Fuzzy
	'cnw-welcome-instruction1' => 'Натисніть на кнопку нижче, щоб почати додавати сторінки на вікі.', # Fuzzy
	'cnw-welcome-help' => 'Знайті відповіді, поради та багато іншого на <a href="http://community.wikia.com">Центральній вікі</a>.', # Fuzzy
 ...
 */
$messages['zh'] = array(
	'createnewwiki-desc' => 'Wiki creation wizard', # Fuzzy
	'cnw-next' => 'Next',
	'cnw-back' => 'Back',
	'cnw-or' => 'or',
	'cnw-title' => 'Create New Wiki',
	'cnw-name-wiki-headline' => 'Start a Wiki', # Fuzzy
	'cnw-name-wiki-creative' => 'Wikia is the best place to build a website and grow a community around what you love.', # Fuzzy
	'cnw-name-wiki-label' => 'Name your wiki', # Fuzzy
	'cnw-name-wiki-domain-label' => 'Give your wiki an address', # Fuzzy
	'cnw-name-wiki-submit-error' => 'Oops! You need to fill in both of the boxes above to keep going.',
	'cnw-login' => 'ننوتل',
	'cnw-signup' => 'Create Account',
	'cnw-signup-prompt' => 'Need an account?',
	...
	'cnw-auth-facebook-signup' => 'Sign up with Facebook',
	'cnw-auth-facebook-login' => 'Login with Facebook',
	'cnw-desc-headline' => "What's your wiki about?", # Fuzzy
	'cnw-desc-creative' => 'Describe your topic', # Fuzzy
	'cnw-desc-placeholder' => 'This will appear on the main page of your wiki.', # Fuzzy
	'cnw-desc-tip1' => 'Hint', # Fuzzy
	'cnw-desc-tip1-creative' => 'Use this space to tell people about your wiki in a sentence or two', # Fuzzy
	'cnw-desc-tip2' => 'Psst', # Fuzzy
	'cnw-desc-tip2-creative' => 'Give your visitors some specific details about your subject', # Fuzzy
	'cnw-desc-select-one' => 'Select one',
	'cnw-desc-default-lang' => 'Your wiki will be in $1', # Fuzzy
	'cnw-desc-change-lang' => 'change',
	'cnw-desc-lang' => 'Language',
	'cnw-desc-wiki-submit-error' => 'Please choose a category',
	'cnw-theme-headline' => 'Choose a theme',
	'cnw-theme-creative' => "Choose a theme below, you'll be able to see a preview of each theme as you select it.", # Fuzzy
	'cnw-theme-instruction' => 'You can also design your own theme later by going to "My Tools".', # Fuzzy
	'cnw-welcome-headline' => 'Congratulations! $1 has been created', # Fuzzy
	'cnw-welcome-instruction1' => 'Click the button below to start adding pages to your wiki.', # Fuzzy
	'cnw-welcome-help' => 'Find answers, advice, and more on <a href="http://community.wikia.com">Community Central</a>.', # Fuzzy
);
...
$messages['zh-hans'] = array(
	...
	'cnw-or' => '或',
	'cnw-title' => '创造一个新的维基',
	'cnw-name-wiki-headline' => '开始一个wikia',
