...
class RelatedVideosController extends WikiaController {
	...
	public function getCarousel(){
		...
		$this->linkToSeeMore = !empty($this->app->wg->EnableSpecialVideosExt) ? SpecialPage::getTitleFor("Videos")->escapeLocalUrl() : Title::newFromText(FilePageHelper::getVideosCategory())->getFullUrl();
		$this->videos = $videos;
