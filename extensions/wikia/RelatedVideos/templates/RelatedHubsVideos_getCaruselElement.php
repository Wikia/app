...
?>
<div class="item"><a class="video-thumbnail video-play" style="height:<?=$elementHeight; ?>px" href="<?=$video['fullUrl'];?>" data-ref="<?=$video['prefixedUrl'];?>" data-external="<?=$video['external'];?>" data-wiki="<?=$video['wiki'];?>"><?
