...
?>
<div class="item"><a class="video-thumbnail  video-hubs-video <?= $videoPlay ?>" style="height:<?=$elementHeight; ?>px" href="<?=$video['fullUrl'];?>" data-ref="<?=$video['prefixedUrl'];?>" data-external="<?=$video['external'];?>" data-video-name="<?=$video['title'];?>" data-wiki="<?=$video['wiki'];?>"><?
