...
?>
<div class="item"><a class="video video-hubs-video lightbox" style="height:<?=$elementHeight; ?>px" href="<?=$video['fullUrl'];?>" data-ref="<?=$video['prefixedUrl'];?>" data-external="<?=$video['external'];?>" data-video-name="<?= htmlspecialchars($video['title']) ?>" data-wiki="<?=$video['wiki'];?>"><?
