...
class RelatedVideosData {
	...
	public function getVideoData( Title $title, $thumbnailWidth, $videoWidth = VideoPage::DEFAULT_OASIS_VIDEO_WIDTH, $autoplay = true, $useMaster = false ) {
		...
		if ($title->exists()) {
			...
			$data['embedCode'] = $videoPage->getEmbedCode( $videoWidth, $autoplay, true );
			$data['embedJSON'] = $videoPage->getJWPlayerJSON( $videoWidth, $autoplay);
