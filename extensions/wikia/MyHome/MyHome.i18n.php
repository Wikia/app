...
$messages['en'] = array(
	...
	'myhome-log-in' => "<center>The My Home feature is only available if you're logged in.<br><br><big>'''<span class=\"plainlinks\">[{{fullurl:Special:UserLogin|returnto=$1}} Please log in to see this page!]</span>'''</big></center>",
...
$messages['es'] = array(
	...
	'myhome-log-in' => '<center>La página de inicio solo está disponible si estás idenfiticado<br><br><big>\'\'\'<span class="plainlinks">[{{fullurl:Special:UserLogin|returnto=$1}} Por favor, ¡identifícate para ver esta página!]</span>\'\'\'</big></center>',
...
$messages['fr'] = array(
	...
	'myhome-log-in' => '<center>La nouvelle fonction Mon Accueil est disponible seulement si vous êtes connecté(e).<br><br><big>\'\'\'<span class="plainlinks">[{{fullurl:Special:UserLogin|returnto=$1}} Veuillez vous connecter pour voir cette page!]</span>\'\'\'</big></center>',
...
$messages['it'] = array(
	...
	'myhome-log-in' => '<center>Il servizio My Home è disponibile solo se effettui il log in. <br><br><big>\'\'\'<span class="plainlinks">[{{fullurl:Special:UserLogin|returnto=$1}} Accedi per vedere la pagina!]</span>\'\'\'</big></center>',
...
$messages['nl'] = array(
	...
	'myhome-log-in' => '<center>De Mijn Home mogelijkheid is alleen beschikbaar als je ingelogd bent.<br><br><big>\'\'\'<span class="plainlinks">[{{fullurl:Special:UserLogin|returnto=$1}} Log a.u.b. in om deze pagina te bekijken!]</span>\'\'\'</big></center>',
...
$messages['ru'] = array(
	...
	'myhome-log-in' => '<center>Функционал "Личный кабинет" будет доступен, только если вы представитесь системе.<br><br><big>\'\'\'<span class="plainlinks">[{{fullurl:Special:UserLogin|returnto=$1}} Для просмотра этой страницы необходимо представиться системе!]</span>\'\'\'</big></center>',
...
$messages['sv'] = array(
	...
	'myhome-log-in' => '<center>My Home funktionen är bara tillgänglig om du är inloggad.<br><br><big>\'\'\'<span class="plainlinks">[{{fullurl:Special:UserLogin|returnto=$1}} Vänligen logga in för att se denna sida!]</span>\'\'\'</big></center>',
