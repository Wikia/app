...
$messages['nl'] = array(
	...
	'myhome-log-in' => '<center>De Mijn Home mogelijkheid is alleen beschikbaar als je ingelogd bent.<br><br><big>\'\'\'<span class="plainlinks">[{{fullurl:Special:UserLogin|$1}} Log a.u.b. in om deze pagina te bekijken!]</span>\'\'\'</big></center>',
...
$messages['ru'] = array(
	...
	'myhome-log-in' => '<center>Функционал "Личный кабинет" будет доступен, только если вы представитесь системе.<br><br><big>\'\'\'<span class="plainlinks">[{{fullurl:Special:UserLogin|$1}} Для просмотра этой страницы необходимо представиться системе!]</span>\'\'\'</big></center>',
