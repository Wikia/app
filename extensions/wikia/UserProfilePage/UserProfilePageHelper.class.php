...
class UserProfilePageHelper {
	...
	static public function onSkinTemplateOutputPageBeforeExec( $skin, $template ) {
		...
		$wgOut->addStyle( AssetsManager::getInstance()->getSassCommonURL("extensions/wikia/UserProfilePage/css/UserPagesHeader.scss"));
	...
	public static function getTopWikisCacheKey( User $user ) {
