...
$messages['ru'] = array(
	...
	'edit-account-closed-flag' => '<div class="errorbox" style="padding: 1em;">Эта учётная запись отключена по [[Справка:Справка:Отключение_учётной_записи|выбору участника]] или по решению сайта Фэндом.</div>',
