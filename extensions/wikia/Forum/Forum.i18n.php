...
* $5 is optional username and you can use it with GENDER parameter',
	...
	'forum-admin-page-editmode-templates-included' => 'Message explaining that in edit mode you can see included templates contents, which are hidden in normal (non-edit) view.',
