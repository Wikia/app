...
$messages['lol'] = array(
	...
	'forum-policies-and-faq' => 'crwdns63274:0{{SITENAME}}crwdnd63274:0{{SITENAME}}crwdnd63274:0{{SITENAME}}crwdne63274:0',
...
: Заметили ошибку? У вас возник вопрос? Спросите прямо на форуме. Если вам нужна помощь сотрудников FANDOM, зайдите на [[w:c:ru.community|Вики Сообщества]] или напишите нам через [[Служебная:Contact]].
...
: Если у вас есть учётная запись на FANDOM, то вы можете отслеживать темы и получать уведомления (на вики или по электронной почте) о новых ответах. Если у вас ещё нет аккаунта, [[Служебная:UserSignup|создайте его прямо сейчас]].
