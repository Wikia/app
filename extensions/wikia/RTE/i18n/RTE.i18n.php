...
$messages['en'] = array(
	...
	'rte-first-run-notice' => 'We have made some improvements to the editor. To learn more [http://www.wikia.com/wiki/User_blog:Kirkburn/Beta_test_the_new_rich_text_editor read the annoucement].',
);
$messages['pl'] = array(
	...
	'rte-edgecase-unclosed-tags' => 'niezamknięte tagi HTML',
        'rte-first-edit-title' => 'Witaj w nowym edytorze Wikia',
        'rte-first-edit-message' => 'Ta wiki używa nowego Edytora Wizualnego. Jeśli chcesz edytować w trybie wikitekstu, użyj przycisku "źródło" na pasku narzędzi. Aby dowiedzieć się więcej o nowym edytorze, zajrzyj na stronę [[Help:New editor]]',
...
$messages['de'] = array(
	...
	'rte-first-edit-title' => 'Willkommen im neuen Wikia-Editor',
	'rte-first-edit-message' => 'Dieses Wiki benutzt den neuen grafischen Editor von Wikia. Wenn du lieber herkömmlichen Wikitext verwenden möchtest, klicke auf „Quelltext“ in der Befehlsleiste. Weitere Informationen findest du unter [[w:c:hilfe:Hilfe:Neuer Editor|Hilfe:Neuer Editor]].',
	'rte-first-edit-dont-show-me' => 'Diese Nachricht nicht mehr anzeigen.',
	'rte-first-edit-dismiss' => 'schließen',
	'rte-tooltip' => '\'\'\'Neu!\'\'\' Befehlsleiste. Weitere Informationen in der [[w:c:hilfe:Hilfe:Neuer Editor|Hilfe]].',
...
$messages['es'] = array(
	...
	'rte-first-edit-title' => 'Bienvenido al nuevo editor de Wikia',
	'rte-first-edit-message' => 'Este wiki usa el nuevo Editor de Texto Enriquecido de Wikia. Si quieres usar el wikitexto tradicional, haz clic en el botón "Fuente HTML" en la barra de herramientas. Para aprender más acerca de este nuevo editor por favor ve a [[Help:New editor]]',
	'rte-first-edit-dont-show-me' => 'No mostrar este mensaje de nuevo',
	'rte-first-edit-dismiss' => 'Cerrar',
	'rte-tooltip' => '\'\'\'¡Nuevo!\'\'\' Barra de edición. Échale un vistazo a [[Help:New editor|ayuda]] para aprender más',
...
$messages['zh'] = array(
	...
	'rte-first-edit-title' => '歡迎使用新版 Wikia 編輯器',
	'rte-first-edit-message' => '此 wiki 使用 Wikia 新的所見即所得編輯器. 您若想使用傳統式 wiki 原碼的話請點擊工具列右方的\'原始碼\'按鈕. 新編輯器的使用解說請詳見 Help:New editor (英文).',
...
$messages['ja'] = array(
	...
	'rte-first-edit-message' => 'このウィキでは、ウィキアの新しい高機能テキストエディタが使用されています。もし、従来のウィキテキストを利用したいのであれば、ツールバーにある"ソース"ボタンをクリックしてください。<!--また、このエディタについての詳細は[[w:ja:<Editor\'s help>|<Editor\'s help>]]]をご覧ください。-->',
