...
{var CKEDITOR={timestamp:'',version:'3.4.2',revision:'r29885 build 20101116',_:{},status:'unloaded',basePath:(function()
...
else{partsStack.push(lineBreakInTail?'\n':'');}}});$.each(params,function(key,value){if(parseInt(key)&&parseInt(key)==key){partsStack.push((value!=''?value:'')+(lineBreakInTail?'\n':''));}
...
{if(CKEDITOR.env.webkit){scrollTopEditor=RTE.instance.document.$.body.scrollTop;}
scrollTop=scrollTopPage+scrollTopEditor;if(scrollTopPage>0){position.top+=scrollTopEditor;}}
