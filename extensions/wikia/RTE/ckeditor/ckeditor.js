...
{var CKEDITOR={timestamp:'',version:'3.4.2',revision:'r31278 build 20101214',_:{},status:'unloaded',basePath:(function()
...
setTimeout(function(){$('.cke_toolbar_tab_tabs span').click(function(e){element=$(e.target);$('.cke_toolbar_tab').hide();$('#cke_toolbar'+element.attr('data-order')).show();$('.cke_toolbar_tab_tabs span').removeClass('selected');element.addClass('selected');});self.updateToolbar.apply(self);},50);}});editor.on('instanceReady',function(){var toolbar=$('#cke_toolbar1');RTE.tools.getThemeColors();if(window.skin=='monaco'){toolbar.find('.color1').css({backgroundColor:RTE.config.baseBackgroundColor,color:RTE.config.baseColor});}
