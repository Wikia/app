...
{var CKEDITOR={timestamp:'',version:'20101102',revision:'r29270',_:{},status:'unloaded',basePath:(function()
...
return elements[i];}
return null;}};CKEDITOR.dom.text=function(text,ownerDocument)
{if(typeof text=='string')
...
{preload.push('icons.png?1288698619','images/sprites_ie6.png?1288698619','images/dialog_sides.gif?1288698619');}
...
{editor.config.smiley_path=editor.config.smiley_path||(this.path+'images/');editor.addCommand('smiley',new CKEDITOR.dialogCommand('smiley'));editor.ui.addButton('Smiley',{label:editor.lang.smiley.toolbar,command:'smiley'});CKEDITOR.dialog.add('smiley',this.path+'dialogs/smiley.js');}});CKEDITOR.config.smiley_images=['regular_smile.gif?1288698619','sad_smile.gif?1288698619','wink_smile.gif?1288698619','teeth_smile.gif?1288698619','confused_smile.gif?1288698619','tounge_smile.gif?1288698619','embaressed_smile.gif?1288698619','omg_smile.gif?1288698619','whatchutalkingabout_smile.gif?1288698619','angry_smile.gif?1288698619','angel_smile.gif?1288698619','shades_smile.gif?1288698619','devil_smile.gif?1288698619','cry_smile.gif?1288698619','lightbulb.gif?1288698619','thumbs_down.gif?1288698619','thumbs_up.gif?1288698619','heart.gif?1288698619','broken_heart.gif?1288698619','kiss.gif?1288698619','envelope.gif?1288698619'];CKEDITOR.config.smiley_descriptions=['smiley','sad','wink','laugh','frown','cheeky','blush','surprise','indecision','angry','angel','cool','devil','crying','enlightened','no','yes','heart','broken heart','kiss','mail'];(function()
{var cssTemplate='.%2 p,'+'.%2 div,'+'.%2 pre,'+'.%2 address,'+'.%2 blockquote,'+'.%2 h1,'+'.%2 h2,'+'.%2 h3,'+'.%2 h4,'+'.%2 h5,'+'.%2 h6'+'{'+'background-repeat: no-repeat;'+'border: 1px dotted gray;'+'padding-top: 8px;'+'padding-left: 8px;'+'}'+'.%2 p'+'{'+'%1p.png?1288698619);'+'}'+'.%2 div'+'{'+'%1div.png?1288698619);'+'}'+'.%2 pre'+'{'+'%1pre.png?1288698619);'+'}'+'.%2 address'+'{'+'%1address.png?1288698619);'+'}'+'.%2 blockquote'+'{'+'%1blockquote.png?1288698619);'+'}'+'.%2 h1'+'{'+'%1h1.png?1288698619);'+'}'+'.%2 h2'+'{'+'%1h2.png?1288698619);'+'}'+'.%2 h3'+'{'+'%1h3.png?1288698619);'+'}'+'.%2 h4'+'{'+'%1h4.png?1288698619);'+'}'+'.%2 h5'+'{'+'%1h5.png?1288698619);'+'}'+'.%2 h6'+'{'+'%1h6.png?1288698619);'+'}';var cssTemplateRegex=/%1/g,cssClassRegex=/%2/g;var commandDefinition={preserveState:true,editorFocus:false,exec:function(editor)
...
return link;};var lang=editor.lang.link;return{title:editor.lang.link.title,minWidth:500,minHeight:185,contents:[{id:'internal',label:lang.internal.tab,title:lang.internal.tab,elements:[{'type':'html','html':'<p class="link-type-note"><span>...</span><img alt="Link Status" class="" src="http://images1.wikia.nocookie.net/__cb21710/common/skins/common/blank.gif?1288698619" /></p>','id':'linkdisplay'},{'type':'text','label':editor.lang.link.label.target,'id':'name',onKeyUp:function(){var linkTextField=this.getDialog().getContentElement('internal','label');if(RTE.tools.isExternalLink(this.getValue())){setMode('external');}
