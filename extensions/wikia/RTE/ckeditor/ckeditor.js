...
{var CKEDITOR={timestamp:'A06B',version:'20100205',revision:'r18126',_:{},status:'unloaded',basePath:(function()
...
var editorX=parseInt(extra.pageX-$('#editform').offset().left);var editorWidth=parseInt($('#editform').width());var data=target.getData();var newAlign=false;var oldAlign=data.params.align;if(!oldAlign){oldAlign=(target.hasClass('thumb')||target.hasClass('frame'))?'right':'left';}
