...
var intro='<div class="RTEPlaceholderPreviewIntro">'+intro+'</div>';var tools='',showEdit=true;var spriteImg='<img class="sprite" src="http://images.wikia.com/common/skins/common/blank.gif?1" />';if(showEdit){tools+='<a class="RTEPlaceholderPreviewToolsEdit'+
