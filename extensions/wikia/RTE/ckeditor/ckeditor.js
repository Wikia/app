...
{var CKEDITOR={timestamp:'A06B',version:'20100218',revision:'r18652',_:{},status:'unloaded',basePath:(function()
...
{preload.push('icons.png?20100218','images/sprites_ie6.png?20100218','images/dialog_sides.gif?20100218');}
...
{var cssTemplate='.%2 p,'+'.%2 div,'+'.%2 pre,'+'.%2 address,'+'.%2 blockquote,'+'.%2 h1,'+'.%2 h2,'+'.%2 h3,'+'.%2 h4,'+'.%2 h5,'+'.%2 h6'+'{'+'background-repeat: no-repeat;'+'border: 1px dotted gray;'+'padding-top: 8px;'+'padding-left: 8px;'+'}'+'.%2 p'+'{'+'%1p.png?20100218);'+'}'+'.%2 div'+'{'+'%1div.png?20100218);'+'}'+'.%2 pre'+'{'+'%1pre.png?20100218);'+'}'+'.%2 address'+'{'+'%1address.png?20100218);'+'}'+'.%2 blockquote'+'{'+'%1blockquote.png?20100218);'+'}'+'.%2 h1'+'{'+'%1h1.png?20100218);'+'}'+'.%2 h2'+'{'+'%1h2.png?20100218);'+'}'+'.%2 h3'+'{'+'%1h3.png?20100218);'+'}'+'.%2 h4'+'{'+'%1h4.png?20100218);'+'}'+'.%2 h5'+'{'+'%1h5.png?20100218);'+'}'+'.%2 h6'+'{'+'%1h6.png?20100218);'+'}';var cssTemplateRegex=/%1/g,cssClassRegex=/%2/g;var commandDefinition={preserveState:true,editorFocus:false,exec:function(editor)
...
{var lang=this.lang.fakeobjects;var attributes={'class':className,src:CKEDITOR.getUrl('images/spacer.gif?20100218'),_cke_realelement:encodeURIComponent(realElement.getOuterHtml()),_cke_real_node_type:realElement.type,alt:lang[realElementType]||lang.unknown};if(realElementType)
...
var notice=$('#RTEFirstRunNotice');notice.children('#RTEFirstRunNoticeClose').bind('click',self.dismiss);notice.slideDown();setTimeout(RTE.repositionRTEStuff,1000);RTE.log('first run notice - show');RTE.track('firstRunNotice','init');});}});CKEDITOR.plugins.add('rte-gallery',{init:function(editor){var self=this;editor.on('wysiwygModeReady',function(){var gallery=RTE.getEditor().find('.image-gallery');self.setupGallery(gallery);});editor.on('toolbarReady',function(toolbar){});if(typeof window.WikiaImageGallery!='undefined'){editor.addCommand('addgallery',{exec:function(editor){WikiaImageGallery.showEditor();}});editor.ui.addButton('Gallery',{title:editor.lang.picturegallery.add,className:'RTEGalleryButton',command:'addgallery'});}
else{RTE.log('WikiaImageGallery is not enabled here - disabling "Gallery" button');return;}},setupGallery:function(gallery){gallery.attr('title',RTE.instance.lang.picturegallery.tooltip).unbind('.gallery').bind('edit.gallery',function(ev){var gallery=$(this);var data=gallery.getData();RTE.log(data);alert(data.wikitext);});}});(function()
