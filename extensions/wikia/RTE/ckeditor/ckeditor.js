...
var intro='<div class="RTEPlaceholderPreviewIntro">'+intro+'</div>';var tools='',showEdit=true;var spriteImg='<img class="sprite" src="'+wgBlankImgUrl+'" />';if(showEdit){tools+='<a class="RTEPlaceholderPreviewToolsEdit'+
