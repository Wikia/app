...
{var CKEDITOR={timestamp:'',version:'20101025',revision:'r28917',_:{},status:'unloaded',basePath:(function()
...
{preload.push('icons.png?20101025','images/sprites_ie6.png?20101025','images/dialog_sides.gif?20101025');}
...
{editor.config.smiley_path=editor.config.smiley_path||(this.path+'images/');editor.addCommand('smiley',new CKEDITOR.dialogCommand('smiley'));editor.ui.addButton('Smiley',{label:editor.lang.smiley.toolbar,command:'smiley'});CKEDITOR.dialog.add('smiley',this.path+'dialogs/smiley.js');}});CKEDITOR.config.smiley_images=['regular_smile.gif?20101025','sad_smile.gif?20101025','wink_smile.gif?20101025','teeth_smile.gif?20101025','confused_smile.gif?20101025','tounge_smile.gif?20101025','embaressed_smile.gif?20101025','omg_smile.gif?20101025','whatchutalkingabout_smile.gif?20101025','angry_smile.gif?20101025','angel_smile.gif?20101025','shades_smile.gif?20101025','devil_smile.gif?20101025','cry_smile.gif?20101025','lightbulb.gif?20101025','thumbs_down.gif?20101025','thumbs_up.gif?20101025','heart.gif?20101025','broken_heart.gif?20101025','kiss.gif?20101025','envelope.gif?20101025'];CKEDITOR.config.smiley_descriptions=['smiley','sad','wink','laugh','frown','cheeky','blush','surprise','indecision','angry','angel','cool','devil','crying','enlightened','no','yes','heart','broken heart','kiss','mail'];(function()
{var cssTemplate='.%2 p,'+'.%2 div,'+'.%2 pre,'+'.%2 address,'+'.%2 blockquote,'+'.%2 h1,'+'.%2 h2,'+'.%2 h3,'+'.%2 h4,'+'.%2 h5,'+'.%2 h6'+'{'+'background-repeat: no-repeat;'+'border: 1px dotted gray;'+'padding-top: 8px;'+'padding-left: 8px;'+'}'+'.%2 p'+'{'+'%1p.png?20101025);'+'}'+'.%2 div'+'{'+'%1div.png?20101025);'+'}'+'.%2 pre'+'{'+'%1pre.png?20101025);'+'}'+'.%2 address'+'{'+'%1address.png?20101025);'+'}'+'.%2 blockquote'+'{'+'%1blockquote.png?20101025);'+'}'+'.%2 h1'+'{'+'%1h1.png?20101025);'+'}'+'.%2 h2'+'{'+'%1h2.png?20101025);'+'}'+'.%2 h3'+'{'+'%1h3.png?20101025);'+'}'+'.%2 h4'+'{'+'%1h4.png?20101025);'+'}'+'.%2 h5'+'{'+'%1h5.png?20101025);'+'}'+'.%2 h6'+'{'+'%1h6.png?20101025);'+'}';var cssTemplateRegex=/%1/g,cssClassRegex=/%2/g;var commandDefinition={preserveState:true,editorFocus:false,exec:function(editor)
...
{var lang=this.lang.fakeobjects;var attributes={'class':className,src:CKEDITOR.getUrl('images/spacer.gif?20101025'),_cke_realelement:encodeURIComponent(realElement.getOuterHtml()),_cke_real_node_type:realElement.type,alt:lang[realElementType]||lang.unknown,align:realElement.getAttribute('align')||''};if(realElementType)
...
else{css.push(window.stylepath+'/monobook/main.css');css.push(CKEDITOR.basePath+'../css/RTEcontent.css');css.push(window.RTEMWCommonCss);}
if(typeof WikiaEnableAutoPageCreate!="undefined"){css.push(wgExtensionsPath+'/wikia/AutoPageCreate/AutoPageCreate.css');}
...
return link;};var lang=editor.lang.link;return{title:editor.lang.link.title,minWidth:500,minHeight:185,contents:[{id:'internal',label:lang.internal.tab,title:lang.internal.tab,elements:[{'type':'html','html':'<p class="link-type-note"><span>...</span><img alt="Link Status" class="" src="http://images1.wikia.nocookie.net/__cb21710/common/skins/common/blank.gif?20101025" /></p>','id':'linkdisplay'},{'type':'text','label':editor.lang.link.label.target,'id':'name',onKeyUp:function(){var linkTextField=this.getDialog().getContentElement('internal','label');if(RTE.tools.isExternalLink(this.getValue())){setMode('external');}
