...
{var CKEDITOR={timestamp:'',version:'20101102',revision:'r29261',_:{},status:'unloaded',basePath:(function()
...
{preload.push('icons.png?1288689380','images/sprites_ie6.png?1288689380','images/dialog_sides.gif?1288689380');}
...
{editor.config.smiley_path=editor.config.smiley_path||(this.path+'images/');editor.addCommand('smiley',new CKEDITOR.dialogCommand('smiley'));editor.ui.addButton('Smiley',{label:editor.lang.smiley.toolbar,command:'smiley'});CKEDITOR.dialog.add('smiley',this.path+'dialogs/smiley.js');}});CKEDITOR.config.smiley_images=['regular_smile.gif?1288689380','sad_smile.gif?1288689380','wink_smile.gif?1288689380','teeth_smile.gif?1288689380','confused_smile.gif?1288689380','tounge_smile.gif?1288689380','embaressed_smile.gif?1288689380','omg_smile.gif?1288689380','whatchutalkingabout_smile.gif?1288689380','angry_smile.gif?1288689380','angel_smile.gif?1288689380','shades_smile.gif?1288689380','devil_smile.gif?1288689380','cry_smile.gif?1288689380','lightbulb.gif?1288689380','thumbs_down.gif?1288689380','thumbs_up.gif?1288689380','heart.gif?1288689380','broken_heart.gif?1288689380','kiss.gif?1288689380','envelope.gif?1288689380'];CKEDITOR.config.smiley_descriptions=['smiley','sad','wink','laugh','frown','cheeky','blush','surprise','indecision','angry','angel','cool','devil','crying','enlightened','no','yes','heart','broken heart','kiss','mail'];(function()
{var cssTemplate='.%2 p,'+'.%2 div,'+'.%2 pre,'+'.%2 address,'+'.%2 blockquote,'+'.%2 h1,'+'.%2 h2,'+'.%2 h3,'+'.%2 h4,'+'.%2 h5,'+'.%2 h6'+'{'+'background-repeat: no-repeat;'+'border: 1px dotted gray;'+'padding-top: 8px;'+'padding-left: 8px;'+'}'+'.%2 p'+'{'+'%1p.png?1288689380);'+'}'+'.%2 div'+'{'+'%1div.png?1288689380);'+'}'+'.%2 pre'+'{'+'%1pre.png?1288689380);'+'}'+'.%2 address'+'{'+'%1address.png?1288689380);'+'}'+'.%2 blockquote'+'{'+'%1blockquote.png?1288689380);'+'}'+'.%2 h1'+'{'+'%1h1.png?1288689380);'+'}'+'.%2 h2'+'{'+'%1h2.png?1288689380);'+'}'+'.%2 h3'+'{'+'%1h3.png?1288689380);'+'}'+'.%2 h4'+'{'+'%1h4.png?1288689380);'+'}'+'.%2 h5'+'{'+'%1h5.png?1288689380);'+'}'+'.%2 h6'+'{'+'%1h6.png?1288689380);'+'}';var cssTemplateRegex=/%1/g,cssClassRegex=/%2/g;var commandDefinition={preserveState:true,editorFocus:false,exec:function(editor)
...
{var lang=this.lang.fakeobjects;var attributes={'class':className,src:CKEDITOR.getUrl('images/spacer.gif?1288689380'),_cke_realelement:encodeURIComponent(realElement.getOuterHtml()),_cke_real_node_type:realElement.type,alt:lang[realElementType]||lang.unknown,align:realElement.getAttribute('align')||''};if(realElementType)
...
return link;};var lang=editor.lang.link;return{title:editor.lang.link.title,minWidth:500,minHeight:185,contents:[{id:'internal',label:lang.internal.tab,title:lang.internal.tab,elements:[{'type':'html','html':'<p class="link-type-note"><span>...</span><img alt="Link Status" class="" src="http://images1.wikia.nocookie.net/__cb21710/common/skins/common/blank.gif?1288689380" /></p>','id':'linkdisplay'},{'type':'text','label':editor.lang.link.label.target,'id':'name',onKeyUp:function(){var linkTextField=this.getDialog().getContentElement('internal','label');if(RTE.tools.isExternalLink(this.getValue())){setMode('external');}
...
return this.sourceButton;},updateSourceButtonTooltip:function(){var sourceButton=this.getSourceButton();var msgKey=(RTE.instance.mode=='wysiwyg')?'toSource':'toWysiwyg';sourceButton.attr('title',RTE.instance.lang.modeSwitch[msgKey]);},updateModeInfo:function(){$('body').removeClass('rte_wysiwyg').removeClass('rte_source').addClass('rte_'+RTE.instance.mode);$('#RTEMode').attr('value',RTE.instance.mode);}});CKEDITOR.plugins.add('rte-overlay',{overlays:false,init:function(editor){var self=this;RTE.overlay.plugin=this;editor.on('instanceReady',function(){self.overlays=$('<div>',{id:'RTEMediaOverlays'}).appendTo($('#RTEStuff'));});editor.on('wysiwygModeReady',function(){if(typeof self.overlays=='object'){self.overlays.html('');}});},showOverlay:function(node){var overlay=this.getOverlay(node);var position=this.getOverlayPositon(node);overlay.css({'left':position.left+'px','top':parseInt(position.top+2)+'px'});var menu=overlay.children().eq(0);if(position.top>0){menu.show();}
...
overlay.show();if(timeoutId=node.data('hideTimeout')){clearTimeout(timeoutId);}},hideOverlay:function(node){var overlay=this.getOverlay(node);node.data('hideTimeout',setTimeout(function(){overlay.children().hide();overlay.hide();node.removeData('hideTimeout');},100));},getOverlay:function(node,items){var self=this;if(!this.overlays){return false;}
...
return width+'px';}});RTE.overlay={plugin:false,add:function(node,items){var self=this.plugin;node.data('items',items);node.each(function(i,el){el=$(el).removeData('overlay').unbind('.overlay').bind({'mouseover.overlay':function(ev){self.showOverlay(el);},'mouseout.overlay':function(ev){self.hideOverlay(el);},'contextmenu.overlay':function(ev){ev.preventDefault();ev.stopPropagation();}});});}};CKEDITOR.plugins.add('rte-paste',{htmlBeforePaste:'',getHtml:function(){return RTE.instance.document.getBody().getHtml();},track:function(ev){RTE.track('paste',ev);},init:function(editor){var self=this;editor.on('dataReady',function(ev){if(editor.mode!='wysiwyg'){return;}
