	...
	var RTE = {
		...
		getContentsCss: function(editor) {
			...
			if (typeof WikiaEnableAutoPageCreate != 'undefined') {
				RTE.config.contentsCss.push('/extensions/wikia/AutoPageCreate/AutoPageCreate.css'); // local path needs to be used here
			}
...
CKEDITOR.getUrl = function( resource ) {
	...
	if (CKEDITOR.langRegExp.test(resource)) {
		...
		var url = '/wikia.php?controller=RTE&method=i18n&uselang=' + lang +
