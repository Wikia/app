require(['wikia.log', 'wikia.window', 'jquery'], function(log, window, $) {
    ...
    var oTable = $('#lu-table').dataTable({
        ...
        "sCookiePrefix": "ListGlobalusers-wikia",
        ...
        "sAjaxSource": window.wgScript + "?action=ajax&rs=ListGlobalUsersAjax::axShowUsers&uselang=" + encodeURIComponent(window.wgUserLanguage),
        ...
        "fnServerData": function (sSource, aoData, fnCallback) {
            ...
            var config = window.mw.config.get('listGlobalUsers');
    ...
    $('#lu_search').autocomplete({
        source: function( request, response ) {
            $.getJSON(
                window.wgScript + "?action=ajax&rs=ListGlobalUsersAjax::axSuggestUsers",
                {
                    'query': request.term
                },
                function(data) {
