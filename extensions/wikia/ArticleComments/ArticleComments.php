...
class ArticleCommentList {
	...
	public function render() {
		...
		global $wgRequireFBConnectionToComment;
		...
		$fb = new FBConnectAPI();
		$isFBConnectionNeeded = ( $wgRequireFBConnectionToComment && ( $fb->user() == 0 ) ); // fb id or 0 if none is found.
		...
		$template->set_vars( array(
			...
			"isFBConnectionNeeded"	=> $isFBConnectionNeeded
		) );
