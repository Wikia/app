...
<? if (!$isReadOnly) { ?>
			...
			<input type="submit" name="wpArticleCancel" id="article-comm-edit-cancel-<?=$title->getArticleId()?>" class="wikia-button secondary" value="<? echo wfMsg('article-comments-cancel') ?>" />
