...
$messages['de'] = array(
	...
	'lvs-swap-video-success' => 'Du hast dein Video erfolgreich durch ein Wikia-Video ausgetauscht. Weitere Informationen auf der Dateibeschreibungsseite $1. $2',
	'lvs-file-link-text' => 'hier',
	...
	'lvs-confirm-swap-title' => 'Video austauschen',
	'lvs-confirm-swap-message-same-title' => "Du bist dabei in deinem Wiki '''$1''' durch ein Wikia-Video zu ersetzen. Damit tauscht du alle Instanzen dieses Videos aus, inklusive der Einbindungen in Artikelseiten, und das Originalvideo wird gelöscht. Jegliche Änderungen können im Nachhinein in der Versionsgeschichte dieser Spezialseite rückgängig gemacht werden. Möchstest du fortfahren?",
	'lvs-confirm-swap-message-different-title' => "Du bist dabei in deinem Wiki '''$1''' durch '''$2''' zu ersetzen. Damit tauscht du alle Instanzen dieses Videos aus, inklusive der Einbindungen in Artikelseiten. Das Originalvideo wird gelöscht und die Dateibeschreibungsseite wird auf die neue Videoseite weiterleiten. Jegliche Änderungen können im Nachhinein in der Versionsgeschichte dieser Spezialseite rückgängig gemacht werden. Möchstest du fortfahren?",
...
$messages['es'] = array(
	...
	'lvs-callout-header' => "Hemos encontrado los siguienes videos de tu wiki en Wikia Video. <br> Sería buena idea reemplazar tus videos desde Wikia Video porque:",
	...
	'lvs-instructions' => "Muchos de los videos que se añaden a vuestros wikis dejan de estar disponibles cuando se borran por violaciones de derechos de autor. Es por esto que Wikia ha subido miles de videos autorizados por nuestros patrocinadores del contenido. Esta página especial es una forma fácil de ver si hay alguna copia autorizada de un video parecido o igual al de vuestro wiki. Por favor, tened en cuenta que a menudo el mismo video puede tener una miniatura diferente así que es mejor que reviséis el video antes de tomar una decisión. ¡Feliz intercambio!",
	...
	'lvs-swap-video-success' => 'Has reemplazado satisfactoriamente tu video con Wikia Video. Puedes comprobar la página del archivo $1. $2',
	'lvs-file-link-text' => 'aquí',
	...
	'lvs-confirm-swap-title' => 'Cambiar video',
	'lvs-confirm-swap-message-same-title' => "Vas a cambiar el video '''$1''' por un video de Wikia Video en tu wiki. Esto reemplazará todas las versiones del video, incluyendo cualquier miniatura del video añadida en los artículos, y el video original será eliminado. Cualquier cambio puede ser revertido después desde el historial de esta página especial. ¿Quieres continuar?",
	'lvs-confirm-swap-message-different-title' => "Vas a cambiar el video '''$1''' por el video '''$2''' en tu wiki. Esto reemplazará todas las versiones del video, incluyendo cualquier miniatura del video añadida en los artículos, y el video original será eliminado. Cualquier cambio puede ser revertido después desde el historial de esta página especial. ¿Quieres continuar?",
...
$messages['pl'] = array(
	...
	'lvs-swap-video-success' => 'Z powodzeniem wymieniono film. Zajrzyj na stronę pliku $1. $2',
	'lvs-file-link-text' => 'tutaj',
	...
	'lvs-confirm-swap-title' => 'Wymień film',
	'lvs-confirm-swap-message-same-title' => "Masz zamiar wymienić '''$1''' na film z Filmoteki Wikii. Spowoduje to wymianę wszystkich odwołań do tego filmu, w tym filmów umieszczonych w artykułach, a oryginalny film zostanie usunięty. Wszystkie zmiany można cofnąć korzystając z historii wymian dostępnej na tej stronie. Czy chcesz kontynuować?",
	'lvs-confirm-swap-message-different-title' => "Masz zamiar wymienić '''$1''' na '''$2''' na wiki.  Spowoduje to wymianę wszystkich odwołań do tego filmu, w tym filmów umieszczonych w artykułach. Oryginalny film zostanie usunięty, a strona pliku zostanie przekierowana do nowej strony filmu. Wszystkie zmiany można cofnąć korzystając z historii wymian dostępnej na tej stronie. Czy chcesz kontynuować?",
