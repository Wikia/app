...
define('ext.wikia.adEngine.provider.btfBlocker', [
	...
	function processBtfSlot(slot) {
		...
		if (typeof slot.collapse === 'function') {
	...
	function decorate(fillInSlot) {
		if (typeof config === 'undefined') {
			throw 'btfBlocker needs to be initialized first';
		}
	...
	function initialize(btfBlockerConfig) {
		log(['initialize', btfBlockerConfig], log.levels.info.debug, logGroup);
		config = btfBlockerConfig;
