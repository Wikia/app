...
define('ext.wikia.adEngine.provider.remnantGpt', [
	...
	return factory.createProvider(
		...
		'remnant',
		{
			...
			INCONTENT_BOXAD_1: {size: '120x160,160x600,300x250,300x600', loc: 'hivi'},
			INCONTENT_LEADERBOARD: {size: '1x1,728x90,300x250,468x60', loc: 'hivi'},
			INVISIBLE_SKIN: {size: '1000x1000,1x1', loc: 'top'},
			LEFT_SKYSCRAPER_2: {size: '120x160,160x600,300x600,300x1050', loc: 'middle'},
			LEFT_SKYSCRAPER_3: {size: '120x160,160x600,300x600', loc: 'footer'},
