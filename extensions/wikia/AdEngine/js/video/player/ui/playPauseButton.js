...
define('ext.wikia.adEngine.video.player.ui.playPauseButton', [
	...
	var logGroup = 'ext.wikia.adEngine.video.player.ui.playPauseButton',
		...
		pauseSvg = '<svg width="14" height="16" viewBox="0 0 14 16" xmlns="http://www.w3.org/2000/svg"><g fill="#FFF" fill-rule="evenodd"><rect width="5" height="16" rx="1"/><rect x="9" width="5" height="16" rx="1"/></g></svg>';
