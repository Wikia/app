...
/***/ function(module, exports, __webpack_require__) {
	...
	var _secureCreatives = __webpack_require__(63);
	...
	var adserver = __webpack_require__(64);
	var targeting = __webpack_require__(65);
	...
	pbjs.version = 'v0.17.0';
	utils.logInfo('Prebid.js v0.17.0 loaded');
...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		"REPO_AND_VERSION": "prebid_prebid_0.17.0",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var utils = __webpack_require__(2);
	var ajax = __webpack_require__(20).ajax;
	var bidfactory = __webpack_require__(10);
	var bidmanager = __webpack_require__(11);
	...
	function AppnexusAstAdapter() {
	  ...
	  baseAdapter.callBids = function (bidRequest) {
	    ...
	    var tags = bids.filter(function (bid) {
	      ...
	      if (bid.params.user) {
	        ...
	        Object.keys(bid.params.user).filter(function (param) {
	          ...
	          return tag.user[param] = bid.params.user[param];
	        });
	      }
	    ...
	    if (!utils.isEmpty(tags)) {
	      var payloadJson = { tags: [].concat(_toConsumableArray(tags)) };
	      if (member > 0) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VERSION = '2.0.1',
	    ...
	    ajax = __webpack_require__(20).ajax;
	...
	var GumgumAdapter = function GumgumAdapter() {
	  ...
	  var _handleGumGumResponse = function _handleGumGumResponse(cachedBidRequest) {
	    return function (bidResponse) {
	      var ad = bidResponse && bidResponse.ad;
	      var pag = bidResponse && bidResponse.pag;
	      /* cache the pageViewId */
	      if (pag && pag.pvid) pageViewId = pag.pvid;
	      /* create the bid */
	      if (ad && ad.id) {
	        var bid = bidfactory.createBid(1);
	        var trackingId = cachedBidRequest.t,
	            productId = cachedBidRequest.pi,
	            placementCode = cachedBidRequest.placementCode;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cygnus_index_adunits = [[728, 90], [120, 600], [300, 250], [160, 600], [336, 280], [234, 60], [300, 600], [300, 50], [320, 50], [970, 250], [300, 1050], [970, 90], [180, 150], [320, 480]]; // jshint ignore:line
	...
	var cygnus_index_start = function cygnus_index_start() {
	  ...
	  OpenRTBRequest.prototype.buildRequest = function () {
	    ...
	    var prebidVersion = encodeURIComponent("0.17.0");
	...
	*/
	...
	var TripleLiftAdapter = function TripleLiftAdapter() {
	  ...
	  function buildTLCall(bid, callbackId) {
	    ...
	    tlCall = utils.tryAppendQueryString(tlCall, 'v', '0.17.0');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SharethroughAdapter = function SharethroughAdapter() {
	  ...
	  function appendEnvFields(url) {
	    url = utils.tryAppendQueryString(url, 'hbVersion', '0.17.0');
