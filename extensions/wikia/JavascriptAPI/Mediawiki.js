...
Mediawiki.editArticleCallback = function(resultJson) {
	...
	try {
		...
		if (Mediawiki.e(result.error)){
			...
			Mediawiki.updateStatus("Edit Article Successful");
...
Mediawiki.getToken = function(titles, tokenType){
	...
	Mediawiki.updateStatus("Obtaining edit token...");
...
Mediawiki.login = function (callBackSuccess, callBackFailure){
	if (Mediawiki.isLoggedIn()){
		Mediawiki.updateStatus("You are already logged in");
		return; 
	}       
...
Mediawiki.loginCallback = function(resultJson) {
	...
	try {
		...
		if (result.login.result == "Success"){
			...
			Mediawiki.updateStatus("Invalid Password");
			...
			Mediawiki.updateStatus("Invalid Username");
...
Mediawiki.updateStatus = function(msg){
	if (typeof console != "undefined" && typeof console.log != "undefined"){
		console.log("Mediawiki API: " + msg);
	} else {
		alert("Mediawiki API: " + msg);
	}
};
