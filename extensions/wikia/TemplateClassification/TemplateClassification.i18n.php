...
$messages['qqq'] = array(
	...
	'template-classification-open-modal-key-tip' => 'Tip text displayed on hover on modal entry point telling what action will happen and inform about shortcut key to use to open the modal. $1: Ctrl or ⌘ string',
...
$messages['fr'] = array(
	...
	'template-classification-description-reference' => "Organise et uniformise l'annotation des sources de contenu sur les pages d'article.",
...
$messages['it'] = array(
	...
	'template-classification-type-reference' => 'Nota o riferimento',
...
$messages['ja'] = array(
	...
	'template-classification-description-reference' => '記事ページ上のコンテンツの出典の記載方法を整理して統一させるためのものです。',
...
$messages['ru'] = array(
	...
	'template-classification-description-reference' => 'Позволяют добавить примечания к статье, например - ссылки на внешние источники информации.',
