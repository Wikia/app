...
[[{{MediaWiki:preferences-v2-fancysig-help-page-name}}|Что такое личная подпись?]]',
	...
	'tog-marketingallowed-v2' => '…на FANDOM появляются новости и события',
	'prefs-email-advanced-v2' => 'Расширенные настройки',
	'prefs-email-unsubscribe' => 'Отписаться от всех рассылок',
	'unsubscribe-preferences-toggle-v2' => 'Отписаться от всех рассылок с FANDOM (заменяет все другие варианты)',
	'tog-watchlistdigest-v2' => '…готов еженедельный дайджест изменений страниц FANDOM, за которыми я слежу',
