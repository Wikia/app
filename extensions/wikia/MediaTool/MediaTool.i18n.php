...
$messages['en'] = array(
	...
	'mediatool-error-file-name-already-exists' => 'Name already used',
	'mediatool-error-invalid-name' => 'Invalid name',
	'mediatool-error-empty-name' => 'Please add a name',
