...
Kung hindi ka nakalagda, maaaring [[Special:UserLogin|dapat]] kang lumagda.',
	...
	'privatedomainsinstructions' => 'Nasa ibaba ang talaan ng mga nasasakupan ng e-liham na ipinapahintulot para sa mga patnugot ng wiking ito.  Bawat guhit ay nagtatalaga ng isang hulaping makakapunta para sa pamamatnugot.  Dapat itong anyuhang may isang hulapi bawat guhit.  Bilang halimbawa:</p><p style="width: 20%; padding:5px; border: 1px solid grey;">cs.stanford.edu<br /> stanfordalumni.org</p><p>Magpapahintulot ito ng mga pagbabago mula kaninuman na may tirahan ng e-liham na anuman@cs.stanford.edu o anuman@stanfordalumni.org</p><p><b>Ipasok ang pinapayagang mga nasasakupan sa loob ng kahon ng tekstong nasa ibaba, at pindutin ang "{{int:saveprefs}}".</b>',
);
