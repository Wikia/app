...
$messages['ru'] = array(
	...
	'global-shortcuts-description' => '
Усовершенствуйте процесс чтения и редактирования на FANDOM с помощью новых клавиатурных сочетаний.

Это расширение подключает ряд новых сочетаний клавиш и открывает доступ к странице просмотра действий. Эта страница поможет освоить новые сочетания, чтобы с лёгкостью перемещаться по важным страницам FANDOM или выполнять определённые действия.
',
