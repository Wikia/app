<form class="wds-global-navigation__search" action="<?= Sanitizer::encodeAttribute( $model['module']['results']['url'] ); ?>">
	<div id="searchInputWrapper" class="wds-dropdown wds-global-navigation__search-input-wrapper">
		<label class="wds-global-navigation__search-label">
			...
			<input id="searchInput"
				...
				<?php if ( !empty( $model['module']['suggestions'] ) ) : ?>
					...
					data-suggestions-tracking-label="<?= Sanitizer::encodeAttribute( $model['module']['suggestions']['tracking-label'] ); ?>"
				<?php endif; ?>
		...
		<button class="wds-button wds-global-navigation__search-submit" type="submit" data-tracking-label="<?= Sanitizer::encodeAttribute( $model['module']['results']['tracking-label'] ); ?>">
			<?= DesignSystemHelper::getSvg(
				'wds-icons-arrow',
