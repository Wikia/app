...
<?php endif; ?>
<a href="<?= Sanitizer::encodeAttribute( $model['href'] ); ?>" id="<?= Sanitizer::encodeAttribute( $model['title']['key'] ); ?>" class="wds-button wds-is-full-width <?= $model['title']['key'] === 'global-navigation-anon-register' ? 'wds-is-secondary' : ''; ?>">
