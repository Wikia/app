...
window.addEventListener('DOMContentLoaded', function () {
	'use strict';
	require(['querystring', require.optional('topbar'), require.optional('toc'), 'events', require.optional('share'), require.optional('popover'), require.optional('cookies'), 'track'],
