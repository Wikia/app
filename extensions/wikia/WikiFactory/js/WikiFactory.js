...
$Factory.VariableCallback = {
	success:function (oResponse) {
		var aData = JSON.parse(oResponse.responseText);
...
$Factory.ReplaceCallback = {
	success:function (oResponse) {
		var Data = JSON.parse(oResponse.responseText);
...
$Factory.Domain.Callback = {
	success:function (oResponse) {
		var oReturn = JSON.parse(oResponse.responseText);
