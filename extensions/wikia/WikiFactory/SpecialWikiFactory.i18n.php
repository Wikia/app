...
$messages['uk'] = array(
	...
	'closed-wiki-dump-exists' => 'Ви можете отримати ваш зміст, якщо він вам подобається.<br />(Якщо ваш вікі нещодавно закрите, то це може зайняти короткий час для файлів, які будуть створені)',
