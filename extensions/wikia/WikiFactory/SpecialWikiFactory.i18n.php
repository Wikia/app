...
$messages['uk'] = array(
	...
	'closed-wiki-dump-exists' => 'Ви можете [$1 завантажити її дамп], якщо бажаєте.<br />(Якщо вашу вікі закрито нещодавно, то створення потрібних файлів може зайняти деякий час)',
