...
$messages['en'] = array(
	...
	'wikiaconfirmemail-error-user-not-match' => 'Oops, this confirmation link doesn\'t match up with the username you entered. Make sure you\'re entering the right username. If you want to log in with a different account, click <a href="{{fullurl:{{ns:special}}:UserLogin}}">here</a>',
...
$messages['cs'] = array(
	...
	'wikiaconfirmemail-error-user-not-match' => 'Hups tento potvrzovací odkaz neodpovídá zadanému uživatelskému jménu.  Zkontrolujte, zda zadáváte správné uživatelské jméno. Pokud se chcete přihlásit pomocí jiného účtu, klepněte <a href="{{fullurl:{{ns:special}}:UserLogin}}">sem</a>',
...
$messages['de'] = array(
	...
	'wikiaconfirmemail-error-user-not-match' => 'Dieser Bestätigungslink passt nicht zum angegebenen Nutzernamen. Bitte prüfe den Nutzernamen. Wenn du dich mit einem anderen Account anmelden willst, klicke <a href="{{fullurl:{{ns:special}}:UserLogin}}">hier</a>',
...
$messages['es'] = array(
	...
	'wikiaconfirmemail-error-user-not-match' => 'Oops, este enlace de confirmación no concuerda con el nombre de usuario. Asegúrate que estás introduciendo el nombre de usuario correcto. Si deseas iniciar sesión con una cuenta diferente, haz clic <a href="{{fullurl:{{ns:special}}:UserLogin}}">aquí</a>',
...
$messages['fa'] = array(
	...
	'wikiaconfirmemail-error-user-not-match' => 'اوه، این پیوند تأیید با نام کاربری مطابقت ندارد. مطمئن شوید که نام کاربری خود را درست وارد کرده‌اید. اگر می‌خواهید با یک حساب کاربری دیگر وارد شوید، <a href="{{fullurl:{{ns:special}}:UserLogin}}">اینجا</a> را کلیک کنید',
...
$messages['fr'] = array(
	...
	'wikiaconfirmemail-error-user-not-match' => 'Oups, ce lien de confirmation ne correspond pas au nom d’utilisateur que vous avez saisi. Assurez-vous d’avoir saisi le bon nom d’utilisateur. Si vous souhaitez vous connecter avec un compte différent, cliquez <a href="{{fullurl:{{ns:special}}:UserLogin}}">ici</a>.',
...
$messages['gl'] = array(
	...
	'wikiaconfirmemail-error-user-not-match' => 'Vaites! Esta ligazón de confirmación non se corresponde co nome de usuario que inseriu. Asegúrese de que escribiu o nome de usuario correcto. Se quere acceder cunha conta diferente, prema <a href="{{fullurl:{{ns:special}}:UserLogin}}">aquí</a>',
...
$messages['hu'] = array(
	...
	'wikiaconfirmemail-error-user-not-match' => 'Hoppá! Ez az ellenőrző hivatkozás nem illik az általad megadott felhasználónévhez. Ellenőrizd, hogy a megfelelő felhasználónevet írod-e be. Amennyiben másik feéhasználóként szeretnél bejelentkezni, kattints <a href="{{fullurl:{{ns:special}}:UserLogin}}">ide</a>',
...
$messages['ia'] = array(
	...
	'wikiaconfirmemail-error-user-not-match' => 'Iste ligamine de confirmation non corresponde al nomine de usator que tu specificava. Assecura te de haber scribite le nomine de usator correcte. Si tu vole aperir session con un altere conto, clicca <a href="{{fullurl:{{ns:special}}:UserLogin}}">hic</a>.',
...
$messages['mk'] = array(
	...
	'wikiaconfirmemail-error-user-not-match' => 'Упс. Потврдната врска не одговара на корисничкото име што го внесовте. Проверете дали сте го внеле исправно. Ако сакате да се најавите со друга сметка, тогаш стиснете <a href="{{fullurl:{{ns:special}}:UserLogin}}">тука</a>',
...
$messages['ms'] = array(
	...
	'wikiaconfirmemail-error-user-not-match' => 'Maaf, pautan pengesahan ini tidak sepadan dengan nama pengguna yang anda berikan. Pastikan anda telah menyatakan nama pengguna yang betul. Jika anda hendak log masuk dengan akaun yang lain, klik di <a href="{{fullurl:{{ns:special}}:UserLogin}}">sini</a>',
...
$messages['nb'] = array(
	...
	'wikiaconfirmemail-error-user-not-match' => 'Ops, denne bekreftelseslenken stemmer ikke overens med brukernavnet du oppga. Sørg for at du oppgir det riktige brukernavnet. Hvis du vil logge inn med en annen konto, klikk <a href="{{fullurl:{{ns:special}}:UserLogin}}">her</a>',
...
$messages['pl'] = array(
	...
	'wikiaconfirmemail-error-user-not-match' => 'Ten link uwierzytelniający nie pasuje do wprowadzonej nazwy użytkownika. Upewnij się, że wpisujesz właściwą nazwę użytkownika. Jeśli chcesz zalogować się korzystając z innego konta, kliknij <a href="{{fullurl:{{ns:special}}:UserLogin}}">tutaj</a>',
...
$messages['ru'] = array(
	...
	'wikiaconfirmemail-error-user-not-match' => 'Эта ссылка для подтверждения не соответствует имени участника, которое вы ввели. Убедитесь, что вы правильно ввели имя участника. Если вы хотите войти в систему с другой учётной записи, нажмите <a href="{{fullurl:{{ns:special}}:UserLogin}}">здесь</a>',
	'wikiaconfirmemail-login-button' => 'Подтвердить и войти',
	'wikiaconfirmemail-heading' => 'Почти готово',
	'wikiaconfirmemail-subheading' => 'Войдите в систему с вашими именем участника и паролем, так как вы уже получили письмо.',
...
$messages['sv'] = array(
	...
	'wikiaconfirmemail-error-user-not-match' => 'Hoppsan, denna bekräftelselänk stämmer inte överens med användarnamnet du skrev in. Se till att du skriver in rätt användarnamn. Om du vill logga in med ett annat konto, klicka <a href="{{fullurl:{{ns:special}}:UserLogin}}">här</a>',
...
$messages['tl'] = array(
	...
	'wikiaconfirmemail-error-user-not-match' => 'Naku, ang kawing na ito ng kumpirmasyon ay hindi tumutugma sa ipinasok mong pangalan ng tagagamit. Paki tiyakin na nagpapasok ka ng tumpak na pangalan ng tagagamit. Kung nais mong lumagdang papasok sa pamamagitan ng isang ibang akawnt, pindutin <a href="{{fullurl:{{ns:special}}:UserLogin}}">dito</a>',
