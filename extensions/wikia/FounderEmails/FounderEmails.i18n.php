...
<div style="font-style: italic; font-size: 120%;">-- Zespół Wikia</div>',
	...
	'founderemails-email-3-days-passed-body' => 'Cześć $USERNAME,
...
<div style="font-style: italic; font-size: 120%;">-- Zespół Wikia</div>',
	...
	'founderemails-email-10-days-passed-body' => 'Cześć $USERNAME,
...
Вы всегда можете зайти на страницу Вики-деятельности, чтобы просмотреть все важные изменения на $WIKINAME. Делайте это как можно чаще, так как вы - основатель, и ваше сообщество ожидает, что вы будете направлять развитие вики и продвигать её.',
	...
	'founderemails-pref-views-digest-v2' => '...ежедневное резюме количества просмотров вики готово',
	'founderemails-pref-complete-digest-v2' => '...ежедневный дайджест новых редакторов, правок и просмотров страницы готов',
);
...
Để nhận được sự hỗ trợ cho ngôn ngữ của bạn, truy cập <a style="color:#2a87d5;text-decoration:none;" href="http://vi.wikia.com">vi.wikia.com</a>',
	...
	'founderemails-email-3-day-explore-content' => 'Đừng ngại khi kiểm tra các wiki khác để xem cách họ đã làm việc trên trang chính của họ, bài viết và nhiều hơn nữa. Để nhận được sự hỗ trợ cho ngôn ngữ của bạn, truy cập http://vi.wikia.com',
