...
$messages['ca'] = array(
	...
	'tog-founderemailsenabled' => 'Envieu per correu electrònic les actualitzacions que fan altres persones (només fundadors)',
	'founderemails-email-user-registered-subject' => 'Algú nou es va unir a $WIKINAME',
	'founderemails-email-user-registered-body' => 'Hola $USERNAME,

Felicitacions! $EDITORNAME s\'ha registrat a $WIKINAME.

Aprofita aquesta oportunitat per donar-li la benvinguda i animar-lo a que edite el wiki. Com més gent, millor i més ràpid creixerà el teu wiki.

L\'equip de Wikia',
	'founderemails-email-user-registered-greeting' => 'Hola $USERNAME,',
	'founderemails-email-user-registered-headline' => 'Felicitacions! $EDITORNAME s\'ha registrat a $WIKINAME.',
	'founderemails-email-user-registered-content' => 'Aprofita aquesta oportunitat per donar-li la benvinguda i animar-lo a que edite el wiki. Com més gent, millor i més ràpid creixerà el teu wiki.',
...
Felicitacions per la creació de $WIKINAME!

Aquí hi ha alguns consells útils per començar:

Afegeix pàgines. Un wiki és compartir informació sobre el teu tema únic. Crea pàgines fent clic a "Afegeix una pàgina" i ompli la informació més específica sobre el teu tema.

Afegeix imatges. Les pàgines sempre són millors quan tenen imatges! Afegeix imatges a les teues pàgines i a la teua pàgina principal. Pots fer clic a "Afegeix una imatge" per afegir una imatge, una galeria d\'imatges, o una presentació de diapositives.

Personalitza el teu tema. Personalitza el tema i logotip del teu wiki per fer que destaque! Utilitza l\'Editor de temes per afegir colors personalitzats al teu wiki i fer-lo únic al teu tema.

No anem a deixar-te a l\'estacada. Estem aquí per ajudar-te a fer $WIKINAME reeixit en cada pas del camí. Visita community.wikia.com per a fòrums, consells i ajuda, o envia\'ns un correu amb les teves preguntes!
...
Vols controlar els correus electrònics que reps? Visita http://community.wikia.com/wiki/Special:Preferences',
...
$messages['de'] = array(
	...
	'founderemails-email-user-registered-subject' => 'Jemand ist dem $WIKINAME beigetreten!',
	'founderemails-email-user-registered-body' => 'Hey $USERNAME,

Herzlichen Glückwunsch! $EDITORNAME ist gerade dem $WIKINAME beigetreten.

Nutze die Gelegenheit um ihn in deinem Wiki zu begrüßen und ermutigen ihn, dir beim Bearbeiten zu helfen. Je mehr desto besser, und umso schneller wird dein Wiki wachsen.
...
Klicke den folgenden Link um dich von allen Wikia-Mails abzumelden: $UNSUBSCRIBEURL',
	...
	'founderemails-email-user-registered-headline' => 'Herzlichen Glückwunsch! $EDITORNAME ist gerade dem $WIKINAME beigetreten.',
...
...und herzlichen Glückwunsch zur Erstellung von $WIKINAME!

Hier ein paar hilfreiche Tipps zum Start:

Erstelle neue Artikel. Die Hauptaufgabe eines Wikis ist es, Informationen über dein Thema mit anderen zu teilen. Klicke dazu einfach auf „Seite erstellen“ und gib mehr Infos zu dem entsprechenden Thema an.

Füge Bilder hinzu. Texte sehen immer besser aus, wenn sie bebildert sind. Du solltest also Bilder zu deinen Artikeln und der Hauptseite hinzufügen. Du kannst auf „Bild hinzufügen“ klicken um Fotos, Foto-Galerien oder eine Diashow zu erstellen.
...
Wir lassen dich nicht alleine. Wir wollen dir dabei helfen, dass das $WIKINAME erfolgreich wird. Besuche das Community-Wiki unter de.community.wikia.com für weitere Informationen und um Hilfe bei Fragen zu finden!
...
<div style="font-style: italic; font-size: 120%;">Das Wikia Team</div>',
	'founderemails-email-3-days-passed-subject' => 'Wie gehts voran mit deinem Wiki?',
	'founderemails-email-3-days-passed-body' => 'Hi $USERNAME,

Wir wollten mal gucken, wie es mit dem Aufbau des $WIKINAME so aussieht.
...
Wie die Zeit vergeht! Es ist bereits 10 Tage her, seitdem du das $WIKINAME erstellt hast.
...
Teile Inhalte! Benutze den „Artikel teilen“-Knopf um Artikel in deinem Wiki mit Freunden und Followern auf Facebook, Twitter oder anderen sozialen Netzwerken zu teilen. Das kannst du auch mit Bilder machen!
...
Das Wikia Team',
	...
	'founderemails-email-page-edited-reg-user-first-edit-body-HTML' => 'Hey $USERNAME,<br /><br />
Es sieht so aus als ob der registrierte Benutzer $EDITORNAME zum ersten Mal dein Wiki verändert hat! Warum besuchst du nicht seine <a href="$EDITORTALKPAGEURL">Diskussionsseite</a> um Hallo zu sagen?<br /><br />
<div style="font-style: italic; font-size: 120%;">-- Das Wikia Team</div>',
...
$EDITORNAME hat gerade nochmal $PAGETITLE im $WIKINAME bearbeitet.
...
Das Wikia Team',
	...
	'founderemails-email-page-edited-reg-user-body-HTML' => 'Hey $USERNAME,<br /><br />
Es sieht so aus als ob der registrierte Benutzer $EDITORNAME dein Wiki verändert hat! Warum besuchst du nicht seine <a href="$EDITORTALKPAGEURL">Diskussionsseite</a> um Hallo zu sagen?<br /><br />
<div style="font-style: italic; font-size: 120%;">-- Das Wikia Team</div>',
...
Es sieht so aus als ob sich $EDITORNAME bei deinem Wiki registriert hat! Warum besuchst du nicht seine Diskussionsseite $EDITORTALKPAGEURL um Hallo zu sagen?

-- Das Wikia Team',
	'founderemails-answers-email-user-registered-body-HTML' => 'Hey $USERNAME,<br /><br />
Es sieht so aus als ob sich $EDITORNAME bei deinem Wiki registriert hat! Warum besuchst du nicht seine <a href="$EDITORTALKPAGEURL">Diskussionsseite</a> um Hallo zu sagen?<br /><br />
<div style="font-style: italic; font-size: 120%;">-- Das Wikia Team</div>',
...
Es sieht so aus als ob der registrierte Benutzer $EDITORNAME zum ersten Mal dein Wiki verändert hat! Warum besuchst du nicht seine Diskussionsseite $EDITORTALKPAGEURL um Hallo zu sagen?
...
Es sieht so aus als ob der registrierte Benutzer $EDITORNAME dein Wiki verändert hat! Warum besuchst du nicht seine Diskussionsseite $EDITORTALKPAGEURL um Hallo zu sagen?
...
$1 {{PLURAL:$1|Person|Personen}} haben sich dein Wiki angesehen.

Mach weiter so und füge interessante Inhalte zum Lesen für deine Besucher hinzu!

$2 {{PLURAL:$2|Bearbeitung wurde|Bearbeitungen wurden}} durchgeführt.
...
$3 {{PLURAL:$3|Person ist|Personen sind}} deinem Wiki beigetreten.
...
¡Felicidades por la creación de $WIKINAME!

Aquí hay algunos consejos útiles para comenzar:

Añade páginas. Un wiki es compartir información sobre tu tema único. Crea páginas haciendo clic en "Añade una página" y rellena la información más específica sobre tu tema.
...
No vamos a dejarte en la estocada. Estamos aquí para ayudarte a hacer $WIKINAME exitoso con cada paso del camino. ¡Visita community.wikia.com para foros, consejos y ayuda, o envíanos un correo con tus preguntas!

¡Feliz construcción del wiki! El equipo de Wikia

___________________________________________

Para ver los últimos acontecimientos en Wikia, visita http://community.wikia.com
¿Quieres controlar los correos electrónicos que recibes? Visita http://messaging.wikia.com/wiki/Special:Preferences.
...
Hemos querido comprobar y ver como te van las cosas en $WIKINAME.
...
¿Necesias ayuda para saber como funciona alguna cosa? Siempre estamos aquí para ti! Ven a pedirnos ayuda y asesoramiento en community.wikia.com.

¡Sigue con tu buen trabajo!
El equipo de Wikia


Para ver los últimos acontecimientos en Wikis, visita community.wikia.com
¿Quieres controlar los correos electrónicos que recibes? Visita http://community.wikia.com/wiki/Special:Preferences',
...
Vaya, ¡cómo pasa el tiempo! Ya han pasado 10 días desde que empezaste $WIKINAME.
...
¿Tu madre no te dijo que compartieras? Utiliza el botón Compartir en la barra de herramientas, artículos e imágenes para mostrar a tus amigos y seguidores en Facebook, Twitter u otros sitios populares.
...
También puedes pedir ayuda a otros Wikianeros para ayudarte en tu wiki mediante la publicación en los foros de community.wikia.com.
...
http://messaging.wikia.com/wiki/Special:Preferences.
Haz clic en el siguiente enlace para darte de baja de todos los correos electrónicos de Wikia: $UNSUBSCRIBEURL',
...
¡Felicidades! ¡Hay muchas cosas ocurriendo hoy en $WIKINAME!

Si todavía no lo has hecho, puedes ir a Wiki Actividad y ver todo en gran trabajo que ha estado ocurriendo.
...
Saisissez cette occasion pour lui souhaiter la bienvenue sur votre wiki et l’encourager pour qu’il contribue. Plus vous serez de fous et plus rapidement votre wiki se développera.
...
Vous avez besoin d’aide pour déterminer comment quelque chose fonctionne ? Nous sommes toujours là pour vous ! Venez nous demander de l’aide et des conseils sur communaute.wikia.com.
...
Vous pouvez aussi demander aux autres Wikiens d’aider sur votre wiki en postant dans les forums de communaute.wikia.com.
...
$EDITORNAME a rejoint $WIKINAME et a effectué sa toute première modification !

Passez lui souhaiter la bienvenue sur sa page de discussion et répondez aux questions qu’il pourrait avoir. Les contributeurs actifs sont très importants, ils peuvent aident à développer votre wiki et le rendre populaire. Faites au mieux pour les encourager et les aider à s’impliquer.

Des contributeurs heureux font des wikis où il fait bon participer !
L\'équipe Wikia
...
Félicitations ! Il se passe beaucoup de choses sur $WIKINAME aujourd’hui !

Si vous ne l’avez pas déjà fait, vous pouvez aller sur l\'activité du wiki pour voir l’excellent travail qui est fourni.
...
$WIKINAME a été vu par $1 {{PLURAL:$1|personne|personnes}} aujourd’hui.
...
Il est l’heure pour votre dose quotidienne d’activité sur $WIKINAME.
...
Parabéns pola creación de $WIKINAME!

Aquí ten algúns consellos útiles para comezar:

Engada páxinas. A base dun wiki é compartir información sobre un tema. Cree páxinas premendo en "Engadir unha páxina" e encha as páxinas con información específica sobre o seu tema.

Engada fotos. As páxinas locen máis con imaxes! Engada fotos ás súas páxinas e á súa páxina principal. Pode premer en "Engadir unha foto" para engadir unha foto, unha galería de fotos ou unha presentación de diapositivas.
...
Non deixaremos que estea só. Estamos aquí para axudar a que $WIKINAME se vaia abrindo paso. Visite community.wikia.com para atopar foros, consellos e axuda ou envíenos un correo electrónico coas súas preguntas!
...
Queremos comentarlle como van as cousas en $WIKINAME.
...
Pode atopar axuda e consellos en community.wikia.com.
...
Como voa o tempo! Hai xa 10 días que comezou $WIKINAME.
...
Non lle dixo a súa nai que compartise? Use o botón de compartir da súa barra de ferramentas, páxinas de artigos e fotos para mostrar aos amigos e seguidores no Facebook, Twitter ou outros sitios populares o seu traballo no wiki.
...
Tamén pode preguntar nos foros aos outros usuarios de Wikia se queren participar no seu wiki en community.wikia.com.
...
Parabéns! Ocorreron moitas cousas hoxe en $WIKINAME!
...
<div style="font-style: italic; font-size: 120%;">-- O equipo de Wikia</div>',
	...
	'founderemails-email-10-day-share-content' => 'Use o botón de compartir da súa barra de ferramentas, páxinas de artigos e fotos para mostrar aos amigos e seguidores no Facebook, Twitter ou outros sitios populares o seu traballo no wiki.',
...
É hora da súa dose diaria da actividade en $WIKINAME.
...
Felicitationes pro le creation de $WIKINAME.

Ecce alcun consilios utile pro comenciar:

Adde paginas. Le essentia de un wiki es divulgar information super le thema unic in question. Crea paginas per cliccar sur "Adder un pagina" e inserer le specific information super tu thema.

Adde photos. Paginas es sempre melior con elementos visual! Adde imagines a tu paginas e a tu pagina principal. Tu pote cliccar sur "Adder un photo" pro adder un photo, un galeria de photos o un presentation de diapositivas.
...
Nos non te abandonara. Nos es hic pro adjutar te a facer $WIKINAME succeder passo pro passo. Visita community.wikia.com pro foros, consilios e adjuta, o pro inviar nos tu questiones!
...
Nos voleva contactar te pro vider como va le cosas in $WIKINAME.

Ha passate 3 dies post que tu comenciava. Nos pensava de offerer alcun consilios additional sur le construction de tu wiki:
...
Necessita adjuta a comprender como functiona qualcosa? Nos sta sempre presente pro te! Veni demandar adjuta e consilios a community.wikia.com.
...
Oy, le tempore vola! Ha jam passate 10 dies post que tu comenciava a usar $WIKINAME.
...
Non te diceva tu matre que il es juste divider? Usa le button Divider in tu instrumentario, paginas de articulo e photos pro demonstrar los a tu amicos e sequitores in Facebook, Twitter o altere popular sitos.
...
Tu pote etiam demandar a altere Wikianos de adjutar te in tu wiki per publicar un message in le foros a community.wikia.com.
...
Tu pote sempre visitar Wiki Activitate pro vider tote le modificationes que es facite in $WIKINAME. Revisita lo frequentemente, proque le communitate depende de te, como fundator, pro adjuta e direction in le gerentia del wiki.
...
Нема да ве оставиме на цедило. Тука сме да ви помогнеме во секој чекор на развојот, сè со цел $WIKINAME да стане успешно вики. На страницата community.wikia.com ќе најдете форуми, совети и помош. Можете и да ни ги испраќате вашите прашања по е-пошта!
...
Сакавме да провериме како ви оди со $WIKINAME.
...
Побарајте помош и совети на community.wikia.com.
...
Е, па времето лета!  Има веќе 10 дена откако го започнавте викито $WIKINAME..  

Привлечете учесници и пофалете се со она што сте го сработиле. Еве како да разгласите:

Зар не ви кажа мама дека треба да делите со другите?Користете го копчето „Сподели“ во алатникот, статиите и сликите за да им ги покажете на пријателите и оние што ве следат на Facebook, Twitter и другите популарни места.
...
Можете да побарате помош и од другите викијанци на форумите на community.wikia.com.
...
Syabas kerana membuka $WIKINAME!
...
Tambah gambar. Laman lebih sedap dipandang kalau ada gambar! Letakkan gambar pada laman-laman anda dan juga laman utama. Anda boleh mengklik Tambah Gambar untuk menambahkan gambar, galeri gambar atau tayangan slaid.
...
Kami tidak akan menyisihkan anda. Kami di sini untuk membantu anda menjayakan $WIKINAME langkah demi langkah. Kunjungi community.wikia.com untuk berforum, mendapat nasihat dan bantuan, atau menge-melkan soalan kepada kami!
...
Kami hendak melihat perkembangan di $WIKINAME.
...
Minta bantuan dan nasihat kami di community.wikia.com.
...
Amboi, cepatnya masa berlalu!  Sudah 10 hari sejak anda membuka $WIKINAME.  
...
Anda juga boleh menanya ahli-ahli Wikia lain untuk tolong mengusahakan wiki anda dengan mengepos dalam forum di community.wikia.com.  
...
$messages['pl'] = array(
	...
	'tog-founderemailsenabled' => 'Chcę otrzymywać powiadomienia o aktywności innych użytkowników (tylko dla założycieli)',
	'founderemails-email-user-registered-subject' => 'Ktoś nowy dołączył do $WIKINAME',
	'founderemails-email-user-registered-body' => 'Cześć $USERNAME,

Gratulacje! $EDITORNAME zarejestrował się na $WIKINAME!
...
Zespół Wikii',
	...
	'founderemails-email-user-registered-content' => 'Skorzystaj z okazji powitaj ich na wiki i zachęć do pomocy w edycji. Bardziej, weselej i szybciej będzie rozrastała się wiki.',
	'founderemails-email-user-registered-signature' => 'Zespół Wikia',
...
Gratulujey utworzenia $WIKINAME!

Kilka dobrych rad na początek:

Dodaj strony. Wiki to doskonałe miejsce do dzielenia się wiedzą na wybrany temat. Dodawaj nowe strony i wypełniaj je informacjami.

Dodaj obrazy. Strony są zawsze ciekwasze gdy mają obrazy! Dodawaj je do artykułów i storny głównej. Możesz dodać zwykły obraz, galerię czy pokaz zdjęć!
...
Nie zostawimy Cię samego! Chcemy aby $WIKINAME osiągnęła sukces! Odwiedź spolecznosc.wikia.com aby zadać pytanie na forum lub zapoznać się z cennymi wskazówkami dotyczącymi budowy wiki.

Miłego edytowania! Zespół Wikia
...
Chcieliśmy, sprawdzić i zobaczyć, jak się rzeczy mają na $WIKINAME.
...
Poproś nas o pomoc i poradę na community.wikia.com.

Pracuj nadal tak dobrze!
Zespół Wikia


Aby Sprawdzić najświeższe wiadomościami na Wikia, odwiedź community.wikia.com
Czy chcesz kontrolować które wiadomości e-mail otrzymywać? Przejdź na stronę
http://community.wikia.com/wiki/Special:Preferences',
	'founderemails-email-3-days-passed-body-HTML' => 'Cześć $USERNAME, <br /> <br />
Minęło już kilka dni od powstania twojej wiki, pomyśleliśmy że chciałbyś dowiedzieć się, co jeszcze możesz zrobić.
<div style="font-style: italic; font-size: 120%;">-- Zespół Wikia</div>',
	'founderemails-email-10-days-passed-subject' => 'Wszystkiego najlepszego z okazji pierwszych 10 dni!',
...
Możesz również poprosić innych wikian by pomogli na wiki wysyłając posty na forum community.wikia.com.  
...
By sprawdzić, co się ostatnio wydarzyło na Wikia, odwiedź  http://community.wikia.com
Chcesz ustawić, jakie e-maile masz otrzymywać? Przejdź na: http://messaging.wikia.com/wiki/Special:Preferences.
...
Odwiedź $PAGETITLE aby zobaczyć zmiany.

Zespół Wikia.',
	'founderemails-email-first-edit-greeting' => 'Witaj $USERNAME,',
	'founderemails-email-first-edit-headline' => 'Bardzo dobrze! $EDITORNAME dokonał(a) swojej pierwszej edycji na $WIKINAME.',
	'founderemails-email-first-edit-content' => 'Udaj się na $PAGETITLE by sprawdzić, co zostało dodane.',
	'founderemails-email-first-edit-signature' => 'Zespół Wikia',
...
Wygląda na to, że zarejestrowany użytkownik $EDITORNAME edytował twoją wiki po raz pierwszy! Może przywitasz się z nim na jego <a href="$EDITORTALKPAGEURL">stronie dyskusji</a>?<br /><br />
<div style="font-style: italic; font-size: 120%;">-- Zespół Wikii</div>',
...
Zespół na Wikia',
	...
	'founderemails-email-general-edit-signature' => 'Zespół Wikia',
	'founderemails-email-general-edit-button' => 'Sprawdź!',
	'founderemails-email-page-edited-reg-user-body-HTML' => 'Witaj $USERNAME,<br /><br />
Wygląda na to, że zarejestrowany użytkownik $EDITORNAME edytował twoją wiki! Może wpadniesz na jego <a href="$EDITORTALKPAGEURL">stronę dyskusji</a> by się przywitać?<br /><br />
<div style="font-style: italic; font-size: 120%;">-- Zespół Wikii</div>',
	'founderemails-email-page-edited-anon-subject' => 'Tajemniczy przyjaciel dokonał zmian na $WIKINAME',
	'founderemails-email-page-edited-anon-body' => 'Cześć $USERNAME,
...
Zespół Wikia',
	...
	'founderemails-email-anon-edit-headline' => 'Współautor Wikii właśnie dokonał edycji strony $PAGETITLE na $WIKINAME.',
	'founderemails-email-anon-edit-content' => 'Współautorzy Wikii to ludzie, którzy wprowadzają zmiany bez logowania na konta Wikia. Zobacz, co dodali ci tajemniczy przyjaciele!',
	'founderemails-email-anon-edit-signature' => 'Zespół Wikia',
...
<div style="font-style: italic; font-size: 120%;">-- Zespół Wikia</div>',
	'founderemails-answers-email-user-registered-subject' => 'Ktoś zarejestrowł konto na QA wiki!',
	'founderemails-answers-email-user-registered-body' => 'Hej $USERNAME,

Wygląda na to, że $EDITORNAME został zarejestrowany na wiki! Czy nie fajnie byłobyzapuścić się na jego stronę dyskucji  $EDITORTALKPAGEURL i się przywitać?

--Zespół Wikii',
	'founderemails-answers-email-user-registered-body-HTML' => 'Cześć $USERNAME,<br /><br />
$EDITORNAME zarejestrował się na twojej wiki! Może przywitasz się z nim na jego <a href="$EDITORTALKPAGEURL">stronie dyskusji</a>?<br /><br />
<div style="font-style: italic; font-size: 120%;">-- Zespół Wikii</div>',
...
<div style="font-style: italic; font-size: 120%;">-- Zespół Wikia</div>',
	...
	'founderemails-answers-email-3-days-passed-body' => 'Hej tam $USERNAME,

Teraz, gdy twoja wiki ma już kilka dni, uznaliśmy, że możesz chcieć sprawdzić kilka innych rzeczy, które możnaby robić.

--Zespół Wikia',
	'founderemails-answers-email-3-days-passed-body-HTML' => 'Cześć $USERNAME, <br /> <br />
Minęło już kilka dni od powstania twojej wiki, pomyśleliśmy że chciałbyś dowiedzieć się, co jeszcze możesz zrobić.
<div style="font-style: italic; font-size: 120%;">-- Zespół Wikia</div>',
...
<div style="font-style: italic; font-size: 120%;">-- Zespół Wikia</div>',
	'founderemails-answers-email-page-edited-reg-user-first-edit-subject' => 'Zarejestrowany użytkownik zmienił witryny po raz pierwszy!',
...
<div style="font-style: italic; font-size: 120%;">--Zespół Wikia</div>',
	'founderemails-answers-email-page-edited-reg-user-subject' => 'Zarejestrowany użytkownik zmienił twoją witrynę!',
	'founderemails-answers-email-page-edited-reg-user-body' => 'Witaj $USERNAME,

$EDITORNAME właśnie dokonał edycji na Twojej wiki! Możesz nawiązać kontakt odwiedzając stronę dyskusji użytkownika ($EDITORTALKPAGEURL).
...
<div style="font-style: italic; font-size: 120%;">-- Zespół Wikia</div>',
	'founderemails-answers-email-page-edited-anon-subject' => 'Ktoś zmienił twoją witrynę!',
...
Na $WIKINAME dziś sporo się działo!
...
<div style="font-style: italic; font-size: 120%;">-- Zespół Wikia</div>',
	...
	'founderemails-email-lot-happening-signature' => 'Zespół Wikia',
	'founderemails-email-lot-happening-button' => 'Zobacz Aktywność',
	'founderemails-email-footer-line1' => 'Aby sprawdzić najświeższe wiadomości na Wikia, odwiedź witrynę <a style="color:#2a87d5;text-decoration:none;" href="http://community.wikia.com">community.wikia.com</a>',
	...
	'founderemails-email-0-day-addpages-heading' => 'Dodaj strony.',
	...
	'founderemails-email-0-day-addphotos-heading' => 'Dodaj zdjęcia.',
	...
	'founderemails-email-0-day-addphotos-button' => 'Dodaj grafikę',
	'founderemails-email-0-day-customizetheme-heading' => 'Dostosuj motyw.',
	'founderemails-email-0-day-customizetheme-content' => 'Dostosuj motyw i znak słowny do twojej wiki, aby ją wyróżnić!  Użyj <a style="color:#2a87d5;text-decoration:none;" href="$CUSTOMIZETHEMEURL">Projektanta motywu</a>, by dodać niestandardowe kolory do wiki i zapewnić jej unikatowość w temacie.',
	'founderemails-email-0-day-customizetheme-button' => 'Dostosuj',
	'founderemails-email-0-day-wikiahelps-text' => '<span style="color:#2a87d5;font-weight:bold">Nie zostawimy cię na mrozie.</span> Jesteśmy tu by ułatwić ci odniesienie przez $WIKINAME sukcesu w każdym kroku.  Odwiedź witrynę <a style="color:#2a87d5;text-decoration:none;" href="http://community.wikia.com">community.wikia.com</a> by przejrzeć forum, porady i pomoc lub <a style="color:#2a87d5;text-decoration:none;" href="http://www.wikia.com/Special:Contact">przreślij nam  pytania e-mailem</a>!',
	'founderemails-email-0-day-wikiahelps-signature' => 'Szczęśliwego budowania wiki!<br />Zespół Wikii',
	'founderemails-email-3-day-heading' => 'Jak tam, $USERNAME,',
	'founderemails-email-3-day-congratulations' => 'Chcieliśmy sprawdzić i zobaczyć, jak się rzeczy mają na $HDWIKINAME.',
	'founderemails-email-3-day-tips-heading' => 'To już 3 dni, od początku twojej przygody z nami, więc uznaliśmy, że możemy wpaść i zaproponować kolejne porady na temat konstruaowania wiki:',
	'founderemails-email-3-day-editmainpage-heading' => 'Dopieść swoją stronę główną',
	'founderemails-email-3-day-editmainpage-content' => 'Strona główna jest jedną z pierwszych rzeczy, które ludzie widzą podczas odwiedzania <a href="$WIKIURL" style="color:#2a87d5;text-decoration:none;">$WIKINAME</a>. Spraw dobre pierwsze wrażenie pisąc szczegółowe podsumowanie tematu twojej wikii i dodając pokaz slajdów, czy statyczną lub dynamiczną galerię grafik.',
	...
	'founderemails-email-3-day-addphotos-content' => 'Jednym z najlepszych sposobów aby strona była cool, dżuisi i trendi jest <a style="color:#2a87d5;text-decoration:none;" href="$ADDAPHOTOURL">"dodanie kolejnych grafik"</a>.',
	'founderemails-email-3-day-addphotos-button' => 'Dodaj zdjęcia',
...
z naszych ulubionych: <a style="color:#2a87d5;text-decoration:none;" href="http://muppets.wikia.com">Muppet Wiki</a>, <a style="color:#2a87d5;text-decoration:none;" href="http://poptarts.wikia.com">Pop Tarts Wiki</a>, <a style="color:#2a87d5;text-decoration:none;" href="http://monsterhigh.wikia.com">Monster High Wiki</a>.',
	...
	'founderemails-email-3-day-wikiahelps-text' => 'Potrzebujesz pomocy w poznaniu, jak coś działa?  Jesteśmy zawsze dla Ciebie!  Poproś nas o pomoc i poradę na <a style="color:#2a87d5;text-decoration:none;" href="http://community.wikia.com">community.wikia.com</a>.',
	'founderemails-email-3-day-wikiahelps-signature' => 'Pracuj dalej tak wspaniale!<br />Zespół Wikia',
	...
	'founderemails-email-10-day-share-content' => "Użyj przycisku 'Lubię to!' na stronach swojej wiki, aby pochwalić się nimi na Facebooku.",
	...
	'founderemails-email-10-day-wikiahelps-signature' => 'Pracuj tak dobrze dalej!<br />Zespół Wikia',
...
Zespół Wikia',
	...
	'founderemails-email-views-digest-signature' => 'Zespół Wikia',
...
$1 {{PLURAL:$1|osoba|osoby|osób}} odwiedziły Twoją wiki.

Kontynuuj dodawanie ciekawych artykułów dla innych do odkrycia!

Dokonano $2 {{PLURAL:$2|edycji|edycji|edycji}}.

Zadowolenie edytorzy to klucz do sukcesu. Spróbuj nawiązać kontakt i współpracę z edytorami.

$3 {{PLURAL:$3|osoba|osoby|osób}} dołączyło do Twojej wiki.
...
Zespół Wikia',
	...
	'founderemails-email-complete-digest-content-heading1' => '$1 {{PLURAL:$1|osoba oglądała|osoby oglądały|osób oglądało}} twojąwiki.',
	...
	'founderemails-email-complete-digest-content2' => 'Szczęśliwi edytorzy czynią szczęśliwą wiki. Pamiętaj aby podziękować z edytorom i sprawdzić ich pracę od czasu do czasu.',
...
<br /><br />
Możesz zawsze odwiedzić rejestr aktywności na wiki aby zobaczyć zmiany na $WIKINAME. Jako, że jesteś założycielem wiki, Twoja społeczność będzie oczekiwać, że trzymasz rękę na pulsie i dbasz o wiki.',
	'founderemails-email-complete-digest-signature' => 'Zespół Wikia',
	'founderemails-email-complete-digest-button' => 'Przejdź do aktywności wiki',
	...
	'founderemails-pref-views-digest' => 'Wysyłaj mi codziennie wiadomości mówiące, ile razy przeglądano $1',
	...
	'founderemails-pref-views-digest-v2' => '...dzienne podsumowanie wszystkich wyświetleń jest gotowe',
	'founderemails-pref-complete-digest-v2' => '...Codziennie Repertorium dołączeń, edycji i poglądów jest gotowe',
);
...
Поздравляем Вас с созданием $WIKINAME!

Вот несколько полезных советов для начала:

Добавление страниц. Вики предназначена для обмена информацией о вашей уникальной теме. Создавайте страницы, нажав на ссылку «Добавить страницу» и заполните их подробной информацией о вашей теме.

Добавьте фотографии. Страницы всегда лучше смотрятся, когда на них есть визуальные эффекты! Добавьте изображения на ваши страницы и на заглавную страницу. Нажмите «Добавить фото» для добавления изображений, фотогалереи или слайдшоу.
...
Мы не оставим вас одного. Мы здесь, чтобы помочь вам сделать каждый шаг пути $WIKINAME успешным. Посетите community.wikia.com, где можно найти форум, советы и помощь, или напишите нам ваши вопросы!
...
Мы хотели проверить и посмотреть, как идут дела на $WIKINAME.
...
Обратитесь к нам за помощью и советом на community.wikia.com.
...
Время летит! Уже прошло 10 дней, как вы начали $WIKINAME.  
...
Не забыли, что нужно делиться? Используйте кнопку Share на вашей панели инструментов, страницах статьи и фотографии, чтобы показать их друзьям на Facebook, Twitter или других популярных сайтах.
...
Вы также можете попросить помочь участников других викий, разместив сообщение на форуме community.wikia.com.
Продолжайте в том же духе!
...
Поздравляем! Очень много всего происходило сегодня на $WIKINAME!
...
<div style="font-style: italic; font-size: 120%;">-- Команда Викия</div>',
	...
	'founderemails-email-10-day-share-content' => 'Используйте кнопку Share на вашей панели инструментов, страницах статьи и фотографии, чтобы показать их друзьям на Facebook, Twitter или других популярных сайтах.',
...
Пришло время для того, чтобы узнать ежедневную активность на $WIKINAME.
...
Ta möjligheten och välkomna dem till din wiki och uppmuntra dem att hjälp till och redigera. Ju fler desto roligare, och då kommer din wiki växa snabbare.
...
<div style="font-style: italic; font-size: 120%;">-- Wikia-teamet</div>',
	...
	'founderemails-email-0-days-passed-body' => 'Trevligt att träffas, $USERNAME,

Grattis för att du skapade $WIKINAME!

Här är några hjälpsamma tips för att låta dig komma igång:

Lägg till sidor. En wiki handlar om att dela information om dit unika ämne. Skapa sidor genom att klicka på "Lägg till en sida" och fylla i mer specifik information om ditt ämne.

Lägg till foton. Sidor är alltid bättre om de innehåller någonting visuellt! Lägg till bilder på dina sidor och till din huvudsida. Du kan klicka på "Lägg till ett foto" för att lägga till ett fotografi, ett fotogalleri eller ett bildspel.
...
Vi kommer inte att lämna dig utanför. Vi är här för att hjälpa dig göra $WIKINAME framgångsrikt varje steg på vägen. Besök community.wikia.com för forum, råd och hjälp, eller e-posta oss dina frågor!

Trevlig wiki-byggning! Wikia-teamet
...
Vi ville titta förbi och se hur saker står till på $WIKINAME.
...
Behöver hjälp med att lista ut hur någonting fungerar? Vi är alltid här för dig! Kom och be oss om hjälp och råd på community.wikia.com.
...
Oj, vad tiden flyger iväg! Det har redan gått 10 dagar sedan du startade $WIKINAME.  

Få andra inblandade i projektet och visa allt häftigt arbete som du har gjort! Här är några sätt att sprida ordet:

Sa aldrig din mamma att du ska dela med dig? Använd Dela-knappen på ditt verktygsfält, artikelsidor och foton för att visa upp dem för dina vänner och följare på Facebook, Twitter eller andra populära sidor.
...
Du kan även fråga andra Wikianer att hjälpa till på din wiki genom att lämna ett inlägg på forumen på community.wikia.com.  
...
Gratulerar! Det pågår mycket på $WIKINAME idag!

Om du inte redan gjort det har kan du gå in på Wiki-aktivitet för att se alla stora arbeten som har gjorts.

Eftersom det är så mycket som redan pågår, kanske du också vill ändra dina e-post-inställningar till sammandragsläge. Med sammandragsläget får du ett e-postmeddelande som listar upp all aktivitet på din wiki varje dag.
...
Det är dags för din dagliga dos av aktiviteten på $WIKINAME.

$1 {{PLURAL:$1|person|personer}} besökte din wiki.

Fortsätt med det suveräna arbetet att lägga till intressant innhåll för folk att läsa!
...
$messages['tl'] = array(
	...
	'founderemails-email-user-registered-body' => 'Hoy $USERNAME,

Tila nagpatala si $EDITORNAME sa wiki mo! Bakit hindi ka dumalaw sa kanilang pahina ng usapang $EDITORTALKPAGEURL upang magsabi ng pagbati?
...
<div style="font-style: italic; font-size: 120%;">-- Ang Pangkat ng Wikia</div>',
	...
	'founderemails-email-3-days-passed-body' => 'Hoy diyan $USERNAME,
...
<div style="font-style: italic; font-size: 120%;">-- Ang Pangkat ng Wikia</div>',
	...
	'founderemails-email-10-days-passed-body' => 'Hoy $USERNAME,
...
Chúc mừng! $EDITORNAME mới tham gia $WIKINAME.
...
Đến hỏi chúng tôi cho trợ giúp và lời khuyên tại vi.wikia.com.
...
Bạn cũng có thể yêu cầu những thành viên Wikia đến giúp wiki của bạn bằng cách gửi thông điệp đến diễn đàn tại vi.wikia.com.
