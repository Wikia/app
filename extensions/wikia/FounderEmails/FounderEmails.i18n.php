...
-- El Equipo Wikia',
	'founderemails-answers-email-page-edited-reg-user-first-edit-body-HTML' => '¡Hey $FOUNDERNAME,<br /><br />
Parece que el usuario registrado $USERNAME ha editado tu wiki por primera vez! ¿Por qué no vas a su <a href="$USERTALKPAGEURL">página de discusión</a> y le dices hola?<br /><br />
<div style="font-style: italic; font-size: 120%;">-- El Equipo Wikia</div>',
	'founderemails-answers-email-page-edited-reg-user-subject' => '¡Un usuario registrado cambió tu sitio!',
	'founderemails-answers-email-page-edited-reg-user-body' => '¡Hey $FOUNDERNAME,

Parece que el usuario registrado $USERNAME ha editado tu wiki! ¿Por qué no vas a su página de discusión ($USERTALKPAGEURL) y le dices hola?
...
<div style="font-size: 70%;margin-top: 25px;text-align: center;">Cliquez <a href="$UNSUBSCRIBEURL">ici</a> pour vous désabonner à tous les courriels de Wikia.</div>',
	...
	'founderemails-email-0-days-passed-body' => 'Enchanté $FOUNDERNAME,
...
<div style="font-style: italic; font-size: 120%;">– L’équipe Wikia</div>',
	...
	'founderemails-email-10-days-passed-body' => 'Comment ça va $FOUNDERNAME ?
...
* Cliquez sur le lien suivant pour vous désabonner de tous les courriels de Wikia : $UNSUBSCRIBEURL',
	...
	'founderemails-email-first-edit-headline' => 'Super ! $USERNAME vient de faire sa toute première modification sur $WIKINAME.',
...
$USERNAME vient de faire une autre modification sur $PAGETITLE sur $WIKINAME !
...
<div style="font-style: italic; font-size: 120%;">-- L\'équipe Wikia</div>',
	...
	'founderemails-email-views-digest-body' => 'Bonjour $FOUNDERNAME,
...
* Cliquez sur le lien suivant pour vous désabonner de tous les courriels de Wikia : $UNSUBSCRIBEURL',
	...
	'founderemails-email-complete-digest-body' => 'Bonjour $FOUNDERNAME,
...
<div style="font-style: italic; font-size: 120%;">-- Екипата на Викија</div>',
	...
	'founderemails-email-0-days-passed-body' => 'Чест ни е што ни се придруживте, $FOUNDERNAME
...
<div style="font-style: italic; font-size: 120%;">-- Екипата на Викија</div>',
	...
	'founderemails-email-10-days-passed-body' => 'Како оди, $FOUNDERNAME?
...
<div style="font-style: italic; font-size: 120%;">-- Pasukan Wikia</div>',
	...
	'founderemails-email-0-days-passed-body' => 'Apa khabar $FOUNDERNAME,
...
<div style="font-style: italic; font-size: 120%;">-- Het Wikia-team</div>',
	...
	'founderemails-email-0-days-passed-body' => 'Leuk u te ontmoeten, $FOUNDERNAME.
...
Het Wikia-team',
	...
	'founderemails-email-complete-digest-body' => 'Hallo $FOUNDERNAME,
...
Grattis! $USERNAME har just registrerat sig på $WIKINAME.
...
Wikia-teamet',
	'founderemails-email-user-registered-greeting' => 'Hej $FOUNDERNAME,',
	'founderemails-email-user-registered-headline' => 'Grattis! $USERNAME har just blivit medlem på $WIKINAME.',
	'founderemails-email-user-registered-signature' => 'Wikia-teamet',
...
<div style="font-style: italic; font-size: 120%;">-- Wikia-teamet</div>',
	...
	'founderemails-email-0-days-passed-body' => 'Trevligt att träffas, $FOUNDERNAME,
...
<div style="font-style: italic; font-size: 120%;">--Wikia-teamet</div>',
	...
	'founderemails-email-page-edited-reg-user-first-edit-subject' => '$WIKINAME har en ny redigering!',
	'founderemails-email-first-edit-greeting' => 'Hej $FOUNDERNAME,',
	'founderemails-email-first-edit-headline' => 'Utmärkt! $USERNAME har just gjort sin första redigering på $WIKINAME.',
	...
	'founderemails-email-page-edited-reg-user-subject' => 'Ny redigering på $WIKINAME!',
	'founderemails-email-page-edited-reg-user-body' => 'Hej $FOUNDERNAME,

$USERNAME har just gjort en till redigering i $WIKINAME på $PAGETITLE.

Gå till $PAGETITLE för att se vad de har ändrat.

Wikia-teamet',
	'founderemails-email-general-edit-greeting' => 'Hej $FOUNDERNAME,',
...
-- Wikia-teamet',
	'founderemails-email-anon-edit-greeting' => 'Hej $FOUNDERNAME,',
	...
	'founderemails-answers-email-user-registered-body' => 'Hej $FOUNDERNAME,
...
-- Wikia-teamet',
	...
	'founderemails-answers-email-page-edited-reg-user-first-edit-body' => 'Hej $FOUNDERNAME,

Det ser ut som den registrerade användaren $USERNAME har redigerat din wiki för första gången! Varför går du inte och besöker dem på deras diskussionssida ($USERTALKPAGEURL) och säger hej?
...
-- Wikia-teamet',
	...
	'founderemails-email-lot-happening-greeting' => 'Hej $FOUNDERNAME,',
	'founderemails-email-lot-happening-signature' => 'Wikia-teamet',
	'founderemails-email-lot-happening-button' => 'Se aktiviteter',
	...
	'founderemails-email-10-day-heading' => 'Hur går det, $FOUNDERNAME?',
	...
	'founderemails-email-views-digest-greeting' => 'Hej $FOUNDERNAME,',
	...
	'founderemails-email-complete-digest-greeting' => 'Hej $FOUNDERNAME,',
