...
<h1 style="color:#fa5c1f;font-size:19px;font-weight:normal"><?= wfMsgForContent('founderemails-email-0-day-heading') ?></h1>
<h2 style="color:#fa5c1f;font-size:22px;font-weight:bold"><?= wfMsgForContent('founderemails-email-0-day-congratulations') ?></h2>
</td>
<td width="30">
&nbsp;
</td>
...
<table cellpadding="0" cellspacing="0" width="100%" style="background:#f6f6f6;border-top:1px solid #ececec">
	...
	<tr>
		<td width="30">&nbsp;</td>
		<td>
			<h2 style="color:#2c85d5;font-size:24px;font-weight:normal;margin:0"><?= wfMsgForContent('founderemails-email-0-day-addpages-heading') ?></h2>
			<span style="color:#3a3a3a;font-size:14px;line-height:20px">
				<?= wfMsgForContent('founderemails-email-0-day-addpages-content') ?>
			</span>
		</td>
		<td width="15">&nbsp;</td>
		<td valign="middle">
			...
			<table cellpadding="0" cellspacing="0" background="http://images1.wikia.nocookie.net/wikianewsletter/images/9/9e/Founder_emails_button2.png" width="102" height="40">
				<tr valign="middle" align="center">
					<td style="color:#fff;font-size:14px"><?= wfMsgForContent('founderemails-email-0-day-addpages-button') ?></td>
				</tr>
			</table>
			</a>
		</td>
...
<table cellpadding="0" cellspacing="0" width="100%" style="background:#ffffff;border-top:1px solid #ececec">
	...
	<tr>
		<td width="30">&nbsp;</td>
		<td>
			<h2 style="color:#2c85d5;font-size:24px;font-weight:normal;margin:0"><?= wfMsgForContent('founderemails-email-0-day-addphotos-heading') ?></h2>
			<span style="color:#3a3a3a;font-size:14px;line-height:20px">
				<?= wfMsgForContent('founderemails-email-0-day-addphotos-content') ?>
			</span>
		</td>
		<td width="15">&nbsp;</td>
		<td valign="middle">
			...
			<table cellpadding="0" cellspacing="0" background="http://images1.wikia.nocookie.net/wikianewsletter/images/9/9e/Founder_emails_button2.png" width="102" height="40">
				<tr valign="middle" align="center">
					<td style="color:#fff;font-size:14px"><?= wfMsgForContent('founderemails-email-0-day-addphotos-button') ?></td>
				</tr>
			</table>
			</a>
		</td>
...
<table cellpadding="0" cellspacing="0" width="100%" style="background:#f6f6f6;border-top:1px solid #ececec">
	...
	<tr>
		<td width="30">&nbsp;</td>
		<td>
			<h2 style="color:#2c85d5;font-size:24px;font-weight:normal;margin:0"><?= wfMsgForContent('founderemails-email-0-day-customizetheme-heading') ?></h2>
			<span style="color:#3a3a3a;font-size:14px;line-height:20px">
				<?= wfMsgForContent('founderemails-email-0-day-customizetheme-content') ?>
			</span>
		</td>
		<td width="15">&nbsp;</td>
		<td valign="middle">
			...
			<table cellpadding="0" cellspacing="0" background="http://images1.wikia.nocookie.net/wikianewsletter/images/9/9e/Founder_emails_button2.png" width="102" height="40">
				<tr valign="middle" align="center">
					<td style="color:#fff;font-size:14px"><?= wfMsgForContent('founderemails-email-0-day-customizetheme-button') ?></td>
				</tr>
			</table>
			</a>
		</td>
...
<table cellpadding="0" cellspacing="0" width="100%" style="background:#ffffff;border-top:1px solid #ececec">
	...
	<tr>
		...
		<td colspan="2">
			<span style="color:#3a3a3a;font-size:14px;line-height:20px">
				<?= wfMsgForContent('founderemails-email-0-day-wikiahelps-text') ?>
			</span>
		</td>
		<td width="30">&nbsp;</td>
	</tr>
	...
	<tr>
		...
		<td style="color:#3a3a3a;font-size:14px;line-height:20px">
			<?= wfMsgForContent('founderemails-email-0-day-wikiahelps-signature') ?>
		</td>
