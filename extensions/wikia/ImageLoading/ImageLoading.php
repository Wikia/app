...
function ImageLoadingInit(&$out, &$text) {
	...
	$script = '<script type="text/javascript" src="http://yui.yahooapis.com/combo?2.5.2/build/yahoo-dom-event/yahoo-dom-event.js&2.5.2/build/imageloader/imageloader-min.js"></script><script type="text/javascript">var foldGroup = new YAHOO.util.ImageLoader.group(window, "scroll");';
