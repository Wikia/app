<div class="rwe-page-header">
	...
	<ul class="rwe-page-header__nav">
		<li class="rwe-page-header__nav-element rwe-page-header__nav-element-dropdown">
			<a class="rwe-page-header__nav-link" href="/" data-tracking="read">
		...
		<li class="rwe-page-header__nav-element rwe-page-header__nav-element-dropdown">
			<a class="rwe-page-header__nav-link" href="/wiki/Special:Community" data-tracking="create">
				<?= DesignSystemHelper::renderSvg(
					'wds-icons-pencil',
