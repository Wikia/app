<div class="rwe-page-header">
	...
	<ul class="rwe-page-header__nav">
		<li class="rwe-page-header__nav-element">
			<a class="rwe-page-header__nav-link rwe-page-header--dropdown" href="/">
		...
		<li class="rwe-page-header__nav-element">
			<a class="rwe-page-header__nav-link rwe-page-header--dropdown" href="/wiki/Special:Community">
				<?= DesignSystemHelper::renderSvg(
					'wds-icons-pencil',
					'wds-icon wds-icon-small rwe-page-header__icon'
				) ?>
				<span class="rwe-page-header__nav-text">Contribute</span>
				<?= DesignSystemHelper::renderSvg(
					'wds-icons-dropdown-tiny',
					'wds-icon wds-icon-tiny rwe-page-header__chevron'
				) ?>
		...
		<li class="rwe-page-header__nav-element">
			<a class="rwe-page-header__nav-link" href="<?= $discussTabLink ?>">
				<?= DesignSystemHelper::renderSvg(
					'wds-icons-reply',
					'wds-icon wds-icon-small rwe-page-header__icon'
				) ?>
		...
		<li class="rwe-page-header__nav-element">
			<a class="rwe-page-header__nav-link" href="/wiki/Special:Search">
				<?= DesignSystemHelper::renderSvg(
