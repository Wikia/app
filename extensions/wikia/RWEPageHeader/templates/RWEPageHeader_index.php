	...
	<ul class="rwe-page-header-nav">
		<li class="rwe-page-header-nav__tab">
			<a class="rwe-page-header-nav__link rwe-page-header--dropdown" href="/" data-tracking="read">
				<svg width="18" height="18" viewBox="0 0 18 18" class="wds-icon wds-icon-small rwe-page-header-nav__icon" xmlns="http://www.w3.org/2000/svg">
		...
		<li class="rwe-page-header-nav__tab">
			<a class="rwe-page-header-nav__link rwe-page-header--dropdown" href="/wiki/Special:Community" data-tracking="create">
				<?= DesignSystemHelper::renderSvg(
					'wds-icons-pencil',
		...
		<li id="searchFormWrapperRWE" class="rwe-page-header-nav__tab">
