	...
	<div class="masthead-info">
		...
		<div>
			<ul class="details">
				...
				<? endif; ?>
				<? if ( !empty( $user['bio'] ) ): ?>
					<li class="discussion-bio"><?= wfMessage( 'user-identity-bio' )->rawParams( $user['bio'] )->parse(); ?></li>
					<div class="discussion-bio-toggle" data-modal-title="<?= wfMessage( 'user-identity-bio-modal-title' )->escaped(); ?>">
						<span>
