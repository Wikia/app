...
class UserTagsStrategy extends WikiaObject {
	...
	/**
	 * Tries to get at most $count user tags for this user's global groups
	 * @param int $requested How many global tags to display
	...
	/**
	 * Tries to get at most $count user tags for this user's local groups
	 * @param int $requested How many local tags to display
