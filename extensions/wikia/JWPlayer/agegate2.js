(function(jwplayer){
    ...
    function setup(evt){
    	checkAge = function(){
			...
			var month;
			if (document.forms["age_form"]["month"].value == "January"){
			month = "1";
			}
			if (document.forms["age_form"]["month"].value == "February"){
			month = "2";
			}
			if (document.forms["age_form"]["month"].value == "March"){
			month = "3";
			}
			if (document.forms["age_form"]["month"].value == "April"){
			month = "4";
			}
			if (document.forms["age_form"]["month"].value == "May"){
			month = "5";
			}
			if (document.forms["age_form"]["month"].value == "June"){
			month = "6";
			}
			if (document.forms["age_form"]["month"].value == "July"){
			month = "7";
			}
			if (document.forms["age_form"]["month"].value == "August"){
			month = "8";
			}
			if (document.forms["age_form"]["month"].value == "September"){
			month = "9";
			}
			if (document.forms["age_form"]["month"].value == "October"){
			month = "10";
			}
			if (document.forms["age_form"]["month"].value == "November"){
			month = "11";
			}
			if (document.forms["age_form"]["month"].value == "December"){
			month = "12";
			}
  ...
  jwplayer().registerPlugin('agegate2', template);
})(jwplayer);