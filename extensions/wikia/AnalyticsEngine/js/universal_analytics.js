...
(function (window, undefined) {
    ...
    _gaWikiaPush(
        ...
        ['set', 'dimension22', String(window.wikiaIsPowerUserAdmin ? 'Yes' : 'No')],        // IsPowerUser: Admin
        ['set', 'dimension23', String(window.wikiaIsPowerUserFrequent ? 'Yes' : 'No')],     // IsPowerUser: Frequent
        ['set', 'dimension24', String(window.wikiaIsPowerUserLifetime ? 'Yes' : 'No')]      // IsPowerUser: Lifetime
    );
