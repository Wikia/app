...
escape(b(document.referrer.substring(0,1E3))));var w=document.createElement("iframe");w.className="hidden";w.name="d_ifrm";w.width=1;w.height=1;w.scrolling="no";w.marginWidth=0;w.marginHeight=0;w.frameBorder=0;void 0!=document.body&&void 0!=document.body.appendChild&&document.body.appendChild(w);void 0!=c&&""!=c&&(w.src=c.replace(/^(.*?):\/\/.*$/,"$1")+"://pbid.pro-market.net/engine?site=131911;size=1x1;e=0;dt="+a+";category="+d+";kw="+e+h+";rnd=("+(new Date).getTime()+")")}catch(x){}};
