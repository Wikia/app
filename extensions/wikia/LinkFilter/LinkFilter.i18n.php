...
function efWikiaLinkFilter() {
	...
	'en' => array(
			...
			'linkfilter-instructions' => 'Here is some info about link filter and stuff',
			'linkfilter-admin-instructions' => 'Here are admin instructions blah blah blah',
			...
			'linkfilter-comments' => '$1 {{PLURAL:$1|comment|comments}}',
			...
			'linkfilter-description-left'=>'left',
			'linkfilter_popular_articles'=>'Don\'t Miss',
