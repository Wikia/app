...
$messages['en'] = array(
	...
	'wikiacuratedcontent-content-description-supported-items-for-sections' => 'Categories are supported in all sections. Additionally "Featured" section supports: articles, blogs, videos (youtube)',
...
$messages['fr'] = array(
	'wikiacuratedcontent-desc' => "Modules pour le contenu de l'application communautaire mobile FANDOM",
	'wikiacuratedcontent-preview-description' => 'Ceci est un simple aperçu de ce à quoi ressembleront les pages dans une application communautaire FANDOM.',
	'wikiacuratedcontent-content-title' => "Outil de gestion du contenu de l'application communautaire FANDOM",
...
$messages['it'] = array(
	...
	'wikiacuratedcontent-preview-description' => "Questa è solo un'anteprima di come le pagine verranno visualizzate in una applicazione con contenuti curati di FANDOM.",
...
$messages['vi'] = array(
	'wikiacuratedcontent-desc' => 'Ứng dụng điện thoại Nội dung chọn lọc FANDOM',
	'wikiacuratedcontent-preview-description' => 'Đây là chỉ là bản xem trước cách mà trang sẽ được hiển thị trong ứng dụng Nội dung chọn lọc FANDOM.',
	'wikiacuratedcontent-content-title' => 'Công cụ quản lý Nội dung chọn lọc FANDOM',
	'wikiacuratedcontent-content-item' => 'Tập tin',
	'wikiacuratedcontent-content-section' => 'Phần tệp (tùy chọn)',
	'wikiacuratedcontent-content-name' => 'Tên nội dung chọn lọc',
	'wikiacuratedcontent-content-add-section' => 'Thêm mục',
	'wikiacuratedcontent-content-add-item' => 'Thêm tập tin',
	'wikiacuratedcontent-content-save' => 'Lưu',
	'wikiacuratedcontent-content-orphaned-error' => 'Tập tin phải thuộc về một mục',
	'wikiacuratedcontent-content-required-entry' => 'Tập tin được yêu cầu',
	'wikiacuratedcontent-content-duplicate-entry' => 'Giá trị này bị trùng lặp',
	'wikiacuratedcontent-content-empty-section' => 'Mục này cần một số tập tin',
	'wikiacuratedcontent-content-description-items' => 'Thêm các "Tập tin" và đổi tên chúng như bạn mong muốn để hiển thị trong Nội dung chọn lọc với "Tên nội dung chọn lọc".',
	'wikiacuratedcontent-content-description-supported-items-for-sections' => 'Thể loại được hỗ trợ trong tất cả các mục. Ngoài ra mục "Tính năng" hỗ trợ cho: bài viết, blog, đoạn phim (youtube và ooyala)',
	'wikiacuratedcontent-content-description-tag-needs-image' => 'Mục phải có hình ảnh',
	'wikiacuratedcontent-content-description-section' => 'Nhóm các tập tin đồng loạt lại với nhau nghe có vẻ được hơn chứ? Tạo một "Mục" và kéo và thả các tập tin ngay bên dưới nó.',
	...
	'wikiacuratedcontent-content-description-no-section' => 'Tập tin thiếu mục hoặc đi kèm với mục rỗng sẽ được hiển thị cuối cùng trong Nội dung chọn lọc.',
	'wikiacuratedcontent-content-description-items-input' => 'Khi thêm tập tin hãy viết nhãn cho chúng (trường bên phải) và điền tên (trường bên trái) với quy ước sau: tên_bài_viết, {{ns:Category}}:tên_thể_loại, {{ns:500}}:tên_thành_viên/tên_bài_đăng, {{ns:File}}:tên_đoạn_phim',
	'wikiacuratedcontent-content-articlenotfound-error' => 'Không tìm thấy bài viết',
	'wikiacuratedcontent-content-emptylabel-error' => 'Bạn cần phải nhập một Tên nội dung chọn lọc cho tập tin này',
	'wikiacuratedcontent-content-videonotsupported-error' => 'Nhà cung cấp tệp đoạn phim này không được hỗ trợ',
	'wikiacuratedcontent-content-notsupportedtype-error' => 'Dạng này không được hỗ trợ',
	...
	'wikiacuratedcontent-content-toolonglabel-error' => 'Tên nội dung chọn lọc không được dài hơn 48 ký tự',
	'wikiacuratedcontent-content-imagemissing-error' => 'Hình ảnh bị thiếu',
	'wikiacuratedcontent-edit-mobile-main-page' => 'Sửa đổi Trang Chính điện thoại',
	'wikiacuratedcontent-close-modal-prompt-message' => 'Bạn có chắc muốn đóng phương thức này không?',
	'wikiacuratedcontent-modal-title' => 'Trang Chính điện thoại',
	'wikiacuratedcontent-image-upload-comment' => 'Đã tải lên thông qua Nội dung chọn lọc',
	'wikiacuratedcontent-image-upload-description' => 'Hình ảnh này đã được tải lên thông qua Nội dung chọn lọc. Nó được dùng để hiển thị cho wiki của bạn trong các kết quả tìm kiếm và ứng dụng cộng đồng',
);
...
$messages['zh-hant'] = array(
	...
	'wikiacuratedcontent-content-add-section' => '添加區塊',
	'wikiacuratedcontent-content-add-item' => '添加項目',
	'wikiacuratedcontent-content-save' => '保存',
	'wikiacuratedcontent-content-orphaned-error' => '項目必須屬於某一區塊',
	'wikiacuratedcontent-content-required-entry' => '需要填充項目',
	'wikiacuratedcontent-content-duplicate-entry' => '此資料可被複制',
	'wikiacuratedcontent-content-empty-section' => '這個區塊需要填寫項目',
	'wikiacuratedcontent-content-description-items' => '請添加Wiki「項目」並且重新命名，以便它們以「內容名稱」的形式出現',
	'wikiacuratedcontent-content-description-supported-items-for-sections' => '分類內容對類別提供支援。支援的其他功能還包括： 文章，博客，視頻 （YouTube和Ooyala）',
	'wikiacuratedcontent-content-description-tag-needs-image' => '區塊必須包含一個圖像',
