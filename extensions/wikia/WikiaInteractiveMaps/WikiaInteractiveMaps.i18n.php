...
$messages[ 'en' ] = [
    ...
    'wikia-interactive-maps-create-map-pin-type-placeholder' => 'Pin Type Title',
...
$messages[ 'qqq' ] = [
    ...
    'wikia-interactive-maps-create-map-pin-type-placeholder' => 'Placeholder for Pin Type name input in edit/create Pin types UI',
