...
$messages[ 'en' ] = [
	...
	'wikia-interactive-maps-parser-tag-error-no-require-parameters' => 'Wikia Maps error occurred: no parameters passed to the tag. The only required parameter is map-id parameter. Make sure it\'s set, please.',
	'wikia-interactive-maps-parser-tag-error-invalid-map-id' => 'Wikia Maps error occurred: invalid map id. Please make sure your map-id parameter is an integer number.',
	'wikia-interactive-maps-parser-tag-error-invalid-longitude' => 'Wikia Maps error occurred: invalid lon. Please make sure your longitude parameter is a number or remove it to set it to default value.',
	'wikia-interactive-maps-parser-tag-error-invalid-latitude' => 'Wikia Maps error occurred: invalid lat. Please make sure your latitude parameter is a number or remove it to set it to default value.',
	'wikia-interactive-maps-parser-tag-error-invalid-zoom' => 'Wikia Maps error occurred: invalid zoom. Please make sure your zoom parameter is an integer number or remove it to set it to default value.',
	'wikia-interactive-maps-parser-tag-error-invalid-width' => 'Wikia Maps error occurred: invalid width. Please make sure your width parameter is an integer number or remove it to set it to default value.',
	'wikia-interactive-maps-parser-tag-error-invalid-height' => 'Wikia Maps error occurred: invalid height. Please make sure your height parameter is an integer number or remove it to set it to default value.',
	'wikia-interactive-maps-parser-tag-error-min-latitude' => 'Wikia Maps error occurred: invalid lat. Please make sure your latitude is higher then $min.',
	'wikia-interactive-maps-parser-tag-error-max-latitude' => 'Wikia Maps error occurred: invalid lat. Please make sure your latitude is lower then $max.',
	'wikia-interactive-maps-parser-tag-error-min-longitude' => 'Wikia Maps error occurred: invalid lon. Please make sure your longitude is higher then $min.',
	'wikia-interactive-maps-parser-tag-error-max-longitude' => 'Wikia Maps error occurred: invalid lon. Please make sure your longitude is lower then $max.',
	'wikia-interactive-maps-parser-tag-error-min-zoom' => 'Wikia Maps error occurred: invalid zoom. Please make sure your zoom parameter is set to $min or higher.',
	'wikia-interactive-maps-parser-tag-error-max-zoom' => 'Wikia Maps error occurred: invalid zoom. Please make sure your zoom parameter is to $max or lower.',
	'wikia-interactive-maps-parser-tag-error-min-width' => 'Wikia Maps error occurred: invalid width. Minimum supported with is $min.',
	'wikia-interactive-maps-parser-tag-error-max-width' => 'Wikia Maps error occurred: invalid width. Maximum supported with is $max.',
	'wikia-interactive-maps-parser-tag-error-min-height' => 'Wikia Maps error occurred: invalid height. Minimum supported height is $min.',
	'wikia-interactive-maps-parser-tag-error-max-height' => 'Wikia Maps error occurred: invalid height. Maximum supported height is $max.',
	'wikia-interactive-maps-parser-tag-error-no-map-found' => 'Wikia Maps error occurred: Map not found.',
...
$messages[ 'qqq' ] = [
	...
	'wikia-interactive-maps-parser-tag-error-no-require-parameters' => 'Maps error after try of parsing wikitext tag; one of the required parameters is not set',
	'wikia-interactive-maps-parser-tag-error-invalid-map-id' => 'Maps error after try of parsing wikitext tag; the map-id is not passed or is not a valid number',
	'wikia-interactive-maps-parser-tag-error-invalid-latitude' => 'Maps error after try of parsing wikitext tag; an invalid latitude value has been passed',
	'wikia-interactive-maps-parser-tag-error-invalid-longitude' => 'Maps error after try of parsing wikitext tag; an invalid longitude has been passed',
	'wikia-interactive-maps-parser-tag-error-invalid-zoom' => 'Maps error after try of parsing wikitext tag; an invalid zoom has been passed',
	'wikia-interactive-maps-parser-tag-error-invalid-width' => 'Maps error after try of parsing wikitext tag; an invalid width has been passed',
	'wikia-interactive-maps-parser-tag-error-invalid-height' => 'Maps error after try of parsing wikitext tag; an invalid height has been passed',
	'wikia-interactive-maps-parser-tag-error-min-latitude' => 'Maps error after try of parsing wikitext tag; an invalid latitude has been passed',
	'wikia-interactive-maps-parser-tag-error-max-latitude' => 'Maps error after try of parsing wikitext tag; an invalid latitude has been passed',
	'wikia-interactive-maps-parser-tag-error-min-longitude' => 'Maps error after try of parsing wikitext tag; an invalid longitude has been passed',
	'wikia-interactive-maps-parser-tag-error-max-longitude' => 'Maps error after try of parsing wikitext tag; an invalid longitude has been passed',
	'wikia-interactive-maps-parser-tag-error-min-zoom' => 'Maps error after try of parsing wikitext tag; an invalid zoom level has been passed',
	'wikia-interactive-maps-parser-tag-error-max-zoom' => 'Maps error after try of parsing wikitext tag; an invalid zoom level has been passed',
	'wikia-interactive-maps-parser-tag-error-min-width' => 'Maps error after try of parsing wikitext tag; value below minimum width has been passed',
	'wikia-interactive-maps-parser-tag-error-max-width' => 'Maps error after try of parsing wikitext tag; value above maximum width has been passed',
	'wikia-interactive-maps-parser-tag-error-min-height' => 'Maps error after try of parsing wikitext tag; value below minimum height has been passed',
	'wikia-interactive-maps-parser-tag-error-max-height' => 'Maps error after try of parsing wikitext tag; value above maximum height has been passed',
	'wikia-interactive-maps-parser-tag-error-no-map-found' => 'Maps error when map of given id doesn\'t exist',

	'wikia-interactive-maps-map-placeholder-error' => 'Maps unexpected error which could happen during some rare situations such as file system dead',
