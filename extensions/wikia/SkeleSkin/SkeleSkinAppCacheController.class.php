<?php
/**
 * SkeleSkin AppCache manifest generator
 * 
 * @authore Federico "Lox" Lucignano <federico(at)wikia-inc.com>
 */
class SkeleSkinAppCacheController extends WikiaController {
	...
	public function serveManifest(){
		...
		if ( !$this->wg->DevelEnvironment ) {
			$files = array_unshift( $files, AssetsManager::getInstance()->getSassCommonURL( 'skins/skeleskin/css/main.scss' ) );
		}
