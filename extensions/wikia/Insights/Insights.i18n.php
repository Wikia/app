...
$messages['en'] = [
	...
	'insights-list-uncategorized-subtitle' => 'Pages without categories',
	'insights-list-uncategorized-description' => 'Add categories to these pages. Good categorization is vital to a successfully organized wikia!',
	'insights-list-withoutimages-subtitle' => 'Pages without images',
	'insights-list-withoutimages-description' => 'Articles with images are read more often, shared more often, and perform better in search engines than those without images. Even adding a loosely related image can help.',
	'insights-list-deadend-subtitle' => 'Pages without links',
	'insights-list-deadend-description' => 'These pages should link to other articles on your wikia. Well-linked articles help readers discover more information about your topic and improve search engine rankings.',
	'insights-list-wantedpages-subtitle' => 'Wanted pages',
	'insights-list-wantedpages-description' => 'There are redlinks pointing to these pages, but the pages don’t exist! Create the article or make it a redirect to the correct article to help readers navigate your community.',
...
$messages['qqq'] = [
	...
	'insights-list-uncategorized-subtitle' => 'A title of a subpage with a list of uncategorized pages',
	...
	'insights-list-deadend-subtitle' => 'A title of a subpage with a list of pages with no links',
	'insights-list-deadend-description' => 'A description for a subpage with a list of pages with no links',
	'insights-list-wantedpages-subtitle' => 'A title of a subpage with a list of wanted pages',
	'insights-list-wantedpages-description' => 'A description for a subpage with a list of wanted pages',
