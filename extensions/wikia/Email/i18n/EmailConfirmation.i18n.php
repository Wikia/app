...
$messages['de'] = [
	...
	'emailext-emailconfirmation-reminder-summary' => 'Es ist schon ein paar Tage her, aber es sieht bisher nicht so aus, als hättest du deine E-Mail-Adresse bei Wikia bestätigt. Wir können es kaum noch erwarten, dass du endlich in das Wikia-Universum eintauchen kannst! Klicke einfach unten auf die Bestätigung und du kannst loslegen:',
	...
	'emailext-emailconfirmation-changed-subject' => 'Bestätige die Änderung deiner E-Mail-Adresse auf Wikia.',
	'emailext-emailconfirmation-changed-summary' => 'Klicke bitte auf den folgenden Link, um die Änderung deiner E-Mail-Adresse auf Wikia zu bestätigen. Nur so kannst du auch weiterhin alle wichtigen Informationen erhalten, die dein Fan-Feuer zum Lodern bringen!',
...
$messages['ja'] = [
	...
	'emailext-emailconfirmation-reminder-summary' => '手続きを開始されてから数日経ちますが、ウィキアでのアカウントの認証が完了していないようです。下の認証用リンクをクリックするだけの簡単な操作で認証完了し、ウィキアのご利用を開始していただけます。',
	...
	'emailext-emailconfirmation-changed-subject' => 'ウィキアでのメールアドレス変更の認証',
	'emailext-emailconfirmation-changed-summary' => 'ウィキアでのメールアドレスの変更を認証していただくため、下のリンクをクリックしてください。認証を完了していただくことで、引き続きさまざまな情報をメールでお受け取りいただけます。',
...
$messages['pl'] = [
	...
	'emailext-emailconfirmation-reminder-summary' => 'Minęło już kilka dni, a Twoje konto na wikia nie zostało potwierdzone. Nie możemy doczekać się, aż w pełni odkryjesz wszechświat Wikia! Kliknij link poniżej w celu potwierdzenia konta i możesz zaczynać:',
	...
	'emailext-emailconfirmation-changed-subject' => 'Potwierdź zmianę adresu e-mail na portalu Wikia',
...
$messages['ru'] = [
	...
	'emailext-emailconfirmation-reminder-summary' => 'Прошло уже несколько дней, но, похоже, вы ещё не подтвердили свою учетную запись на Викия. Скорее же погрузитесь во вселенную Викия! Просто нажмите на ссылку ниже — и готово:',
	...
	'emailext-emailconfirmation-changed-subject' => 'Подтвердите изменение адреса электронной почты на Викия',
	'emailext-emailconfirmation-changed-summary' => 'Перейдите по ссылке ниже, чтобы подтвердить изменение адреса электронной почты на Викия. Не прекращайте общение со своим любимым сообществом!',
...
$messages['zh-hans'] = [
	...
	'emailext-emailconfirmation-reminder-summary' => '您已经注册好几天了，但好像还没有确认您的维基账户。我们期待您加入Wikia！只需点击下面的确认链接即可完成注册:',
	'emailext-emailconfirmation-reminder-footer-1' => '如果您在23天内沒有完成注册，其他用戶将可以使用用戶名$1。现在就点击确认，拥有这个用户名吧！',
	'emailext-emailconfirmation-changed-subject' => '确认更改您在Wikia上的电子邮件地址。',
	'emailext-emailconfirmation-changed-summary' => '请点击下面的链接确认您将更改Wikia上的电子邮件地址，这样您才能收到社区上所有信息的更新通知。',
...
$messages['zh-hant'] = [
	...
	'emailext-emailconfirmation-reminder-summary' => '您已經註冊好幾天了，但好像還沒有確認您的維基賬戶。我們期待您加入Wikia！只需點擊下面的確認鏈接即可完成註冊:',
	'emailext-emailconfirmation-reminder-footer-1' => '如果您在23天內沒有完成註冊，其他用戶將可以使用用戶名$1。現在就點擊確認，擁有這個用戶名吧！',
	'emailext-emailconfirmation-changed-subject' => '確認更改您在Wikia上的電子郵件地址。',
	'emailext-emailconfirmation-changed-summary' => '請點擊下面的鏈接確認您將更改Wikia上的電子郵件地址，這樣您才能​​收到社區上所有信息的更新通知。',
