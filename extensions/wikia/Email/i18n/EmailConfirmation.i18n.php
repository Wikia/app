...
$messages['ru'] = array(
	'emailext-emailconfirmation-subject' => 'Подтвердите адрес электронной почты и начните работу с Викия!',
	'emailext-emailconfirmation-summary' => 'Вы у цели! Перейдите по ссылке ниже, чтобы подтвердить свой адрес электронной почты и начните работу с Викия:',
	'emailext-emailconfirmation-footer-1' => 'Зачем подтверждать адрес электронной почты, спросите вы? Вы сможете получать последние обновления по любой отслеживаемой теме, сообщения от других участников и многое другое — прямо в своей папке «Входящие». Также вы сможете создавать собственные вики и получать другие особые права, доступные только участникам, полностью подтвердившим данные своей учетной записи.',
	'emailext-emailconfirmation-footer-2' => 'Будем рады приветствовать вас в нашем сообществе!',
	'emailext-emailconfirmation-reminder-subject' => 'Подтвердите адрес электронной почты, чтобы забронировать имя участника $1!',
	'emailext-emailconfirmation-reminder-summary' => 'Прошло уже несколько дней, но, похоже, вы еще не подтвердили свою учетную запись Викия. Скорее погрузитесь во вселенную Викия! Просто нажмите на ссылку ниже, и готово:',
	'emailext-emailconfirmation-reminder-footer-1' => 'Если вы не подтвердите свое имя участника $1 в течение 23 дней, оно вновь станет доступно. Так что поторопитесь! Никто не должен использовать это имя, оно ваше!',
	'emailext-emailconfirmation-changed-subject' => 'Подтверждение изменения адреса электронной почты на Викия',
	'emailext-emailconfirmation-changed-summary' => 'Перейдите по ссылке ниже, чтобы подтвердить изменение адреса электронной почты на Викия. Не прекращайте общение со своим фандомом!',
	'emailext-emailconfirmation-changed-footer-1' => 'Вы будете продолжать получать электронные сообщения на свой прежний e-mail, до тех пор пока не подтвердите этот.',
	'emailext-emailconfirmation-changed-footer-2' => 'До встречи во вселенной Викия!',
	'emailext-emailconfirmation-community-team' => 'Команда сообщества Викия',
...
$messages['zh-hans'] = array(
	...
	'emailext-emailconfirmation-footer-1' => '您是说为什么要确认电子邮件？确认电子邮件后，您可以收到所关注主题的最新更新内容、粉丝发布的消息，以及发送到您的邮箱中任您随时查阅的很多其他信息。您还可以创建您自己的维基页面，并获得已认证会员的其他各种专属权限。',
	'emailext-emailconfirmation-footer-2' => '期待在社区里见到您！',
	'emailext-emailconfirmation-reminder-subject' => '赶快确认您的电子邮件、锁定您的$1用户名吧！',
	'emailext-emailconfirmation-reminder-summary' => '您已经注册好几天了，但好像还没有确认您的维基账户。我们期待您尽快使用Wikia！只需点击下面的确认链接即可完成确认:',
	'emailext-emailconfirmation-reminder-footer-1' => '如果您在23天内没有完成确认，其他用户就可以使用$1这个用户名。快点儿确认吧，此用户名就归你所有了！',
	'emailext-emailconfirmation-changed-subject' => '确认您更改了您的Wikia电子邮件',
	'emailext-emailconfirmation-changed-summary' => '请点击下面的链接确认您更改了Wikia电子邮件地址，这样您才能收到所有粉丝们的热情参与和回应。',
