...
$messages['ru'] = array(
	'emailext-fbdisconnect-subject' => 'Ваша учётная запись на FANDOM отключена от Facebook!',
	'emailext-fbdisconnect-summary' => 'Похоже, что вы отключили вашу учётную запись на FANDOM от Facebook. Мы сохраним историю ваших правок, сообщений и информацию вашего профиля, потому что вы являетесь важной частью FANDOM.',
	'emailext-fbdisconnect-intro' => 'Вы можете использовать то же имя участника, но, возможно, вам понадобится перейти по ссылке ниже и установить новый пароль на FANDOM:',
	'emailext-fbdisconnect-instructions' => 'Если вы уже установили пароль на FANDOM, то не обращайте внимания на это сообщение и продолжайте использовать нынешний пароль для входа в систему. В противном случае нажмите на ссылку выше, чтобы установить новый пароль.',
);
