<?php
/** Internationalization file for /extensions/wikia/Email/i18n/BlogPost extension. */
$messages = [];
...
$messages['fr'] = [
	...
	'emailext-blogpost-user-summary' => 'Un nouveau billet a été ajouté au [$1 blog de $2] sur [{{SERVER}} {{SITENAME}}]. Allez jeter un œil !',
...
$messages['ko'] = [
	...
	'emailext-blogpost-list-summary' => '[{{SERVER}} {{SITENAME}}]의 [$1 $2]에 새 글이 있습니다. 지금 확인해 보세요!',
