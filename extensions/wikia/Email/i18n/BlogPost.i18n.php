...
$messages['de'] = array(
	...
	'emailext-blogpost-user-summary' => 'Unter [$1 im Blog von $2] auf der Seite [{{SERVERCANONICAL}} {{SITENAME}}] wurde ein neuer Beitrag eingestellt. Schau mal vorbei!',
	'emailext-blogpost-list-summary' => 'Unter [$1 $2] auf der Seite [{{SERVERCANONICAL}} {{SITENAME}}] wurde ein neuer Beitrag eingestellt. Schau mal vorbei!',
	'emailext-blogpost-link-label' => 'Ganzen Beitrag lesen',
	'emailext-blogpost-view-all' => '[$1 Alle neuen Blog-Artikel auf dem Blog von $2]',
...
$messages['es'] = array(
	...
	'emailext-blogpost-user-summary' => 'Hay una nueva entrada en [$1 blog de $2] en [{{SERVERCANONICAL}} {{SITENAME}}]. ¡Dale un vistazo!',
	'emailext-blogpost-list-summary' => 'Hay una nueva entrada en [$1 $2] en [{{SERVERCANONICAL}} {{SITENAME}}]. ¡Dale un vistazo!',
...
$messages['fr'] = array(
	...
	'emailext-blogpost-user-summary' => 'Un nouveau billet a été ajouté au [$1 blog de $2] sur [{{SERVERCANONICAL}} {{SITENAME}}]. Allez jeter un œil !',
	'emailext-blogpost-list-summary' => 'Un nouveau billet a été ajouté à la page [$1 $2] de [{{SERVERCANONICAL}} {{SITENAME}}]. Allez jeter un œil !',
	'emailext-blogpost-link-label' => 'Lire le billet',
	'emailext-blogpost-view-all' => '[$1 Tous les billets récents sur le blog de $2]',
...
$messages['nl'] = array(
	...
	'emailext-blogpost-user-summary' => 'Er is een nieuw bericht op [$1 de blog van $2] op [{{SERVERCANONICAL}} {{SITENAME}}]. Neem een kijkje!',
	'emailext-blogpost-list-summary' => 'Er is een nieuw bericht op [$1 $2] op [{{SERVERCANONICAL}} {{SITENAME}}]. Neem een kijkje!',
...
$messages['pl'] = array(
	...
	'emailext-blogpost-user-summary' => 'Na blogu [$1 użytkownika $2] na [{{SERVERCANONICAL}} {{SITENAME}}] pojawił się nowy post. Zobacz!',
	'emailext-blogpost-list-summary' => 'Na [$1 $2] na [{{SERVERCANONICAL}} {{SITENAME}}] pojawił się nowy post. Zobacz!',
	'emailext-blogpost-link-label' => 'Przeczytaj cały post',
	'emailext-blogpost-view-all' => '[$1 Wszystkie najnowsze posty na blogu $2]',
...
$messages['ru'] = array(
	...
	'emailext-blogpost-user-summary' => 'В [$1 блоге участника $2] на [{{SERVERCANONICAL}} {{SITENAME}}] появилась новая запись. Посмотрите.',
	'emailext-blogpost-list-summary' => 'В блоге [$1 $2] на [{{SERVERCANONICAL}} {{SITENAME}}] появилась новая запись. Посмотрите!',
...
$messages['zh-hans'] = array(
	...
	'emailext-blogpost-user-summary' => '在[{{SERVERCANONICAL}} {{SITENAME}}]的[$1 $2的博客]页面有一篇新文章。快来看看吧！',
	'emailext-blogpost-list-summary' => '在[{{SERVERCANONICAL}} {{SITENAME}}]的 [$1 $2]頁面有一篇新文章。快來看看吧！',
...
$messages['zh-hant'] = array(
	...
	'emailext-blogpost-user-summary' => '在[{{SERVERCANONICAL}} {{SITENAME}}]的[$1 $2的網誌]頁面有一篇新文章。快來看看吧！',
	'emailext-blogpost-list-summary' => '在[{{SERVERCANONICAL}} {{SITENAME}}]的 [$1 $2]頁面有一篇新文章。快來看看吧！',
