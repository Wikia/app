...
$messages['en'] = array(
	...
	'emailext-wallmessage-owned-summary' => "'''$1 wrote you a new message on [{{SERVER}} {{SITENAME}}]. Lucky you!'''",
	'emailext-wallmessage-following-summary' => "'''$1 wrote $2 a new message on [{{SERVER}} {{SITENAME}}].'''",
...
$messages['qqq'] = array(
	...
	'emailext-wallmessage-owned-summary' => 'Text describing that another user wrote a new message on your wall. $1 is the name of the user who posted the message',
	'emailext-wallmessage-following-summary' => "Text describing that a user wrote a new message on another user's wall. $1 is the name of the user who posted the message, $2 is the wall owner (user).",
...
$messages['de'] = array(
	...
	'emailext-wallmessage-owned-summary' => "'''Hast du ein Glück! $1 hat dir auf der Seite [{{SERVER}} {{SITENAME}}] eine neue Nachricht geschickt.'''",
	'emailext-wallmessage-following-summary' => "'''$1 hat $2 auf der Seite [{{SERVER}} {{SITENAME}}] eine neue Nachricht geschickt.'''",
...
$messages['es'] = array(
	...
	'emailext-wallmessage-owned-summary' => "'''$1 te escribió un mensaje nuevo en [{{SERVER}} {{SITENAME}}]. ¡Qué suerte tienes!'''",
	'emailext-wallmessage-following-summary' => "'''$1 le escribió a $2 un mensaje nuevo en [{{SERVER}} {{SITENAME}}].'''",
...
$messages['fr'] = array(
	...
	'emailext-wallmessage-owned-summary' => "'''$1 vous a laissé un nouveau message sur [{{SERVER}} {{SITENAME}}]. Hourra !'''",
	'emailext-wallmessage-following-summary' => "'''$1 a laissé un nouveau message à $2 sur [{{SERVER}} {{SITENAME}}].'''",
...
$messages['it'] = array(
	...
	'emailext-wallmessage-owned-summary' => "'''$1 ti ha scritto un nuovo messaggio in [{{SERVER}} {{SITENAME}}]. Urrà!'''",
	'emailext-wallmessage-following-summary' => "'''$1 ha scritto un nuovo messaggio per $2 in [{{SERVER}} {{SITENAME}}].'''",
...
$messages['ja'] = array(
	...
	'emailext-wallmessage-owned-summary' => "'''$1さんが[{{SERVER}} {{SITENAME}}]で新しいメッセージを投稿しました。'''",
	'emailext-wallmessage-following-summary' => "'''$1さんが$2さんに[{{SERVER}} {{SITENAME}}]で新しいメッセージを投稿しました。",
...
$messages['pl'] = array(
	...
	'emailext-wallmessage-owned-summary' => "'''$1 napisał do ciebie nową wiadomość na [{{SERVER}} {{SITENAME}}]. Wspaniale!'''",
	'emailext-wallmessage-following-summary' => "'''$1 napisał do $2 nową wiadomość na [{{SERVER}} {{SITENAME}}].'''",
...
$messages['pt'] = array(
	...
	'emailext-wallmessage-owned-summary' => "'''$1 escreveu-lhe uma mensagem nova na [{{SERVER}} {{SITENAME}}]. Que sorte!'''",
	'emailext-wallmessage-following-summary' => "'''$1 escreveu uma mensagem nova para $2 na [{{SERVER}} {{SITENAME}}].'''",
...
$messages['ru'] = array(
	...
	'emailext-wallmessage-owned-summary' => "'''$1 оставил(а) вам новое сообщение на [{{SERVER}} {{SITENAME}}]. Вот так удача!'''",
	'emailext-wallmessage-following-summary' => "'''$1 оставил(а) участнику $2 новое сообщение на [{{SERVER}} {{SITENAME}}].'''",
...
$messages['zh-hans'] = array(
	...
	'emailext-wallmessage-owned-summary' => "'''$1在[{{SERVER}} {{SITENAME}}]上给您留言了。真幸运！'''",
	'emailext-wallmessage-following-summary' => "'''$1在[{{SERVER}} {{SITENAME}}]上给$2留言了。'''",
...
$messages['zh-tw'] = array(
	...
	'emailext-wallmessage-owned-summary' => "'''$1在[{{SERVER}} {{SITENAME}}]上給你留言了。好幸運喔！'''",
	'emailext-wallmessage-following-summary' => "'''$1在[{{SERVER}} {{SITENAME}}]上給$2留言了。'''",
