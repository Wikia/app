...
$messages['de'] = array(
	...
	'emailext-watchedpage-deleted-button-text' => 'Versionsgeschichte des Artikels ansehen',
);
...
$messages['it'] = array(
	'emailext-watchedpage-article-edited-subject' => '$2 ha modificato $1 su {{SITENAME}}',
	'emailext-watchedpage-salutation' => 'Ciao, $1.',
	'emailext-watchedpage-article-edited' => "'''Qualcuno ha modificato [$1 $2] su [{{SERVER}} {{SITENAME}}]. Controlla le modifiche!'''",
	...
	'emailext-watchedpage-article-protected-subject' => '$2 ha protetto $1 su {{SITENAME}}',
	'emailext-watchedpage-article-unprotected-subject' => '$2 ha tolto la protezione a $1 su {{SITENAME}}',
	'emailext-watchedpage-article-renamed-subject' => '$2 ha cambiato titolo a $1 su {{SITENAME}}',
	'emailext-watchedpage-article-deleted-subject' => '$2 ha eliminato $1 su {{SITENAME}}',
	'emailext-watchedpage-article-protected' => "'''Qualcuno ha protetto [$1 $2] su [{{SERVER}} {{SITENAME}}]. Dacci un'occhiata!'''",
	'emailext-watchedpage-article-unprotected' => "'''Qualcuno ha tolto la protezione a [$1 $2] su [{{SERVER}} {{SITENAME}}]. Dacci un'occhiata!'''",
	'emailext-watchedpage-article-renamed' => "'''Qualcuno ha cambiato titolo a [$1 $2] su [{{SERVER}} {{SITENAME}}]. Dacci un'occhiata!'''",
	'emailext-watchedpage-article-deleted' => "'''Qualcuno ha eliminato [$1 $2] su [{{SERVER}} {{SITENAME}}].'''",
...
$messages['zh-hans'] = array(
	...
	'emailext-watchedpage-article-protected' => "'''[{{SERVER}} {{SITENAME}}]网站上题为[$1 $2]的文章已受保护。快来查看吧！'''",
