...
$messages['qqq'] = array(
	...
	'emailext-founder-activity-digest-footer' => 'Footer text for activity digest that suggests visiting the Community Central wiki for help',
	'emailext-founder-views-digest-link-label' => 'Button label linking to the wiki inviting the user to add new pages.',
	'emailext-founder-digest-views-header' => 'Header text for number of pages viewed. $1 -> number of page views',
	...
	'emailext-founder-digest-edits-header' => 'Header text for number of edits made',
	'emailext-founder-digest-edits-description' => 'Description text for the number-of-edits header',
	'emailext-founder-digest-users-header' => 'Header text for number of new users',
