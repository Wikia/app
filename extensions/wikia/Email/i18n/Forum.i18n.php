...
$messages['en'] = array(
	...
	'emailext-forum-summary' => 'There is a new discussion on [$1 $2] on [{{SERVERCANONICAL} {{SITENAME}}].',
	'emailext-forum-button-label' => 'See the discussion',
	'emailext-forum-reply-subject' => '$1 on {{SITENAME}} has new replies.',
	'emailext-forum-reply-summary' => '[$2 $1] on [{{SERVERCANONICAL} {{SITENAME}}] has new replies.',
...
$messages['de'] = array(
	...
	'emailext-forum-summary' => 'Im Forum [$1 $2] auf der Seite [{{SERVERCANONICAL} {{SITENAME}}] wurde eine neue Diskussion gestartet.',
	...
	'emailext-forum-reply-summary' => 'Zu [$2 $1] auf der Seite [{{SERVERCANONICAL} {{SITENAME}}] wurden neue Antworten eingestellt.',
...
$messages['es'] = array(
	...
	'emailext-forum-summary' => 'Hay una nueva discusión sobre [$1 $2] en [{{SERVERCANONICAL} {{SITENAME}}].',
...
$messages['fr'] = array(
	...
	'emailext-forum-summary' => 'Une nouvelle discussion a été ajoutée à [$1 $2] sur [{{SERVERCANONICAL} {{SITENAME}}].',
	'emailext-forum-button-label' => 'Voir la discussion',
	'emailext-forum-reply-subject' => '$1 sur {{SITENAME}} a de nouvelles réponses.',
	'emailext-forum-reply-summary' => '[$2 $1] sur [{{SERVERCANONICAL} {{SITENAME}}] a de nouvelles réponses.',
...
$messages['it'] = array(
	...
	'emailext-forum-summary' => "C'è una nuova discussione in [$1 $2] della [{{SERVERCANONICAL} {{SITENAME}}].",
	'emailext-forum-button-label' => 'Vedi la discussione',
	'emailext-forum-reply-subject' => '$1 su {{SITENAME}} ha delle nuove risposte.',
	'emailext-forum-reply-summary' => '[$2 $1] su [{{SERVERCANONICAL} {{SITENAME}}] ha delle nuove risposte.',
...
$messages['ja'] = array(
	...
	'emailext-forum-summary' => '[{{SERVERCANONICAL} {{SITENAME}}]の[$1 $2]に新しいスレッドが追加されました。',
	'emailext-forum-button-label' => 'スレッドを見る',
	'emailext-forum-reply-subject' => '{{SITENAME}}の$1に新しい返信があります',
	'emailext-forum-reply-summary' => '[{{SERVERCANONICAL} {{SITENAME}}]の[$2 $1]に新しい返信があります。',
...
$messages['ko'] = array(
	...
	'emailext-forum-reply-summary' => "'''[{{SERVERCANONICAL} {{SITENAME}}]의 [$2 $1] 토론에 새 댓글이 있습니다.'''",
	'emailext-forum-reply-view-all' => '[$1 토론 내용 전체 보기]',
	'emailext-forum-subject' => '{{SITENAME}}의 $1에 새 토론이 있습니다',
	'emailext-forum-summary' => "'''[{{SERVERCANONICAL} {{SITENAME}}]의 [$1 $2]에 새 토론이 있습니다.'''",
	'emailext-forumreply-unfollow-text' => '더 이상 이에 관한 이메일 알림을 받고 싶지 않으신가요? [$1 이곳]에서 [{{SERVERCANONICAL} {{SITENAME}}]의 [$2 토론]을 주시 해제하실 수 있습니다.',
);
...
$messages['pl'] = array(
	...
	'emailext-forum-summary' => 'Na forum [$1 $2] na [{{SERVERCANONICAL} {{SITENAME}}]  pojawiła się nowa dyskusja.',
	'emailext-forum-button-label' => 'Zobacz dyskusję',
	'emailext-forum-reply-subject' => 'Pojawiły się nowe odpowiedzi w $1 na {{SITENAME}}.',
	'emailext-forum-reply-summary' => 'Pojawiły się nowe odpowiedzi w [$2 $1] na [{{SERVERCANONICAL} {{SITENAME}}].',
	'emailext-forum-reply-link-label' => 'Przeczytaj odpowiedź',
	'emailext-forum-reply-view-all' => '[$1 Zobacz pełną dyskusję.]',
	'emailext-forumreply-unfollow-text' => 'Nie jesteś już zainteresowany otrzymywaniem powiadomień? Kliknij [$1 tutaj], aby przestać śledzić  [$2 tą dyskusję] na [{{SERVERCANONICAL} {{SITENAME}}].',
);

$messages['pt'] = array(
	'emailext-forum-subject' => 'Há uma nova discussão em $1 na {{SITENAME}}.',
	'emailext-forum-summary' => 'Há uma nova discussão em [$1 $2] na [{{SERVERCANONICAL} {{SITENAME}}].',
	'emailext-forum-button-label' => 'Ver a discussão',
	'emailext-forum-reply-subject' => '$1 na {{SITENAME}} tem novas respostas.',
	'emailext-forum-reply-summary' => '[$2 $1] na [{{SERVERCANONICAL} {{SITENAME}}] tem novas respostas.',
...
$messages['ru'] = array(
	...
	'emailext-forum-summary' => 'В разделе [$1 $2] на [{{SERVERCANONICAL} {{SITENAME}}] появилось новое обсуждение.',
	...
	'emailext-forum-reply-summary' => 'В теме [$2 $1] на [{{SERVERCANONICAL} {{SITENAME}}] появились новые ответы.',
...
$messages['zh-hans'] = array(
	...
	'emailext-forum-summary' => '在[{{SERVERCANONICAL} {{SITENAME}}]网站的[$1 $2]页面，大家正在对一个新的话题进行讨论。',
	'emailext-forum-button-label' => '查看讨论内容',
	'emailext-forum-reply-subject' => '{{SITENAME}}上的$1有新的回复。',
	'emailext-forum-reply-summary' => '[{{SERVERCANONICAL} {{SITENAME}}]上的[$2 $1]有新的回复。',
...
$messages['zh-hant'] = array(
	...
	'emailext-forum-summary' => '在[{{SERVERCANONICAL} {{SITENAME}}]網站的[$1 $2]網頁，大家正在對一個新的話題進行討論。',
	'emailext-forum-button-label' => '查看討論',
	'emailext-forum-reply-subject' => '{{SITENAME}}的$1有新的回覆郵件。',
	'emailext-forum-reply-summary' => '[{{SERVERCANONICAL} {{SITENAME}}]的[$2 $1]有新的回覆郵件。',
	'emailext-forum-reply-link-label' => '閲讀回覆郵件',
	'emailext-forum-reply-view-all' => '[$1 查看整個討論內容]',
	'emailext-forumreply-unfollow-text' => '不想再收到這類更新通知？按一下[$1 這裡] 取消對[{{SERVERCANONICAL} {{SITENAME}}]上[$2 這個討論]的關注。',
);
