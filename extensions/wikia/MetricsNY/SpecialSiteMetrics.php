	...
	function execute(){
		...
		$user_groups = array_flip($user_groups);
			...
			$output .= "<div class=\"sm-navigation\">
				...
				<a href=\"".$stat_link->escapeFullURL('stat=Users Greater Than 5 Edits')."\">Users Greater Than 5 Edits</a>
				<a href=\"".$stat_link->escapeFullURL('stat=Users Greater Than 100 Edits')."\">Users Greater Than 100 Edits</a>
				<a href=\"".$stat_link->escapeFullURL('stat=Anonymous Edits')."\">Anonymous Edits</a>
				<a href=\"".$stat_link->escapeFullURL('stat=Images')."\">Images</a>
				<a href=\"".$stat_link->escapeFullURL('stat=Video')."\">Video</a>
