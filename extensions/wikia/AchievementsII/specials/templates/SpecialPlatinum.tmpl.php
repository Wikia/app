...
<div class="CustomizePlatinum">
	...
	<form id="createPlatinumForm" class="clearfix"
		  action="<?= $wgScriptPath ?>/index.php?action=ajax&amp;rs=AchAjax&amp;method=addPlatinumBadge" method="POST"
		  onsubmit="return SpecialCustomizePlatinum.addSubmit(this)" enctype="multipart/form-data">
		<fieldset class="customize-platinum-badge new editable">
			...
			<div class="column description-fields">
				<label><?= wfMsg( 'achievements-community-platinum-awarded-for' ); ?></label><span
					class="input-suggestion">&nbsp;(<?= wfMsg( 'achievements-community-platinum-awarded-for-example' ); ?>
					)</span>
				<textarea name="awarded_for"></textarea>
				<label><?= wfMsg( 'achievements-community-platinum-how-to-earn' ); ?></label><span
					class="input-suggestion">&nbsp;(<?= wfMsg( 'achievements-community-platinum-how-to-earn-example' ); ?>
					)</span>
			...
			<div class="sponsored-fields">
				...
				<div class="sponsored-fields-3" style="display:none;">
					<label
						for="hover_content"><?= wfMsg( 'achievements-community-platinum-sponsored-hover-content-label' ); ?></label>
					<input type="file" name="hover_content"/>

					<label
						for="hover_impression_pixel_url"><?= wfMsg( 'achievements-community-platinum-sponsored-hover-impression-pixel-url-label' ); ?></label>
					<input type="text" name="hover_impression_pixel_url"/>

					<label
						for="badge_impression_pixel_url"><?= wfMsg( 'achievements-community-platinum-sponsored-badge-impression-pixel-url-label' ); ?></label>
					<input type="text" name="badge_impression_pixel_url"/>

					<label
						for="badge_redirect_url"><?= wfMsg( 'achievements-community-platinum-sponsored-badge-click-url-label' ); ?></label>
