...
$messages['qqq'] = array(
	...
	'wikia-hubs-module-sponsored-image-tip' => 'Special Edit Hub - Tip Text under add sponsored image button, informing that maximum image size is 85px X 15px',
	'wikia-hubs-module-slider-image-tip' => 'Special Edit Hub - Wikia\'s picks module - Tip Text under photo button, informing that image size should be 160px X 100px',
	'wikia-hubs-module-explore-image-tip' => 'Special Edit Hub - Wikia\'s picks module - Tip Text under photo button, informing that image size should be 142px wide and no taller than 200px',
