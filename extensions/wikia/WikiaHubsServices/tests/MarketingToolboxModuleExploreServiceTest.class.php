...
class MarketingToolboxModuleExploreServiceTest extends PHPUnit_Framework_TestCase {
	...
	public function testGetStructuredData($data, $expected) {
		$mtbExploreServiceMock = $this->getMock('MarketingToolboxModuleExploreService', array('getLinkGroupsFromApiResponse'), array(self::DEFAULT_LANG, self::DEFAULT_SECTION, self::DEFAULT_VERTICAL), '', false);
