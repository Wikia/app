...
class WikiaHubsModuleFromthecommunityServiceTest extends WikiaBaseTest {
	/**
	 * (non-PHPdoc)
	...
	public function getJsValidatorDataProvider() {
		return array(
			...
			array(2, 'photo', "{required: '#WikiaHubstitle2:filled,#WikiaHubsusersUrl2:filled,#WikiaHubsquote2:filled,#WikiaHubsurl2:filled'}"),
			array(2, 'title', "{required: '#WikiaHubsphoto2:filled,#WikiaHubsusersUrl2:filled,#WikiaHubsquote2:filled,#WikiaHubsurl2:filled'}"),
			array(2, 'url', "{required: '#WikiaHubsphoto2:filled,#WikiaHubstitle2:filled,#WikiaHubsusersUrl2:filled,#WikiaHubsquote2:filled'} wikiaUrl"),
			array(2, 'quote', "{required: '#WikiaHubsphoto2:filled,#WikiaHubstitle2:filled,#WikiaHubsusersUrl2:filled,#WikiaHubsurl2:filled'}"),
			array(2, 'usersUrl', "{required: '#WikiaHubsphoto2:filled,#WikiaHubstitle2:filled,#WikiaHubsquote2:filled,#WikiaHubsurl2:filled'} wikiaUrl"),
			array(5, 'quote', "{required: '#WikiaHubsphoto5:filled,#WikiaHubstitle5:filled,#WikiaHubsusersUrl5:filled,#WikiaHubsurl5:filled'}"),
		);
	}
	...
	public function testGetStructuredData($inputData, $expectedData) {
		...
		$modelMock = $this->getMock(
			'WikiaHubsFromthecommunityModel',
			array('getBoxesCount')
		);
		...
		$moduleMock = $this->getMock(
			'WikiaHubsModuleFromthecommunityService',
