...
class EditHubModelTest extends WikiaBaseTest {
	...
	public function testGetModulesDataFromDefault() {
		...
		// Mock database
		$dbMock = $this->getMock('DatabaseMysqli', array('makeList'));
	...
	public function testSaveModuleInsert() {
		...
		$dbMock = $this->getMock('DatabaseMysqli', array('selectField', 'insert'));
	...
	public function testSaveModuleUpdate() {
		...
		$dbMock = $this->getMock('DatabaseMysqli', array('selectField', 'update'));
		$dbMock->expects($this->once())
			->method('selectField')
	...
	public function testGetDataPublished() {
		...
		$dbMock = $this->getMock('DatabaseMysqli', array('makeList', 'select', 'fetchRow'));
	...
	public function testCheckModulesSaved($savedModules, $expectedVal) {
		$dbMock = $this->getMock('DatabaseMysqli', array( 'select', 'fetchRow'));
