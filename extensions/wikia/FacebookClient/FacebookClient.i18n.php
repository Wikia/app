...
Das Ersatz-Passwort wurde nur an diese E-Mail-Adresse geschickt.
...
Le mot de passe de substitution n'a été envoyé qu'à vous, à cette adresse e-mail.
...
La password sostitutiva è stata inviata solo a te a questo indirizzo e-mail.
...
Het lijkt erop dat je zojuist jouw Wikia-account hebt ontkoppeld van Facebook. We hebben je geschiedenis, punten en speldjes intact gehouden, geen zorgen!

Je kunt dezelfde gebruikersnaam als voorheen gebruiken met hetzelfde wachtwoord.

Bedankt,

Het Wikia Community-Team',
	'fbconnect-wikia-signup-w-facebook' => 'Sign up with Facebook',
...
Zastępcze hasło zostało wysłane tylko do Ciebie na ten adres e-mail.
...
A sua nova senha só foi enviada a você neste email. 
...
$messages['vi'] = array(
	...
	'fbconnect-passwordremindertitle' => 'Your Wikia account is now disconnected from Facebook!',
	'fbconnect-passwordremindertitle-exist' => 'Your Wikia account is now disconnected from Facebook!',
	'fbconnect-passwordremindertext' => 'Xin chào,
...
Bạn có thể sử dụng tên thành viên như trước và chúng tôi đã thiết đặt mật khẩu mới cho bạn sử dụng:

Tên người dùng: $2
Mật khẩu: $3

Mật khẩu thay thế này chỉ được gửi cho bạn tại địa chỉ email này.
...
$messages['zh-hans'] = array(
	...
	'fbconnect-graphapi-not-configured' => 'Facebook应用帐户和密码不正确。',
	...
	'fbconnect-desc' => '让用户连结到他们的[http://www.facebook.com Facebook]帐户。提供基于Facebook群体的认证以及在Wiki文本中使用FBML。',
	...
	'fbconnect-passwordremindertitle' => '您的FANDOM帐户与Facebook的连结现已断开！',
	'fbconnect-passwordremindertitle-exist' => '您的FANDOM帐户与Facebook的连结现已断开！',
	'fbconnect-passwordremindertext' => '您好，
您刚才中断了您FANDOM帐户和Facebook的连结。我们已经保留了您所有的编辑纪录、编辑点数、成就等，因此不用担心！

您仍可以像以前一样使用同个用户名，我们也给了您一个新的密码。以下是详细资讯：
