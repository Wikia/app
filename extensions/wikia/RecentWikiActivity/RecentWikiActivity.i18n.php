<?php
/**
 * Internationalisation file for the RecentWikiActivity extension.
 *
...
$messages['en'] = [
	...
	'recent-wiki-activity-edit-details' => 'edited by $1 $2',
...
$messages['cs'] = [
	'recent-wiki-activity-header' => 'Nedávná aktivita na Wiki',
...
$messages['de'] = [
	'recent-wiki-activity-header' => 'Letzte Aktivitäten',
...
$messages['es'] = [
	'recent-wiki-activity-header' => 'Actividad reciente de la wiki',
...
$messages['fa'] = [
	'recent-wiki-activity-header' => 'آخرین فعالیت‌های ویکی',
...
$messages['fi'] = [
	'recent-wiki-activity-header' => 'Viimeisimmät muutokset wikissä',
...
$messages['fr'] = [
	'recent-wiki-activity-header' => 'Activité récente du wiki',
...
$messages['gl'] = [
	'recent-wiki-activity-header' => 'Actividade recente no wiki',
	'recent-wiki-activity-new-details' => 'creado por $1 $2',
	'recent-wiki-activity-edit-details' => 'editado por $1 $2',
	'recent-wiki-activity-delete-details' => 'borrado por $1 $2',
...
$messages['he'] = [
	'recent-wiki-activity-header' => 'פעילות ויקי אחרונה',
...
$messages['ia'] = [
	'recent-wiki-activity-header' => 'Activitate recente in wiki',
...
$messages['it'] = [
	'recent-wiki-activity-header' => 'Attività recente',
...
$messages['ja'] = [
	'recent-wiki-activity-header' => 'ウィキアクティビティ',
...
$messages['lt'] = [
	'recent-wiki-activity-header' => 'Naujausias Wiki aktyvumas',
...
$messages['mk'] = [
	'recent-wiki-activity-header' => 'Скорешни вики-активности',
...
$messages['ml'] = [
	'recent-wiki-activity-header' => 'സമീപകാല വിക്കി പ്രവർത്തനം',
...
$messages['ms'] = [
	'recent-wiki-activity-header' => 'Kegiatan Terbaru di Wiki Ini',
...
$messages['nb'] = [
	'recent-wiki-activity-header' => 'Siste wiki-aktivitet',
...
$messages['nl'] = [
	'recent-wiki-activity-header' => 'Recente wikiactiviteit',
...
$messages['pl'] = [
	'recent-wiki-activity-header' => 'Ostatnia aktywność na wiki',
...
$messages['pt'] = [
	'recent-wiki-activity-header' => 'Actividade Recente na Wiki',
...
$messages['pt-br'] = [
	'recent-wiki-activity-header' => 'Wiki Atividade recente',
	'recent-wiki-activity-new-details' => 'criada por $1 $2',
	'recent-wiki-activity-edit-details' => 'editada por $1 $2',
	'recent-wiki-activity-delete-details' => 'eliminada por $1 $2',
	'recent-wiki-activity-see-more' => 'Ver mais',
...
$messages['ru'] = [
	'recent-wiki-activity-header' => 'Последние действия в вики',
...
$messages['sv'] = [
	'recent-wiki-activity-header' => 'Senaste Wiki-aktivitet',
...
$messages['vi'] = [
	'recent-wiki-activity-header' => 'Hoạt động Wiki gần đây',
...
Example output: created by Avatar 3 hours ago',
	'recent-wiki-activity-edit-details' => 'Parameters:
* $1 is a username
* $2 is a point in time

Example output: edited by Avatar 3 hours ago',
	'recent-wiki-activity-delete-details' => 'Parameters:
* $1 is a username
* $2 is a point in time

Example output: deleted by Avatar 3 hours ago',
	'recent-wiki-activity-see-more' => 'Label for link which takes user to full recent wiki activity list. Link is located under Recent Wiki Activity module.',
];
