...
$messages['en'] = array(
	...
	'owb-button-done' => 'Start Your Wiki',
	'owb-button-plus' => 'Sign up for Plus',
	'owb-step1' => 'Step 1',
	...
	'owb-step4' => 'Step 4',
	'owb-step4-label-formatted' => 'Pricing<br/>plans',
	'owb-step4-label' => 'Pricing Plans',
	'owb-step4-instruction' => 'Select a pricing plan for your new wiki.',
	'owb-step4-basic-price' => '<strong>$0</strong>/month',
	'owb-step4-basic-details' => '<ul><li>Wikia ads for users who are not logged in</li><li>No bandwidth limits</li><li>Unlimited pages</li><li>Standard wiki editor tools</li></ul>',
	'owb-step4-plus-price' => '<strong>$$1</strong>/month',
	'owb-step4-plus-details' => '<ul><li><b>No Ads!</b></li><li>No bandwidth limits</li><li>Unlimited pages</li><li>Standard wiki editor tools</li></ul>',
	'owb-step4-error-caption' => 'Error',
	'owb-step4-error-content' => "This Wiki can't be upgraded to Plus.",
