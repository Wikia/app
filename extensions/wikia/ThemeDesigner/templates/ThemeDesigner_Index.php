...
<head>
	...
	<link rel="stylesheet" href="<?= F::app()->getAssetsManager()->getSassCommonURL('/extensions/wikia/ThemeDesigner/css/ThemeDesigner.scss') ?>">
	...
	<script src="<?= $wgStylePath ?>/common/jquery/jquery-1.5.1.js"></script>
