...
class UploadCommunityHeaderBackgroundFromFile extends UploadFromFile {
	...
	public function verifyUpload() {
		...
		if ( $details['status'] == self::OK ) {
			...
			if ( $this->checkFileExtension( $this->mFinalExtension, [ 'png', 'jpg', 'jpeg', 'gif' ] ) ) {
