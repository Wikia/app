<div id="lightbox-image" title="<?= htmlspecialchars($name) ?>" style="text-align: center">
	...
	<div id="lightbox-caption" class="neutral clearfix" style="padding: 5px">
		<a id="lightbox-link" href="<?= htmlspecialchars($href) ?>" title="<?= wfMsg('lightbox_details_tooltip') ?>" style="float: right"><img class="sprite magnify-clip" width="16" height="16" src="<?= $wgBlankImgUrl ?>" alt="" /></a>
