...
?>
		<td valign="middle" style="padding:0px 2px 0px 1px;">
			...
			<label for="checkBoxFor<?=$groupName?>"><span style="padding-bottom:5px;"><?= $link ?> <small>(<?= wfMessage( 'listuserscount', ( isset( $group['count'] ) ) ? intval($group['count']) : 0 )->parse() ?>)</small></span></label>
		</td>
<?
		$i++;
	}
