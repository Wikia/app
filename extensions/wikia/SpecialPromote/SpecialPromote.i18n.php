...
$messages['pl'] = array(
	...
	'promote-introduction-header' => 'Wyromuj swoją wiki na pl.wikia.com',
	...
	'promote-nocorp-upload-main-photo-explanation' => 'Ten obraz opisuje Twoją wiki, jest jej wizytówką. Będzie reprezentowało Twoją wiki w wynikach wyszukiwania, aplikacjach mobilnych i innych, więc postaraj się aby był wyjątkowy! Pamiętaj, że w każdej chwili możesz go zmienić.',
	'promote-upload-additional-photos-header' => 'Dodatkowe obrazy',
	'promote-upload-additional-photos-explanation' => 'Im więcej obrazów dodasz do swojej wikii, tym będzie bardziej interesująca dla innych użytkowników. Maksymalna ilość zdjęć która możesz dodać to 9. Gorąco zachęcamy, do wyczerpywania limitów!',
	...
	'promote-upload-additional-image-form-modal-copy' => 'Dodaj więcej obrazów, aby bardziej szczegółowo opowiedzieć o swojej wiki. Dozwolony format pliku to ".png", a minimalna wielkość to 480x320.',
	...
	'promote-error-upload-unknown-error' => 'Nieznany błąd podzczas przesyłania pliku',
	...
	'promote-statusbar-rejected' => 'Jeden lub więcej dodanych przez Ciebie obraów nie przeszło weryfikacji pomyślnie. [[Special:Contact|Dowiedz się dlaczego]]',
