...
<section id=wkRelPag>
	...
	<? foreach ( $pages as $page ) :?>
		...
		<li><a href="<?= $page['url'] ;?>"><img src="<?= wfBlankImgUrl() ;?>" width=100 height=50 data-src="<?= $imgUrl ;?>" class="lazy noSect noThumb"/><noscript><img src="<?= $page['imgUrl'] ;?>" width=100 height=50/></noscript><?= $page['title'] ?></a></li>
	<? endforeach ;?>
	</ul>
</section>
<? endif ;?>