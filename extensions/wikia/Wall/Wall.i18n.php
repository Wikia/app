...
Оригинал сообщения и ваш комментарий останутся в истории вики.',
	...
	'wall-message-staff-text' => 'Этот участник является сотрудником FANDOM',
	...
	'wall-message-not-found' => 'Это сообщение не найдено. Если вы видите это сообщение об ошибке, свяжитесь с сотрудниками FANDOM через [[Служебная:Contact|форму обратной связи]] и сообщите подробности, чтобы мы могли решить проблему.',
);
