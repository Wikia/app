...
$messages['qqq'] = array(
	...
	'wall-message-elseswall' => "Link to a user's wall, $1 is the username(you can use GENDER in this message)",
	...
	'wall-placeholder-message' => "Entry field for the first message of a new thread, $1 is the wall owner (you can use GENDER in this message)",
	...
	'wall-message-removed-thread-because' => "Summary at the top of a removed thread page, $1 is the user who removed the thread(you can use GENDER in this message)",
	'wall-message-deleted-thread-because' => "Summary at the top of a deleted thread page, $1 is the user who deleted the thread(you can use GENDER in this message)",
	'wall-message-restore-thread' => "Button to restore a thread on a removed thread page",
	'wall-message-removed-reply-because' => "Summary at the top of a removed reply page, $1 is the user who removed the reply(you can use GENDER in this message)",
	'wall-message-deleted-reply-because' => "Summary at the top of a deleted reply page, $1 is the user who deleted the reply(you can use GENDER in this message)",
	...
	'wn-user1-reply-you-your-wall' => "Notification when someone replies on your wall, $1 is username(you can use GENDER in this message)",
	'wn-user2-reply-you-your-wall' => "Notification when 2 users reply on your wall, $1 and $2 are usernames who replied(you can use GENDER in this message)",
	'wn-user3-reply-you-your-wall' => "Notification when 3 or more users reply on your wall, $1 is first username who replied(you can use GENDER in this message)",
	'wn-user1-reply-self-your-wall' => "Notification when a user replies to a thread that user started, $1 is username(you can use GENDER in this message)",
	'wn-user2-reply-self-your-wall' => "Notification when 2 users reply to a thread that one of them started, $1 and $2 are usernames who replied(you can use GENDER in this message)",
	'wn-user3-reply-self-your-wall' => "Notification when 3 or more users reply to a thread that one of them started, $1 is first username who replied(you can use GENDER in this message)",
	'wn-user1-reply-other-your-wall' => "Notification, $1 is user replying, $2 is user who started the thread(you can use GENDER in this message)",
	'wn-user2-reply-other-your-wall' => "Notification, $1 and $2 are users replying, $3 is user who started the thread(you can use GENDER in this message)",
	'wn-user3-reply-other-your-wall' => "Notification, $1 is first user replying, $2 is user who started the thread(you can use GENDER in this message)",
	'wn-user1-reply-you-other-wall' => "Notification, $1 is user replying to a thread you started, $2 is wall owner(you can use GENDER in this message)",
	'wn-user2-reply-you-other-wall' => "Notification, $1 and $2 are users replying to a thread you started, $3 is wall owner(you can use GENDER in this message)",
	'wn-user3-reply-you-other-wall' => "Notification, $1 is first user replying to a thread you started, $3 is wall owner(you can use GENDER in this message)",
	'wn-user1-reply-self-other-wall' => "Notification, $1 is user replying to a thread that user started, $2 is wall owner(you can use GENDER in this message)",
	'wn-user2-reply-self-other-wall' => "Notification, $1 and $2 are users replying to a thread that one of them started, $3 is wall owner(you can use GENDER in this message)",
	'wn-user3-reply-self-other-wall' => "Notification when 3 or more users reply to a thread that one of them started, $1 is first user who replied, $2 is wall owner(you can use GENDER in this message)",
	'wn-user1-reply-other-other-wall' => "Notification, $1 is user replying, $2 is user who started the thread, $3 is wall owner(you can use GENDER in this message)",
	'wn-user2-reply-other-other-wall' => "Notification, $1 and $2 are users replying, $3 is user who started the thread, $4 is wall owner(you can use GENDER in this message)",
