...
$messages['en'] = array(
	...
	'wn-user3-reply-you-your-wall' => '$1 and 2+ others replied to your message on your Wall',
	...
	'wn-user3-reply-self-your-wall' => '$1 and 2+ others replied to a message on your Wall',
	...
	'wn-user3-reply-other-your-wall' => '$1 and 2+ others replied to $2\'s message on your Wall',
	...
	'wn-user3-reply-you-other-wall' => '$1 and 2+ others replied to your message on $2\'s Wall',
	...
	'wn-user3-reply-self-other-wall' => '$1 and 2+ others replied to a message on $2\'s Wall',
	...
	'wn-user3-reply-other-other-wall' => '$1 and 2+ others replied to $2\'s message on $3\'s Wall',
	'wn-user1-reply-you-a-wall' => '$1 replied to your message on a Wall',
	'wn-user2-reply-you-a-wall' => '$1 and $2 replied to your message on a Wall',
	'wn-user3-reply-you-a-wall' => '$1 and 2+ others replied to your message on a Wall',
	'wn-user1-reply-self-a-wall' => '$1 replied to a message on a Wall',
	'wn-user2-reply-self-a-wall' => '$1 and $2 replied to a message on a Wall',
	'wn-user3-reply-self-a-wall' => '$1 and 2+ others replied to a message on a Wall',
	'wn-user1-reply-other-a-wall' => '$1 replied to $2\'s message on a Wall',
	'wn-user2-reply-other-a-wall' => '$1 and $2 replied to $3\'s message on a Wall',
	'wn-user3-reply-other-a-wall' => '$1 and 2+ others replied to $2\'s message on a Wall',
