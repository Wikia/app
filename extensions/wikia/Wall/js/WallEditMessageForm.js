...
require(['jquery', 'mw', 'wikia.window'], function($, mw, context) {
	...
	context.Wall.EditMessageForm = $.createClass(context.Wall.MessageForm, {
		oldHTML: {},
		constructor: function(page) {
			context.Wall.EditMessageForm.superclass.constructor.apply(this,arguments);
		...
		cancelEdit: function(e) {
			...
			if ( context.skin && context.skin !== "monobook" ) {
				context.WikiaButtons.init(bubble);
			}
	...
	context.Wall.settings.classBindings.editMessageForm = context.Wall.EditMessageForm;
