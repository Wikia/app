...
require(['jquery', 'mw', 'wikia.window'], function ($, mw, context) {
	...
	context.Wall.ReplyMessageForm = $.createClass(context.Wall.MessageForm, {
		constructor: function(page, model) {
			context.Wall.ReplyMessageForm.superclass.constructor.apply(this, arguments);
			...
			this.model.postReply(
				...
				this.proxy(function (newMessage) {
					...
					if (mw.config.get('skin') !== 'monobook') {
						context.WikiaButtons.init(newMessage);
					}
	...
	context.Wall.settings.classBindings.replyMessageForm = context.Wall.ReplyMessageForm;
