...
require(['jquery', 'wikia.window'], function ($, context) {
	...
	context.Wall.Pagination = $.createClass(context.Observable, {
		constructor: function(page, model) {
			context.Wall.Pagination.superclass.constructor.apply(this, arguments);
	...
	context.Wall.settings.classBindings.pagination = context.Wall.Pagination;
