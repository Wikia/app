				...
				<table width="100%" cellpadding="0" cellspacing="0">
					<tr>
						...
						<table cellpadding="0" cellspacing="0" width="100%">
							...
							<tr>
								...
								<table cellpadding="7" cellspacing="0" width="100%">
									...
									<? if (!empty($buttonUrl)) { ?>
										<tr>
											<td><a href="<?= $buttonUrl ?>" style="text-decoration: none">
											<table cellpadding="0" cellspacing="0" height="39">
												<tr valign="middle" align="center">
													...
													<td style="color: #fff; font-size: 14px; padding: 0 10px;"
														background="http://images2.wikia.nocookie.net/wikianewsletter/images/5/53/Ctacenter.png"><?= $button ?></td>
													<td height="39" width="5"
						...
						<table cellpadding="0" cellspacing="0" width="100%"
							...
							<tr>
								<td align="center"
									style="font-size: 11px; color: #3a3a3a; line-height: 16px"><?= wfMsgForContent('founderemails-email-footer-line1') ?>
								<br>
								<?= wfMsgForContent('founderemails-email-footer-line2') ?></td>
							</tr>
							<tr>
								<td align="center" valign="middle" height="50"><?= wfMsgForContent('founderemails-email-footer-line3') ?>
								</td>
							</tr>
						</table>
