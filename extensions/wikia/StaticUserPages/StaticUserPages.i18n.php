...
$messages['qqq'] = array(
	'static-user-pages-user-content' => 'User page content for FANDOM account',
	'static-user-pages-bot-content' => 'User page content for FANDOMbot account',
);
...
Si tienes preguntas acerca de la herramienta de bienvenida de FANDOM [[Especial:Contactar|contacta con el staff de FANDOM]].',
	'static-user-pages-bot-content' => 'Usuario:FANDOMbot es un bot operado por personal FANDOM para grandes ediciones y cambios.',
);
...
Fandomに関する一般的なサポートが必要な場合は、[[ヘルプ:コンテンツ|Fandomヘルプ]]をご利用ください。ヘルプで答えが見つからない場合は、[[ヘルプ:Fandomとの連絡|スタッフまでお問い合わせ]]ください。

==ウェルカムツールに関する情報とサポート==
自動ウェルカムメッセージについての詳細は、[[ヘルプ:ウェルカムツール|ウェルカムツールのヘルプページ]]をご覧ください。

Fandomウェルカムツールについてご不明な点がありましたら、[[ヘルプ:Fandomとの連絡|Fandomスタッフにお問い合わせ]]ください。',
	'static-user-pages-bot-content' => 'User:FANDOMbotは、一括編集や一括変更のためにFandomスタッフが運営している[[Help:ボット|ボット・アカウント]]です。',
);
...
$messages['pt'] = array(
	'static-user-pages-user-content' => '<h2 style="overflow:auto"> Bem-vindo ao FANDOM!</h2>

Se você recebeu as boas-vindas desta conta, então você é um novo editor desta wiki. 
...
$messages['zh-hans'] = array(
	'static-user-pages-user-content' => '<h2 style="overflow:auto">欢迎来到FANDOM！</h2>

如果你收到这条欢迎消息，就说明你是这个Wiki上的新用户。你好！

如果你需要任何帮助，你可以给发布欢迎消息的人留言。点击链接进入到这个用户的讨论页，之后你就可以留言了。

如果需要关于FANDOM的一般性帮助，请查阅[[Help:Contents|FANDOM帮助页]]或[[Special:Contact|联络员工]]进行询问。

==欢迎工具的使用说明==
有关如何使用自动发布欢迎消息工具，请查阅[[Help:Welcome tool|欢迎工具帮助页]]。

如果你还有其他关于FANDOM欢迎工具的使用问题，请[[Special:Contact|联络FANDOM员工]]。
 ',
	'static-user-pages-bot-content' => 'User:FANDOMbot是FANDOM员工在批量编辑和更改时使用的机器人帐户。',
);

$messages['zh-hant'] = array(
	'static-user-pages-user-content' => '<h2 style="overflow:auto">歡迎來到FANDOM！ </h2>

如果你收到這條歡迎消息，就說明你是這個Wiki上的新用戶。你好！

如果你需要任何幫助，你可以給發佈歡迎消息的人留言。使用連結進入到這個用戶的討論頁，之後你就可以留言了。

如果需要關於FANDOM的常規幫助，請查閱[[Help:Contents|FANDOM幫助頁]]或[[Special:Contact|聯絡員工]]進行詢問。

==歡迎工具的使用說明==
有關如何使用自動發佈歡迎消息工具，請查閱[[Help:Welcome tool|歡迎工具幫助頁]]。

如果你還有其他關於FANDOM歡迎工具的使用問題，請[[Special:Contact|聯絡FANDOM員工]]。',
	'static-user-pages-bot-content' => 'User:FANDOMbot是FANDOM員工在大量編輯和更改時使用的機器人帳戶。',
);
