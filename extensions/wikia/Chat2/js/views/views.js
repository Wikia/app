...
define('ChatViews', ['underscore', 'mw', 'ChatEmoticons'], function (_, mw, chatEmoticons) {
	'use strict';
	...
	var ChatView = Backbone.View.extend({
		...
		emoticonMapping: new chatEmoticons.EmoticonMapping(),
		...
		processText: function (text, allowHtml) {
			...
			text = chatEmoticons.WikiaEmoticons.doReplacements(text, this.emoticonMapping);
	...
	var UserView = Backbone.View.extend({
		...
		liId: function () {
			...
			var username = this.model.get('name').replace(/ /g, "_"); // encodeURIComponent would add invalid characters
...
//TODO: rename it to frame NodeChatFrame ?
	...
	return {
		NodeChatDiscussion: NodeChatDiscussion,
		NodeChatUsers: NodeChatUsers,
	};
});
