/* global require, $, Observable */
require(['mw', 'ChatViews', 'ChatModels'], function (mw, chatViews, models) {
	'use strict';
	...
	var NodeRoomController = $.createClass(Observable, {
		...
		constructor: function (roomId) {
			...
			this.viewDiscussion = new chatViews.NodeChatDiscussion({model: this.model, el: $('body'), roomId: roomId});
	...
	var NodeChatController = $.createClass(NodeRoomController, {
		...
		constructor: function (roomId) {
			...
			this.viewUsers = new chatViews.NodeChatUsers({model: this.model, el: $('body')});
