...
class ChatHelper {
	...
	public static function onContributionsToolLinks(  $id, $nt, &$tools ) {
		...
		if(!empty($user)) {
			$tools[] = Linker::link(SpecialPage::getSafeTitleFor('Log', 'chatban'), wfMsgHtml( 'chat-chatban-log' ), array('class' => 'chat-ban-log'), array('page' => $user->getUserPage()->getPrefixedText())); # Add chat ban log link (@author: Sactage)
