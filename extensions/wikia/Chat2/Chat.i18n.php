...
* $2 is the moderator removing the ban.',
	...
	'chat-failover-log-entry' => 'Log entry for toggling Chat-failover mode.
* $1: Chat name
* $2: User who did it
* $3: Current op mode
* $4: Reason given',
...
Falls der Chat bereits im Ausfallsicherungs-Modus läuft und der Chat doch nicht funktioniert: Setze ihn NICHT ohne Rücksprache mit einem Betriebsentwickler in den Standardmodus zurück!',
	'chat-failover-server-list' => 'Genutzte Chat-Server:',
	'chat-failover-operating-failover' => 'Chat nun betrieben in: <span>Ausfallsicherungs-Modus</span>',
	'chat-failover-operating-regular' => 'Chat nun betrieben in: <span>Standard-Modus</span>',
	'chat-failover-reason' => 'Für Moduswechsel einen Grund eingeben und Schaltfläche betätigen',
	'chat-failover-switchmode-failover' => 'In den Standard-Modus wechseln',
	'chat-failover-switchmode-regular' => 'In den Ausfallsicherungsmodus wechseln',
	'chat-failover-mode-areyousure' => 'Bist du dir der Konsequenzen dieser Operation bewusst??',
	'chat-failover-reason-empty' => 'Grund darf nicht leer sein',
	'chat-failover-log-entry' => 'Betriebsmodus Chat "$1" von [[User:$2]] zu $3 geändert. \'\'\'Grund\'\'\': $4',
...
Por favor, contáctalo para más información.',
	...
	'chatfailover' => 'Centro de control de errores del chat',
	'chat-failover-warning-title' => '¡Lee atentamente!',
	'chat-failover-warning' => 'Esta página especial permite cambiar el chat al modo de fallos.<br /><br />Si no eres un ingeniero, necesitarás una consulta para ejecutar esta operación.<br /><br />Si el chat ya está funcionando en modo de fallos y la aplicación del chat no está funcionando: NO la cambies al modo normal sin haber consultado a un ingeniero de operaciones.',
	'chat-failover-server-list' => 'Servidores de chat en uso:',
	'chat-failover-operating-failover' => 'El chat está operando ahora en: <span>modo de fallos</span>',
	'chat-failover-operating-regular' => 'El chat está operando ahora en: <span>modo normal</span>',
	'chat-failover-reason' => 'Para cambiar el modo, ingresa un motivo y presiona el botón',
	'chat-failover-switchmode-failover' => 'Cambiar a modo normal',
	'chat-failover-switchmode-regular' => 'Para cambiar a modo de tolerancia a fallos',
	'chat-failover-mode-areyousure' => '¿Eres consciente de la consecuencias derivadas al realizar esta operación?',
	'chat-failover-reason-empty' => 'El motivo no puede estar vacío',
	'chat-failover-log-entry' => "Operación del chat $1 cambiado a $3 por el usuario [[User:$2|$2]]. '''Motivo''': $4",
...
Si le chat fonctionne déjà en mode secours et que l’application de tchat ne fonctionne pas : NE PAS le remettre en mode normal sans consulter un ingénieur des opérations',
	'chat-failover-server-list' => 'Serveurs de tchat utilisés :',
	'chat-failover-operating-failover' => 'Le tchat fonctionne maintenant en : <span>mode secours</span>',
	'chat-failover-operating-regular' => 'Le tchat fonctionne maintenant en : <span>mode normal</span>',
	'chat-failover-reason' => 'Pour changer le mode saisissez une raison et appuyez sur le bouton',
	'chat-failover-switchmode-failover' => 'Passer en mode normal',
	'chat-failover-switchmode-regular' => 'Passer en mode secours',
	'chat-failover-mode-areyousure' => 'Comprenez-vous les conséquences de cette opération ???',
	'chat-failover-reason-empty' => 'La raison ne peut pas être vide',
	'chat-failover-log-entry' => "Mode de fonctionnement du tchat de $1 modifié par [[User:$2|Utilisateur:$2]] en $3. '''Raison :''' $4",
...
$messages['gl'] = array(
	...
	'chatfailover' => 'Centro de control da seguridade do chat',
	'chat-failover-warning-title' => 'Lea isto con atención!',
	'chat-failover-warning' => 'Esta páxina especial permite cambiar o chat ao modo seguro.
<br /><br />Se non é un enxeñeiro, a realización desta operación necesita unha consulta.<br /><br />
Se o chat xa está operando no modo seguro e non funcione a aplicación do chat, NON o cambie ao modo normal sen consultar cun enxeñeiro de operacións',
	'chat-failover-server-list' => 'Servidores do chat en uso:',
	'chat-failover-operating-failover' => 'Nestes intres, o chat está operando no <span>modo seguro</span>',
	'chat-failover-operating-regular' => 'Nestes intres, o chat está operando no <span>modo normal</span>',
	'chat-failover-reason' => 'Para cambiar o modo escriba un motivo e prema no botón',
	'chat-failover-switchmode-failover' => 'Para cambiar ao modo normal',
	'chat-failover-switchmode-regular' => 'Para cambiar ao modo seguro',
	'chat-failover-mode-areyousure' => 'Comprende as consecuencias desta operación?',
	'chat-failover-reason-empty' => 'O motivo non pode quedar baleiro',
	'chat-failover-log-entry' => "O usuario [[User:$2|$2]] modificou o modo de operación do chat $1 a $3. '''Motivo:'' $4",
...
Per favor contacta le pro plus informationes.',
	...
	'chatfailover' => 'Centro de controlo pro le systema de reserva del chat',
	'chat-failover-warning-title' => 'Lege isto con attention!',
	'chat-failover-warning' => 'Iste pagina special permitte cambiar le chat al systema de reserva.
<br /><br />Si tu non es un ingeniero, iste operation require consultation.<br /><br />
		Si le chat jam es in le systema de reserva e le application de chat non functiona: NON retorna lo al systema normal sin consultar un ingeniero de operationes!',
	'chat-failover-server-list' => 'Servitores de chat in uso:',
	'chat-failover-operating-failover' => 'Le chat functiona ora in: <span>le systema de reserva</span>',
	'chat-failover-operating-regular' => 'Le chat functiona ora in: <span>le systema normal</span>',
	'chat-failover-reason' => 'Pro cambiar de systema, specifica un motivo e preme le button',
	'chat-failover-switchmode-failover' => 'Pro cambiar al systema normal',
	'chat-failover-switchmode-regular' => 'Pro cambiar al systema de reserva',
	'chat-failover-mode-areyousure' => 'Comprende tu le consequentias de iste operation?',
	'chat-failover-reason-empty' => 'Le motivo non pote esser vacue',
	'chat-failover-log-entry' => "$1 Systema de chat cambiate per le usator [[User:$2]] a $3. '''Motivo''': $4",
...
Ако разговорите веќе работат во вонреден режим, но самиот програм не работи: НЕ го враќајте во редовен режим без да се консултирате со техничко лице',
	'chat-failover-server-list' => 'Опслужувачи во употреба:',
	'chat-failover-operating-failover' => 'Разговорите сега работат во: <span>вонреден режим</span>',
	'chat-failover-operating-regular' => 'Разговорите сега работат во: <span>редовен режим</span>',
	'chat-failover-reason' => 'За да го префрлите режимот, внесете причина и стиснете на копчето',
	'chat-failover-switchmode-failover' => 'За да го префрлите системот на редовен режим',
	'chat-failover-switchmode-regular' => 'За да го префрлите системот на вонреден режим',
	'chat-failover-mode-areyousure' => 'Дали ги разбирате последиците од овие постапки ???',
	'chat-failover-reason-empty' => 'Мора да наведете причина',
	'chat-failover-log-entry' => "Режимот на работа на разговорот $1 е сменет на $3 од страна на корисникот [[User:$2]]. '''Причина''': $4",
...
<br /><br />Jika anda bukan seorang jurutera, sila minta nasihat sebelum melakukan operasi ini.<br /><br />
	...
	'chat-failover-server-list' => 'Pelayan sembang yang sedang digunakan:',
	'chat-failover-operating-failover' => 'Ruang sembang sedang beroperasi dalam <span>ragam kecemasan</span>',
	'chat-failover-operating-regular' => 'Ruang sembang sedang beroperasi dalam <span>ragam biasa</span>',
	'chat-failover-reason' => 'Untuk bertukar ragam, nyatakan sebab dan tekan butang',
	'chat-failover-switchmode-failover' => 'Tukar ke ragam biasa',
	'chat-failover-switchmode-regular' => 'Tukar ke ragam kecemasan',
	'chat-failover-mode-areyousure' => 'Adakah anda memahami akibat daripada operasi ini ???',
	'chat-failover-reason-empty' => 'Sebab jangan dibiarkan kosong',
	'chat-failover-log-entry' => "Ragam operasi Ruang Sembang $1 ditukar oleh [[User:$2]] kepada $3. '''Sebab''': $4",
...
$messages['nl'] = array(
	...
	'chat-welcome-message' => 'Welkom bij de $1 chat',
	...
	'chat-kick-you-need-permission' => 'U bent niet gemachtigd om een gebruiker te verbannen.',
	'chat-kick-cant-kick-moderator' => 'Je kan een andere Chat Moderator niet verbannen.',
	'chat-user-was-kicked' => '$1 is verbannen door  $2.',
	'chat-you-were-kicked' => 'U bent uit de chat gezet door $1.',
	'chat-user-was-banned' => '$1 is verbannen door  $2 $3.',
	'chat-you-were-banned' => 'Je bent verbannen door  $1.',
	'chat-ban-cannt-undo' => 'Verbod is al ongedaan gemaakt',
	...
	'chat-log-reason-banadd' => 'Misdragen in chat',
	...
	'chat-ban-modal-change-ban-heading' => 'Verander de chat blokkade van deze gebruiker',
...
Neem alstublieft contact op met deze gebruiker voor meer informatie.',
	...
	'chat-chatconnect-log-entry' => 'verbonden met  $1 van adres $2',
	'chat-checkuser-join-action' => 'Verbonden Chat',
);
...
$messages['pl'] = array(
	...
	'chatfailover' => 'Panel sterowania trybem awaryjnym czatu',
	'chat-failover-warning-title' => 'Przeczytaj uważnie!',
	'chat-failover-warning' => 'Ta strona specjalna umożliwia przełączenie czatu na tryb awaryjny.
<br /><br />Jeśli nie jesteś inżynierem, ta operacja wymaga konsultacji.<br /><br />
Jeśli czat jest już w trybie awaryjnym i nadal nie działa: NIE włączaj go z powrotem do normalnego trybu bez konsultacji z inżynierem',
	'chat-failover-server-list' => 'Serwery czatu w użyciu:',
	'chat-failover-operating-failover' => 'Czat działa teraz w: <span>trybie awaryjnym</span>',
	'chat-failover-operating-regular' => 'Czat działa teraz w: <span>trybie normalnym</span>',
	'chat-failover-reason' => 'Aby zmienić tryb, podaj przyczynę i naciśnij przycisk',
	'chat-failover-switchmode-failover' => 'Aby zmienić na tryb normalny',
	'chat-failover-switchmode-regular' => 'Aby zmienić na tryb awaryjny',
	'chat-failover-mode-areyousure' => 'Czy rozumiesz konsekwencje tej operacji?',
	'chat-failover-reason-empty' => 'Pole powodu nie może być puste',
	'chat-failover-log-entry' => "Tryb czatu $1 zmieniono przez [[User:$2|$2]] na $3. '''Powód''': $4",
...
Если чат уже работает в отказоустойчивом режиме и чат не работает: НЕ включайте его обратно в обычный режим без консультаций с инженером',
	'chat-failover-server-list' => 'Серверы чата в эксплуатации:',
	'chat-failover-operating-failover' => 'В настоящее время чат функционирует: <span>отказоустойчивый режим</span>',
	'chat-failover-operating-regular' => 'В настоящее время чат функционирует: <span>обычный режим</span>',
	'chat-failover-reason' => 'Для переключения режима введите причину и нажмите кнопку',
	'chat-failover-switchmode-failover' => 'Переключиться в обычный режим',
	'chat-failover-switchmode-regular' => 'Переключиться в режим отказоустойчивости',
	'chat-failover-mode-areyousure' => 'Вы понимает последствия этой операции???',
	'chat-failover-reason-empty' => 'Нельзя не указывать причину',
	'chat-failover-log-entry' => "Режим работы $1 Чат изменён участником [[User:$2]] на $3. '''Причина''': $4",
...
Nếu tán gẫu đã được cài đặt trong chế độ chuyển đổi dự phòng và các ứng dụng tán gẫu không hoạt động: KHÔNG được chuyển nó về chế độ thông thường mà không có ý kiến của một kỹ sư lập trình',
	'chat-failover-server-list' => 'Máy chủ tán gẫu đang sử dụng:',
	'chat-failover-operating-failover' => 'Tán gẫu được cài đặt lúc này tại: <span>chế độ chuyển đổi dự phòng</span>',
	'chat-failover-operating-regular' => 'Tán gẫu được cài đặt lúc này tại: <span>chế độ thông thường</span>',
	'chat-failover-reason' => 'Để đổi chế độ, nhập một lý do và nhấn nút',
	'chat-failover-switchmode-failover' => 'Để chuyển sang chế độ thông thường',
	'chat-failover-switchmode-regular' => 'Để chuyển sang chế độ chuyển đổi dự phòng',
	'chat-failover-mode-areyousure' => 'Bạn có hiểu rõ những hậu quả của việc cài đặt này ???',
	'chat-failover-reason-empty' => 'Lý do không thể để trống',
	'chat-failover-log-entry' => "$1 Chế độ tán gẫu đã được thay đổi bởi [[User:$2|Thành viên:$2]] sang $3. '''Lý do''': $4",
