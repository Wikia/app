...
<br /><br />If you're not an engineer, performing this operation requires consultation.<br /><br />
		If chat is operating allready in failover mode and the chat app is not working: DO NOT switch it back to regular mode without consultating an operations engineer",
...
$messages['qqq'] = array(
		...
		'chat-user-was-banned' => 'The user was banned from chat; $1 is the banned user; $2 is the banning user; $3 is the chat-ban-undolink message formatted as an HTML link.',
		'chat-you-were-banned'  => 'sent to a user when he was banned; $1 is the baning chat moderator',
		'chat-user-was-unbanned' => 'says that a moderator has removed a ban for a user; $1 is the unbanned user; $2 is the moderator removing the ban.',
