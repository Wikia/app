<h1><?php echo wfMsg('plb-widget-name-plb_sinput'); ?></h1>
...
<div class="label"><?php echo wfMsg('plb-property-editor-choices'); ?>
<span class="helpicon"><span class="helpicon-text"><?php echo wfMsg('plb-property-editor-help-choices'); ?></span></span>
</div>
<div class="input"><textarea name="x-options"></textarea></div>
