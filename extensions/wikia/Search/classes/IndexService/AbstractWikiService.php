...
abstract class AbstractWikiService extends AbstractService {
	/**
	 * Allows us to reuse an atomic update for multiple documents on the backend, if it applies to a wiki and not a
	 * page.
	 */
	...
	public function getStubbedWikiResponse() {
		...
		return [ 'contents' => $response, 'wid' => $this->getService()->getWikiId() ];
	}
