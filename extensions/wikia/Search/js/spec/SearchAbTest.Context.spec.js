...
describe('SearchAbTest.Context', function() {
	...
	it("returns a dummy if 'Wikia' is not loaded", function() {
		var windowMock = { };
		var groupProvider = require('SearchAbTest.Context')( windowMock, logMock, getQueryStringMock() );
	...
	it("does not fail when there are no parameters", function() {
		...
		var windowContext = require('SearchAbTest.Context')( windowMock, logMock, getQueryStringMock({}) );
	...
	it("returns query string parameters", function() {
		...
		var windowContext = require('SearchAbTest.Context')( windowMock, logMock, getQueryStringMock({ a: 'x', b: '1'}) );
		expect(typeof windowContext).toBe('object');
	...
	it("does not break if query string has some unset values", function() {
		...
		var windowContext = require('SearchAbTest.Context')( windowMock, logMock, getQueryStringMock({ 'a': undefined, b: '1' }) );
		expect(typeof windowContext).toBe('object');
	...
	it("returns correctly A/B testing parameters", function() {
		...
		var windowContext = require('SearchAbTest.Context')( windowMock, logMock, getQueryStringMock({ 'search': 'asd', 'x': undefined, 'AbTest.SEARCH_DESIGN_1': 'NEW_DESIGN', ab: '105' }) );
		expect(typeof windowContext).toBe('object');
