<?php
	...
	$imageFileName = PromoImage::oldVersionFixup($result['image_s'], $result['id']);
	$xwikiImage = PromoImage::getImage($imageFileName);

	if (! empty( $xwikiImage ) ) {
		$imageURL = $xwikiImage->getCroppedThumbnailUrl(
