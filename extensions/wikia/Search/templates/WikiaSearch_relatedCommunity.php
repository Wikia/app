<div class="exact-wiki-match">
	...
	<div class="exact-wiki-match__result">
		<a href="<?= Sanitizer::encodeAttribute( $url ) ?>" title="<?= Sanitizer::encodeAttribute( $name ) ?>"
		   data-event="image">
			<img src="<?= Sanitizer::encodeAttribute( $imageURL ) ?>" alt="<?= Sanitizer::encodeAttribute( $name ) ?>"
				 class="exact-wiki-match__image" />
		</a>
		<div class="exact-wiki-match__content">
			<h1 class="exact-wiki-match__wiki-header">
				<a href="<?= Sanitizer::encodeAttribute( $url ) ?>" data-event="title"><?= Sanitizer::encodeAttribute
					( $name ) ?></a>
			</h1>
