...
// TODO: Make sure that all subpages (EXCEPT checkKey!) redirect to Api wiki if they're on another wiki (needed for that right-rail template to work & still be community editable - including the images on it).
	...
	public function subpage_keyStats( $apiKey ){
		...
		$lineName = "DAILY NAME"; // TODO: i18n
		$chartName = "DAILY CHART NAME"; // TODO: i18n
		$html .= $this->getChartHtmlByPeriod( $apiKey, "daily", $lineName, $chartName );

		$lineName = "HOURLY NAME"; // TODO: i18n
		$chartName = "HOURLY CHART NAME"; // TODO: i18n
		$html .= $this->getChartHtmlByPeriod( $apiKey, "hourly", $lineName, $chartName );
	 ...
	 */
	public function getChartHtmlByPeriod( $apiKey, $period, $lineName, $chartName ){
		wfProfileIn( __METHOD__ );
...
// TODO: Figure out whether to wrap in a DATE() sometimes or if that will be handled all in OutputChart.
		...
		$html = SpecialApiGate::getChartHtmlByQuery( $queryString, $frequency, $uniqueMemCacheKey, $lineName, $chartName );
	 ...
	 * @param chartName - string - the name of the whole chart.
	 */
	public static function getChartHtmlByQuery( $queryString, $frequency, $uniqueMemCacheKey, $lineName, $chartName ){
		wfProfileIn( __METHOD__ );
