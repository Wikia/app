...
class EditorUserPropertiesHandler extends WikiaUserPropertiesHandlerBase {
	...
	public function dismissEditorMainPageNotice($params = null) {
		...
		if ($this->wg->ReadOnly) {
			...
			$this->wg->User->setLocalPreference(self::MAIN_PAGE_NOTIFICATIONS_HIDDEN_PROP_NAME, true, $this->app->wg->CityId);
	...
	public function getEditorMainPageNoticePropertyForCurrentUser() {
		return $this->wg->User->getLocalPreference(self::MAIN_PAGE_NOTIFICATIONS_HIDDEN_PROP_NAME, $this->app->wg->CityId);
	}
