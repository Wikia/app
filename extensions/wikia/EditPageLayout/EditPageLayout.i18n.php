...
$messages['en'] = array(
	...
	'semiprotectedpagewarning-notice' => "'''Note:''' This page has been locked so that only registered users can edit it. Please log in to edit. [More info]",
...
$messages['de'] = array(
	...
	'protectedpagewarning-notice' => "'''Hinweis:''' Diese Seite wurde gesperrt, sodass nur Benutzer mit bestimmten Rechten diese bearbeiten können. [Mehr Informationen]",
...
$messages['gl'] = array(
	...
	'protectedpagewarning-notice' => "'''Atención:''' Esta páxina foi bloqueada de xeito que só algúns usuarios con certos privilexios a poidan editar. [Máis información]",
...
$messages['ia'] = array(
	...
	'protectedpagewarning-notice' => "'''Attention:''' Iste pagina ha essite protegite de sorta que solmente usatores con certe privilegios pote modificar lo. [Plus info]",
...
$messages['ru'] = array(
	...
	'protectedpagewarning-notice' => "'''Внимание!''' Эта страница была защищена от редактирования. Только участники с определёнными могут править её. [Подробнее]",
...
$messages['sv'] = array(
	...
	'protectedpagewarning-notice' => "'''Varning:''' Denna sida har låsts så att bara användare med vissa rättigheter kan redigera den. [Mer info]",
...
$messages['vi'] = array(
	...
	'rev-deleted-text-notice' => "Phiên bản này của trang đã được '\"xóa'''. [Thông tin chi tiết]",
	'readonlywarning-notice' => "'''Cảnh báo: Cơ sở dữ liệu đã bị khóa để bảo trì.''' [Thông tin chi tiết]",
	'semiprotectedpagewarning-notice' => "'''Lưu ý:''' Trang này đã bị khóa và chỉ thành viên đăng nhập mới có thể sửa đổi. [Thông tin chi tiết]",
	'protectedpagewarning-notice' => "'''Cảnh báo:''' Trang này đã bị khóa và chỉ có thành viên với đặc quyền nhất định mới có thể sửa đổi. [Thông tin chi tiết]",
	'titleprotectedwarning-notice' => "'''Cảnh báo:''' Trang này đã bị khóa và chỉ có một số thành viên mới có thể tạo ra nó. [Thông tin chi tiết]",
