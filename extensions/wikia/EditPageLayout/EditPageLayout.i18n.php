...
$messages['zh-hans'] = array(
	...
	'editpagelayout-desc' => '应用更新的编辑页面布局',
...
$messages['zh-hant'] = array(
	...
	'editpagelayout-desc' => '應用更新的編輯頁面版式',
	'editpagelayout-more' => '更多',
	'editpagelayout-less' => '較少',
	'editpagelayout-helpLink-url' => 'Help:如何編輯頁面',
	'editpagelayout-helpLink' => '[[Help:Editing|需要幫忙編輯？]]',
	...
	'wikia-editor-edittools-caption' => '更多',
	'wikia-editor-edittools-dialog-title' => 'Wikitext的快捷方式',
	'nonunicodebrowser-notice' => "'''警告：您的瀏覽器不相容Unicode。 '''",
	'rev-deleted-text-notice' => "警告：本頁面修訂已被'''刪除'''。 [詳細內容]",
	'readonlywarning-notice' => "'''警告：資料庫已被鎖定以進行維護。'''一旦完成，編輯將會恢復。[更多資訊]",
	'anoneditwarning-notice' => '',
	'longpagewarning-notice' => '',
	'userinvalidcssjstitle-notice' => "'''警告：'''皮膚\"\$1\"不存在。 [更多訊息]",
	'semiprotectedpagewarning-notice' => "'''注：''' 本頁面已被鎖定，僅註冊使用者可以編輯。您可能需要登入以進行編輯。 [詳細內容]",
	'protectedpagewarning-notice' => "'''注：''' 本頁面已被鎖定，只有管理員可以編輯。本地管理員可以更改此狀態。 [詳細內容]",
	'titleprotectedwarning-notice' => "'''注：''' 本頁面已被鎖定，只有特定使用者（管理員、註冊使用者）可以創建。[詳細內容]",
	'recreate-moveddeleted-warn-notice' => "'''注：'''您正在重新創建一個已刪除的頁面。[詳細內容]",
	'restore-edits-notice' => "歡迎回來！ 我們保存了一些您尚未發佈的更改。<a class='notice-action restoreeditlink'>刪除我的更改，開始新的編輯</a>",
	'restore-edits-diff-notice' => "歡迎回來！ 我們已經保存了一些你還沒有發佈的內容。但是，頁面已經被更改。你希望：<a class='notice-action restoreeditlink'>刪除更改回到之前的文本</a>還是<a class='notice-action difflink'>查看新舊頁面的內容對比</a>",
	'explainconflict-notice' => "'''警告!''' 其他使用者在您開始編輯後已對此頁做出了改動！ [詳細訊息]",
	'wikia-editor-add-file-notice' => '$1已經添加。在頁面上拖放$1或懸停在縮略圖上點擊"修改"查看更多選項。',
	'wikia-editor-add-file-notice-no-wysiwyg' => '$1已添加。',
	'prefs-general' => '常規',
	'prefs-monobook-layout' => '只有MonoBook佈局',
	'prefs-editarea-size' => '編輯視窗的大小（僅MonoBook佈局）',
	'tog-forceeditsummary' => '在我未填寫編輯摘要時提示我',
	...
	'editpagelayout-preview-dropdown-item-desktopxl' => '大銀幕桌面電腦',
);
