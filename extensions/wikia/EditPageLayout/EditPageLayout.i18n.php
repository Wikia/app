...
$messages['ru'] = array(
	...
	'titleprotectedwarning-notice' => "'''Примечание!''' Эта страница была защищена таким образом, что администраторы могут создать её. Местные администраторы могут изменить статус этой страницы. [Подробнее]", # Fuzzy
