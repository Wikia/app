...
class UploadAvatar extends UnlistedSpecialPage {
  ...
  function initAvatar(&$request){
	...
	/**
	 * create thumbnail from orignal file
	 */
	function createThumbnail($imageSrc, $ext,$imgDest,$thumbWidth){
		global $wgEnableUploadInfoExt, $wgTitle;
		...
		switch( $TypeCode ) {
			case 1:
				$target = $this->avatarUploadDirectory . "/" . $imgDest . ".gif";
				exec( "convert -size " .
					$thumbWidth . "x" . $thumbWidth . " -resize " .
					$thumbWidth . " -crop " . $thumbWidth . "x" . $thumbWidth .
					"+0+0 " . $imageSrc . " " . $border . " " . $target
				);
				break;
			case 2:
				$target = $this->avatarUploadDirectory . "/" . $imgDest . ".jpg";
				exec( "convert -size " .
					$thumbWidth . "x" . $thumbWidth . " -resize " .
					$thumbWidth . " -crop " . $thumbWidth . "x" . $thumbWidth .
					"+0+0   -quality 100 " . $border . " " . $imageSrc . " " .
					$target
				);
				break;
			case 3:
				$target = $this->avatarUploadDirectory . "/" . $imgDest . ".png";
				exec( "convert -size " .
					$thumbWidth . "x" . $thumbWidth . " -resize " .
					$thumbWidth . " -crop " . $thumbWidth . "x" . $thumbWidth .
					"+0+0 " . $imageSrc . " " . $target
