...
CKEDITOR.plugins.add('rte-media', {
	...
	setupPlaceholder: function (placeholder) {
		...
		images.attr('title', ('rte-ck-imagePlaceholder-tooltip'));//RTE.getInstance().lang.imagePlaceholder.tooltip);
		...
		videos.attr('title', ('rte-ck-imagePlaceholder-tooltip'))//RTE.getInstance().lang.videoPlaceholder.tooltip);
