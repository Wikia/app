...
<label for="wpReadHelp"><?= wfMessage( 'specialcontact-label-forget-account-read-help' )->parse() ?></label>
</p>

<p>
<input type="checkbox" name="wpConfirm" required />
<label for="wpConfirm"><?= wfMessage( 'specialcontact-label-forget-account-confirm' )->escaped() ?></label>
</p>
