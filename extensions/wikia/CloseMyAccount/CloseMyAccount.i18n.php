...
Si necesitas más información de lo que una cuenta cerrada realmente hace, puedes visitar nuestra página de [[Ayuda:Cerrar_mi_cuenta|ayuda sobre como cerrar una cuenta]]. Si estás seguro de querer cerrar tu cuenta, por favor haz clic en el botón de abajo.
...
Ten en cuenta que tendrás $1 {{PLURAL:$1|día|días}} después de hacer el pedido para reactivar tu cuenta ingresando y siguiendo las instrucciones. Después del periodo de espera, tu cuenta será cerrada permanentemente y no podrá ser restaurada.',
	...
	'closemyaccount-confirm' => '{{GENDER:$1|Yo}} he leído la página de [[Ayuda:Cerrar_mi_cuenta|ayuda sobre como cerrar mi cuenta]] y confirmo que deseo desactivar mi cuenta de Wikia.',
...
Se ti servono più informazioni su cosa la disabilitazione dell'account comporta, puoi leggere [[w:it:Aiuto:Chiudere un account|questa pagina d'aiuto]]. Se sei sicuro di voler chiudere il tuo account, clicca il pulsante qui sotto per favore.
...
$messages['pt'] = array(
	...
	'closemyaccount-intro-text' => 'Lamentamos que {{GENDER:$2|você}} queira desativar sua conta. O Fandom tem muitas comunidades sobre todos os tipos de assuntos e nós gostaríamos que você ficasse por aqui para encontrar o que é certo para você. Se você estiver tendo um problema local com sua wiki, não hesite em contatar seu [[Special: ListUsers/sysop|administrador local]] para ajuda e conselhos.

Se você decidiu definitivamente desativar sua conta, por favor, esteja ciente: 
* O Fandom não tem a capacidade de remover completamente as contas, mas pode desativá-las. Isto garantirá que a conta está bloqueada e não pode ser usada.
 * Este processo NÃO é reversível após $1 {{PLURAL:$1|dia|dias}, e você terá que criar uma nova conta se quiser se juntar ao Fandom.
...
Por favor, note que você terá $1 {{PLURAL:$1|dia|dias}} depois de fazer este pedido para reativar sua conta registrando e seguindo as instruções. Após este período, sua conta será permanentemente fechada e não pode ser restaurada.',
	...
	'closemyaccount-confirm' => '{{GENDER:$1|Eu}} li a [[Ajuda:Fechando_uma_conta|página sobre o encerramento de conta]] e confirmo que desejo desativar minha conta Wikia.',
