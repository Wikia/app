...
* FANDOM не имеет технической возможности полностью удалить учётную запись, но может её отключить. В этом случае ваш аккаунт будет заблокирован и вы больше не сможете его использовать.
...
Обратите внимание, что после отправки этого запроса у вас будет $1 {{PLURAL:$1|день|дня|дней}}, чтобы вернуться и восстановить учётную запись. Для этого войдите в свою учётную запись и следуйте инструкциям по остановке процесса отключения аккаунта. По истечении периода ожидания учётная запись будет закрыта окончательно и не сможет быть восстановлена.',
	...
	'closemyaccount-confirm' => 'Я прочитал(а) [[w:c:ru.community:Справка:Отключение учётной записи|справочную статью об отключении учётной записи]] и подтверждаю, что хочу отключить свой аккаунт на сайте FANDOM.',
...
Вы хотите восстановить свою учётную запись?',
	...
	'closemyaccount-reactivate-error-email' => 'Вы не указали действительный адрес электронной почты для отключённой учётной записи, поэтому она не может быть восстановлена. Пожалуйста, [[Special:Contact|свяжитесь с сотрудниками FANDOM]], если у вас есть вопросы.',
	...
	'closemyaccount-reactivate-error-disabled' => 'Эта учётная запись была отключена. Если у вас есть вопросы, [[Special:Contact|свяжитесь с сотрудниками FANDOM]].',
	'closemyaccount-reactivate-error-failed' => 'Произошла ошибка при попытке восстановить эту учётную запись. Пожалуйста, попробуйте ещё раз. Если проблема не исчезла, [[Special:Contact|свяжитесь с сотрудниками FANDOM]].',
...
Обратите внимание, что у вас будет $1 {{PLURAL:$1|день|дня|дней}}, чтобы восстановить аккаунт. Для этого [[Special:UserLogin|войдите в свою учётную запись]] и следуйте инструкциям. По прошествии указанного времени ваш аккаунт будет окончательно отключён, и его будет невозможно восстановить.',
	'closemyaccount-scheduled-failed' => 'Произошла ошибка при отключении учётной записи. Пожалуйста, попробуйте [[Special:CloseMyAccount|отключить аккаунт ещё раз]]. Если проблема повторяется, [[Special:Contact|свяжитесь с сотрудниками FANDOM]].',
