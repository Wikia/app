...
<tr class="exp<?= empty( $showDetails ) ? ' collapsed' : '' ?>" data-id="<?= $experiment[ 'id' ] ?>">
    ...
    <td><?= $experiment[ 'id' ] ?></td>
    <td class="<?= $experiment[ 'is_running' ] ? 'running' : 'not-running'; ?>"><?= htmlspecialchars( $experiment[ 'name' ] ) ?></td>
			...
			<tbody>
				<? foreach( $experiment[ 'versions' ] as $ver ): ?>
					<tr class="ver" data-id="<?= $ver[ 'id' ] ?>">
			            <td class="<?= $ver[ 'is_running' ] ? 'running' : 'not-running'; ?>"><?= htmlspecialchars( $ver[ 'start_time' ] ) ?></td>
			            <td class="<?= $ver[ 'is_running' ] ? 'running' : 'not-running'; ?>"><?= htmlspecialchars( $ver[ 'end_time' ] ) ?></td>
