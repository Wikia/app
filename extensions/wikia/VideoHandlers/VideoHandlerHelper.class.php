...
class VideoHandlerHelper extends WikiaModel {
	...
	public function addCategoryVideos( $title, $user, $flags = EDIT_NEW ) {
		...
		if ( $title instanceof Title && !$title->exists() ) {
			...
			$status = $article->doEdit( $content, wfMessage('videohandler-rc-add-video')->inContentLanguage()->plain(), $flags, false, $user );
		}
	...
	public function setVideoDescription( $title, $description ) {
		...
		$summary = wfMessage('videohandler-rc-add-description')->inContentLanguage()->plain();
