...
Create blog listing pages for categories such as "Barrack Obama", "Fan Fiction", or even combine multiple categories.',
	...
	"blog-avatar-goto-userpage" => "Go to $1 user page",
	...
	"blog-avatar-remove-info" => "Remove user's avatar. Please put correct username in text box below, and press button ",
	"blog-avatar-getuser" => "Search user",
