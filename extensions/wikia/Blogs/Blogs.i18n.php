...
$messages['en'] = array(
	...
	'create-blog-login-required' => 'You must be <span class="plainlinks">[{{fullurl:Special:UserLogin|returnto=$1}} logged in]</span> to create blog post or listing.',
...
Blogiartikkeleita voidaan luokitella listasivuille blogiartikkelin tunnisteiden mukaan. Voit sallia arvostelun ja kommentoinnin blogiartikkeli kohtaisesti.",
	...
	'create-blog-login-required' => 'Sinun täytyy <span class="plainlinks">[{{fullurl:Special:UserLogin|returnto=$1}} kirjautua sisän]</span> kirjoittaaksesi blogiartikkeleita tai listataksesi niitä.',
...
$messages['de'] = array(
	...
	'create-blog-login-required' => 'Du musst <span class="plainlinks">[{{fullurl:Special:UserLogin|returnto=$1}} angemeldet sein]</span> um einen Blog-Beitrag zu verfassen.',
...
Las entradas de blog pueden ser agregadas a una página con una lista de blogs basada en las etiquetas de las entradas. Puedes elegir si quieres permitir que se vote o se comente tu entrada.',
	...
	'create-blog-login-required' => 'Debes estar <span class="plainlinks">[{{fullurl:Special:UserLogin|returnto=$1}} identificado/a]</span> para crear una entrada o una lista de blogs.',
...
$messages['ja'] = array(
	...
	'create-blog-login-required' => 'ブログの記事やリストを作成するには<span class="plainlinks">[{{fullurl:Special:UserLogin|returnto=$1}} ログイン]</span>する必要があります。',
