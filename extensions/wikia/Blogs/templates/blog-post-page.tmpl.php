...
<? if (!empty($isCommenting)) { ?><li class="blog-comment"><img src="<?=$wgStylePath?>/common/blank.gif" border="0" class="sprite talk" /> <?=$skin->makeLinkObj($commentTitle, wfMsg('blog-nbrcomments', intval($aRow['comments'])))?></li><? } ?>
