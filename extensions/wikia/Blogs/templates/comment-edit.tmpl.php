...
<? if (!$isReadOnly) { ?>
			<a href="<?php echo $title->getFullURL() ?>" name="wpBlogSubmit" id="blog-comm-submit-<?=$title->getArticleId()?>" class="bigButton"><big><? echo wfMsg("blog-comment-post") ?></big><small></small></a>
<? } ?>
