...
<div class="wk_blogs_panel" style="<?=(isset($aOptions['style']))?$aOptions['style']:''?>">
	<div class="wk_blogs_title color1">
		<div><?= ( !empty($aOptions['title']) ) ? $aOptions['title'] : "" ?></div>
		<div class="wk_blogs_title_refresh"><?=$skin->makeLinkObj($wgTitle, "<img src=\"".wfBlankImgUrl()."\" border=\"0\" class=\"sprite refresh\" />", "action=purge")?></div>
	</div>
