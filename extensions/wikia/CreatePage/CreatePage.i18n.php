...
Please select different name.',
	...
	'createpage-dialog-title' => 'Add New Page',
	'createpage-dialog-message2' => 'Write your page title here:',
	'createpage-dialog-message3' => 'We currently have {{NUMBEROFARTICLES}} {{PLURAL:$1|page|pages}} on {{SITENAME}}. We need to check if the name is available.',
...
Bitte wähle einen anderen Namen.',
	...
	'createpage-error-empty-title' => 'Deine Seite braucht einen Titel. Du kannst ihn später ändern, indem du unter der Schaltfläche „Bearbeiten“ auf „Verschieben“ klickst.',
...
Seleziona un nome diverso.',
	...
	'createpage-dialog-message3' => 'Al momento disponiamo di {{NUMBEROFARTICLES}} pagine su {{SITENAME}}. Dobbiamo verificare se il nome sia disponibile.',
...
$messages['ja'] = array(
	...
	'createpage_empty_title_error' => '新規ページのタイトルを指定してください。',
...
ここに2番目の節を書く。',
	...
	'createpage-dialog-redlinks-list-header' => 'または下記のタイトルのいずれかをクリックし、書き込みを開始してください！',
);
...
Je hebt een nieuwe pagina aangemaakt!',
	...
	'createpage-dialog-message3' => 'We currently have {{NUMBEROFARTICLES}} pages on {{SITENAME}}. We need to check if the name is available.',
...
Wybierz inną nazwę.',
	...
	'createpage-dialog-message3' => 'Mamy obecnie {{NUMBEROFARTICLES}} {{PLURAL:$1|stronę|strony|stron}} na {{SITENAME}}. Musimy sprawdzić czy nazwa jest dostępna.',
...
Escreva a segunda seção do seu artigo aqui.',
	...
	'createpage-button-cancel' => 'Cancelar',
	'createpage-dialog-redlinks-list-header' => 'Ou clique em um dos títulos abaixo e começar a escrever!',
...
請選擇不同的名稱。',
	...
	'createpage-dialog-message3' => '目前在{{SITENAME}} 上有{{NUMBEROFARTICLES}} 個頁面。我們需要檢查這個名稱是否可使用。',
