...
class WikiaInYourLangControllerTest extends WikiaBaseTest {
	...
	public function getDomainsList() {
		return [
			...
			['http://sandbox-mercury.naruto.wikia.com', 'naruto.wikia.com'],
			['http://sandbox-mercury.zh.naruto.wikia.com', 'naruto.wikia.com'],
			['http://sandbox-mercury.pt-br.naruto.wikia.com', 'naruto.wikia.com'],
			['http://sandbox-xw2.naruto.wikia.com', 'naruto.wikia.com'],
			['http://sandbox-xw2.zh.naruto.wikia.com', 'naruto.wikia.com'],
			['http://sandbox-xw2.pt-br.naruto.wikia.com', 'naruto.wikia.com'],
