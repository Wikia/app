...
<div id="userloginErrorBox">
		...
		<img alt="status" class="sprite error" src="<?= $wgStylePath ?>/common/blank.gif"/>
	...
	<table width="100%">
		...
		<tr>
			<td class="mw-input" id="wpNameTD">
				<label for='wpName2'><?php $this->msg('yourname') ?></label> <img alt="status" src="<?= $wgStylePath ?>/common/blank.gif"/><br/>
		...
		<tr>
			...
			<td class="mw-input" id="wpEmailTD">
				<label for='wpEmail'><?php $this->msg('signup-mail') ?></label><a id="wpEmailInfo" href="#"><?php $this->msg( 'signup-moreinfo' ) ?></a> <img alt="status" src="<?= $wgStylePath ?>/common/blank.gif"/><br/>
		...
		<tr>
			<td class="mw-input" id="wpPasswordTD">
				<label for='wpPassword2'><?php $this->msg('yourpassword') ?></label> <img alt="status" src="<?= $wgStylePath ?>/common/blank.gif"/><br/>
	...
	<?php } ?>
		<tr>
			<td class="mw-input" id="wpRetypeTD">
				<label for='wpRetype'><?php $this->msg('yourpasswordagain') ?></label> <img alt="status" src="<?= $wgStylePath ?>/common/blank.gif"/><br/>
...
<?php endif ?>
		...
		<tr>
			<td class="mw-input" id="wpBirthDateTD">
				<label for='wpBirthYear'><?php $this->msg('yourbirthdate') ?></label><a id="wpBirthDateInfo" href="#"><?php $this->msg( 'signup-moreinfo' ) ?></a> <img alt="status" src="<?= $wgStylePath ?>/common/blank.gif"/><br/>
	...
	<?php if($this->haveData('captcha')) { ?>
		<tr>
			<td>
				<div id="blurryword"><span class="pseudolabel"><?php $this->msg( 'usercaptcha' ) ?></span><a id="wpUserCaptchaInfo" href="#"><?php $this->msg( 'signup-moreinfo' ) ?></a> <img alt="status" src="<?= $wgStylePath ?>/common/blank.gif"/></div>
			</td>
