...
CKEDITOR.plugins.add('rte-media', {
	init: function (editor) {
		...
		editor.ui.addButton('Image', {
			label: editor.lang['rte-media']['image-photo'],
			title: editor.lang['rte-media']['image-add'],
		...
		if (window.wgEnableVideoToolExt) {
			...
			editor.ui.addButton('Video', {
				label: editor.lang['rte-media']['video-video'],
				title: editor.lang['rte-media']['add'],
	...
	setupPlaceholder: function (placeholder) {
		...
		images.attr('title', RTE.getInstance().lang['rte-media']['imagePlaceholder-tooltip']);
		...
		videos.attr('title', RTE.getInstance().lang['rte-media']['videoPlaceholder-tooltip']);
