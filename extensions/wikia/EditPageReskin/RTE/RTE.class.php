...
class RTE {
	...
	public static function makeGlobalVariablesScript(&$vars) {
		...
		$vars['RTELocalPath'] = $wgServer .  $wgScriptPath . '/extensions/wikia/EditPageReskin/RTE';

		$vars['CKEDITOR_BASEPATH'] = $wgServer .  $wgScriptPath . '/extensions/wikia/EditPageReskin/RTE/ckeditor/';
...
HTML
	...
	static function onEditingPreferencesBefore($user, &$preferences) {
		...
		$wgOut->addScript( "<script type=\"{$wgJsMimeType}\" src=\"$wgExtensionsPath/wikia/EditPageReskin/RTE/js/RTE.preferences.js?$wgStyleVersion\"></script>" );
