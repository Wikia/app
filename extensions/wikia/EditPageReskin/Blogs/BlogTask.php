...
class BlogTask extends BatchTask {
	...
	public function execute( $params = null ) {
		...
		if( $city_id ) {
			 ...
			 */
			$cmd = sprintf("SERVER_ID={$city_id} php {$IP}/extensions/wikia/EditPageReskin/Blogs/maintenance.php --conf {$wgWikiaLocalSettingsPath} --aconf {$wgWikiaAdminSettingsPath}");
