...
class LayoutWidgetGallery extends LayoutWidgetImage {
	...
	public static function renderImageForPreview(&$image) {
		global $wgExtensionsPath;
		$image['link'] = "#";
		$image['thumbnail'] = $wgExtensionsPath.'/wikia/EditPageReskin/PageLayoutBuilder/images/picture-placeholder.png';
		return true;
	}
	...
	public function renderForRTE() {
		...
		return
			...
			."<img src=\"$wgExtensionsPath/wikia/EditPageReskin/PageLayoutBuilder/images/picture-placeholder.png\" style=\"width: {$width}px\" alt=\"".htmlspecialchars($caption)."\">"
			.$this->getRTEUIMarkup()
