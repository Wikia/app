...
class LayoutWidgetImage extends LayoutWidgetBase {
	...
	public function renderForResultEmpty($url) {
		...
		$data['editurl'] = $url;
		$data['img'] = "";
		$data['avatar'] = $wgExtensionsPath.'/wikia/EditPageReskin/PageLayoutBuilder/widget/images/user.jpg';
	...
	public function renderForPreview() {
		...
		$data['isform'] = false;
		$data['isempty'] = false;
		$data['img'] = $wgExtensionsPath.'/wikia/EditPageReskin/PageLayoutBuilder/images/picture-placeholder.png';
		$data['avatar'] = $wgExtensionsPath.'/wikia/EditPageReskin/PageLayoutBuilder/widget/images/user.jpg';
		$data['caption'] = $this->getAttrVal( 'caption');
		$data['width'] = $this->getAttrVal( 'size', true );
		$data['divwidth'] =  $data['width'] + 4;
