...
class SpecialPageLayoutBuilder extends SpecialCustomEditPage {
	...
	public function renderHeader($par) {
		$this->out->addScriptFile( $this->app->getGlobal('wgExtensionsPath') . "/wikia/EditPageReskin/PageLayoutBuilder/js/editor.js" );
		$this->out->addScriptFile( $this->app->getGlobal('wgScript') . "?action=ajax&rs=PageLayoutBuilderEditor::getPLBEditorData&uselang=" . $this->app->getGlobal('wgLang')->getCode()
			. "&cb=" . time() );
		$this->out->addScriptFile( $this->app->getGlobal('wgExtensionsPath')  . "/wikia/EditPageReskin/PageLayoutBuilder/widget/allWidgets.js" );
	...
	public function execute( $par ) {
		...
		$this->out->addStyle( AssetsManager::getInstance()->getSassCommonURL('extensions/wikia/EditPageReskin/PageLayoutBuilder/css/editor.scss'));
	...
	function executeLayoutCopy($request) {
		...
		$wgOut->addScriptFile($wgExtensionsPath."/wikia/EditPageReskin/PageLayoutBuilder/js/copy.js");
