...
<div id="AjaxLoginBox" title="<?= wfMsg('login') ?>">
	...
	<div id="AjaxLoginButtons" title="<?= wfMsg('login') ?>">
			<a id="wpGoLogina" class="wikia_button ajaxregister_button" href="#" onclick="AjaxLogin.showLogin(this);" >
				<span><?= wfMsg("login") ?></span>
			</a>
			<a id="wpGoRegister" class="wikia_button ajaxregister_button" href="#" onclick="AjaxLogin.showRegister(this);" >
				<span><?= wfMsg("login") ?></span>
			</a>
	</div>
