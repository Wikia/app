...
$messages["en"] = array(
	...
	"comboajaxlogin-connectmarketing" => "<h1>Connect your accounts</h1><ul><li>Keep your current username, history, edits... Nothing changes except how you log in</li><li>Share your activity on Wikia with your friends on Facebook</li><li>Complete control of what is published</li></ul>",
	"comboajaxlogin-connectmarketing-back" => "&laquo; Back",
	"comboajaxlogin-connectmarketing-forward" => "Get started &raquo;",
	"comboajaxlogin-connectdirections" => "<p>Enter your Wikia username and password here - we will magically connect your Wikia and Facebook accounts in the background.</p><p>Once you are done, you can log in easily using any Facebook Connect button.",
