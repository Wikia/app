...
<div id="AjaxLoginBox" title="<?= wfMsg('login') ?>">
	<form action="" method="post" style="margin:5px; font-size: 0.95em" name="userajaxloginform">
		...
		<label for="wpPassword1" style="display: block; font-weight: bold"><?= wfMsg("yourpassword") ?></label><a id="wpMailmypassword" href="#" onclick="AjaxLogin.action='password'; AjaxLogin.form.submit();" style="margin: 3px;"><?= wfMsg('mailmypassword') ?></a>
