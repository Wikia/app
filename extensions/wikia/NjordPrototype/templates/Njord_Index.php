...
<header>
	<div id="MainPageHero" class="MainPageHero">
			...
			<div class="upload">
				<div class="upload-group">
					<div class="upload-btn">
						...
						<span class="upload-text">add an cover image</span>
					</div>
					<input name="file" type="file" hidden/>
					<span class="upload-desc">or, drop an image here (1600x600px minimum)</span>
				</div>
				<div class="upload-mask"></div>
			</div>
			<div class="overlay">
				<div class="overlay-flex upload">
					<span class="overlay-text">drop an image here</span></div>
			</div>
		</div>
		...
		<h1 class="hero-title"><?= $wikiData->title ?><span class="title-default-text">Wikia name can goes three lines (50 characters max)</span>
			<img class="title-edit-btn" src="/extensions/wikia/NjordPrototype/images/pencil.svg">
		</h1>

<!--		<div class="edit-btn new-btn">edit</div>-->
	</div>
	<div class="hero-description"><?= $wikiData->description ?><span class="desc-default-text">Add a summary that will be used to
