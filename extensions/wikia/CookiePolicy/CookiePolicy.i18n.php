...
$messages['ru'] = array(
	'cookie-policy-description' => 'В Европейском союзе действует закон, согласно которому пользователи при первом посещении веб-сайта должны быть уведомлены об использовании на нём файлов cookies. Это расширение позволяет FANDOM выполнять требование данного закона.',
	'cookie-policy-notification-message' => 'FANDOM использует файлы cookies, чтобы продолжать совершенствоваться и предлагать пользователям самый интересный им контент. Мы полагаем, что продолжая пользоваться сервисами FANDOM, вы соглашаетесь с нашей политикой использования cookies. [[w:c:ru:Конфиденциальность#Cookies|Подробнее о cookies]]',
);
