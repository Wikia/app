...
<?php
			switch($notification['type']) {
				...
				case BannerNotificationsController::NOTIFICATION_NEW_ACHIEVEMENTS_BADGE:
?>
...
<?php
				...
				case BannerNotificationsController::NOTIFICATION_TALK_PAGE_MESSAGE:
				case BannerNotificationsController::NOTIFICATION_EDIT_SIMILAR:
				case BannerNotificationsController::NOTIFICATION_COMMUNITY_MESSAGE:
?>
...
<?php
				...
				case BannerNotificationsController::NOTIFICATION_SITEWIDE:
					$first = 1;
...
<?php
				...
				case BannerNotificationsController::NOTIFICATION_CUSTOM:
?>
