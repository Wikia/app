...
Please ensure the accuracy of your notice before sending it, and please note that Wikia is not in a position to provide legal advice. If you have questions, we recommend that you speak to an attorney.',
	...
	'dmcarequest-request-links-original-label' => 'Link(s) to the original material allegedly being infringed:',
	'dmcarequest-request-upload-label' => 'Need to attach a file of the material? If so, please upload here:',
	'dmcarequest-request-links-wikia-label' => 'Link(s) to the allegedly infringing material on Wikia:',
	...
	'dmcarequest-request-outro' => 'By clicking "Send to Wikia" below, you are sending a completed DMCA takedown notice. If you already have a DMCA takedown notice and do not require the guided form, you may send your notice directly to [mailto:copyright@wikia.com copyright@wikia.com].',
	'dmcarequest-request-success' => 'Thank you for contacting Wikia with your DMCA request. We will review your request and do our best to get back to you in the next 2-3 business days.',
...
$13',
	...
	'dmcarequestmanagement-list-action-taken' => 'Action taken',
...
$messages['qqq'] = [
	...
	'dmcarequestmanagement-list-action-taken' => 'Table header in the list of notices for the action taken on the notice.',
