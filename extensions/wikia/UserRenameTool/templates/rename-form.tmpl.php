...
<form method='post' action='<?= $submitUrl; ?>' id='renameuser'>
	...
	<fieldset>
		...
		<table id='mw-renameuser-table'>
			<tr>
				<td class='mw-label'>
					<label for='old-username'><?= wfMessage( 'userrenametool-old' )->escaped(); ?></label>
				</td>
				<td class='mw-input'>
			...
			<tr>
				<td class='mw-label'>
					<label for='new-username'><?= wfMessage( 'userrenametool-new' )->escaped(); ?></label>
				</td>
				<td class='mw-input'>
			...
			<tr>
				<td class='mw-label'>
					<label for='new-username-repeat'><?= wfMessage( 'userrenametool-new-repeat' )->escaped(); ?></label>
				</td>
				<td class='mw-input'>
			...
			<? if ( $selfRename ): ?>
				<tr>
					<td class='mw-label'>
						<label for="password"><?= wfMessage( 'userrenametool-current-password' )->escaped(); ?></label>
					</td>
					<td class='mw-input'>
			...
			<tr>
				...
				<td class='mw-input'>
					...
					<label for="understand-consequences"><?= wfMessage( 'userrenametool-understand-consequences' )->escaped(); ?></label>
				</td>
			</tr>
			<? if ( $errors ): ?>
				<tr>
					<td class='mw-label'><?= wfMessage( 'userrenametool-errors' )->escaped(); ?></td>
					<td class='mw-input'>
			...
			<tr>
				...
				<td class='mw-submit'>
					<input type="submit" name="submitbutton" tabindex="4" value="<?= wfMessage( 'userrenametool-submit' )->escaped(); ?>"/>
				</td>
			</tr>
		</table>
		<? endif; ?>
