...
Здравствуйте и добро пожаловать на {{SITENAME}}. Я представляю команду поддержки FANDOM. Спасибо за вашу правку на странице «[[:$1]]».
...
Вы также можете следить за [[w:c:ru.community.wikia.com/wiki/Блог:Блоги_сотрудников|блогами сотрудников]], чтобы получать последние новости и быть в курсе происходящего на FANDOM. Также, посмотрите видеоуроки [[w:c:ru.community:Университет FANDOM|Университета FANDOM]], которые помогут вам быстро освоить редактирование.
...
Надеюсь, что вам понравится на {{SITENAME}}.',
	'welcome-message-wall-user-staff' => 'Здравствуйте и добро пожаловать на {{SITENAME}}. Я представляю команду поддержки FANDOM. Спасибо за правку на странице [[:$1]]!
...
Также, посмотрите видеоуроки [[w:c:ru.community:Университет FANDOM|Университета FANDOM]], которые помогут вам быстро освоить редактирование.
...
Надеюсь, что вам понравится на {{SITENAME}}.",
	'welcome-message-wall-anon-staff' => "Здравствуйте и добро пожаловать на {{SITENAME}}. Я представляю команду поддержки FANDOM. Спасибо за вашу правку на странице «[[:$1]]».
...
Вы также можете следить за [[w:c:ru.community:Блог:Блоги_сотрудников|блогами сотрудников]], чтобы получать последние новости и быть в курсе происходящего на FANDOM. И не забывайте о наших учебных видео [[w:c:ru.community:Университет FANDOM|Университета FANDOM]], которые быстро введут вас в курс дела.
