...
* Lien vers la page #2
* Lien vers la page #3',
	'welcome-message-user' => 'Bonjour $4 ! Bienvenue sur {{SITENAME}}.

Nous sommes heureux que vous participez à {{SITENAME}} et que vous ayez modifié la page [[:$1]].

S\'il y a des questions, vous pouvez les poser sur ma page de [[$2|discussion]] !
