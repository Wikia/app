...
class VideoEmbedTool {
	...
	function loadMainFromView( $error = false ) {
		...
		$out .= '<img src="'.$wgStylePath.'/common/blank.gif" id="fe_vetback_img" class="sprite back" alt="'.wfMsg('vet-back').'" />';
		$out .= '<img src="'.$wgStylePath.'/common/blank.gif" id="fe_vetclose_img" class="sprite close" alt="'.wfMsg('vet-close').'" />';
