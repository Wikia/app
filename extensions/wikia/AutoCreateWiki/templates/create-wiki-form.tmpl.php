...
<!-- Create an account -->
	...
	<div class="formblock" style="padding:2px;">
		...
		<li class="data1">
			<a id="AWClogin" class="bigButton ajaxLogin" style="z-index: 10;" href="/index.php?title=Special:UserLogin&returnto=Special:CreateWiki" rel="nofollow"><big><?=wfMsg('login')?></big><small> </small></a>
		</li>
