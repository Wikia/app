...
class SpecialWikiaHubsV2Controller extends WikiaSpecialPageController {
	...
	public function index() {
		...
		foreach ($toolboxModel->getModulesIds() as $moduleId) {
			...
			if( in_array($moduleId, array(MarketingToolboxModuleExploreService::MODULE_ID, MarketingToolboxModulePollsService::MODULE_ID, MarketingToolboxModuleWikiaspicksService::MODULE_ID)) ) {
