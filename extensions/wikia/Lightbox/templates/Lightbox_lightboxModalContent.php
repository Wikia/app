<div class="WikiaLightbox">
    ...
    <div id="LightboxCarousel" class="LightboxCarousel">
        <div id="LightboxCarouselInner" class="LightboxCarouselInner">
            <div class="content">
                <ul class="toolbar">
                    <li><span class="icon pin button secondary" title="<?= wfMsg('lightbox-pin-carousel-tooltip') ?>"
                              data-pinned-title="<?= wfMsg('lightbox-unpin-carousel-tooltip') ?>"
                              data-pin-title="<?= wfMsg('lightbox-pin-carousel-tooltip') ?>"></span></li>
                </ul>
    ...
    <script id="LightboxHeaderTemplate" class="template" type="text/template">
        ...
        <a href="{{fileUrl}}"
           class="wikia-button more-info-button secondary"><?= wfMsg('lightbox-header-more-info-button') ?></a>
    ...
    <script id="LightboxCarouselThumbs" type="text/template">
        ...
        <li data-backfill="{{backfill}}">
            <a class="{{thumbWrapperClass}}">
                {{{playButtonSpan}}}
                <img class="thumb" src="<?= $wg->BlankImgUrl ?>" data-src="{{thumbUrl}}" data-caption="{{caption}}"
                     width="90" height="55">
            </a>
        </li>
        {{/thumbs}}
