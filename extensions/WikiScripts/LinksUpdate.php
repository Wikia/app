<?php
/**
 * Built-in scripting language for MediaWiki: link updating code
 * Copyright (C) 2011 Victor Vasiliev <vasilvv@gmail.com> et al
...
class WSLinksUpdateHooks {
	...
	public static function appendToOutput( &$parser, &$text ) {
		if( isset( $parser->is_interpreter ) ) {
			$parser->mOutput->is_links = $parser->is_interpreter->mUsedModules;
		}
		return true;
	}
