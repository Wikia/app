...
قائمة أسماء المستخدمين السوداء]].
 ...
 */
$messages['arz'] = array(
	'usernameblacklist-desc' => 'بيزود [[MediaWiki:Usernameblacklist| البلاك ليست بتاعة اسامى اليوزرز]] علشان يحدد فتح حسابات لليوزر اللى بتطابق واحد او اكتر من التعابير العادية.',
	'blacklistedusername' => 'اسم اليوزر فى البلاك ليست',
	'blacklistedusernametext' => 'اسم اليوزر اللى اختارته بيطابق [[MediaWiki:Usernameblacklist|لستة اليوزرز اللى فى البلاك ليست]].
لو سمحت تختار اسم تاني.',
	'usernameblacklist' => '<pre>
# المدخلات اللى فى الليستة دى ح تستخدم كجزء من تعبير عادى لما
# منع اليوزرز اللى فى البلاك ليست من التسجيل. كل بند لازم يكون جزء من
# لستة مترقمة, مثلا
#
# * Foo
# * [Bb]ar
</pre>',
	'usernameblacklist-invalid-lines' => 'الـ {{PLURAL:$1|خط دا|خطوط دول}}  اللى فى البلاك ليست بتاعة اليوزر{{PLURAL:$1|مش صح|مش صح}} ; لو سمحت تصلح{{PLURAL:$1|ـه|هم}} قبل الحفظ:',
	'right-uboverride' => 'اتجاوز البلاك ليست بتاعة اسامى اليوزرز',
);
...
$messages['bg'] = array(
	...
	'right-uboverride' => 'Пренебрегване на черния списък за потребителски имена',
);
...
$messages['es'] = array(
	...
	'right-uboverride' => 'Ignorar la lista negra de usuarios',
);
...
# * [Bb]ar
	...
	'right-uboverride' => 'Płaćiwosć čorneje lisćiny wužiwarskich mjenow zběhnyć',
);
...
# * [Bb]jarne
	...
	'right-uboverride' => 'Overkøyra svartelista over brukarnamn',
);
 ...
 */
$messages['stq'] = array(
	'usernameblacklist-desc' => 'Föiget ne [[MediaWiki:Usernameblacklist|Lieste fon nit wonskede Benutsernoomen]] bietou, do der ap Basis fon reguläre Uutdrukke nit moaked wäide konnen',
...
# * [Bb]ar
	...
	'right-uboverride' => 'Buute Kraft sätten fon ju Lieste fon nit wonskede Benutsernoomen',
);
 ...
 */
$messages['uk'] = array(
	'usernameblacklist-desc' => 'Додає [[MediaWiki:Usernameblacklist|чорний список імен користувачів]], щоб заборонити створення облікових записів, які підпадають під вказані регулярні вирази',
	...
	'usernameblacklist' => '<pre>
# Записи у цьому списку вживатимуться як частини регулярних виразів
# для заборони використання деяких імен користувачів при реєстрації.
# Кожний запис має бути частиною маркованого списку, наприклад
#
# * Foo
# * [Bb]ar
</pre>',
	'usernameblacklist-invalid-lines' => '{{PLURAL:$1|Наступний рядок чорного списку імен користувачів помилковий, будь ласка, виправіть його|Наступні рядки чорного списку імен користувачів помилкові, будь ласка, виправіть їх}} перед збереженням:',
