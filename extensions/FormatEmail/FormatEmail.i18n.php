 ...
 */
$messages['arz'] = array(
	'email-desc' => 'يسمح بمقدمات/خواتيم شخصية للإضافة فى البريد الإلكترونى من مستخدم إلى مستخدم.',
	'email_footer' => '
----------------------------------------------------------------------------
هذا البريد الإلكترونى تم إرساله إليك من خلال نظام البريد الإلكترونى فى {{SITENAME}} بواسطة $1.
 ...
 */
$messages['he'] = array(
	'email-desc' => 'אפשרות להוספת כותרת עילית או תחתית להודעות הדוא"ל של משתמשים',
	'email_footer' => '----------------------------------------------------------------------------
הודעה זו נשלחה אליך דרך מערכת הדוא"ל של {{SITENAME}} על ידי $1.
