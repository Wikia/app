 ...
 */
$messages['el'] = array(
	'htmlets-desc' => 'Σας επιτρέπει να εισάγετε μέσα στη γραμμή αποσπάσματα κώδικα HTML από αρχεία χρησιμοποιώντας την ετικέτα  <code>&lt;htmlet&gt;</code>',
);
 ...
 */
$messages['hi'] = array(
	'htmlets-desc' => '<code>&lt;htmlet&gt;</code> टैग का इस्तेमाल करके फ़ाइलमें इन-लाइन HTML स्निपेट्ट्स डालने की अनुमति देता हैं',
);
 ...
 */
$messages['te'] = array(
	'htmlets-desc' => '<code>&lt;htmlet&gt;</code> అనే ట్యాగుని ఉపయోగించడం ద్వారా ఫైళ్ళనుండి HTML ముక్కలని పేజీలలో చేర్చుకోనిస్తుంది',
);
