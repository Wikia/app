...
$messages['arz'] = array(
	...
	'sf_createtemplate_aggregation' => 'أجريجاشن',
	'sf_createtemplate_aggregationdesc' => 'لعرض، على أية صفحة تستخدم هذا القالب، كل المقالات التى تمتلك خاصية معينة تشير إلى هذه الصفحة، حدد الخاصية المناسبة بالأسفل:',
	'sf_createtemplate_aggregationlabel' => 'العنوان للقائمة:',
	'sf_createtemplate_outputformat' => 'صيغة الخرج:',
	'sf_createtemplate_standardformat' => 'قياسي',
	'sf_createtemplate_infoboxformat' => 'صندوق معلومات على اليمين',
	...
	'createform' => 'إنشاء استمارة',
	'sf_createform_nameinput' => 'اسم الاستمارة (يفضل تسمية الاستمارة بعد القالب الرئيسى الذى هى فيه):',
	'sf_createform_template' => 'القالب:',
	'sf_createform_templatelabelinput' => 'علامة القالب (اختياري):',
...
$messages['be-tarask'] = array(
	...
	'sf_createform_nameinput' => 'Назва формы (звычайна па назьве шаблёну, які яна запаўняе):',
...
$messages['de'] = array(
	...
	'sf_createproperty_allowedvalsinput' => 'Wenn du für dieses Attribut nur bestimmte Werte ermöglichen willst, gib diese bitte als kommagetrennte Liste ein (wenn ein Wert ein Komma enthält, ersetze dieses mit „\\,“):',
	'sf_createproperty_propname' => 'Name:',
	'sf_createproperty_proptype' => 'Typ:',
	'templates' => 'Vorlagen',
...
$messages['dsb'] = array(
	...
	'sf_createtemplate_aggregationdesc' => 'Aby nalicył na wšych bokach, kótarež wužywaja toś tu pśedłogu, wšykne nastawki, kótarež maju wěstu kakosć, kótaraž pokazujo na toś ten bok, pódaj dołojce góžecu se kakosć:',
...
$messages['ia'] = array(
	...
	'sf_createtemplate_aggregation' => 'Aggregation',
	'sf_createtemplate_aggregationdesc' => 'Pro listar, in omne pagina que usa iste patrono, tote le articulos que ha un certe proprietate punctante verso ille pagina, specifica le proprietate in question infra:',
	...
	'createform' => 'Crear un formulario',
	'sf_createform_nameinput' => 'Nomine del formulario (le convention es nominar le formulario post le patrono principal que illo reimple):',
...
$messages['ja'] = array(
	...
	'sf_createproperty_allowedvalsinput' => 'このプロパティに一部の値しか設定できないようにするには、許可する値のリストをコンマで区切って入力します (値がコンマを含む場合は「\\,」に置き換えてください)。',
	...
	'sf_createtemplate_fieldislist' => 'このフィールドには値をコンマ区切りのリストで入力することができます',
	...
	'sf_createtemplate_aggregationlabel' => 'リスト名:',
	...
	'createform' => 'フォームの作成',
	'sf_createform_nameinput' => 'フォーム名 (慣例では、フォームがデータを投入する本体のテンプレートの名前から命名します):',
	...
	'sf_createform_fieldproplist' => 'このフィールドは、型 $2 のプロパティ $1 をもつ要素のリストを定義します。',
...
"Special:EditData?form=&lt;フォーム名&gt;&target=&lt;対象ページ&gt;" あるいは "Special:EditData/&lt;フォーム名&gt;/&lt;対象ページ&gt;" というような形式になります。',
	...
	'sf_property_allowedvals' => 'このプロパティが取ることのできる値:',
...
$messages['oc'] = array(
	...
	'sf_createtemplate_aggregationdesc' => "Sus cada pagina qu'utilizan aqueste modèl, per listar totas las qu'an una proprietat que punta cap a aquesta pagina, indicatz la proprietat adeqüata çaijós :",
