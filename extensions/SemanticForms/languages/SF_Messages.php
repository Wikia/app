...
it should look like \'Special:EditData?form=&lt;form name&gt;&target=&lt;target page&gt;\', or  \'Special:EditData/&lt;form name&gt;/&lt;target page&gt;\'.',
	'sf_editdata_morethanoneform'        => "'''Warning:''' More than one default form is defined for this page.",
...
أما غير ذلك، فسيتم إرسالك إلى الاستمارة لإضافة الصفحة.',
	...
	'sf_editdata_morethanoneform' => "'''تحذير:''' أكثر من نموذج مبدئي معرّف لهذه الصفحة.",
...
$messages['arz'] = array(
	...
	'sf_createcategory_makesubcategory' => 'اجعل هذا تصنيفا فرعيا لتصنيف آخر (اختياري):',
	'addpage' => 'إضافة صفحة مع نموذج',
	'sf_addpage_badform' => 'خطأ: لا صفحة استمارة تم العثور عليها فى $1',
	'sf_addpage_docu' => "أدخل اسم الصفحة هنا، لكى يتم تعديلها مع الاستمارة '$1'.
إذا كانت هذه الصفحة موجودة بالفعل، سيتم إرسالك إلى الاستمارة لتعديل هذه الصفحة.
أما غير ذلك، فسيتم إرسالك إلى الاستمارة لإضافة الصفحة.",
	'sf_addpage_noform_docu' => 'أدخل اسم الصفحة هنا، واختر الاستمارة لتعديلها معها.
إذا كانت هذه الصفحة موجودة بالفعل، سيتم إرسالك إلى الاستمارة لتعديل هذه الصفحة.
أما غير ذلك، فسيتم إرسالك إلى الاستمارة لإضافة الصفحة.',
	...
	'adddata' => 'إضافة بيانات',
	'sf_adddata_title' => 'أضف $1: $2',
	'sf_adddata_badurl' => "هذه هى الصفحة لإضافة البيانات. يجب عليك تحديد اسم صفحة وصفحة هدف فى المسار؛ ينبغى أن تبدو ك 'Special:AddData?form=&lt;form name&gt;&target=&lt;target page&gt;' أو  'Special:AddData/&lt;form name&gt;/&lt;target page&gt;'.",
	'sf_adddata_altforms' => 'يمكنك كبديل إضافة هذه الصفحة مع واحد من الاستمارات التالية:',
	'sf_adddata_altformsonly' => 'من فضلك اختر إحدى الاستمارات التالية لإضافة هذه الصفحة إليها:',
	'editdata' => 'عدل البيانات',
	'sf_formedit' => 'عدل مع الاستمارة',
	...
	'sf_editsource' => 'مصدر التعديل',
	'sf_editdata_title' => 'عدل $1: $2',
	'sf_editdata_badurl' => "هذه هى الصفحة لتعديل البيانات. يجب عليك تحديد اسم استمارة وصفحة هدف فى المسار؛ ينبغى أن تبدو ك 'Special:EditData?form=&lt;form name&gt;&target=&lt;target page&gt;' أو  'Special:EditData/&lt;form name&gt;/&lt;target page&gt;'.",
	'sf_editdata_formwarning' => 'تحذير: هذه الصفحة <a href="$1">موجودة بالفعل</a>، لكنها لا تستخدم هذه الاستمارة.',
	'sf_editdata_remove' => 'إزالة',
	'sf_editdata_addanother' => 'إضافة آخر',
	'sf_editdata_none' => 'لا شيء',
...
$messages['be-tarask'] = array(
	...
	'sf_addpage_badtitle' => 'Памылка: «$1» — няслушная назва для старонкі.',
...
гэта павінна мець выгляд як 'Special:EditData?form=&lt;form name&gt;&target=&lt;target page&gt;' альбо  'Special:EditData/&lt;form name&gt;/&lt;target page&gt;'.",
	'sf_editdata_morethanoneform' => 'Увага: для гэтай старонкі вызначана па змоўчваньні больш за адну форму.',
...
$messages['br'] = array(
	...
	'sf_adddata_altformsonly' => 'Diuzit unan eus ar furmskridoù-mañ evit ouzhpennañ ar bajenn-mañ :',
	'editdata' => 'Aozañ ar roadennoù',
	'sf_formedit' => 'Aozañ gant ur furmskrid',
...
$messages['ca'] = array(
	...
	'addpage' => 'Afegeix pàgina via formulari',
...
Für mehrere Optionen nutze bitte die Seite $1.',
	...
	'sf_editdata_morethanoneform' => 'Warnung: Mehr als ein Standardformular ist für diese Seite definiert.',
...
Za dalšne opcije wužyj boki $1 město togo.',
	...
	'addpage' => 'Bok z formularom pśidaś',
	'sf_addpage_badform' => 'Zmólka: žeden formular njejo se namakał pla $1',
	'sf_addpage_badtitle' => 'Zmólka: "$1" jo njepłaśiwy titel za bok.',
	'sf_addpage_docu' => "Zapódaj how mě boka, kótaryž ma se z formularom '$1' wobźěłaś.
...
Howac buźoš se k formularoju za pśidawanje boka dalej pósrědnjaś.",
	'sf_addpage_noform_docu' => 'Zapódaj how mě boka a wubjeŕ formular, z kótarymž coš jen wobźěłaś.
Jolic toś ten bok južo eksistěrujo, buźoš se k formularoju za wobźěłowanje togo boka dalej pósrědnjaś.
Howac buźoš se k formularoju za pśidawanje boka dalej pósrědnjaś.',
	'addoreditdata' => 'Pśidaś abo wobźěłaś',
	'adddata' => 'Daty pśidaś',
	'sf_adddata_title' => '$1 pśidaś: $2',
	'sf_adddata_badurl' => "To jo bok za pśidawanje datow. Musyš ako mě formulara tak teke celowy bok w URL pódaś; URL by měł kaž 'Special:AddData?form=&lt;mě formulara&gt;&target=&lt;celowy bok&gt;' abo  'Special:AddData/&lt;mě formulara&gt;/&lt;celowy bok&gt;' wuglědaś.",
	'sf_adddata_altforms' => 'Móžoš město togo toś ten bok z jadnym ze slědujucych formularow pśidaś:',
	'sf_adddata_altformsonly' => 'Pšosym wubjeŕ jaden ze slědujucych formularow, aby pśidał toś ten bok:',
	'editdata' => 'Daty wobźěłaś',
	'sf_formedit' => 'Z formularom wobźěłaś',
	'sf_formcreate' => 'Z formularom napóraś',
	'sf_viewform' => 'Formular se woglědaś',
	'sf_editsource' => 'Žrědło wobźěłaś',
	'sf_editdata_title' => '$1 wobźěłaś: $2',
	'sf_editdata_badurl' => "To jo bok za wobźěłowanje datow. Musyš ako mě formulara tak teke celowy bok w URL pódaś; URL by měł kaž  'Special:EditData?form=&lt;mě formulara&gt;&target=&lt;celowy bok&gt;' abo  'Special:EditData/&lt;mě formulara&gt;/&lt;celowy bok&gt;'.",
	'sf_editdata_morethanoneform' => 'Warnowanje: Za toś ten bok jo se definěrował wěcej ako jaden standardny formular.',
	'sf_editdata_formwarning' => 'Warnowanje: Toś ten bok <a href="$1">južo eksistěrujo</a>, ale njewužywa toś ten formular.',
	'sf_editdata_remove' => 'Wótpóraś',
	'sf_editdata_addanother' => 'Drugi pśidaś',
	'sf_editdata_none' => 'Žeden',
...
$messages['el'] = array(
	...
	'sf_adddata_title' => 'Προσθήκη $1: $2',
	'editdata' => 'Δεδομένα επεξεργασίας',
	'sf_formedit' => 'Επεξεργασία με φόρμα',
	'sf_formcreate' => 'Δημιουργία με φόρμα',
	'sf_viewform' => 'Εμφάνιση φόρμας',
	'sf_editsource' => 'Επεξεργασία πηγής',
	'sf_editdata_title' => 'Επεξεργασία $1: $2',
...
$messages['es'] = array(
	...
	'sf_editdata_morethanoneform' => 'Advertencia: Más de un formulario por defecto está definido para esta página.',
...
$messages['fr'] = array(
	...
	'sf_addpage_badtitle' => 'Erreur : « $1 » est un titre de page invalide.',
	'sf_addpage_docu' => 'Entrez ici le nom de la page destinée à être modifiée avec le formulaire « $1 ». Si cette page existe déjà, vous serez dirigé vers le formulaire afin de le modifier. Dans le cas contraire, vous serez redirigé vers celui permettant de l’ajouter.',
	'sf_addpage_noform_docu' => 'Entrez ici le nom de la page, puis sélectionnez le formulaire qui servira à la modifier. Si cette page existe déjà, vous serez dirigé vers le formulaire afin de le modifier. Dans le cas contraire, vous serez redirigé vers celui permettant de l’ajouter.',
	'addoreditdata' => 'Modifier ou ajouter des données',
	'adddata' => 'Ajouter des données',
	'sf_adddata_title' => 'Ajouter $1 : $2',
	'sf_adddata_badurl' => 'Ceci est la page d’ajout de données. Il faut indiquer un nom de formulaire et une page cible dans l’URL ;
l’URL doit ressembler à « <tt>Special:AddData?form=&lt;nom de formulaire&gt;&target=&lt;nom de page cible&gt;</tt> » ou « <tt>Special:AddData/&lt;nom de formulaire&gt;/&lt;nom de page cible&gt;</tt> ».',
	...
	'sf_editdata_title' => 'Modifier $1 : $2',
	'sf_editdata_badurl' => 'Ceci est la page de modification des données. Il faut indiquer un nom de formulaire et une page cible dans l’URL ;
l’URL doit ressembler à « <tt>Special:EditData?form=&lt;nom de formulaire&gt;&target=&lt;nom de page cible&gt;</tt> » ou « <tt>Special:EditData/&lt;nom de formulaire&gt;/&lt;nom de page cible&gt;</tt> ».',
	'sf_editdata_morethanoneform' => 'Avertissement : Plus d’un formulaire par défaut est spécifié pour cette page.',
	...
	'sf_editdata_addanother' => 'Ajouter une autre',
...
$messages['gl'] = array(
	...
	'sf_addpage_badtitle' => 'Erro: "$1" é un título incorrecto para unha páxina.',
	...
	'sf_editdata_morethanoneform' => 'Aviso: hai máis dun formulario por defecto definido para esta páxina.',
...
$messages['gsw'] = array(
	...
	'sf_addpage_badtitle' => "Fähler: '$1' isch kei giltige Titel fir e Syte.",
	...
	'sf_editdata_morethanoneform' => 'Warnig: s isch meh wie ei Standardformular definiert fir die Syte.',
...
$messages['he'] = array(
	...
	'addpage' => 'הוספת דף עם טופס',
	'sf_addpage_badform' => 'שגיאה: לא נמצא דף טופס ב־$1',
	'sf_addpage_badtitle' => 'שגיאה: "$1" היא כותרת דף בלתי תקינה.',
	'sf_addpage_docu' => "כתבו כאן את שם הדף, שייערך באמצעות הטופס '$1'.
אם דף זה כבר קיים, תועברו אל הטופס לעריכת אותו הדף.
אחרת, תועברו אל הטופס להוספת הדף.",
	'sf_addpage_noform_docu' => 'כתבו כאן את שם הדף, ובחרו את הטופס באמצעותו תבוצע עריכת הדף.
אם דף זה כבר קיים, תועברו אל הטופס לעריכת אותו הדף.
אחרת, תועברו אל הטופס להוספת הדף.',
	'addoreditdata' => 'הוספה או עריכה',
	'adddata' => 'הוספת נתונים',
	'sf_adddata_title' => 'הוספת $1: $2',
	'sf_adddata_badurl' => "דף זה משמש להוספת נתונים. עליכם לפרט גם את שם הטופס וגם את כתובת דף היעד; התוצאה אמורה להראות כך: 'Special:AddData?form=&lt;form name&gt;&target=&lt;target page&gt;', או כך - 'Special:AddData/&lt;form name&gt;/&lt;target page&gt;'.",
	'sf_adddata_altforms' => 'במקום זאת תוכלו להוסיף דף זה באמצעות אחד מהטפסים הבאים:',
	'sf_adddata_altformsonly' => 'אנא בחרו מאחד הטפסים הבאים להוספת דף זה:',
	'editdata' => 'עריכת נתונים',
	'sf_formedit' => 'עריכה באמצעות טופס',
	'sf_formcreate' => 'יצירה עם טופס',
	'sf_viewform' => 'הצגת הטופס',
	'sf_editsource' => 'עריכת מקור',
	'sf_editdata_title' => 'עריכת $1: $2',
	...
	'sf_editdata_morethanoneform' => "'''אזהרה:''' יותר מטופס ברירת מחדל אחד מוגדר לדף זה.",
	'sf_editdata_formwarning' => 'אזהרה: דף זה <a href="$1">כבר קיים</a>, אך אינו משתמש בטופס זה.',
	'sf_editdata_remove' => 'הסרה',
	'sf_editdata_addanother' => 'הוספת עוד',
	'sf_editdata_none' => 'לא כלום',
...
Za dalše opcije wužij strony $1 město toho.',
	...
	'sf_addpage_badtitle' => 'Zmylk: "$1" je njepłaćiwy titul za stronu.',
	...
	'sf_editdata_morethanoneform' => 'Warnowanje: Za tutu stronu bu wjace hač jedyn standardny formular definowany.',
...
Alteremente, tu essera inviate al formulario pro adder le pagina.",
	'sf_addpage_noform_docu' => 'Entra hic le nomine del pagina, e selige le formulario con le qual modificar lo.
...
Alteremente, tu esserea inviate al formulario pro modificar le pagina.',
	'addoreditdata' => 'Adder o modificar',
	'adddata' => 'Adder datos',
	'sf_adddata_title' => 'Adder $1: $2',
	'sf_adddata_badurl' => "Isto es le pagina pro adder datos. Tu debe specificar e un nomine de formulario e un pagina de destination in le adresse URL; illo debe resimilar 'Special:AddData?form=&lt;form name&gt;&target=&lt;target page&gt;', o  'Special:AddData/&lt;form name&gt;/&lt;target page&gt;'.",
	'sf_adddata_altforms' => 'Tu pote, in loco de isto, adder iste pagina con un del sequente formularios:',
	'sf_adddata_altformsonly' => 'Per favor selige un del sequente formularios pro adder iste pagina:',
	'editdata' => 'Modificar datos',
	'sf_formedit' => 'Modificar con formulario',
	'sf_formcreate' => 'Crear con formulario',
	'sf_viewform' => 'Vider formulario',
	'sf_editsource' => 'Modificar fonte',
	'sf_editdata_title' => 'Modificar $1: $2',
	'sf_editdata_badurl' => "Isto es le pagina pro modificar datos. Tu debe specificar e le nomine de un formulario e un pagina de destination in le adresse URL; illo debe haber le aspecto de 'Special:EditData?form=&lt;nomine del formulario&gt;&target=&lt;pagina de destination&gt;', o 'Special:EditData/&lt;nomine del formulario&gt;/&lt;pagina de destination&gt;'.",
	'sf_editdata_morethanoneform' => 'Attention: Plus de un formulario predefinite es definite pro iste pagina.',
	'sf_editdata_formwarning' => 'Attention: Iste pagina <a href="$1">existe ja</a>, sed non usa iste formulario.',
	'sf_editdata_remove' => 'Remover',
	'sf_editdata_addanother' => 'Adder un altere',
	'sf_editdata_none' => 'Nulle',
...
Pro adder un pagina con iste formulario, entra le nomine del pagina in basso;
si un pagina con ille nomine existe ja, tu essera inviate a un formulario pro modificar ille pagina.",
...
$messages['id'] = array(
	...
	'addpage' => 'Buat halaman dengan formulir',
	'sf_addpage_badform' => 'Kesalahan: halaman formulir tak ditemukan di $1',
	'sf_addpage_badtitle' => 'Kesalahan: "$1" adalah judul yang tidak valid untuk suatu halaman.',
	'sf_addpage_docu' => 'Masukkan nama halaman untuk disunting dengan formulir "$1" di sini.
...
Jika belum, Anda akan diarahkan ke formulir untuk menambahkan halaman.',
	'sf_addpage_noform_docu' => 'Masukkan nama halaman di sini dan pilih formulir untuk menyuntingnya.
Jika halaman ini sudah ada, Anda akan diarahkan ke formulir untuk menyunting halaman itu.
Jika belum, Anda akan diarahkan ke formulir untuk menambahkan halaman.',
	'addoreditdata' => 'Tambah atau sunting',
	'adddata' => 'Tambah data',
	'sf_adddata_title' => 'Tambah $1: $2',
	'sf_adddata_badurl' => "Ini adalah halaman untuk menambah data. Anda harus memberikan baik nama formulir maupun nama halaman target di URL;
bentuknya harus seperti 'Special:AddData?form=&lt;form name&gt;&target=&lt;target page&gt;', atau 'Special:AddData/&lt;form name&gt;/&lt;target page&gt;'.",
	'sf_adddata_altforms' => 'Sebagai gantinya, Anda dapat menambahkan halaman ini dengan salah satu dari formulir berikut:',
	'sf_adddata_altformsonly' => 'Silakan pilih salah satu dari formulir berikut untuk menambah halaman ini:',
	'editdata' => 'Sunting data',
	'sf_formedit' => 'Sunting dengan formulir',
	'sf_formcreate' => 'Buat dengan formulir',
	'sf_viewform' => 'Lihat formulir',
	'sf_editsource' => 'Sunting sumber',
	'sf_editdata_title' => 'Sunting $1: $2',
	'sf_editdata_badurl' => "Ini adalah halaman untuk menyuntin data. Anda harus memberikan baik nama formulir maupun nama halaman target di URL;
bentuknya harus seperti 'Special:EditData?form=&lt;form name&gt;&target=&lt;target page&gt;', atau 'Special:EditData/&lt;form name&gt;/&lt;target page&gt;'..",
	'sf_editdata_morethanoneform' => "'''Peringatan:''' Lebih dari satu formulir baku ditentukan untuk halaman ini.",
	'sf_editdata_formwarning' => 'Peringatan: Halaman ini <a href="$1">telah ada</a> tapi tidak menggunakan formulir ini.',
	'sf_editdata_remove' => 'Hapus',
	'sf_editdata_addanother' => 'Tambah lagi',
...
$messages['ja'] = array(
	...
	'addpage' => 'フォームによるページの追加',
	'sf_addpage_badform' => 'エラー: $1 にはフォームページが見つかりませんでした',
	'sf_addpage_badtitle' => 'エラー:「$1」はページ名として無効です。',
	'sf_addpage_docu' => 'フォーム「$1」で編集するページの名前をここに入力してください。そのページが既に存在する場合、そのページを編集するためのフォームへ転送されます。その他の場合は、そのページを追加するためのフォームへ転送されます。',
...
"Special:AddData?form=&lt;フォーム名&gt;&target=&lt;対象ページ&gt;" あるいは "Special:AddData/&lt;フォーム名&gt;/&lt;対象ページ&gt;" というような形式になります。',
	...
	'sf_adddata_altformsonly' => 'このページを追加するために、次のうちどれかのフォームを選んでください:',
	'editdata' => 'データ編集',
...
"Special:EditData?form=&lt;フォーム名&gt;&target=&lt;対象ページ&gt;" あるいは "Special:EditData/&lt;フォーム名&gt;/&lt;対象ページ&gt;" というような形式になります。',
	'sf_editdata_morethanoneform' => '警告: このページに対するデフォルトのフォームが複数定義されています。',
	'sf_editdata_formwarning' => '警告: このページは<a href="$1">既に存在します</a>が、このフォームを利用していません。',
	'sf_editdata_remove' => '削除',
	'sf_editdata_addanother' => '別のものを追加',
	'sf_editdata_none' => 'なし',
	'runquery' => 'クエリー実行',
...
$messages['km'] = array(
	...
	'sf_addpage_badform' => 'កំហុស: គ្មាន​ទំព័រទម្រង់​ត្រូវ​បាន​រកឃើញ​នៅ $1 ទេ',
	...
	'sf_editdata_formwarning' => 'ការព្រមាន: ទំព័រ​នេះ <a href="$1">មាន​រួចហើយ</a> ប៉ុន្តែ​វា​មិនអាច​ប្រើប្រាស់​ទម្រង់​នេះ​បាន​ទេ​។',
...
$messages['ksh'] = array(
	...
	'addpage' => 'Donn en Sigg dobei övver e Fommullaa',
	'sf_addpage_badform' => 'Ene Fähler es opjetrodde: Mer han kei Fommullaa „$1“ jefonge.',
	'sf_addpage_badtitle' => 'Fähler: „$1“ es ene onjöltige Sigggetittel.',
	'sf_addpage_docu' => 'Jiff hee dä Name vun dä Sigg en, di mem Fommulaa „$1“ beärbeidt wäde sull. Wann de Sigg ald doh es, küß De op dat Fommullaa, för di Sigg ze ändere. Söns küß De op dat Fommullaa för di Sigg aanzelääje.',
	'sf_addpage_noform_docu' => 'Jiff hee dä Name vun däm Sigg en, un donn dat Fommulaa ußsööke woh drövver di Sigg beärbeidt wäde sull. Wann di Sigg ald doh es, küß De op dat Fommullaa, för di Sigg ze ändere. Söns küß De op dat Fommullaa för di Sigg aanzelääje.',
	'addoreditdata' => 'Dobei donn udder Ändere',
	'adddata' => 'Date dobei donn',
	'sf_adddata_title' => 'Donn $1 dobei: $2',
	'sf_adddata_badurl' => "Date es de Sigg för Date dobei ze donn. Do moß ene Name för e Fommulaa un för en Sigg an dä ierem <i lang=\"en\">URL</i> aanjevve. Dat sullt eu ähnlesch ußsinn, wieh: <code>{{#special:addData}}?form=''&lt;Fomullaa_Name&gt;''&target=''&lt;Sigge_Name&gt;''</code>, udder wi: <code>{{#special:addData}}/''&lt;Fomullaa_Name &gt;''/''&lt;Sigge_Name&gt;''</code>.",
	'sf_adddata_altforms' => 'Shtatt dämm kanns De di Sigg övver ein vun hee dä Fommulaare aanlääje:',
	'sf_adddata_altformsonly' => 'Donn ein vun dä Fommulaare ußwähle, öm di Sigg aanzelääje:',
	...
	'sf_editdata_badurl' => "Dat hee is de Sigg för Date ze ändere. Mer moß dä ier <i lang=\"en\">URL</i> dä Name för et Fommulaa aanjevve, un och dä Name för de Sigg zem Ändere. Dat sullt esu ußsünn wieh: <code>{{#special:editData}}?form=''&lt;Fomullaa_Name&gt;''&target=''&lt;Sigge_Name&gt;''</code>, udder wi: <code>{{#special:editData}}/''&lt;Fomullaa_Name &gt;''/''&lt;Sigge_Name&gt;''</code>.",
	'sf_editdata_morethanoneform' => 'Opjepaß: Dör di Sigg hee es mieh wie ein Shtandadt-Fommulaa ennjeshtallt.',
...
$messages['lb'] = array(
	...
	'sf_addpage_badform' => 'Feeler: et gouf keng Formulaire-Säit op $1 fonnt.',
	'sf_addpage_badtitle' => 'Feeler: "$1" ass kee valaben Titel fir eng Säit',
	'addoreditdata' => 'Derbäisetzen oder änneren',
	'adddata' => 'Donnéeën derbäisetzen',
	'sf_adddata_title' => '$1: $2 derbäisetzen',
	'sf_adddata_altformsonly' => 'Sicht w.e.g. e vun dëse Formulairen eraus fir dës Säit derbäizesetzen:',
	...
	'sf_editdata_formwarning' => 'Opgepasst: Dës Säit <a href="$1">gëtt et schonn</a>, awer si benotzt dëse Formulaire net.',
...
$messages['mk'] = array(
	...
	'addpage' => 'Додај страница со образец',
	'sf_addpage_badform' => 'Грешка: на $1 не е пронајден образец',
	'sf_addpage_badtitle' => 'Грешка: „$1“ не претставува важечки наслов за страница.',
	'sf_addpage_docu' => 'Тука внесете го името на страницата која ќе се уредува со образецот „$1“.
...
Ако не постои, ќе бидете пренасочени кон образецот за додавање на страницата.',
	'sf_addpage_noform_docu' => 'Тука внесете го името на страницата, и одберете го образецот со кој ќе уредувате.
Ако оваа страница веќе постои, ќе ви бидете пренасочени кон образецот за уредување.
Ако не постои, ќе бидете пренасочени кон образецот за додавање на страницата.',
	'addoreditdata' => 'Додај или уреди',
	'adddata' => 'Додај податоци',
	'sf_adddata_title' => 'Додај $1: $2',
	'sf_adddata_badurl' => 'Ова е страницата за уредување на податоци. Мора да назначите име на образецот и целна страница во URL-адресата;
треба да изгледа нешто како „Special:AddData?form=&lt;form name&gt;&target=&lt;target page&gt;“, или  „Special:AddData/&lt;form name&gt;/&lt;target page&gt;“.',
	'sf_adddata_altforms' => 'Наместо тоа, можете да ја додадете оваа страница со еден од следниве обрасци:',
	'sf_adddata_altformsonly' => 'Одберете еден од следните обрасци за додавање на страницата:',
	'editdata' => 'Уреди податоци',
	'sf_formedit' => 'Уреди со образец',
	'sf_formcreate' => 'Создај со образец',
	'sf_viewform' => 'Види го образецот',
	'sf_editsource' => 'Уреди го изворот',
	'sf_editdata_title' => 'Уреди $1: $2',
	'sf_editdata_badurl' => 'Ова е страницата за уредување на податоци. Мора да назначите име на образецот и целна страница во URL-адресата;
треба да изгледа нешто како „Special:EditData?form=&lt;form name&gt;&target=&lt;target page&gt;“, или  „Special:EditData/&lt;form name&gt;/&lt;target page&gt;“.',
	'sf_editdata_morethanoneform' => "'''Предупредување:''' за оваа страница е дефиниран повеќе од еден основен образец.",
	'sf_editdata_formwarning' => 'Предупредување: Оваа страница <a href="$1">веќе постои</a>, но не го користи овој образец.',
	'sf_editdata_remove' => 'Отстрани',
	'sf_editdata_addanother' => 'Додај уште',
...
Gebruik de pagina's $1 voor meer mogelijkheden.",
	...
	'sf_addpage_badtitle' => 'Fout: "$1" is een ongeldige paginanaam.',
	...
	'sf_editdata_morethanoneform' => 'Waarschuwing: er is meer één standaard formulier is ingesteld voor deze pagina.',
	'sf_editdata_formwarning' => 'Deze pagina <a href="$1">bestaat al</a>, maar die gebruikt dit formulier niet.',
...
$messages['no'] = array(
	...
	'sf_addpage_badtitle' => 'Feil: «$1» er en ugyldig tittel for en side.',
...
$messages['pms'] = array(
	...
	'addpage' => 'Gionté na pàgina con un formolari',
	'sf_addpage_badform' => "Eror: gnun-a pàgina ëd formolari a l'é stàita trovà a $1",
	'sf_addpage_badtitle' => 'Eror: "$1" a l\'é un tìtol pa bon për na pàgina.',
	'sf_addpage_docu' => 'Ch\'a anserissa ël nòm ëd la pàgina ambelessì, da modifiché con ël formolari "$1".
...
Dësnò, a sarà mandà al formolari për gionté la pàgina.',
	'sf_addpage_noform_docu' => "Ch'a anserissa ël nòm ëd la pàgina ambelessì, e ch'a selession-a ël formolari për modifichela.
Se sta pàgina-sì a esist già, a sarà mandà al formolari për modifiché cola pàgina.
Dësnò, a sarà mandà al formolari për gionté la pàgina.",
	'addoreditdata' => 'Gionta o modìfica',
	'adddata' => 'Gionta dat',
	'sf_adddata_title' => 'Gionta $1: $2',
...
$messages['ro'] = array(
	...
	'addpage' => 'Adaugă o pagină cu un formular',
	'addoreditdata' => 'Adăugaţi sau modificaţi',
	'adddata' => 'Adăugare date',
	'sf_adddata_title' => 'Adăugare $1: $2',
	'editdata' => 'Modificare date',
	'sf_formedit' => 'Editează cu un formular',
	'sf_formcreate' => 'Creaţi un formular',
	'sf_viewform' => 'Vedeţi formular',
	'sf_editsource' => 'Modificare sursă',
	'sf_editdata_title' => 'Modificare $1: $2',
	'sf_editdata_remove' => 'Elimină',
	'sf_editdata_addanother' => 'Adăugaţi altul',
...
$messages['ru'] = array(
	...
	'sf_addpage_badtitle' => 'Ошибка. «$1» — недопустимое название страницы.',
	...
	'sf_editdata_morethanoneform' => 'Внимание. Для этой страницы была определена больше чем одна форма по умолчанию.',
...
$messages['sk'] = array(
	...
	'sf_addpage_badtitle' => 'Chyba: „$1“ nie je platný názov stránky.',
	...
	'sf_editdata_morethanoneform' => 'Upozornenie: Táto stránka má definovaný viac ako jeden štandardný formulár.',
...
$messages['sr-ec'] = array(
	...
	'editdata' => 'Измени податке',
	'sf_editsource' => 'Измени сорс',
	'sf_editdata_title' => 'Измени $1: $2',
...
$messages['sr-el'] = array(
	...
	'sf_editdata_title' => 'Izmeni $1: $2',
	'sf_editdata_remove' => 'Ukloni',
	'sf_editdata_none' => 'Nema',
...
$messages['sv'] = array(
	...
	'sf_addpage_badtitle' => 'Fel: "$1" är inte en giltig titel på en sida.',
...
$messages['tg-latn'] = array(
	...
	'editdata' => 'Viroişi doda',
	'sf_editdata_remove' => 'Hazf',
	'sf_editdata_addanother' => 'Ilovai digare',
	'sf_editdata_none' => 'Heç kadom',
...
$messages['vi'] = array(
	...
	'sf_editdata_morethanoneform' => 'Cảnh báo: Có nhiều hơn một mẫu đơn mặc định được định nghĩa cho trang này.',
...
$messages['vo'] = array(
	...
	'sf_addpage_badform' => 'Pöl: fometapad nonik petuvon lä $1',
	'sf_addpage_docu' => 'Penolös is nemi pada, kel poredakon me fomet: „$1“.
If pad at ya dabinon, ologol fometi ad redakön padi dabinöl at.
Voto ologol fometi ad läükön padi.',
	'sf_addpage_noform_docu' => 'Penolös is padanemi e välolös fometi, me kel vilol redakön oni.
If pad at ya dabinons, ologol fometi ad redakön padi dabinöl at.
Voto ologol fometi ad läükön padi.',
	'addoreditdata' => 'Läükön u votükön',
	'adddata' => 'Läükön nünodis',
	'sf_adddata_title' => 'Läükön $1: $2',
	'sf_adddata_badurl' => 'Pad at pagebon ad läükön nünodis. Mutoy penön fometanemi e zeilapadi ini el URL, kel muton logotön so: „Special:AddData?form=&lt;fometanem&gt;&target=&lt;zeilapad&gt;“, u: „Special:AddData/&lt;fometanem&gt;/&lt;zeilapad&gt;“.',
	'sf_adddata_altforms' => 'Kanol plao läükön padi at me bal fometas fovik:',
	'sf_adddata_altformsonly' => 'Välolös bali fometas sököl ad läükön padi at:',
	'editdata' => 'Votükön nünodis',
	'sf_formedit' => 'Redakön me fomet',
	'sf_viewform' => 'Logön fometi',
	'sf_editsource' => 'Redakön fonäti',
	'sf_editdata_title' => 'Votükön $1: $2',
	'sf_editdata_badurl' => 'Me pad at kanoy votükön nünodis. Mutoy penön fometanemi e zeilapadi ini el URL, kel muton logotön so: „Special:EditData?form=&lt;fometanem&gt;&target=&lt;zeilapad&gt;“, u  „Special:EditData/&lt;fometanem&gt;/&lt;zeilapad&gt;“.',
	'sf_editdata_formwarning' => 'Nuned: Pad at <a href="$1">ya dabinon</a>, ab no gebon fometi at.',
	'sf_editdata_remove' => 'Moükön',
	'sf_editdata_addanother' => 'Läükön votiki',
...
Enter all the data here to create the properties, template, form and category for a single class. For more options, use the pages $1 instead.',
	...
	'sf_editdata_morethanoneform' => "'''警告：'''用來編輯此頁的表單已超過一個以上了。",
