...
$wgSpecialPages ['spamregex'] = array('SpecialPage', 'Spamregex', 'spamregex', true, 'wfSpamRegexSpecial', false) ;
...
function wfSpamRegexUnsetKeys () {
	...
	$wgMemc->delete (wfSpamRegexGetMemcDB () . ":spamRegexCore:spamRegex:Textbox") ;
	$wgMemc->delete (wfSpamRegexGetMemcDB () . ":spamRegexCore:spamRegex:Summary") ;
	$wgMemc->delete (wfSpamRegexGetMemcDB () . ":spamRegexCore:numResults") ;
}
