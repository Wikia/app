<?php
/** Internationalization file for /extensions/SpamRegex/SpamRegex extension. */
$messages = [];
...
Caution advised, expressions should not be too short or too common.',
	...
	'right-spamregex' => 'Block text from pages and edit summaries across all Wikia',
];
...
$messages['no'] = [
	'right-spamregex' => 'Blokkere usakelig innhold gjennom [[Spesial:SpamRegex]]',
];
