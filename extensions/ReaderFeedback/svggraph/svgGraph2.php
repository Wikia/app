...
* </pre>
*/
class svgGraph2 extends svgGraph { var
  $graphicWidth           = 400,
  $graphicHeight          = 300,
  ...
  $styleTitleDefault      = 'text-rendering: geometricPrecision; ',
  $styleLabelXDefault     = 'text-rendering: geometricPrecision; ',
  $styleLabelYDefault     = 'text-rendering: geometricPrecision; ',
  
  $styleTagsXDefault      = 'text-rendering: geometricPrecision; ',
  $styleTagsYDefault      = 'text-rendering: geometricPrecision; ',
