 ...
 */
$messages['fr'] = array(
	'editsectionhilitelink-desc' => 'Mettre en surbrillance la section d’un article lorsque vous placez votre souris sur le lien Modifier',
);
 ...
 */
$messages['gl'] = array(
	'editsectionhilitelink-desc' => 'Resalta a sección axeitada dunha páxina cando move o rato sobre a ligazón de edición',
);
 ...
 */
$messages['ksh'] = array(
	'editsectionhilitelink-desc' => 'Donn ene Afschnett en en Sigg pär Färf makeere wann dem Kompjuter sing Maus övver dä Lengk för en ze beärbeide jeiht.',
);
