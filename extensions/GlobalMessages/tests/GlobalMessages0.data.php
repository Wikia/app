...
// 7 ---------------------------------------------------------------------------
'autocreatewiki-info-terms-agree' => 'By creating a wiki and user account, you agree to the <a class="external" href="http://community.wikia.com/wiki/Terms_of_use">Fandom\'s Terms of Use</a>',
// 8 ---------------------------------------------------------------------------
...
* This process is NOT reversible after $1 days have passed, and you will have to create a new account if you wish to rejoin Fandom.
...
Please note you will have $1 days after making this request to reactivate your account by logging in and following the instructions you will see. After this waiting period, your account will be closed permanently and cannot be restored.',
// 19 --------------------------------------------------------------------------
...
// 21 --------------------------------------------------------------------------
'closemyaccount-reactivate-intro' => 'You have previously requested that we close your account. You still have $1 days left until your account is closed. If you still wish to close your account, simply go back to browsing Fandom. However, if you would like to reactivate your account, please click the button below and follow the instructions in the email.
...
Before contributing to the MediaWiki Forums, please keep in mind a few best practices for conduct:
...
:Please take a moment to sift through the MediaWiki Forum boards to see if a discussion already exists about something you want to talk about. If you can't find what you're looking for, jump right in and start a new discussion!
...
'''Have fun!'''
:The MediaWiki community is happy to have you here. We look forward to seeing you around as we discuss this topic we all love.
...
// 143 -------------------------------------------------------------------------
'founderprogressbar-wikialabs-visit-description' => 'Labs allows you to turn on the newest features from Fandom on your wiki. These features are all in beta, but it\'s a good way to see what\'s coming up from Fandom and try it out yourself.',
// 144 -------------------------------------------------------------------------
'founderprogressbar-wikialabs-visit-label' => 'Visit Labs',
// 145 -------------------------------------------------------------------------
...
// 195 -------------------------------------------------------------------------
'prefs-help-terms' => 'By creating an account, you agree to the <a class="external" href="http://www.wikia.com/Terms_of_use">Wikia, Inc\'s Terms of Use</a>',
// 196 -------------------------------------------------------------------------
...
Text should be placed on this page if you wish to explain usage, style and policy guidelines which apply only to MediaWiki. Text added in this edit box will be displayed above the boxed help text.",
// 199 -------------------------------------------------------------------------
...
// 242 -------------------------------------------------------------------------
'tagline-url' => 'From [http://localhost MediaWiki], a [http://www.wikia.com Fandom] wiki.',
// 243 -------------------------------------------------------------------------
'tagline-url-interwiki' => 'From [[wikia:c:$1|MediaWiki]], a [[wikia:|Fandom]] wiki.',
// 244 -------------------------------------------------------------------------
...
// 259 -------------------------------------------------------------------------
'vet-search-results-WVL' => 'We found $1 results for "$2" on Fandom Video Library',
// 260 -------------------------------------------------------------------------
...
Hi, I'm an admin for the MediaWiki community. Welcome and thank you for your edit to [[:$1]]!
...
Please [[$2|leave me a message]] if I can help with anything. Enjoy your time at MediaWiki!

$2",
// 275 -------------------------------------------------------------------------
'welcome-message-anon-staff' => "==Welcome==

Hi, welcome to MediaWiki! I'm a member of Fandom's Community Support team. Thank you for your edit to [[:$1]]!
...
$2",
// 278 -------------------------------------------------------------------------
'welcome-message-wall-anon' => "Hi, I'm an admin for the MediaWiki community. Welcome and thank you for your edit to [[:$1]]!
...
Enjoy your time at MediaWiki!",
// 279 -------------------------------------------------------------------------
'welcome-message-wall-anon-staff' => "Hi, welcome to MediaWiki! I'm a member of Fandom's Community Support team. Thank you for your edit to [[:$1]]!
...
Enjoy your time at MediaWiki!",
// 280 -------------------------------------------------------------------------
'welcome-message-wall-user' => "Hi, I'm an admin for the MediaWiki community. Welcome and thank you for your edit to [[:$1]]!

If you need help getting started, check out our [[Help:Getting Started|help pages]] or contact me or [[Special:Listusers/sysop|another admin]] here. For general help, you could also stop by [[w:c:community:main page|Community Central]] to explore the [[w:c:community:Special:Forum|forums]] and [[w:c:community:Blog:Wikia_Staff_Blog|blogs]].

Enjoy your time at MediaWiki!",
// 281 -------------------------------------------------------------------------
'welcome-message-wall-user-staff' => "Hi, welcome to MediaWiki! I'm a member of Fandom's Community Support team. Thank you for your edit to [[:$1]]!
...
// 290 -------------------------------------------------------------------------
'wikia-visualeditor-dialog-wikiamediainsert-policy-message' => "Please adhere to MediaWiki's image policy and Fandom's [http://www.wikia.com/Terms_of_Use terms of use] when embedding new videos and uploading new photos.",
// 291 -------------------------------------------------------------------------
