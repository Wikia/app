...
$messages['be-tarask'] = array(
	...
	'absenteelandlord-desc' => 'Аўтаматычнае блякаваньне базы зьвестак вікі, калі ніхто з адміністратараў некаторы час не праяўляе актыўнасьці',
);
 ...
 */
$messages['eu'] = array(
	'absenteelandlord-reason' => 'Administratzaileen aktibitate eza dela eta datubasea automatikoki blokeatua izan da.',
 ...
 */
$messages['jv'] = array(
	'absenteelandlord-reason' => 'Basis data wis dikunci sacara otomatis amerga ora ana aktivitas saka para opsis.',
...
$messages['roa-tara'] = array(
	'absenteelandlord-reason' => "L'archivije ha state blocchete automaticamende purcè le amministratore non ge stonne a fatjene.",
	'absenteelandlord-desc' => "Auto-blocco de l'archivije de Uicchi ce le amministratore sonde tutte inattive pe 'nu picche de timbe",
);
 ...
 */
$messages['ru'] = array(
	'absenteelandlord-reason' => 'База данных была автоматически заблокирована из-за неактивности администраторов.',
 ...
 */
$messages['sah'] = array(
	'absenteelandlord-reason' => 'Бу бырайыак дьаһабыллара (администраатардара) өр кэмҥэ кыттыбатахтарыттан бу биики билэтин олоҕо хааччахтаммыт.',
 ...
 */
$messages['su'] = array(
	'absenteelandlord-reason' => 'Basis data geus dikonci sacara otomatis alatan teu aktifna kuncén.',
	'absenteelandlord-desc' => 'Ngonci basis data wiki sacara otomatis lamun sakumna kuncén henteu aktip salila période nu tangtu.',
);
 ...
 */
$messages['vo'] = array(
	'absenteelandlord-reason' => 'Nünodem pelökofärmukon itjäfidiko kodü nejäfid guvanas.',
