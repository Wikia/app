...
$messages['en'] = array(
	...
	'wikia-visualeditor-dialog-wikiamediainsert-upload-error-size' => 'Oops! That image is too big. 10MB is as much as we can take, captain!',
	'wikia-visualeditor-dialog-wikiamediainsert-upload-error-size-filetype' => 'Oops! That image is too big and it\'s of the wrong filetype! 10MB is as much as we can take, captain! We only support .png, .jpg, .jpeg, .gif and a few obscure others',
	'wikia-visualeditor-dialog-wikiamediainsert-upload-error-filetype' => 'Oops! We only support .png, .jpg, .jpeg, .gif and a few obscure others',
