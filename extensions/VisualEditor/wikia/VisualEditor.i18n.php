...
$messages['ru'] = array(
	...
	'wikia-visualeditor-dialog-wikiamediainsert-policy-message' => 'Пожалуйста, придерживайтесь правил загрузки изображений на {{SITENAME}} и соблюдайте [http://ru.wikia.com/Условия_использования Условия использования] FANDOM при вставке новых видео и загрузке новых изображений.',
	...
	'wikia-visualeditor-notification-media-only-premium-videos-allowed' => 'На эту вики можно добавлять только лицензионный контент из <a href="http://video.wikia.com" target="_blank">Видеотеки FANDOM</a>. Пожалуйста, перейдите на <a href="http://video.wikia.com" target="_blank">video.wikia.com</a> для поиска видео.',
