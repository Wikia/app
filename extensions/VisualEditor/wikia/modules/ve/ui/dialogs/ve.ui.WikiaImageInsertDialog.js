...
ve.ui.WikiaImageInsertDialog.static.size = '840px';

ve.ui.WikiaImageInsertDialog.static.actions = [
	{
		action: 'apply',
...
ve.ui.WikiaImageInsertDialog.static.pages = [ 'main', 'search' ];
 ...
 * @returns {jQuery}
 */
ve.ui.WikiaImageInsertDialog.static.formatPolicy = function ( html ) {
	return $( '<div>' )
		.html( html )
		.find( '*' )
		.each( function () {
