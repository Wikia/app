...
QUnit.test( 'HTMLDOM -> NodeViewHTML', function( assert ) {
	...
	/**
	 * Get the mocked HTML output for a view.
	 *
	 * @method
	...
	getOutputHTML = (function () {
		...
		return function ( attributes ) {
			...
			$mock.addClass( getAlignClass( $mock, attributes ) );
	...
	/**
	 * Get the mocked HTML output for a document (HTMLDOM).
	 *
	 * @method
	 * @param {Object} attributes The attributes from which to build the mock.
	 * @returns {String} The mocked HTML.
