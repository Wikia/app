...
$messages['qqq'] = array(
	'recaptcha-desc' => '{{desc}}',
	'recaptcha-misconfigured' => 'An error shown when the ReCaptcha extension does not have the proper settings configured',
);
...
$messages['de'] = array(
	'recaptcha-desc' => 'reCAPTCHA-Modul für die Bestätigung von Bearbeitungen',
	'recaptcha-edit' => 'Zum Schutz vor automatisiertem Spam gib bitte die folgenden Wörter in das untenstehende Feld ein:',
	'recaptcha-addurl' => 'Deine Bearbeitung enthält neue externe Links. Zum Schutz vor automatisiertem Spam gib bitte die folgenden Wörter in das untenstehende Feld ein:',
	'recaptcha-badpass' => 'Zum Schutz gegen automatisiertes Knacken von Passwörtern gib bitte die folgenden Wörter in das untenstehende Feld ein:',
	'recaptcha-createaccount' => 'Um das automatisierte Erstellen von Benutzerkonten zu verhindern, gib bitte die folgenden Wörter in das untenstehende Feld ein:',
	'recaptcha-createaccount-fail' => 'Fehlerhafte oder unvollständige reCAPTCHA-Eingabe.',
	'recaptcha-create' => 'Zum Schutz gegen die automatisierte Erstellung von Seiten gib bitte die folgenden Wörter in das untenstehende Feld ein:',
...
$messages['es'] = array(
	'recaptcha-edit' => 'Como medida de protección contra el spam automatizado en las ediciones, por favor escribe las dos palabras que ves en el siguiente cuadro:',
	'recaptcha-addurl' => 'Tu edición incluye enlaces externos. Como medida de protección contra el spam automatizado, por favor escribe las dos palabras que ves en el siguiente cuadro:',
	'recaptcha-badpass' => 'Como medida de protección contra el spam automatizado en las ediciones, por favor escribe las dos palabras que ves en el siguiente cuadro:',
	'recaptcha-createaccount' => 'Como medida de protección contra el spam automatizado en las ediciones, por favor escribe las dos palabras que ves en el siguiente cuadro:',
	'recaptcha-createaccount-fail' => 'Falta la respuesta reCAPTCHA, o ésta es incorrecta.',
	'recaptcha-create' => 'Como medida de protección contra el spam automatizado en las ediciones, por favor escribe las dos palabras que ves en el siguiente cuadro:',
...
$messages['fr'] = array(
	...
	'recaptcha-createaccount-fail' => 'Réponse de reCAPTCHA incorrecte ou manquante.',
...
$messages['it'] = array(
	'recaptcha-edit' => 'Per aiutare a proteggerci dalle modifiche automatiche che aggiungono spam, scrivi le due parole mostrate nel riquadro sottostante:',
	'recaptcha-addurl' => 'La tua modifica aggiunge qualche nuovo collegamento esterno. Per aiutare a proteggerci dallo spam automatico, scrivi le due parole mostrate nel riquadro sottostante:',
	'recaptcha-badpass' => 'Per aiutare a proteggerci dalla forzatura automatica delle password, scrivi le due parole mostrate nel riquadro sottostante:',
	'recaptcha-createaccount' => 'Per aiutare a proteggerci dalla creazione automatica di nuovi account, scrivi le due parole mostrate nel riquadro sottostante:',
	'recaptcha-createaccount-fail' => 'Risposta reCAPTCHA mancante o errata.',
	'recaptcha-create' => 'Per aiutare a proteggerci dalla creazione automatica di pagine, scrivi le due parole mostrate nel riquadro sottostante:',
...
$messages['ja'] = array(
	'recaptcha-desc' => '編集の確認用リキャプチャモジュール',
	'recaptcha-edit' => '自動編集スパムから保護するため、下の画像に表示されている２つの言葉を入力してください。',
	'recaptcha-addurl' => 'あなたの編集は新しい外部リンクを含んでいます。自動化されたスパムから保護するため、下の画像に表示されている２つの言葉を入力してください。',
	'recaptcha-badpass' => '自動パスワードクラッキングから保護するために、下の画像に表示されている２つの言葉を入力してください。',
	'recaptcha-createaccount' => '自動化されたアカウント登録から保護するために、下の画像に表示されている２つの言葉を入力してください。',
	'recaptcha-createaccount-fail' => '入力されたリキャプチャが正しくありません。',
	'recaptcha-create' => '自動化されたページ作成を防止するために、下の画像に表示されている２つの言葉を入 力してください。',
	'recaptcha-misconfigured' => 'リキャプチャが正しく設定されていません',
);
...
$messages['zh-hant'] = array(
	'recaptcha-edit' => '為了協助防止自動的垃圾訊息編輯，請鍵入您在下面的框中看到的這兩個詞：',
	'recaptcha-addurl' => '您的編輯包含新的外部鏈接。為了幫助防止自動垃圾訊息編輯，請鍵入您在下面的框中看到這兩個詞：',
	'recaptcha-badpass' => '為幫助防止自動密碼破解，請鍵入您在下面的框中看到的兩個字：',
	'recaptcha-createaccount' => '為了協助防止機器人自動創建帳戶，請鍵入您在下面的框中看到的這兩個字：',
	'recaptcha-createaccount-fail' => '不正確或缺失的驗證碼答案。',
	'recaptcha-create' => '為了幫助防止自動的頁面創建，請鍵入您在下面的框中看到這兩個詞：',
	'recaptcha-misconfigured' => '驗證碼放置不正確',
	'recaptcha-desc' => '用來認證編輯的驗證碼模組',
);
