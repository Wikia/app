...
$messages['ksh'] = array(
	...
	'crossnamespacelinks-desc' => '[[Special:CrossNamespaceLinks|Leß med Lengkß zwesche de Appachtemangs]], di_mer {{GRAMMAR:en|{{SITENAME}}}} nit hann sulte.',
...
$messages['mk'] = array(
	...
	'crossnamespacelinks-summary' => 'Оваа страница дава список на врски од страница во главниот именски простор кон страница во други именски простори (освен за именски простори од типот {{ns:special}}, {{ns:talk}}, {{ns:project}} и {{ns:template}}), кои не се препорачува да се користат.',
...
$messages['ml'] = array(
	...
	'crossnamespacelinks-summary' => 'മുഖ്യ നാമമേഖലയിൽ നിന്നു മറ്റു നാമമേഖലകളിലുള്ള താളുകളിലേക്ക് ({{ns:special}}, {{ns:talk}}, {{ns:project}}, {{ns:template}} എന്നീ നാമമേഖലകൾ ഒഴിച്ച്) കണ്ണി ചേർക്കപ്പെട്ടിരിക്കുന്ന താളുകളിലെ കണ്ണികളുടെ പട്ടിക ഈ താൾ പ്രദർശിപ്പിക്കുന്നു. (ഇങ്ങനെ കണ്ണി കൊടുക്കുന്നത് ആശാസ്യമല്ല)',
	'crossnamespacelinkstext' => '$1: $3 നാമമേഖലയിലേയ്ക്ക് {{PLURAL:$2|ഒരു കണ്ണി|$2 കണ്ണികൾ}}',
);
