...
/*
$Id: nusoap.php,v 1.1 2005/12/05 10:37:59 motiveforce Exp $

// NOTE: Modified 20060727 by Sean Colombo to make it interoperable with .NET by adding the link in the xsd:schema tag.
...
* @version  $Id: nusoap.php,v 1.1 2005/12/05 10:37:59 motiveforce Exp $
* @access   public
*/
class nusoap_base {
...
class XMLSchema extends nusoap_base  {
	...
	*/
	function serializeSchema(){
		...
		// finish 'er up
		$el = "<$schemaPrefix:schema xmlns=\"http://www.w3.org/2001/XMLSchema\" targetNamespace=\"$this->schemaTargetNamespace\"\n";
...
//			print $this->webDescription();
	...
	*/
	function invoke_method() {
		...
		$this->debug("leaving invoke_method: called method $this->methodname, received of type".gettype($this->methodreturn));
	}
