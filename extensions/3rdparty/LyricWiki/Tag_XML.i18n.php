...
$messages = Array();
$messages['en'] = Array(
	'xml-feedfailed' => "Unable to fetch RSS feed.  Verify that your feed URL is correct. If this problem persists, please contact [[User:Sean Colombo]] or [[User:Teknomunk]]",
