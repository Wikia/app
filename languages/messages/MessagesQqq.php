...
'uploadnologintext' => 'Information that user have to log in to upload files or add videos. Displayed for non logged in users that perform upload action. 1st parameter is LogIn page link.',
