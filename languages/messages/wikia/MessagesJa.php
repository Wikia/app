...
'recentchanges-on-wikia-content' => "「テンプレートの種類」をリリース — テンプレートを種類ごとに整理して、[[Special:Templates|テンプレートの管理]]をシンプル化したり、モバイル端末での表示を改善したりできます。[[ヘルプ:テンプレートの種類|詳細]]をご覧になるか、'''[[Special:Insights/templateswithouttype|今すぐお試しください]]'''。
