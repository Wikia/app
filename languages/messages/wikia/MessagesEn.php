...
'needhelp' => "Need Help: Please edit [[MediaWiki:needhelp|this page]] to show pages here.",
'shoutbox' => 'Shout Box',
'send' => 'Send',
...
#Special:SharedHelp
'shared_help_info' => 'This text is stored on Wikia Help. [$1 Suggest changes here].',
...
'edit_this_page' => "<a href=\"$1\">Edit this page</a>",
...
'oasis-total-articles-mainpage' => '<em>{{FORMATNUM:$1}}</em> {{PLURAL:$1|page on<br>this wiki|pages on<br> this wiki}}',
'oasis-latest-photos-header' => '<em>{{FORMATNUM:$1}}</em> {{PLURAL:$1|photo on<br> this wiki|photos on<br> this wiki}}',
