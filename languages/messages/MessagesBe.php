...
Можна працягваць працу на {{SITENAME}} ананімна, або можна $1, пад тым самым або пад іншым удзельніцкім імем. Заўважце, што некаторыя старонкі могуць паказвацца так, быццам вы яшчэ не выйшлі; у такім разе трэба ачысціць кэш вашага браўзера.",
'logouttext-link-text'       => 'ўвайсці ў сістэму ізноў',
