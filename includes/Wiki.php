...
class MediaWiki {
    ...
    if ( $request->getCheck( 'search' ) ) {
      // Temporarily making old search URLs obsoleted by PLA-131 still work
			// Do not merge this into dev, this should be in production only until varnish caches expire
