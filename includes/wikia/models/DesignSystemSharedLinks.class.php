...
class DesignSystemSharedLinks {
	...
	private $hrefs = [
		'default' => [
			...
			'wam' => '//community.wikia.com/WAM',
			'help' => '//community.wikia.com/wiki/Help:Contents',
			'media-kit' => '//fandom.wikia.com/mediakit',
		...
		'de' => [
			'explore-wikis' => '//fandom.wikia.com/explore-de?uselang=de',
			'fandom-logo' => '//fandom.wikia.com/explore-de?uselang=de',
			'about' => '//fandom.wikia.com/about?uselang=de',
			'press' => '//fandom.wikia.com/press?uselang=de',
			'contact' => '//fandom.wikia.com/about?uselang=de',
			...
			'wam' => '//community.wikia.com/WAM?langCode=de',
			'help' => 'http://de.community.wikia.com/wiki/Hilfe:%C3%9Cbersicht',
			'media-kit' => '//fandom.wikia.com/mediakit?uselang=de',
			...
			'games' => '//fandom.wikia.com/explore-de?uselang=de#Videospiele',
			'movies' => '//fandom.wikia.com/explore-de?uselang=de#Filme',
			'tv' => '//fandom.wikia.com/explore-de?uselang=de#TV',
		],
		'en' => [
			'fan-contributor' => '//fandom.wikia.com/fan-contributor',
			'media-kit-contact' => '//fandom.wikia.com/mediakit#contact',
		],
		'es' => [
			'explore-wikis' => '//fandom.wikia.com/explore-es?uselang=es',
			'fandom-logo' => '//fandom.wikia.com/explore-es?uselang=es',
			'about' => '//fandom.wikia.com/about?uselang=es',
			'press' => '//fandom.wikia.com/press?uselang=es',
			'contact' => '//fandom.wikia.com/about?uselang=es',
			...
			'wam' => '//community.com/WAM?langCode=es',
			'help' => 'http://comunidad.wikia.com/wiki/Ayuda:Contenidos',
			'media-kit' => '//fandom.wikia.com/mediakit?uselang=es',
			...
			'games' => '//fandom.wikia.com/explore-es?uselang=es#Juegos',
			'movies' => '//fandom.wikia.com/explore-es?uselang=es#Películas',
			'tv' => '//fandom.wikia.com/explore-es?uselang=es#TV',
		],
		'fr' => [
			'explore-wikis' => '//fandom.wikia.com/explore-fr?uselang=fe',
			'fandom-logo' => '//fandom.wikia.com/explore-fr?uselang=fr',
			'about' => '//fandom.wikia.com/about?uselang=fr',
			'press' => '//fandom.wikia.com/press?uselang=fr',
			'contact' => '//fandom.wikia.com/about?uselang=fr',
			...
			'wam' => '//community.com/WAM?langCode=fr',
			...
			'games' => '//fandom.wikia.com/explore-fr?uselang=fr#Jeux_vidéo',
			'movies' => '//fandom.wikia.com/explore-fr?uselang=fr#Cinéma',
			'tv' => '//fandom.wikia.com/explore-fr?uselang=fr#Télévision',
		],
		'it' => [
			'explore-wikis' => '//fandom.wikia.com/explore-it?uselang=it',
			'fandom-logo' => '//fandom.wikia.com/explore-it?uselang=it',
			'about' => '//fandom.wikia.com/about?uselang=it',
			'press' => '//fandom.wikia.com/press?uselang=it',
			'contact' => '//fandom.wikia.com/about?uselang=it',
			...
			'wam' => '//community.wikia.com/WAM?langCode=it',
			...
			'games' => '//fandom.wikia.com/explore-it?uselang=it#Giochi',
			'movies' => '//fandom.wikia.com/explore-it?uselang=it#Cinema',
			'tv' => '//fandom.wikia.com/explore-it?uselang=it#TV',
		],
		'ja' => [
			'explore-wikis' => '//fandom.wikia.com/explore-ja?uselang=ja',
			'fandom-logo' => '//fandom.wikia.com/explore-ja?uselang=ja',
			'about' => '//fandom.wikia.com/about?uselang=ja',
			'press' => '//fandom.wikia.com/press?uselang=ja',
			'contact' => '//fandom.wikia.com/about?uselang=ja',
			...
			'wam' => '//community.wikia.com/WAM?langCode=ja',
			...
			'games' => '//fandom.wikia.com/explore-ja?uselang=ja#ゲーム',
			'movies' => '//fandom.wikia.com/explore-ja?uselang=ja#映画',
			'tv' => '//fandom.wikia.com/explore-ja?uselang=ja#TV',
		],
		'pl' => [
			'explore-wikis' => '//fandom.wikia.com/explore-pl?uselang=pl',
			'fandom-logo' => '//fandom.wikia.com/explore-pl?uselang=pl',
			'about' => '//fandom.wikia.com/about?uselang=pl',
			'press' => '//fandom.wikia.com/press?uselang=pl',
			'contact' => '//fandom.wikia.com/about?uselang=pl',
			...
			'wam' => '//community.wikia.com/WAM?langCode=pl',
			...
			'games' => '//fandom.wikia.com/explore-pl?uselang=pl#Gry',
			'movies' => '//fandom.wikia.com/explore-pl?uselang=pl#Filmy',
			'tv' => '//fandom.wikia.com/explore-pl?uselang=pl#TV',
		],
		'pt-br' => [
			'explore-wikis' => '//fandom.wikia.com/explore-pt-br?uselang=pt-br',
			'fandom-logo' => '//fandom.wikia.com/explore-pt-br?uselang=pt-br',
			'about' => '//fandom.wikia.com/about?uselang=pt-br',
			'press' => '//fandom.wikia.com/press?uselang=pt-br',
			'contact' => '//fandom.wikia.com/about?uselang=pt-br',
			...
			'wam' => '//community.wikia.com/WAM?langCode=pt-br',
			...
			'games' => '//fandom.wikia.com/explore-pt-br?uselang=pt-br#Jogos',
			'movies' => '//fandom.wikia.com/explore-pt-br?uselang=pt-br#Filmes',
			'tv' => '//fandom.wikia.com/explore-pt-br?uselang=pt-br#TV',
		],
		'ru' => [
			'explore-wikis' => '//fandom.wikia.com/explore-ru?uselang=ru',
			'fandom-logo' => '//fandom.wikia.com/explore-ru?uselang=ru',
			'about' => '//fandom.wikia.com/about?uselang=ru',
			'press' => '//fandom.wikia.com/press?uselang=ru',
			'contact' => '//fandom.wikia.com/about?uselang=ru',
			...
			'wam' => '//community.wikia.com/WAM?langCode=ru',
			...
			'games' => '//fandom.wikia.com/explore-ru?uselang=ru#Видеоигры',
			'movies' => '//fandom.wikia.com/explore-ru?uselang=ru#Кино',
			'tv' => '//fandom.wikia.com/explore-ru?uselang=ru#ТВ',
		],
		'zh-hans' => [
			'explore-wikis' => '//fandom.wikia.com/explore-zh?uselang=zh',
			'fandom-logo' => '//fandom.wikia.com/explore-zh?uselang=zh',
			'about' => '//fandom.wikia.com/about?uselang=zh',
			'press' => '//fandom.wikia.com/press?uselang=zh',
			'contact' => '//fandom.wikia.com/about?uselang=zh',
			...
			'wam' => '//community.wikia.com/WAM?langCode=zh',
			...
			'games' => '//fandom.wikia.com/explore-zh?uselang=zh#游戏',
			'movies' => '//fandom.wikia.com/explore-zh?uselang=zh#电影',
			'tv' => '//fandom.wikia.com/explore-zh?uselang=zh#电视',
		],
		'zh-hant' => [
			'explore-wikis' => '//fandom.wikia.com/explore-zh-tw?uselang=zh-tw',
			'fandom-logo' => '//fandom.wikia.com/explore-zh-tw?uselang=zh-tw',
			'about' => '//fandom.wikia.com/about?uselang=zh-tw',
			'press' => '//fandom.wikia.com/press?uselang=zh-tw',
			'contact' => '//fandom.wikia.com/about?uselang=zh-tw',
			...
			'wam' => '//community.wikia.com/WAM?langCode=zh-tw',
			'help' => 'http://zh.community.wikia.com/wiki/Help:%E5%86%85%E5%AE%B9',
			...
			'games' => '//fandom.wikia.com/explore-zh-tw?uselang=zh-tw#遊戲',
			'movies' => '//fandom.wikia.com/explore-zh-tw?uselang=zh-tw#電影',
			'tv' => '//fandom.wikia.com/explore-zh-tw?uselang=zh-tw#電視',
		],
		'vi' => [
