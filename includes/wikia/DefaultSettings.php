...
$wgAutoloadClasses['WdsTranslatableTextWithParams'] = "{$IP}/includes/wikia/models/DesignSystem/WdsTranslatableTextWithParams.class.php";
...
$wgAutoloadClasses['WdsLinkAuthentication'] = "{$IP}/includes/wikia/models/DesignSystem/WdsLinkAuthentication.class.php";
$wgAutoloadClasses['WdsLinkAuthenticationWithSubtitle'] = "{$IP}/includes/wikia/models/DesignSystem/WdsLinkAuthenticationWithSubtitle.class.php";
