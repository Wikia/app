...
class ApiQueryAllimages extends ApiQueryGeneratorBase {
	...
	public function getExamples() {
		return array(
			'api.php?action=query&list=allimages&aifrom=B' => 'Show a list of images starting at the letter "B"',
			'api.php?action=query&generator=allimages&gailimit=4&gaifrom=T&prop=imageinfo' => 'Show info about 4 images starting at the letter "T"',
		);
	}
