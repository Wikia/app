...
class SkinTemplate extends Skin {
	...
	function outputPage( OutputPage $out=null ) {
		...
		*/
		...
		// Wikia change - using inherited methods from ContextSource to get instances of User and Title classes (nAndy)
		$user = $this->getUser();
		$title = $this->getTitle();
		...
		Hooks::run( 'SkinTemplatePageBeforeUserMsg', array( &$ntl ) );
	...
	protected function buildPersonalUrls() {
		...
		Hooks::run( 'PersonalUrls', array( &$personal_urls, &$title ) );
		wfProfileOut( __METHOD__ );
