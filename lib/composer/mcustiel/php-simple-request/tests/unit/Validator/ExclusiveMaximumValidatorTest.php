...
use Mcustiel\SimpleRequest\Validator\ExclusiveMaximum;

class ExclusiveMaximumValidatorTest extends \PHPUnit_Framework_TestCase
{
    private $validator;

    public function setUp()
    {
        $this->validator = new ExclusiveMaximum();
    }

    /**
     * @test
     * @expectedException \Mcustiel\SimpleRequest\Exception\UnspecifiedValidatorException
     * @expectedExceptionMessage The validator ExclusiveMaximum is being initialized without a valid number
     */
    ...
    public function testValidationWithIntegers()
    {
        ...
        $this->assertFalse($this->validator->validate(5));
