...
class AttributesApi
{
    ...
    public function getAttributesWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\User\Attributes\Models\AllAttributesHalResponse',
                '/attr'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\User\Attributes\Models\AllAttributesHalResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\User\Attributes\Models\AllAttributesHalResponse', $e->getResponseHeaders());
    ...
    /**
     * Operation getUserAttributeByName
     *
    ...
    {
        list($response) = $this->getUserAttributeByNameWithHttpInfo($name);
        return $response;
    }

    /**
     * Operation getUserAttributeByNameWithHttpInfo
     *
     * Returns the value of the given attribute
     *
     * @param string $name name of the user attribute (required)
    ...
    public function getUserAttributeByNameWithHttpInfo($name)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\User\Attributes\Models\AttributeHalResponse',
                '/attr/{name}'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\User\Attributes\Models\AttributeHalResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\User\Attributes\Models\AttributeHalResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
