...
class UsersAttributesApi
{
    ...
    {
        list($response) = $this->deleteAttributeWithHttpInfo($user_id, $attr_name);
        return $response;
    }
    ...
    {
        list($response) = $this->getAllAttributesWithHttpInfo($user_id);
        return $response;
    }
    ...
    public function getAllAttributesWithHttpInfo($user_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\User\Attributes\Models\AllUserAttributesHalResponse',
                '/user/{userId}'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\User\Attributes\Models\AllUserAttributesHalResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\User\Attributes\Models\AllUserAttributesHalResponse', $e->getResponseHeaders());
    ...
    /**
     * Operation getAllAttributesForMultipleUsers
     *
    ...
    {
        list($response) = $this->getAllAttributesForMultipleUsersWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation getAllAttributesForMultipleUsersWithHttpInfo
     *
     * Returns all available attributes for the specified list of users
     *
     * @param string[] $id  (optional)
    ...
    public function getAllAttributesForMultipleUsersWithHttpInfo($id = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\User\Attributes\Models\UsersWithAttributes',
                '/user/bulk'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\User\Attributes\Models\UsersWithAttributes', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\User\Attributes\Models\UsersWithAttributes', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
    ...
    {
        list($response) = $this->getAttributeWithHttpInfo($user_id, $attr_name);
        return $response;
    }
    ...
    public function getAttributeWithHttpInfo($user_id, $attr_name)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\User\Attributes\Models\UserAttributeHalResponse',
                '/user/{userId}/attr/{attrName}'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\User\Attributes\Models\UserAttributeHalResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\User\Attributes\Models\UserAttributeHalResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
    ...
    {
        list($response) = $this->saveAttributeWithHttpInfo($user_id, $attr_name, $value);
        return $response;
    }
     ...
     *
     * @param string $user_id The id of the user (required)
     * @param object $attributes HashMap that contains UserAttributes, key - attribute name, value - attribute value (required)
     * @return \Swagger\Client\User\Attributes\Models\UserAttributeHalResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function saveAttributes($user_id, $attributes)
    {
        list($response) = $this->saveAttributesWithHttpInfo($user_id, $attributes);
        return $response;
    }

    /**
     * Operation saveAttributesWithHttpInfo
     *
     * Saves multiple attributes for a specified user
     *
     * @param string $user_id The id of the user (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function saveAttributesWithHttpInfo($user_id, $attributes)
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null) {
        ...
        if ($attributes === null) {
            throw new \InvalidArgumentException('Missing the required parameter $attributes when calling saveAttributes');
        }
        // parse inputs
        $resourcePath = "/user/{userId}";
        $httpBody = '';
