...
/**
 * WikiToEntityRelationshipsApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   http://github.com/swagger-api/swagger-codegen
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WikiToEntityRelationshipsApi
{
     ...
     *
     * @return WikiToEntityRelationshipsApi
     */
    ...
    {
        list($response) = $this->createWithHttpInfo($wiki_id, $entity_id);
        return $response;
    }
    ...
    public function createWithHttpInfo($wiki_id, $entity_id)
    {
        ...
        if ($wiki_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $wiki_id when calling create');
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                null,
                '/wiki/relationships/{wikiId}/entity/{entityId}'
            );
    ...
    {
        list($response) = $this->getRelatedEntitiesWithHttpInfo($wiki_id);
        return $response;
    }
    ...
    {
        list($response) = $this->getRelatedWikisWithHttpInfo($entity_id);
        return $response;
    }

    /**
     * Operation getRelatedWikisWithHttpInfo
     *
     * get wiki related to an entity
     *
     * @param string $entity_id  (required)
    ...
    public function getRelatedWikisWithHttpInfo($entity_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                'string[]',
                '/wiki/relationships/entity/{entityId}'
            );
    ...
    {
        list($response) = $this->unrelateWithHttpInfo($wiki_id, $entity_id);
        return $response;
    }
    ...
    public function unrelateWithHttpInfo($wiki_id, $entity_id)
    {
        // verify the required parameter 'wiki_id' is set
        if ($wiki_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $wiki_id when calling unrelate');
        }
        // verify the required parameter 'entity_id' is set
        if ($entity_id === null) {
    ...
    {
        list($response) = $this->unrelateAllFromWikiWithHttpInfo($wiki_id);
        return $response;
    }

    /**
     * Operation unrelateAllFromWikiWithHttpInfo
     *
     * delete all of a wiki's entity relationships
     *
     * @param string $wiki_id  (required)
