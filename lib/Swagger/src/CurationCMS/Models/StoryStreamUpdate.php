...
/**
 * StoryStreamUpdate Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class StoryStreamUpdate implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StoryStreamUpdate';
    ...
    public function setHeadline($headline)
    {
        if ((strlen($headline) > 80)) {
            throw new \InvalidArgumentException('invalid length for $headline when calling StoryStreamUpdate., must be smaller than or equal to 80.');
        }
        if ((strlen($headline) < 1)) {
            throw new \InvalidArgumentException('invalid length for $headline when calling StoryStreamUpdate., must be bigger than or equal to 1.');
        }
