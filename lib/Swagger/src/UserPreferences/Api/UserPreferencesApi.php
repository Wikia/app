...
namespace Swagger\UserPreferences\Api;

use Swagger\Client\ApiClientConfiguration;
use Swagger\Client\ApiClient;
use Swagger\Client\ApiException;
use Swagger\Client\ObjectSerializer;

use Swagger\UserPreferences\Models\Preference;
use Swagger\UserPreferences\Models\Problem;
...
class UserPreferencesApi {
   ...
   */
   public function getUserPreferences($user_id) {
      ...
      try {
        ...
        switch ($e->getCode()) { 
          case 200:
            $data = ObjectSerializer::deserialize($e->getResponseBody(), 'array[\\Swagger\\UserPreferences\\Models\\Preference]');
            $e->setResponseObject($data);
            break;
          case 404:
            $data = ObjectSerializer::deserialize($e->getResponseBody(), '\\Swagger\\UserPreferences\\Models\\Problem');
            $e->setResponseObject($data);
            break;
        }
      ...
      $responseObject = ObjectSerializer::deserialize($response,'array[\\Swagger\\UserPreferences\\Models\\Preference]');
   ...
   *
   * @param int $user_id The id of the user to list the preferences (required)
   * @param array[\\Swagger\\UserPreferences\\Models\\Preference] $updated_user_preferences An array of user preference objects (required)
   * @return void
   * @throws \Swagger\Client\ApiException on non-2xx response
   */
   ...
   public function updateUserPreference($user_id, $preference_name, $updated_value) {
      ...
      if($preference_name !== null) {
        $resourcePath = str_replace("{" . "preferenceName" . "}",
                                    ObjectSerializer::toPathValue($preference_name),
                                    $resourcePath);
      }
