 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class HalLinks implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'HalLinks';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['__links__'] === null) {
            $invalid_properties[] = "'__links__' can't be null";
        }
     ...
     * @return string
     */
    public function getLinks_()
    {
        return $this->container['__links__'];
    }

    /**
     * Sets __links__
     * @param string $__links__
     * @return $this
     */
    public function setLinks_($__links__)
    {
        $this->container['__links__'] = $__links__;
