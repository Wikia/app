...
class PermalinksApi
{
     ...
     * @return \Swagger\Client\Discussion\Models\SimplifiedThreadResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getThread($site_id, $post_id, $viewable_only = null)
    {
        list($response) = $this->getThreadWithHttpInfo($site_id, $post_id, $viewable_only);
        return $response;
    }
     ...
     * @param int $post_id The id of a specific post (required)
     * @param bool $viewable_only viewableOnly (optional, default to true)
     * @return Array of \Swagger\Client\Discussion\Models\SimplifiedThreadResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getThreadWithHttpInfo($site_id, $post_id, $viewable_only = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Discussion\Models\SimplifiedThreadResponse',
                '/{siteId}/permalinks/posts/{postId}'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Discussion\Models\SimplifiedThreadResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Discussion\Models\SimplifiedThreadResponse', $e->getResponseHeaders());
