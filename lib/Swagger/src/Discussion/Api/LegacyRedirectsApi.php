...
class LegacyRedirectsApi
{
     ...
     * @return \Swagger\Client\Discussion\Models\LegacyRedirect
     ...
     * @param int $site_id The id of the site (required)
     * @param int $board_id Legacy Forum board ID (required)
     * @return Array of \Swagger\Client\Discussion\Models\LegacyRedirect, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getForumRedirectWithHttpInfo($site_id, $board_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Discussion\Models\LegacyRedirect',
                '/{siteId}/redirect/board/{boardId}'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Discussion\Models\LegacyRedirect', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Discussion\Models\LegacyRedirect', $e->getResponseHeaders());
