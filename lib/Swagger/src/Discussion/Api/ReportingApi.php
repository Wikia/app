...
class ReportingApi
{
     ...
     */
    public function createPostReport($site_id, $post_id)
    {
        list($response) = $this->createPostReportWithHttpInfo($site_id, $post_id);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function createPostReportWithHttpInfo($site_id, $post_id)
    {
     ...
     * @return \Swagger\Client\Discussion\Models\PostReportDetailList
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param int $site_id The id of the site (required)
     * @param int[] $post_id The id of the post (optional)
     * @return Array of \Swagger\Client\Discussion\Models\PostReportDetailList, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getPostListReportersWithHttpInfo($site_id, $post_id = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Discussion\Models\PostReportDetailList',
                '/{siteId}/reports'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Discussion\Models\PostReportDetailList', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Discussion\Models\PostReportDetailList', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Discussion\Models\HalProblem', $e->getResponseHeaders());
