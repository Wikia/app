...
// Files used to get basic settings an utilities (used almost universally by the others).
require_once "$dir/ApiGate_Config.php";
require_once "$dir/ApiGate_Profiler.php"; // has no dependencies & most other file depend on this... always include this before other files which have functions/methods in them.
