...
class gapi
{
  ...
  private $http_interface = null;
  private $curl_proxy = null;
   ...
   * @return gapi
   */
  public function __construct($email, $password, $token=null, $http_interface = 'auto' /* 'auto': autodetect, 'curl' or 'fopen' */, $curl_proxy = null)
  {
  	$this->http_interface = $http_interface;
  	$this->curl_proxy = $curl_proxy;
  ...
  protected function httpRequest($url, $get_variables=null, $post_variables=null, $headers=null)
  {
    ...
    {
      throw new Exception('Invalid http interface defined. No such interface "' . $this->http_interface . '"');
    }
  }
