...
define('wikia.breakpointsLayout',  function() {
	...
	function getArticleWidth(breakpoint, isRightRailDropped) {
		var maxArticleWidth = isRightRailDropped ? 1178 : 858,
			currentArticleWidth = isRightRailDropped ? 1004 : 684,
			minArticleWidth = 718;

		switch(breakpoint) {
			case 'current':
				return currentArticleWidth;
			case 'max':
